...
\begin{proof}[\pf{i:3.6.9}]
  ...
  \begin{itemize}
    ...
    \item If \(f(x) \leq i \leq m\), then by \cref{i:2.2.12.d,i:2.2.12.e}, we have \(f(x) < i\pp \leq m\pp = n\).
...
\begin{proof}[\pf{i:3.6.14.b}]
  ...
  \begin{itemize}
    ...
    \item If \(z_1 \in X\) and \(z_2 \in Y\), then by \cref{i:ac:2.2.3} and \cref{i:2.2.12.b,i:2.2.12.d}, we have
          \[
            1 \leq h(z_1) = f(z_1) \leq \#(X) < \#(X) + 1 \leq h(z_2) = g(z_2) + \#(X) \leq \#(X) + \#(Y).
          \]
          By \cref{i:2.2.13}, this means \(h(z_1) \neq h(z_2)\).
    \item If \(z_1 \in Y\) and \(z_2 \in X\), then by \cref{i:ac:2.2.3} and \cref{i:2.2.12.b,i:2.2.12.d}, we have
          \[
