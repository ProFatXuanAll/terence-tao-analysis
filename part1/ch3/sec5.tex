...
\begin{ex}\label{i:ex:3.5.1}
  \begin{enumerate}
    ...
    \item\label{i:ex:3.5.1.b} For an additional challenge, show that the alternate definition \((x, y) := \set{x, \set{x, y}}\) also verifies \cref{i:3.5.1} and is thus also an acceptable definition of ordered pair.
