...
\begin{rmk}\label{i:3.1.3}
  ...
  however, from a conceptual point of view, it is often easier to deal with impure set theories in which some objects are not considered to be set.
...
\begin{ac}\label{i:ac:3.1.1}
  The definition of equality in \labelcrefs{i:3.1.4} is reflexive, symmetric, and transitive.
\end{ac}

\begin{proof}[\pf{i:ac:3.1.1}]
  Let \(A, B, C\) be sets.
  We first show that \labelcrefs{i:3.1.4} is reflexive.
  Since \(x \in A \iff x \in A\) for all \(x \in A\), by \labelcrefs{i:3.1.4}, we have \(A = A\).
  Thus, \labelcrefs{i:3.1.4} is reflexive.

  Next we show that \labelcrefs{i:3.1.4} is symmetric.
  Suppose that \(A = B\).
  By \labelcrefs{i:3.1.4}, we have \(x \in A \iff x \in B\) for all \(x \in A\).
  But this means \(y \in B \iff y \in A\) for all \(y \in B\).
  Thus, by \labelcrefs{i:3.1.4}, we have \(B = A\).
  So \labelcrefs{i:3.1.4} is symmetric.

  Finally, we show that \labelcrefs{i:3.1.4} is transitive.
  Suppose that \(A = B\) and \(B = C\).
  By \labelcrefs{i:3.1.4}, we have \(x \in A \iff x \in B\) for all \(x \in A\), and \(y \in B \iff y \in C\) for all \(y \in B\).
  Then we have \(x \in A \iff x \in C\) for all \(x \in A\), and, by \labelcrefs{i:3.1.4}, we have \(A = C\).
  Thus, \labelcrefs{i:3.1.4} is transitive.
\end{proof}

\begin{note}
  Observe that if \(x \in A\) and \(A = B\), then \(x \in B\), by \labelcrefs{i:3.1.4}.
...
\begin{note}
  ...
  The situation is analogous to how we defined the natural numbers in \labelcrefs{i:ch:2};
...
\begin{proof}[\pf{i:ac:3.1.2}]
  ...
  Then the statement ``every element \(x\) of \(\emptyset\) is also an element of \(\emptyset'\)'' is vacuously true, since, by \labelcrefs{i:3.2}, there does not exist any element of \(\emptyset\).
  ...
  By \labelcrefs{i:3.1.4}, this means \(\emptyset = \emptyset'\).
...
\begin{proof}[\pf{i:3.1.6}]
  ...
  Also, by \labelcrefs{i:3.2}, we have \(x \notin \emptyset\).
  Thus, \(x \in A \iff x \in \emptyset\) (both statements are equally false), and so \(A = \emptyset\) by \labelcrefs{i:3.1.4}, a contradiction.
\end{proof}

\begin{rmk}\label{i:3.1.7}
  \labelcrefs{i:3.1.6} asserts that given any non-empty set \(A\), we are allowed to ``choose'' an element \(x\) of \(A\) which demonstrates this non-emptyness.
  Later on (in \labelcrefs{i:3.5.12}) we will show that given any finite number of non-empty sets, say \(A_1, \dots, A_n\), it is possible to choose one element \(x_1, \dots, x_n\) from each set \(A_1, \dots, A_n\);
  this is known as ``finite choice.''
  However, in order to choose elements from an infinite number of sets, we need an additional axiom, the \emph{axiom of choice} (\labelcrefs{i:8.1}).
\end{rmk}
...
\begin{rmk}\label{i:3.1.9}
  ...
  Also, \labelcrefs{i:3.1.4} also ensures that \(\set{a, b} = \set{b, a}\) and \(\set{a, a} = \set{a}\).
  Thus, the singleton set axiom is in fact redundant, being a consequence of the pair set axiom.
  Conversely, the pair set axiom will follow from the singleton set axiom and the pairwise union axiom (\labelcrefs{i:3.4}) below (see \labelcrefs{i:3.1.13}).
  One may wonder why we don't go further and create triplet axioms, quadruplet axioms, etc.;
  however there will be no need for this once we introduce the pairwise union axiom (\labelcrefs{i:3.4}) below.
\end{rmk}
...
\begin{proof}[\pf{i:3.1.9}]
  ...
  Then by \labelcrefs{i:3.3}, we have ``\(x \in A \iff x = a\)'' and ``\(x \in A' \iff x = a\).''
  But this means \(x \in A \iff x \in A'\).
  Thus, by \labelcrefs{i:3.1.4}, we have \(A = A'\), and therefore the uniqueness of singleton set is proved.

  Next we show the uniqueness of pair set.
  Suppose there exist two sets \(X\) and \(X'\) which are pair sets of object \(a\) and \(b\).
  Then by \labelcrefs{i:3.3}, we have ``\(x \in X \iff (x = a) \lor (x = b)\)'' and ``\(x \in X' \iff (x = a) \lor (x = b)\).''
  But this means \(x \in X \iff x \in X'\).
  Thus, by \labelcrefs{i:3.1.4}, we have \(X = X'\), and therefore the uniqueness of pair set is proved.
  ...
  \end{align*}
  by \labelcrefs{i:3.1.4}, we know that \(\set{a, b} = \set{b, a}\).
  ...
  \end{align*}
  by \labelcrefs{i:3.1.4}, we know that \(\set{a, a} = \set{a}\).
\end{proof}
...
\begin{proof}[\pf{i:3.1.12}]
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \(A \cup B = A' \cup B\).
...
\begin{proof}[\pf{i:3.1.13}]
  ...
  By \labelcrefs{i:3.3}, we know the sets \(\set{a}, \set{b}, \set{a, b}\) exist.
  By \labelcrefs{i:3.4}, we know the set \(\set{a} \cup \set{b}\) exists.
  Then we have
  \begin{align*}
         & x \in \set{a, b}                                     \\
    \iff & (x = a) \lor (x = b)                 &  & \by{i:3.3} \\
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \(\set{a, b} = \set{a} \cup \set{b}\).

  Next we show the commutative identity of union sets.
  Suppose that \(A, B\) are sets.
  By \labelcrefs{i:3.4}, we know that both \(A \cup B\) and \(B \cup A\) exist.
  Then we have
  \begin{align*}
         & x \in A \cup B                           \\
    \iff & (x \in A) \lor (x \in B) &  & \by{i:3.4} \\
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \(A \cup B = B \cup A\).

  Next we show the associativity identity of union sets.
  Suppose \(A, B, C\) are sets.
  By \labelcrefs{i:3.4}, we know that both \(A \cup B\) and \(B \cup C\) exist.
  Thus, by \labelcrefs{i:3.4} again, we know that both \((A \cup B) \cup C\) and \(A \cup (B \cup C)\) exist.
  Then we have
  \begin{align*}
         & x \in (A \cup B) \cup C                                   \\
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \((A \cup B) \cup C = A \cup (B \cup C)\).

  Finally we show that \(A \cup A = A \cup \emptyset = \emptyset \cup A = A\) for any set \(A\).
  By \labelcrefs{i:3.4}, we know that the sets \(A \cup A\), \(A \cup \emptyset\), and \(\emptyset \cup A\) exist.
  Then we have
  \begin{align*}
         & x \in A \cup A                                   \\
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we see that \(A \cup A = A = A \cup \emptyset\).
  Using commutative law of union, we see that \(A \cup \emptyset = \emptyset \cup A\).
\end{proof}

\begin{note}
  Because of \labelcrefs{i:3.1.13}, we do not need to use parentheses to denote multiple unions, thus for instance we can write \(A \cup B \cup C\) instead of \((A \cup B) \cup C\) or \(A \cup (B \cup C)\).
...
\begin{note}
  \labelcrefs{i:3.4} allows us to define triplet sets, quadruplet sets, and so forth: if \(a, b, c\) are three objects, we define \(\set{a, b, c} \coloneqq \set{a} \cup \set{b} \cup \set{c}\);
  ...
  For similar reasons, we cannot yet define sets consisting of infinitely many objects, because that would require iterating the axiom of pairwise union (\labelcrefs{i:3.4}) infinitely often, and it is not clear at this stage that one can do this rigorously.
...
\begin{proof}[\pf{i:3.1.17}]
  ...
  Therefore, by \labelcrefs{i:3.1.15}, we have \(A \subseteq A\).
  The statement ``\(x \in \emptyset \implies x \in A\)'' is vacuously true, since \(x \in \emptyset\) is false for all object \(x\) (\labelcrefs{i:3.2}).
  Thus, by \labelcrefs{i:3.1.15}, we have \(\emptyset \subseteq A\).
\end{proof}
...
\begin{proof}[\pf{i:3.1.18}]
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.15}, we only need to show that \(A \neq C\).
  Suppose for the sake of contradiction that \(A = C\).
  ...
  But this contradicts \(B \subsetneq C\).
  Thus, we must have \(A \neq C\).
\end{proof}
...
\begin{rmk}\label{i:3.1.20}
  ...
  Given any two distinct natural numbers \(n\), \(m\), we know that one of them is smaller than the other (\labelcrefs{i:2.2.13});
  however, given two distinct sets, it is not in general true that one of them is a subset of the other.
  We say that sets are only \emph{partially ordered}, whereas the natural numbers are \emph{totally ordered} (see \labelcrefs{i:8.5.1,i:8.5.3}).
\end{rmk}
...
\begin{note}
  \labelcrefs{i:3.5} is also known as the \emph{axiom of separation}.
...
\begin{prop}[Sets form a boolean algebra]\label{i:3.1.28}
  ...
  \begin{enumerate}
    \item\label{i:3.1.28.a} (Minimal element) We have \(A \cup \emptyset = A\) and \(A \cap \emptyset = \emptyset\).
    \item\label{i:3.1.28.b} (Maximal element) We have \(A \cup X = X\) and \(A \cap X = A\).
    \item\label{i:3.1.28.c} (Identity) We have \(A \cap A = A\) and \(A \cup A = A\).
    \item\label{i:3.1.28.d} (Commutativity) We have \(A \cup B = B \cup A\) and \(A \cap B = B \cap A\).
    \item\label{i:3.1.28.e} (Associativity) We have \((A \cup B) \cup C = A \cup (B \cup C)\) and \((A \cap B) \cap C = A \cap (B \cap C)\).
    \item\label{i:3.1.28.f} (Distributivity) We have \(A \cap (B \cup C) = (A \cap B) \cup (A \cap C)\) and \(A \cup (B \cap C) = (A \cup B) \cap (A \cup C)\).
    \item\label{i:3.1.28.g} (Partition) We have \(A \cup (X \setminus A) = X\) and \(A \cap (X \setminus A) = \emptyset\).
    \item\label{i:3.1.28.h} (De Morgan laws) We have \(X \setminus (A \cup B) = (X \setminus A) \cap (X \setminus B)\) and \(X \setminus (A \cap B) = (X \setminus A) \cup (X \setminus B)\).
  \end{enumerate}
\end{prop}

\begin{proof}[\pf{i:3.1.28.a}]
  By \labelcrefs{i:3.1.13}, we have \(A \cup \emptyset = A\).
  Then we have
  \begin{align*}
         & x \in A \cap \emptyset                               \\
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \(A \cap \emptyset = \emptyset\).
\end{proof}
...
\begin{proof}[\pf{i:3.1.28.b}]
  ...
  \begin{align*}
    ...
    \iff & \begin{dcases}
           ...
           \end{dcases}.    &  & \by{i:3.1.15}
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \(A \cup X = X\).
  Similarly, we have
  \begin{align*}
         & \begin{dcases}
             x \in A \cap X \\
    ...
    \iff & \begin{dcases}
           ...
           \end{dcases}.     &  & \by{i:3.1.15}
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \(A \cap X = A\).
\end{proof}

\begin{proof}[\pf{i:3.1.28.c}]
  By \labelcrefs{i:3.1.13}, we have \(A \cup A = A\).
  Then we have
  \begin{align*}
         & x \in A \cap A                               \\
    ...
    \iff & x \in A.
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \(A \cap A = A\).
\end{proof}

\begin{proof}[\pf{i:3.1.28.d}]
  By \labelcrefs{i:3.1.13}, we have \(A \cup B = B \cup A\).
  Then we have
  \begin{align*}
         & x \in A \cap B                               \\
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \(A \cap B = B \cap A\).
\end{proof}

\begin{proof}[\pf{i:3.1.28.e}]
  By \labelcrefs{i:3.1.13}, we have \((A \cup B) \cup C = A \cup (B \cup C)\).
  Then we have
  \begin{align*}
         & x \in (A \cap B) \cap C                                        \\
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \((A \cap B) \cap C = A \cap (B \cap C)\).
\end{proof}
...
\begin{proof}[\pf{i:3.1.28.f}]
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we know that \(A \cap (B \cup C) = (A \cap B) \cup (A \cap C)\), and \(A \cup (B \cap C) = (A \cup B) \cap (A \cup C)\).
\end{proof}
...
\begin{proof}[\pf{i:3.1.28.g}]
  ...
  \begin{align*}
    ...
    \iff & x \in \emptyset.                               &  & \by{i:3.2}
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \(A \cup (X \setminus A) = A \cup X\), and \(A \cap (X \setminus A) = \emptyset\).
\end{proof}
...
\begin{proof}[\pf{i:3.1.28.h}]
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \(X \setminus (A \cup B) = (X \setminus A) \cap (X \setminus B)\), and \(X \setminus (A \cap B) = (X \setminus A) \cup (X \setminus B)\).
\end{proof}
...
\begin{rmk}\label{i:3.1.30}
  ...
  \labelcrefs{i:3.1.28} are collectively known as the \emph{laws of Boolean algebra}, after the mathematician George Boole (1815--1864), and are also applicable to a number of other objects other than sets;
...
\begin{note}
  ...
  \(E\) must exist so that we can apply \labelcrefs{i:3.6}.
...
\begin{ex}\label{i:ex:3.1.1}
  Show that the definition of equality in \labelcrefs{i:3.1.4} is reflexive, symmetric, and transitive.
\end{ex}

\begin{proof}[\pf{i:ex:3.1.1}]
  See \labelcrefs{i:ac:3.1.1}.
\end{proof}

\begin{ex}\label{i:ex:3.1.2}
  Using only \labelcrefs{i:3.1.4}, \labelcrefs{i:3.1}, \labelcrefs{i:3.2}, and \labelcrefs{i:3.3}, prove that the sets \(\emptyset\), \(\set{\emptyset}\), \(\set{\set{\emptyset}}\), and \(\set{\emptyset, \set{\emptyset}}\) are all distinct
...
\begin{ex}\label{i:ex:3.1.3}
  Prove the remaining claims in \labelcrefs{i:3.1.13}.
\end{ex}

\begin{proof}[\pf{i:ex:3.1.3}]
  See \labelcrefs{i:3.1.13}.
\end{proof}

\begin{ex}\label{i:ex:3.1.4}
  Prove the remaining claims in \labelcrefs{i:3.1.18}.
\end{ex}

\begin{proof}[\pf{i:ex:3.1.4}]
  See \labelcrefs{i:3.1.18}.
\end{proof}
...
\begin{proof}[\pf{i:ex:3.1.5}]
  ...
  By \labelcrefs{i:3.1.28.b}, we see that \(A \subseteq B \implies A \cup B = B\).
  ...
  Then by \labelcrefs{i:3.1.15}, there exists an object \(x \in A\), such that \(x \notin B\).
  Since \(x \in A\), by \labelcrefs{i:3.4}, we know that \(x \in A \cup B\).
  But, by \labelcrefs{i:3.1.4}, we know that \(A \cup B = B\) implies \(x \in B\), a contradiction.
  Thus, we must have \(A \subseteq B\).
  We conclude that \(A \subseteq B \iff A \cup B = B\).

  Now we show that \(A \subseteq B \iff A \cap B = A\).
  By \labelcrefs{i:3.1.28.b}, we see that \(A \subseteq B \implies A \cap B = A\).
  ...
  \begin{align*}
    ...
    \implies & x \in B.
  \end{align*}
  By \labelcrefs{i:3.1.15}, this means \(A \subseteq B\).
  We conclude that \(A \subseteq B \iff A \cap B = A\).
\end{proof}

\begin{ex}\label{i:ex:3.1.6}
  Prove \labelcrefs{i:3.1.28}.
\end{ex}

\begin{proof}[\pf{i:ex:3.1.6}]
  See \labelcrefs{i:3.1.28}.
\end{proof}
...
\begin{proof}[\pf{i:ex:3.1.7}]
  ...
  \begin{align*}
    ...
    \implies & x \in A.
  \end{align*}
  Thus, by \labelcrefs{i:3.1.15}, we have \(A \cap B \subseteq A\).
  Using an identical argument, we see that \(B \cap A \subseteq B\).
  By \labelcrefs{i:3.1.28.d}, we see that \(B \cap A = A \cap B \subseteq B\).
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.15}, we have \(A \subseteq A \cup B\).
  Using an identical argument, we see that \(B \subseteq B \cup A\).
  By \labelcrefs{i:3.1.28.d}, we have \(B \subseteq A \cup B = B \cup A\).
...
\begin{proof}[\pf{i:ex:3.1.8}]
  ...
  \begin{align*}
    ...
    \iff & x \in A.
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \(A \cap (A \cup B) = A\) and \(A \cup (A \cap B) = A\).
\end{proof}
...
\begin{proof}[\pf{i:ex:3.1.9}]
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \(A = (A \cup B) \setminus B\).
  Hence, \(A = X \setminus B\).

  By \labelcrefs{i:3.1.28.d}, we have \(A \cup B = B \cup A = X\) and \(A \cap B = B \cap A = \emptyset\).
...
\begin{proof}[\pf{i:ex:3.1.10}]
  ...
  \begin{align*}
    ...
    \iff & x \in \emptyset.                                                 &  & \by{i:3.2}
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \((A \setminus B) \cap (A \cap B) = \emptyset\).
  Hence, \(A \setminus B\) and \(A \cap B\) are disjoint.
  By \labelcrefs{i:3.1.28.d}, we have \(B \cap A = A \cap B\).
  ...
  \begin{align*}
    ...
    \iff & x \in \emptyset.                                                    &  & \by{i:3.2}
  \end{align*}
  Hence, by \labelcrefs{i:3.1.4}, we have \((A \setminus B) \cap (B \setminus A) = \emptyset\).
  ...
  \begin{align*}
    ...
    \iff & x \in A \cup B.                                                                                     &  & \by{i:3.4}
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have \((A \setminus B) \cup (A \cap B) \cup (B \setminus A) = A \cup B\).
\end{proof}
...
\begin{proof}[\pf{i:ex:3.1.11}]
  To show that \labelcrefs{i:3.6} implies \labelcrefs{i:3.5}, we need to show that every set created by \labelcrefs{i:3.5} can also be created by \labelcrefs{i:3.6}.
  So let \(\set{x \in A : Q(x)}\) be a set created by \labelcrefs{i:3.5}, where \(A\) is a set, and \(Q(x)\) is a property of object \(x \in A\).
  ...
  Hence, we can use \labelcrefs{i:3.6} to create a set \(\set{y : P(x, y) \text{ is true for some } x \in A}\).
  Then we have
  \begin{align*}
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4}, we have
  \[
    \set{y : P(x, y) \text{ is true for some } x \in A} = \set{x \in A : Q(x) \text{ is true}}.
  \]
  This means any set created by \labelcrefs{i:3.5} can be created by \labelcrefs{i:3.6}.
  We conclude that \labelcrefs{i:3.6} implies \labelcrefs{i:3.5}.
\end{proof}
