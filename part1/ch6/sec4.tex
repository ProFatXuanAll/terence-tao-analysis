...
\begin{proof}
  ...
  Thus, by \labelcrefs{i:6.4.1} \(c\) is a limit point of \((a_n)_{n = m}^\infty\).

  Now we show that \(c\) is the only limit point of \((a_n)_{n = m}^\infty\).
  Let \(N \in \N\).
  Suppose for the sake of contradiction that \(c'\) is also a limit point of \((a_n)_{n = m}^\infty\) and \(c' \neq c\).
...
\begin{prop}\label{i:6.4.12}
  ...
  \begin{enumerate}
    \item\label{i:6.4.12.a} For every \(x > L^+\), there exists an \(N \geq m\) such that \(a_n < x\) for all \(n \geq N\).
    ...
    \item\label{i:6.4.12.b} For every \(x < L^+\), and every \(N \geq m\), there exists an \(n \geq N\) such that \(a_n > x\).
    ...
    \item\label{i:6.4.12.c} We have \(\inf(a_n)_{n = m}^\infty \leq L^- \leq L^+ \leq \sup(a_n)_{n = m}^\infty\).
    \item\label{i:6.4.12.d} If \(c\) is any limit point of \((a_n)_{n = m}^\infty\), then we have \(L^- \leq c \leq L^+\).
    \item\label{i:6.4.12.e} If \(L^+\) is finite, then it is a limit point of \((a_n)_{n = m}^\infty\).
    Similarly, if \(L^-\) is finite, then it is a limit point of \((a_n)_{n = m}^\infty\).
    \item\label{i:6.4.12.f} Let \(c\) be a real number.
    If \((a_n)_{n = m}^\infty\) converges to \(c\), then we must have \(L^+ = L^- = c\).
    Conversely, if \(L^+ = L^- = c\), then \((a_n)_{n = m}^\infty\) converges to \(c\).
  \end{enumerate}
\end{prop}

\begin{proof}[\pf{i:6.4.12.a}]
  Suppose first that \(x > L^+\).
  Then by definition of \(L^+\), we have \(x > \inf(a_N^+)_{N = m}^\infty\).
  By \labelcrefs{i:6.3.7}, there must then exist an integer \(N \geq m\) such that \(x > a_N^+\).
  By definition of \(a_N^+\), this means that \(x > \sup(a_n)_{n = N}^\infty\).
  Thus, by \labelcrefs{i:6.3.6}, we have \(x > a_n\) for all \(n \geq N\), as desired.

  Now suppose that \(y < L^-\).
  Then by definition of \(L^-\), we have \(y < \sup(a_N^-)_{N = m}^\infty\).
  By \labelcrefs{i:6.3.6}, there must then exist an integer \(N \geq m\) such that \(y < a_N^-\).
  By definition of \(a_N^-\), this means that \(y < \inf(a_n)_{n = N}^\infty\).
  Thus, by \labelcrefs{i:6.3.7}, we have \(y < a_n\) for all \(n \geq N\), as desired.
\end{proof}

\begin{proof}[\pf{i:6.4.12.b}]
  Suppose that \(x < L^+\).
  Then we have \(x < \inf(a_N^+)_{N = m}^\infty\).
  If we fix any \(N \geq m\), then by \labelcrefs{i:6.3.7}, we thus have \(x < a_N^+\).
  By definition of \(a_N^+\), this means that \(x < \sup(a_n)_{n = N}^\infty\).
  By \labelcrefs{i:6.3.6}, there must thus exist \(n \geq N\) such that \(a_n > x\), as desired.

  Now suppose that \(y > L^-\).
  Then we have \(y > \sup(a_N^-)_{N = m}^\infty\).
  If we fix any \(N \geq m\), then by \labelcrefs{i:6.3.6}, we thus have \(y > a_N^-\).
  By definition of \(a_N^-\), this means that \(y > \inf(a_n)_{n = N}^\infty\).
  By \labelcrefs{i:6.3.7}, there must thus exist \(n \geq N\) such that \(a_n < y\), as desired.
\end{proof}

\begin{proof}[\pf{i:6.4.12.c}]
  Let \(N \in \N\).
  ...
  Let \(N_1, N_2 \in \N\).
  Suppose for the sake of contradiction that \(L^- > L^+\).
  Then we have
  \begin{align*}
             & L^+ < L^-                                                                     \\
...
\begin{proof}[\pf{i:6.4.12.d}]
  Let \(N, n' \in \N\).
  Suppose that \(c\) is a limit point of \((a_n)_{n = m}^\infty\).
  We first show that \(L^- \leq c\).
  Suppose for the sake of contradiction that \(L^- > c\).
  Let \(\varepsilon = (L^- - c) / 2\).
  Since \(c\) is a limit point, by \labelcrefs{i:6.4.1} \(\forall N \geq m\), \(\exists n \geq N\) such that \(\abs{a_n - c} \leq \varepsilon\).
  So we have \(-\varepsilon \leq a_n - c \leq \varepsilon\) and thus \(a_n \leq c + \varepsilon\).
  Since \(L^- - \varepsilon < L^-\), by \labelcrefs{i:6.4.12.a} we have \(\exists N \geq m\) such that \(a_{n'} > L^- - \varepsilon\) for every \(n' \geq N\).
  ...
  Since \(L^+ < L^+ + \varepsilon\), by \labelcrefs{i:6.4.12.a} we have \(\exists N \geq m\) such that \(a_{n'} < L^+ + \varepsilon\) for every \(n' \geq N\).
...
\begin{proof}[\pf{i:6.4.12.e}]
  Let \(N, N' \in \N\).
  We first show that if \(L^+\) is finite, then \(L^+\) is a limit point of \((a_n)_{n = m}^\infty\).
  By \labelcrefs{i:6.4.1} we need to show that \(\forall \varepsilon \in \R^+\), \(\forall N \geq m\), \(\exists n \geq N\) such that \(\abs{a_n - L^+} \leq \varepsilon\).
  Since \(L^+ < L^+ + \varepsilon\), by \labelcrefs{i:6.4.12.a} \(\exists N' \geq m\) such that \(a_n < L^+ + \varepsilon\) for every \(n \geq N'\).
  But this also means \(\forall N \geq m\), \(\exists n \geq N\) such that \(a_n < L^+ + \varepsilon\) as long as we always choose \(n \geq \max(N', N)\).
  Since \(L^+ - \varepsilon < L^+\), by \labelcrefs{i:6.4.12.b}, \(\forall N \geq m\), \(\exists n \geq N\) such that \(a_n > L^+ - \varepsilon\).
  ...
  By \labelcrefs{i:6.4.1} we need to show that \(\forall \varepsilon \in \R^+\), \(\forall N \geq m\), \(\exists n \geq N\) such that \(\abs{a_n - L^-} \leq \varepsilon\).
  Since \(L^- - \varepsilon < L^-\), by \labelcrefs{i:6.4.12.a} \(\exists N' \geq m\) such that \(a_n > L^- - \varepsilon\) for every \(n \geq N'\).
  But this also means \(\forall N \geq m\), \(\exists n \geq N\) such that \(a_n > L^- - \varepsilon\) as long as we always choose \(n \geq \max(N', N)\).
  Since \(L^- < L^- + \varepsilon\), by \labelcrefs{i:6.4.12.b}, \(\forall N \geq m\), \(\exists n \geq N\) such that \(a_n < L^- + \varepsilon\).
  Combine the two statements above we have \(\forall N \geq m\), \(\exists n \geq N\) such that \(L^- - \varepsilon < a_n < L^- + \varepsilon\).
  Thus, \(\abs{a_n - L^-} < \varepsilon\) and \(L^-\) is also a limit point.
\end{proof}

\begin{proof}[\pf{i:6.4.12.f}]
  Let \(N, N_1, N_2, n_1, n_2 \in \N\).
  We first show that if \(\lim_{n \to \infty} a_n = c\), then \(L^+ = c\).
  By \labelcrefs{i:6.4.5}, \(c\) is the only limit point of \((a_n)_{n = m}^\infty\).
  And by \labelcrefs{i:6.4.12.d}, we have \(L^- \leq c \leq L^+\).
  Suppose for the sake of contradiction that \(c \neq L^+\).
  Then we must have \(c < L^+\).
  Let \(\varepsilon = (L^+ - c) / 2\).
  Since \(L^+ - \varepsilon < L^+\), by \labelcrefs{i:6.4.12.b}, \(\forall N_1 \geq m\), \(\exists n_1 \geq N_1\) such that \(a_{n_1} > L^+ - \varepsilon\).
  ...
  Let \(\varepsilon = (c - L^-) / 2\).
  Since \(L^- < L^- + \varepsilon\), by \labelcrefs{i:6.4.12.b}, \(\forall N_1 \geq m\), \(\exists n_1 \geq N_1\) such that \(a_{n_1} < L^- + \varepsilon\).
  ...
  Since \(c = L^+\), by \labelcrefs{i:6.4.12.a} \(\exists N_1 \geq m\) such that \(a_{n_1} < c + \varepsilon\) for every \(n_1 \geq N_1\).
  Similarly, since \(c = L^-\), by \labelcrefs{i:6.4.12.a} \(\exists N_2 \geq m\) such that \(c - \varepsilon < a_{n_2}\) for every \(n_2 \geq N_2\).
  Let \(N = \max(N_1, N_2)\).
...
\begin{note}
  Parts (d) and (e) of \labelcrefs{i:6.4.12} say, in particular, that \(L^+\) is the largest limit point of \((a_n)_{n = m}^\infty\), and \(L^-\) is the smallest limit point
  (providing that \(L^+\) and \(L^-\) are finite).
  \labelcrefs{i:6.4.12} (f) then says that if \(L^+\) and \(L^-\) coincide (so there is only one limit point), then the sequence in fact converges.
...
\begin{proof}
  ...
  Suppose for the sake of contradiction that \(\sup(a_n)_{n = m}^\infty > \sup(b_n)_{n = m}^\infty\).
  Then by \labelcrefs{i:6.3.6} \(\exists n' \geq m\) such that \(a_{n'} > \sup(b_n)_{n = m}^\infty\).
  Also by \labelcrefs{i:6.3.1} \(\forall n \geq m\) we have \(\sup(b_n)_{n = m}^\infty \geq b_n\).
  ...
  Suppose for the sake of contradiction that \(\inf(a_n)_{n = m}^\infty > \inf(b_n)_{n = m}^\infty\).
  Then by \labelcrefs{i:6.3.7} \(\exists n' \geq m\) such that \(b_{n'} < \inf(a_n)_{n = m}^\infty\).
  Also by \labelcrefs{i:6.3.1} \(\forall n \geq m\) we have \(\inf(a_n)_{n = m}^\infty \leq a_n\).
  ...
  Suppose for the sake of contradiction that \(\limsup_{n \to \infty} a_n > \limsup_{n \to \infty} b_n\).
  By \labelcrefs{i:6.4.6} we have \(\inf(a_n^+)_{n = m}^\infty > \inf(b_n^+)_{n = m}^\infty\).
  By \labelcrefs{i:6.3.7} \(\exists n' \geq m\) such that \(b_{n'}^+ < \inf(a_n^+)_{n = m}^\infty\).
  By \labelcrefs{i:6.3.1} \(\forall n \geq m\) we have \(\inf(a_n^+)_{n = m}^\infty \leq a_n^+\).
  But this means \(b_{n'}^+ < a_n^+\), in particular, \(b_{n'}^+ < a_{n'}^+\).
  Again by \labelcrefs{i:6.4.6} we have \(\sup(b_n)_{n = n'}^\infty < \sup(a_n)_{n = n'}^\infty\).
  But this contradicts the proof above that \(\sup(b_n)_{n = n'}^\infty \geq \sup(a_n)_{n = n'}^\infty\).
  ...
  Suppose for the sake of contradiction that \(\liminf_{n \to \infty} a_n > \liminf_{n \to \infty} b_n\).
  By \labelcrefs{i:6.4.6} we have \(\sup(a_n^-)_{n = m}^\infty > \sup(b_n^-)_{n = m}^\infty\).
  By \labelcrefs{i:6.3.6} \(\exists n' \geq m\) such that \(a_{n'}^- > \sup(b_n^-)_{n = m}^\infty\).
  By \labelcrefs{i:6.3.1} \(\forall n \geq m\) we have \(\sup(b_n^-)_{n = m}^\infty \geq b_n^-\).
  But this means \(a_{n'}^- > b_n^-\), in particular, \(a_{n'}^- > b_{n'}^-\).
  Again by \labelcrefs{i:6.4.6} we have \(\inf(a_n)_{n = n'}^\infty > \inf(b_n)_{n = n'}^\infty\).
  But this contradicts the proof above that \(\inf(a_n)_{n = n'}^\infty \leq \inf(b_n)_{n = n'}^\infty\).
...
\begin{proof}
  Since \(\lim_{n \to \infty} a_n = \lim_{n \to \infty} c_n = L\), by \labelcrefs{i:6.4.12.f} we have
  \[
  ...
  \]
  by \labelcrefs{i:6.4.12.f} we have \(\lim_{n \to \infty} b_n = L\).
\end{proof}
...
\begin{proof}
  \labelcrefs{i:6.1.12} already tells us that every convergent sequence is Cauchy, so it suffices to show that every Cauchy sequence is convergent.

  Let \((a_n)_{n = 1}^\infty\) be a Cauchy sequence.
  We know from \labelcrefs{i:5.1.15} (or more precisely, from the extension of this lemma to the real numbers, which is proven in exactly the same fashion) that the sequence \((a_n)_{n = 1}^\infty\) is bounded;
  by \labelcrefs{i:6.4.13} (or \labelcrefs{i:6.4.12.c}) this implies that \(L^- \coloneqq \liminf_{n \to \infty} a_n\) and \(L^+ \coloneqq \limsup_{n \to \infty} a_n\) of the sequence are both finite.
  To show that the sequence converges, it will suffice by \labelcrefs{i:6.4.12.f} to show that \(L^- = L^+\).
  ...
  By \labelcrefs{i:6.3.6} (or \labelcrefs{i:6.4.13}) this implies that
  \[
    a_N - \varepsilon \leq \inf(a_n)_{n = N}^\infty \leq \sup(a_n)_{n = N}^\infty \leq a_N + \varepsilon
  \]
  and hence by the definition of \(L^-\) and \(L^+\) (and \labelcrefs{i:6.3.6} again)
  \[
  ...
  By \labelcrefs{i:6.4.12.f} we thus see that the sequence converges.
\end{proof}

\begin{rmk}\label{i:6.4.19}
  While \labelcrefs{i:6.4.18} is very similar in spirit to \labelcrefs{i:6.1.15}, it is a bit more general, since \labelcrefs{i:6.1.15} refers to Cauchy sequences of rationals instead of real numbers.
\end{rmk}

\begin{rmk}\label{i:6.4.20}
  In the language of metric spaces, \labelcrefs{i:6.4.18} asserts that the real numbers are a \emph{complete} metric space
  ...
  This property is closely related to the least upper bound property (\labelcrefs{i:5.5.9}), and is one of the principal characteristics which make the real numbers superior to the rational numbers for the purposes of doing analysis
...
\begin{ex}\label{i:ex:6.4.1}
  Prove \labelcrefs{i:6.4.5}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:6.4.5}.
\end{proof}
...
\begin{ex}\label{i:ex:6.4.2}
  ...
  Show that
  \begin{enumerate}
    \item\label{i:ex:6.4.2.a} \(c\) is a limit point of \((a_n)_{n = m}^\infty\) iff \(c\) is a limit point of \((a_n)_{n = m'}^\infty\).
    \item\label{i:ex:6.4.2.b} \(c\) is the limit superior of \((a_n)_{n = m}^\infty\) iff \(c\) is the limit superior of \((a_n)_{n = m'}^\infty\).
    \item\label{i:ex:6.4.2.c} \(c\) is the limit inferior of \((a_n)_{n = m}^\infty\) iff \(c\) is the limit inferior of \((a_n)_{n = m'}^\infty\).
    \item\label{i:ex:6.4.2.d} \(c\) is a limit point of \((a_n)_{n = m}^\infty\) iff \(c\) is a limit point of \((a_{n + k})_{n = m}^\infty\).
    \item\label{i:ex:6.4.2.e} \(c\) is the limit superior of \((a_n)_{n = m}^\infty\) iff \(c\) is the limit superior of \((a_{n + k})_{n = m}^\infty\).
    \item\label{i:ex:6.4.2.f} \(c\) is the limit inferior of \((a_n)_{n = m}^\infty\) iff \(c\) is the limit inferior of \((a_{n + k})_{n = m}^\infty\).
  \end{enumerate}
\end{ex}

\begin{proof}[\pf{i:ex:6.4.2.a}]
  Let \(N, \in \N\).
  We first show that \(c\) is a limit point of \((a_n)_{n = m}^\infty\) implies \(c\) is a limit point of \((a_n)_{n = m'}^\infty\).
  Since \(c\) is a limit point of \((a_n)_{n = m}^\infty\), by \labelcrefs{i:6.4.1} \(\forall \varepsilon \in \R^+\), we have \(\forall N \geq m\), \(\exists n \geq N\) such that \(\abs{a_n - c} \leq \varepsilon\).
...
\begin{proof}[\pf{i:ex:6.4.2.d}]
  Since \((a_{n + k})_{n = m}^\infty = (a_n)_{n = m + k}^\infty\), by \labelcrefs{i:ex:6.4.2.a} we conclude that \(c\) is a limit point of \((a_n)_{n = m}^\infty\) iff \(c\) is a limit point of \((a_{n + k})_{n = m}^\infty\).
\end{proof}

\begin{proof}[\pf{i:ex:6.4.2.e}]
  Since \((a_{n + k})_{n = m}^\infty = (a_n)_{n = m + k}^\infty\), by \labelcrefs{i:ex:6.4.2.b} we conclude that \(c\) is the limit superior of \((a_n)_{n = m}^\infty\) iff \(c\) is the limit superior of \((a_{n + k})_{n = m}^\infty\).
\end{proof}

\begin{proof}[\pf{i:ex:6.4.2.f}]
  Since \((a_{n + k})_{n = m}^\infty = (a_n)_{n = m + k}^\infty\), by \labelcrefs{i:ex:6.4.2.c} we conclude that \(c\) is the limit inferior of \((a_n)_{n = m}^\infty\) iff \(c\) is the limit inferior of \((a_{n + k})_{n = m}^\infty\).
\end{proof}

\begin{ex}\label{i:ex:6.4.3}
  Prove \labelcrefs{i:6.4.12}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:6.4.12}.
\end{proof}

\begin{ex}\label{i:ex:6.4.4}
  Prove \labelcrefs{i:6.4.13}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:6.4.13}.
\end{proof}

\begin{ex}\label{i:ex:6.4.5}
  Use \labelcrefs{i:6.4.13} to prove \labelcrefs{i:6.4.14}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:6.4.14}.
\end{proof}
...
\begin{ex}\label{i:ex:6.4.6}
  ...
  Explain why this does not contradict \labelcrefs{i:6.4.13}.
\end{ex}
...
\begin{proof}
  ...
  This does not contradict to \labelcrefs{i:6.4.13} since \(\sup(a_n)_{n = 1}^\infty \leq \sup(b_n)_{n = 1}^\infty\) does not enforce strictly order, i.e., \(\sup(a_n)_{n = 1}^\infty < \sup(b_n)_{n = 1}^\infty\).
\end{proof}

\begin{ex}\label{i:ex:6.4.7}
  Prove \labelcrefs{i:6.4.17}.
  Is the corollary still true if we replace zero in the statement of this Corollary by some other number?
\end{ex}

\begin{proof}
  See \labelcrefs{i:6.4.17}.

  Now we show that \labelcrefs{i:6.4.17} is not true if we replace zero by some other number.
  ...
  We conclude that \labelcrefs{i:6.4.17} is not true if we replace zero by some other number.
\end{proof}
...
\begin{proof}
  By \labelcrefs{i:6.4.12.e} we already know the cases where \((a_n)_{n = m}^\infty\) has finite upper bound or lower bound.
  So we only consider the cases where \((a_n)_{n = m}^\infty\) has no finite upper bound or lower bound.
  By \labelcrefs{i:6.4.12.d} we know that \(L^- \leq c \leq L^+\) if \(c\) is a limit point of \((a_n)_{n = m}^\infty\).
...
\begin{ex}\label{i:ex:6.4.9}
  Using the definition in \labelcrefs{i:ex:6.4.8}, construct a sequence \((a_n)_{n = 1}^\infty\) which has exactly three limit points, at \(-\infty\), \(0\) and \(+\infty\).
\end{ex}
...
\begin{proof}
  ...
  Since \(c\) is a limit point of \((b_m)_{m = M}^\infty\), by \labelcrefs{i:6.4.1} we have \(\forall i \geq M\), \(\exists m \geq i\) such that \(\abs{b_m - c} \leq \varepsilon / 2\).
  Now we fix such \(m\).
  Since \(b_m\) is a limit point of \((a_n)_{n = N}^\infty\), by \labelcrefs{i:6.4.1} we have \(\forall j \geq N\), \(\exists n \geq j\) such that \(\abs{a_n - b_m} \leq \varepsilon / 2\).
  Then we have
  \begin{align*}
  ...
  Since \(\varepsilon\) was arbitrary, by \labelcrefs{i:6.4.1} we know that \(c\) is a limit point of \((a_n)_{n = N}^\infty\).
\end{proof}
