...
\begin{proof}[\pf{i:6.4.12.f}]
  ...
  Since \(c = L^+\), by \cref{i:6.4.12.a} \(\exists N_1 \geq m\) such that \(a_{n_1} < c + \varepsilon\) for every \(n_1 \geq N_1\).
  Similarly, since \(c = L^-\), by \cref{i:6.4.12.a} \(\exists N_2 \geq m\) such that \(c - \varepsilon < a_{n_2}\) for every \(n_2 \geq N_2\).
  Let \(N = \max(N_1, N_2)\).
