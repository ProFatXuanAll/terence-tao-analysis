...
\begin{proof}
  ...
  \]
  Thus, by \labelcrefs{i:6.1.8} we have \(\lim_{n \to \infty} a_n = \lim_{n \to \infty} c = c\).
\end{proof}
...
\begin{proof}
  From \labelcrefs{i:5.6.6} we know that \(1 / n^{1 / k}\) is a decreasing function of \(n\), while being bounded below by \(0\).
  By \labelcrefs{i:ac:6.3.1} (for decreasing sequences instead of increasing sequences) we thus know that this sequence converges to some limit \(L \geq 0\):
  \[
    L = \lim_{n \to \infty} 1 / n^{1 / k}.
  \]
  Raising this to the \(k^{th}\) power and using the limit laws (or more precisely, \labelcrefs{i:6.1.19.b} and induction), we obtain
  \[
    L^k = \lim_{n \to \infty} 1 / n.
  \]
  By \labelcrefs{i:6.1.11} we thus have \(L^k = 0\);
...
\begin{proof}
  ...
  And because \(-\abs{x}^n \leq x^n \leq \abs{x}^n\), by Squeeze test (\labelcrefs{i:6.4.14}) we have \(\lim_{n \to \infty} x^n = 0\).

  Next we show that if \(x = 1\), then \(\lim_{n \to \infty} x^n = 1\).
  This is done by \labelcrefs{i:ac:6.5.1}.
  ...
  \begin{itemize}
    \item If \(x > 1\), then by \labelcrefs{i:ex:6.3.4} \(\lim_{n \to \infty} x^n\) does not exist.
    \item If \(x < -1\), then \(\forall n \geq 1\) we have
          \begin{align*}
            \abs{x^{n + 1} - x^n} & = \abs{x^n(x - 1)}     \\
                                  ...
                                  & > 2.
          \end{align*}
          This means \(x\) is not a Cauchy sequence, so by \labelcrefs{i:6.4.18} \(\lim_{n \to \infty} x^n\) does not exist.
  \end{itemize}
...
\begin{proof}
  ...
  Since \(1 / (1 + \varepsilon) < 1\), by \labelcrefs{i:6.5.2} we have \(\lim_{n \to \infty} 1 / (1 + \varepsilon)^n = 0\).
  Let \(a_n = 1 / (1 + \varepsilon)^n\).
  Then \(\inf(a_n)_{n = 1}^\infty = 0\).
  Since \(1 / M > 0\), we have \(1 / M > \inf(a_n)_{n = 1}^\infty\).
  By \labelcrefs{i:6.3.7} \(\exists n \geq 1\) such that \(a_n = 1 / (1 + \varepsilon)^n < 1 / M\).
  Thus, we have \(M < (1 + \varepsilon)^n\), and by \labelcrefs{i:5.6.9.d} \(M^{1 / n} < 1 + \varepsilon\).
  ...
  \begin{itemize}
    \item If \(x \geq 1\), then by the proof above we have \(\forall \varepsilon \in \R^+\), \(\exists n \geq 1\) such that \(x^{1 / n} < 1 + \varepsilon\).
          ...
          \begin{align*}
                     & x \geq 1                                                                        \\
            \implies & x^{1 / n} \geq 1^{1 / n} = 1                      &  & \by{i:5.6.6.d,i:5.6.6.e} \\
            \implies & \abs{x^{1 / n} - 1} = x^{1 / n} - 1 < \varepsilon
          \end{align*}
          and by \labelcrefs{i:6.1.8} \(\lim_{n \to \infty} x^{1 / n} = 1\).
    \item If \(x < 1\), then \(1 / x > 1\).
          So from the proof above we have \(\lim_{n \to \infty} x^{-1 / n} = 1\).
          By \labelcrefs{i:6.1.19.e} we have \(\lim_{n \to \infty} x^{-1 / n} = (\lim_{n \to \infty} x^{1 / n})^{-1} = 1^{-1} = 1\).
  \end{itemize}
...
\begin{ex}\label{i:ex:6.5.2}
  Prove \labelcrefs{i:6.5.2}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:6.5.2}.
\end{proof}

\begin{ex}\label{i:ex:6.5.3}
  Prove \labelcrefs{i:6.5.3}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:6.5.3}.
\end{proof}
