...
\begin{note}
  Clearly, \labelcrefs{i:6.1.1} is consistent with \labelcrefs{i:4.3.2}.
  Further, \labelcrefs{i:4.3.3} works just as well for real numbers as it does for rationals, because the real numbers obey all the rules of algebra that the rationals do.
\end{note}
...
\begin{note}
  Again, it is clear that \labelcrefs{i:6.1.2} is consistent with \labelcrefs{i:4.3.4}.
\end{note}
...
\begin{note}
  ...
  These definitions are consistent with the corresponding definitions for rational numbers (\labelcrefs{i:5.1.3,i:5.1.6,i:5.1.8}), although verifying consistency for Cauchy sequences takes a little bit of care.
\end{note}

\begin{prop}\label{i:6.1.4}
  Let \((a_n)_{n = m}^\infty\) be a sequence of rational numbers starting at some integer index \(m\).
  Then \((a_n)_{n = m}^\infty\) is a Cauchy sequence in the sense of \labelcrefs{i:5.1.8} iff it is a Cauchy sequence in the sense of \labelcrefs{i:6.1.3}.
\end{prop}

\begin{proof}[\pf{i:6.1.4}]
  Suppose first that \((a_n)_{n = m}^\infty\) is a Cauchy sequence in the sense of \labelcrefs{i:6.1.3};
  then it is eventually \(\varepsilon\)-steady for every \(\varepsilon \in \R^+\).
  In particular, it is eventually \(\varepsilon\)-steady for every \(\varepsilon \in \Q^+\), which makes it a Cauchy sequence in the sense of \labelcrefs{i:5.1.8}.

  Now suppose that \((a_n)_{n = m}^\infty\) is a Cauchy sequence in the sense of \labelcrefs{i:5.1.8};
  then it is eventually \(\varepsilon'\)-steady for every \(\varepsilon' \in \Q^+\).
  If \(\varepsilon \in \R^+\), then there exists an \(\varepsilon' \in \Q^+\) which is smaller than \(\varepsilon\), by \labelcrefs{i:5.4.12}.
  ...
  Since \(\varepsilon\) is an arbitrary positive real number, we thus see that \((a_n)_{n = m}^\infty\) is a Cauchy sequence in the sense of \labelcrefs{i:6.1.3}.
\end{proof}

\begin{note}
  Because of \labelcrefs{i:6.1.4}, we will no longer care about the distinction between \labelcrefs{i:5.1.8} and \labelcrefs{i:6.1.3}, and view the concept of a Cauchy sequence as a single unified concept.
\end{note}
...
\begin{note}
  \labelcrefs{i:6.1.7} ensures that a sequence can have at most one limit.
  Thus, if the limit exists, it is a single real number, otherwise it is undefined.
\end{note}

\begin{rmk}\label{i:6.1.9}
  The notation \(\lim_{n \to \infty} a_n\) does not give any indication about the starting index \(m\) of the sequence, but the starting index is irrelevant (\labelcrefs{i:ex:6.1.3}).
...
\begin{proof}[\pf{i:6.1.11}]
  ...
  \]
  Thus, if we pick \(N > 1 / \varepsilon\) (which we can do by the Archimedean principle, \labelcrefs{i:5.4.13}), then \(1 / N < \varepsilon\), and so \((a_n)_{n = N}^\infty\) is \(\varepsilon\)-close to \(0\).
...
\begin{proof}[\pf{i:6.1.12}]
  ...
  Let \(\varepsilon \in \R^+\).
  Since \(\lim_{n \to \infty} a_n = L\), by \labelcrefs{i:6.1.5} there exists an \(N \in \Z_{\geq m}\) such that \((a_n)_{n = N}^\infty\) is \(\varepsilon / 2\)-close to \(L\).
  ...
  Since \(\varepsilon\) was arbitrary, by \labelcrefs{i:6.1.3} we see that \((a_n)_{n = m}^\infty\) is a Cauchy sequence of reals.
\end{proof}

\setcounter{thm}{13}
\begin{rmk}\label{i:6.1.14}
  For a converse to \labelcrefs{i:6.1.12}, see \labelcrefs{i:6.4.18} below.
\end{rmk}
...
\begin{proof}[\pf{i:6.1.15}]
  ...
  By \labelcrefs{i:5.3.1} we know that \(L \in \R\).
  Thus, by \labelcrefs{i:6.1.4,i:6.1.5} we can ask whether \((a_n)_{n = m}^\infty\) converges to \(L\).
  ...
  \begin{align*}
    \dfrac{\varepsilon}{4} & \geq \abs{a_j - a_k}                                                             &  & \by{i:6.1.3}             \\
                           & \geq \abs{a_j - L} - \abs{a_k - L}                                               &  & \by{i:4.3.3.f,i:4.3.3.g} \\
...
\begin{note}
  \labelcrefs{i:6.1.16} is consistent with \labelcrefs{i:5.1.12}.
  See \labelcrefs{i:ex:6.1.7}.
\end{note}
...
\begin{proof}[\pf{i:6.1.17}]
  Recall from \labelcrefs{i:5.1.15} that every Cauchy sequence of rationals is bounded.
  An inspection of the proof of \labelcrefs{i:5.1.15} shows that the same argument works for reals;
  every Cauchy sequence of reals is bounded.
  From \labelcrefs{i:6.1.12} we see that every convergent sequence of reals is a Cauchy sequence.
...
\begin{proof}[\pf{i:ac:6.1.1}]
  ...
  \begin{itemize}
    \item If \(x \leq y\), then we have \(-x \geq -y\) by \labelcrefs{i:ex:4.2.6}.
          Thus,
          \begin{align*}
            \min(x, y) & = x                                   \\
                       & = -(-x)          &  & \by{i:ac:5.3.3} \\
                       & = -\max(-x, -y). &  & (-x \geq -y)
          \end{align*}
    \item If \(x > y\), then we have \(-x < -y\) by \labelcrefs{i:ex:4.2.6}.
          Thus,
          \begin{align*}
            \min(x, y) & = y                                   \\
                       & = -(-y)          &  & \by{i:ac:5.3.3} \\
...
\begin{thm}[Limit Laws]\label{i:6.1.19}
  ...
  \begin{enumerate}
    \item\label{i:6.1.19.a} The sequence \((a_n + b_n)_{n = m}^\infty\) converges to \(x + y\);
    in other words,
    \[
      \lim_{n \to \infty} (a_n + b_n) = \pa{\lim_{n \to \infty} a_n} + \pa{\lim_{n \to \infty} b_n}.
    \]
    \item\label{i:6.1.19.b} The sequence \((a_n b_n)_{n = m}^\infty\) converges to \(xy\);
    in other words,
    \[
      \lim_{n \to \infty} (a_n b_n) = \pa{\lim_{n \to \infty} a_n} \pa{\lim_{n \to \infty} b_n}.
    \]
    \item\label{i:6.1.19.c} For any real number \(c\), the sequence \((c a_n)_{n = m}^\infty\) converges to \(cx\);
    in other words,
    \[
      \lim_{n \to \infty} (c a_n) = c \pa{\lim_{n \to \infty} a_n}.
    \]
    \item\label{i:6.1.19.d} The sequence \((a_n - b_n)_{n = m}^\infty\) converges to \(x - y\);
    in other words,
    \[
      \lim_{n \to \infty} (a_n - b_n) = \pa{\lim_{n \to \infty} a_n} - \pa{\lim_{n \to \infty} b_n}.
    \]
    \item\label{i:6.1.19.e} Suppose that \(y \neq 0\), and that \(b_n \neq 0\) for all \(n \geq m\).
    Then the sequence \((b_n^{-1})_{n = m}^\infty\) converges to \(y^{-1}\);
    in other words,
    \[
      \lim_{n \to \infty} b_n^{-1} = \pa{\lim_{n \to \infty} b_n}^{-1}.
    \]
    \item\label{i:6.1.19.f} Suppose that \(y \neq 0\), and that \(b_n \neq 0\) for all \(n \in \Z_{\geq m}\).
    ...
    \]
    \item\label{i:6.1.19.g} The sequence \((\max(a_n, b_n))_{n = m}^\infty\) converges to \(\max(x, y)\);
    in other words,
    \[
      \lim_{n \to \infty} \max(a_n, b_n) = \max\pa{\lim_{n \to \infty} a_n, \lim_{n \to \infty} b_n}.
    \]
    \item\label{i:6.1.19.h} The sequence \((\min(a_n, b_n))_{n = m}^\infty\) converges to \(\min(x, y)\);
    in other words,
    \[
...
\begin{proof}[\pf{i:6.1.19.a}]
  Let \(\varepsilon \in \R^+\).
  By \labelcrefs{i:6.1.8}, there exists an \(N_a \in \Z_{\geq m}\) such that \(\abs{a_n - x} \leq \varepsilon / 2\) for every \(n \in \Z_{\geq N_a}\).
  ...
  \end{align*}
  Thus, by \labelcrefs{i:6.1.5}, \((a_n + b_n)_{n = N}^\infty\) is \(\varepsilon\)-close to \(x + y\), and \((a_n + b_n)_{n = m}^\infty\) is eventually \(\varepsilon\)-close to \(x + y\).
  Since \(\varepsilon\) was arbitrary, by \labelcrefs{i:6.1.5} again we know that \((a_n + b_n)_{n = m}^\infty\) converges to \(x + y\).
\end{proof}

\begin{proof}[\pf{i:6.1.19.b}]
  Since \(x = \lim_{n \to \infty} a_n\) and \(y = \lim_{n \to \infty} b_n\), by \labelcrefs{i:6.1.17}, there exist some \(A, B \in \R_{\geq 0}\) such that \(\abs{a_n} \leq A\) and \(\abs{b_n} \leq B\) for all \(n \in \Z_{\geq m}\).
  Fix both \(A\) and \(B\).
  ...
  Since \(x = \lim_{n \to \infty} a_n\), by \labelcrefs{i:6.1.8}, there exists an \(N_a \in \Z_{\geq m}\) such that \(\abs{a_n - x} \leq \dfrac{\varepsilon}{2(B + 1)}\) for all \(n \in \Z_{\geq N_a}\).
  ...
  \end{align*}
  Thus, by \labelcrefs{i:6.1.5}, \((a_n b_n)_{n = N}^\infty\) is \(\varepsilon\)-close to \(xy\), and \((a_n b_n)_{n = m}^\infty\) is eventually \(\varepsilon\)-close to \(xy\).
  Since \(\varepsilon\) was arbitrary, by \labelcrefs{i:6.1.5} again we know that \((a_n b_n)_{n = m}^\infty\) converges to \(xy\).
\end{proof}
...
\begin{proof}[\pf{i:6.1.19.e}]
  ...
  Since \(y = \lim_{n \to \infty} b_n \neq 0\), by \labelcrefs{i:6.1.8}, there exists an \(N \in \Z_{\geq m}\) such that \(\abs{b_n - y} \leq \varepsilon M \abs{y}\) for all \(n \in \Z_{\geq N}\).
  Fix such \(N\).
  Then we have
  \begin{align*}
  ...
  \end{align*}
  Thus, by \labelcrefs{i:6.1.5}, \(\pa{b_n^{-1}}_{n = N}^\infty\) is \(\varepsilon\)-close to \(y^{-1}\), and \(\pa{b_n^{-1}}_{n = m}^\infty\) is eventually \(\varepsilon\)-close to \(y^{-1}\).
  Since \(\varepsilon\) was arbitrary, by \labelcrefs{i:6.1.5} again we know that \(\pa{b_n^{-1}}_{n = m}^\infty\) converges to \(y^{-1}\).
\end{proof}
...
\begin{proof}[\pf{i:6.1.19.g}]
  ...
  Let \(\varepsilon \in \R^+\).
  By \labelcrefs{i:6.1.8}, there exists an \(N_a \in \Z_{\geq m}\) such that \(\abs{a_n - x} \leq \varepsilon\) for all \(n \in \Z_{\geq N_a}\).
  ...
  \end{align*}
  By \labelcrefs{i:6.1.5}, \(\pa{\max(a_n, b_n)}_{n = N}^\infty\) is \(\varepsilon\)-close to \(\max(x, y)\), and \(\pa{\max(a_n, b_n)}_{n = m}^\infty\) is eventually \(\varepsilon\)-close to \(\max(x, y)\).
  Since \(\varepsilon\) was arbitrary, by \labelcrefs{i:6.1.5} again we know that \(\pa{\max(a_n, b_n)}_{n = m}^\infty\) converges to \(\max(x, y)\).
  ...
  By \labelcrefs{i:6.1.8}, there exists an \(N_a \in \Z_{\geq m}\) such that \(\abs{a_n - x} \leq \min\pa{\varepsilon, \dfrac{y - x}{2}}\) for all \(n \in \Z_{\geq N_a}\).
...
\begin{proof}[\pf{i:ex:6.1.1}]
  ...
  Thus, we have \(a_j < a_{j + 1} < \dots < a_{k - 1} < a_k\), and by \labelcrefs{i:5.4.7}(c) we have \(a_j < a_k\).
\end{proof}
...
\begin{proof}[\pf{i:ex:6.1.3}]
  ...
  Let \(\varepsilon \in \R^+\).
  By \labelcrefs{i:6.1.5}, there exists an \(N \in \Z_{\geq m}\) such that \(\abs{a_n - c} \leq \varepsilon\) for all \(n \in \Z_{\geq N}\).
  Fix such \(N\).
  ...
  Thus, by \labelcrefs{i:6.1.5}, we see that \((a_n)_{n = m'}^\infty\) is eventually \(\varepsilon\)-close to \(c\).
  Since \(\varepsilon\) was arbitrary, by \labelcrefs{i:6.1.5} again we see that \((a_n)_{n = m'}^\infty\) converges to \(c\).
...
\begin{proof}[\pf{i:ex:6.1.4}]
  ...
  Since \(m + k \geq m\), by \labelcrefs{i:ex:6.1.3} we see that \((a_n)_{n = m}^\infty\) converges to \(c\) iff \((a_n)_{n = m + k}^\infty\) converges to \(c\).
  Thus, \((a_n)_{n = m}^\infty\) converges to \(c\) iff \((a_{n + k})_{n = m}^\infty\) converges to \(c\).
\end{proof}

\begin{ex}\label{i:ex:6.1.5}
  Prove \labelcrefs{i:6.1.12}.
\end{ex}

\begin{proof}[\pf{i:ex:6.1.5}]
  See \labelcrefs{i:6.1.12}.
\end{proof}

\begin{ex}\label{i:ex:6.1.6}
  Prove \labelcrefs{i:6.1.15}.
\end{ex}

\begin{proof}[\pf{i:ex:6.1.6}]
  See \labelcrefs{i:6.1.15}.
\end{proof}

\begin{ex}\label{i:ex:6.1.7}
  Show that \labelcrefs{i:6.1.16} is consistent with \labelcrefs{i:5.1.12}
  (i.e., prove an analogue of \labelcrefs{i:6.1.4} for bounded sequences instead of Cauchy sequences).
\end{ex}

\begin{proof}[\pf{i:ex:6.1.7}]
  First, suppose that \((a_n)_{n = m}^\infty\) is a sequence of reals which is bounded in the sense of \labelcrefs{i:6.1.16}.
  Then there exists an \(M \in \R_{\geq 0}\) such that \(\abs{a_n} \leq M\) for all \(n \in \Z_{\geq m}\).
  By \labelcrefs{i:5.4.12}, there exists an \(M' \in \Z^+\) such that \(M \leq M'\).
  Clearly, \(M' \in \Z^+\) implies \(M' \in \Q_{\geq 0}\).
  Thus, by \labelcrefs{i:5.4.7}(c), we have \(\abs{a_n} \leq M'\) for all \(n \in \Z_{\geq m}\).
  This means that \((a_n)_{n = m}^\infty\) is a bounded sequence in the sense of \labelcrefs{i:5.1.12}.

  Now suppose that \((a_n)_{n = m}^\infty\) is a sequence of reals which is bounded in the sense of \labelcrefs{i:5.1.12}.
  Then there exists an \(M \in \Q_{\geq 0}\) such that \(\abs{a_n} \leq M\) for all \(n \in \Z_{\geq m}\).
  Since \(M\) is also a real number, we see that \((a_n)_{n = m}^\infty\) is a bounded sequence in the sense of \labelcrefs{i:6.1.16}.
\end{proof}

\begin{ex}\label{i:ex:6.1.8}
  Proof \labelcrefs{i:6.1.19}.
\end{ex}

\begin{proof}[\pf{i:ex:6.1.8}]
  See \labelcrefs{i:6.1.19}.
\end{proof}

\begin{ex}\label{i:ex:6.1.9}
  Explain why \labelcrefs{i:6.1.19.f} fails when the limit of the denominator is \(0\).
  (To repair that problem requires \emph{L'Hôpital's rule}, see \labelcrefs{i:sec:10.5}.)
\end{ex}

\begin{proof}[\pf{i:ex:6.1.9}]
  Suppose for the sake of contradiction that \labelcrefs{i:6.1.19.f} works when denominator is \(0\).
  Let \((a_n)_{n = 1}^\infty = (1 / n)_{n = 1}^\infty\).
  Then we have
  \[
    \lim_{n \to \infty} \dfrac{a_n}{a_n} = \lim_{n \to \infty} \dfrac{1 / n}{1 / n} = \lim_{n \to \infty} 1 = 1.
  \]
  But by \labelcrefs{i:6.1.11} we also have
  \[
    \dfrac{\lim_{n \to \infty} a_n}{\lim_{n \to \infty} a_n} = \dfrac{0}{0}
  \]
  which is undefined.
  Thus, \labelcrefs{i:6.1.19.f} fails when denominator is \(0\).
\end{proof}

\begin{ex}\label{i:ex:6.1.10}
  Show that the concept of equivalent Cauchy sequence, as defined in \labelcrefs{i:5.2.6}, does not change if \(\varepsilon\) is required to be positive real instead of positive rational.
...
\begin{proof}[\pf{i:ex:6.1.10}]
  ...
  Let \(\varepsilon' \in \R^+\).
  By \labelcrefs{i:5.4.12}, there exists an \(\varepsilon \in \Q^+\) such that \(\varepsilon \leq \varepsilon'\).
  Fix such \(\varepsilon\).
