...
\begin{proof}
  ...
  By \labelcrefs{i:6.4.18} it is enough to show that \((x^{q_n})_{n = 1}^\infty\) is a Cauchy sequence.
  ...
  We know by \labelcrefs{i:6.5.3} that the sequence \((x^{1 / k})_{k = 1}^\infty\) is eventually \(\varepsilon x^{-M}\)-close to \(1\).
  ...
  But from \labelcrefs{i:6.5.3} we know that the sequence \((x^{1 / k})_{k = 1}^\infty\) is eventually \(\varepsilon\)-close to \(1\).
  Since \(\lim_{k \to \infty} x^{-1 / k}\) is also equal to \(1\) by \labelcrefs{i:6.5.3}, we know that \((x^{-1 / k})_{k = 1}^\infty\) is also eventually \(\varepsilon\)-close to \(1\).
  ...
  In particular, \(x^{r_n}\) is also eventually \(\varepsilon\)-close to \(1\) (see \labelcrefs{i:4.3.7.f}), as desired.
\end{proof}
...
\begin{note}
  Let us check that \labelcrefs{i:6.7.2} is well-defined.
  First, of all, given any real number \(\alpha\) we always have at least one sequence \((q_n)_{n = 1}^\infty\) of rational numbers converging to \(\alpha\), by the definition of real numbers (and \labelcrefs{i:6.1.15}).
  Secondly, given any such sequence \((q_n)_{n = 1}^\infty\), the limit \(\lim_{n \to \infty} x^{q_n}\) exists by \labelcrefs{i:6.7.1}.
  Finally, even though there can be multiple choices for the sequence \((q_n)_{n = 1}^\infty\), they all give the same limit by \labelcrefs{i:6.7.1}.
  Thus, \labelcrefs{i:6.7.2} is well-defined.
\end{note}

\begin{note}
  If \(\alpha\) is not just real but rational, i.e., \(\alpha = q\) for some rational \(q\), then \labelcrefs{i:6.7.2} could in principle be inconsistent with our earlier definition of exponentiation in \labelcrefs{i:sec:5.6}.
...
\begin{prop}\label{i:6.7.3}
  All the results of \labelcrefs{i:5.6.9}, which held for rational numbers \(q\) and \(r\), continue to hold for real numbers \(q\) and \(r\).
\end{prop}

\begin{proof}[\pf{i:6.7.3}(a)]
  Let \(r\) be a real number.
  Then we can write \(r = \lim_{n \to \infty} r_n\) for some sequences \((r_n)_{n = 1}^\infty\) of rationals, by the definition of real numbers (and \labelcrefs{i:6.1.15}).
  Since \((r_n)_{n = 1}^\infty\) is a Cauchy sequence, it is bounded by some \(M \in \Q^+\), i.e, \(-M \leq r_n \leq M\) for every \(n \geq 1\).
  By \labelcrefs{i:5.6.9}, both \(x^M\) and \(x^{-M}\) are positive real numbers.
  If \(0 < x < 1\), then \(x^M \leq x^{r_n} \leq x^{-M}\).
  If \(x \geq 1\), then \(x^{-M} \leq x^{r_n} \leq x^M\).
  By \labelcrefs{i:6.1.19.h} we have
  \begin{align*}
...
\begin{proof}[\pf{i:6.7.3}(b)]
  Let \(q\) and \(r\) be real numbers.
  Then we can write \(q = \lim_{n \to \infty} q_n\) and \(r = \lim_{n \to \infty} r_n\) for some sequences \((q_n)_{n = 1}^\infty\) and \((r_n)_{n = 1}^\infty\) of rationals, by the definition of real numbers (and \labelcrefs{i:6.1.15}).
  ...
  \]
  But by \labelcrefs{i:5.6.9.b} (applied to \emph{rational} exponents) we have \(x^{q_n + r_n} = x^{q_n} x^{r_n}\).
  Thus, by limit laws we have \(x^{q + r} = x^q x^r\), as desired.

  Now we show that \((x^q)^r = \lim_{n \to \infty} (x^{q_n})^{r_n}\).
  By \labelcrefs{i:6.1.19.c} we know that \(q r_n = \lim_{m \to \infty} q_m r_n\).
  Thus, we have
  \begin{align*}
...
\begin{proof}[\pf{i:6.7.3}(c)]
  Let \(r \in \R\) where \(r = \lim_{n \to \infty} r_n\) for some sequences \((r_n)_{n = 1}^\infty\) of rationals.
  By \labelcrefs{i:6.1.15} \(r\) is well-defined and by \labelcrefs{i:6.1.19.c} we know that \(-r\) is the limit of \((-r_n)_{n = 1}^\infty\).
  By \labelcrefs{i:6.7.3}(a) we know that \(x^{-r} > 0\) and by \labelcrefs{i:5.6.9.a} we know that \(x^{r_n} > 0\) for every \(n \in \Z^+\).
  Thus, we have
  \begin{align*}
...
\begin{proof}[\pf{i:6.7.3}(d)]
  Let \(x, y, r \in \R^+\) where \(r = \lim_{n \to \infty} r_n\) for some sequences \((r_n)_{n = 1}^\infty\) of rationals.
  By \labelcrefs{i:6.1.15} \(r\) is well-defined.
  Since \(r \in \R^+\), by \labelcrefs{i:5.4.3} we know that \(\exists c \in \R^+\) such that \(r_n \geq c\) for every \(n \in \Z^+\).
  ...
  \end{align*}
  But by \labelcrefs{i:5.6.9.d} we know that \(x > y \implies x^{r_n} > y^{r_n}\), thus by setting \(\varepsilon = (x^{r_n} - y^{r_n}) / 2\) we get
  \[
...
\begin{proof}[\pf{i:6.7.3}(e)]
  ...
  By \labelcrefs{i:6.1.15} \(q, r\) are well-defined.
  Since \(q, r \in \R^+\), by \labelcrefs{i:5.4.3} we know that \(\exists c_1, c_2 \in \R^+\) such that \(q_n \geq c_1\) and \(r_n \geq c_2\) for every \(n \in \Z^+\).
  Thus, by \labelcrefs{i:5.6.9.a} we know that \(x^{q_n}, x^{r_n} > 0\) for every \(n \in \Z^+\).
  ...
  This means \(q_n > r_n\) for every \(n \geq N\), and by \labelcrefs{i:6.4.13} we know that \(q = \lim_{n \to \infty} q_n \geq \lim_{n \to \infty} r_n = r\).
...
\begin{ex}\label{i:ex:6.7.1}
  Prove the remaining components of \labelcrefs{i:6.7.3}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:6.7.3}.
\end{proof}
