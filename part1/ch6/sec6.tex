...
\begin{proof}
  ...
  Since \(f\) is strictly increasing, by \labelcrefs{i:6.6.1} we know that \((a_n)_{n = 0}^\infty\) is a subsequence of \((a_n)_{n = 0}^\infty\).
  ...
  Since \((b_n)_{n = 0}^\infty\) is a subsequence of \((a_n)_{n = 0}^\infty\), by \labelcrefs{i:6.6.1} \(\exists f : \N \to \N\) such that \(f\) is strictly increasing and \(b_n = a_{f(n)}\).
  Since \((c_n)_{n = 0}^\infty\) is a subsequence of \((b_n)_{n = 0}^\infty\), by \labelcrefs{i:6.6.1} \(\exists g : \N \to \N\) such that \(g\) is strictly increasing and \(c_n = b_{g(n)}\).
  Let \(h = g \circ f\).
  ...
  Thus, \(h\) is also strictly increasing, and by \labelcrefs{i:6.6.1} \((c_n)_{n = 0}^\infty\) is a subsequence of \((a_n)_{n = 0}^\infty\) where \(c_n = a_{g(f(n))}\).
\end{proof}
...
\begin{proof}
  ...
  By \labelcrefs{i:6.6.4} we know that \((a_n)_{n = 0}^\infty\) is a subsequence of \((a_n)_{n = 0}^\infty\), thus \(\lim_{n \to \infty} a_n = L\).
...
\begin{proof}
  ...
  Since \(L\) is a limit point of \((a_n)_{n = 0}^\infty\), by \labelcrefs{i:6.4.1} \(\forall \varepsilon \in \R^+\), \(\forall n_j > 0\), \(\exists n \geq n_j\) such that \(\abs{a_n - L} \leq \varepsilon\).
  ...
  By Archimedian property (\labelcrefs{i:5.4.13}) we know that \(\forall \varepsilon \in \R^+\), \(\exists j \in \Z^+\) such that \(j \varepsilon > 1\).
  ...
  Thus, by \labelcrefs{i:6.4.1} \(L\) is a limit point of \((a_n)_{n = 0}^\infty\).
\end{proof}

\begin{rmk}\label{i:6.6.7}
  \labelcrefs{i:6.6.5,i:6.6.6} give a sharp contrast between the notion of a limit, and that of a limit point.
...
\begin{proof}
  ...
  Since we have \(-M \leq a_n \leq M\) for all natural numbers \(n\), it follows from the comparison principle (\labelcrefs{i:6.4.13}) that \(-M \leq L \leq M\).
  In particular, \(L\) is a real number (not \(+\infty\) or \(-\infty\)).
  By \labelcrefs{i:6.4.12.e}, \(L\) is thus a limit point of \((a_n)_{n = 0}^\infty\).
  Thus, by \labelcrefs{i:6.6.6}, there exists a subsequence of \((a_n)_{n = 0}^\infty\) which converges
  (in fact, it converges to \(L\)).
\end{proof}

\begin{note}
  we could as well have used the limit inferior instead of the limit superior in the argument of \labelcrefs{i:6.6.8}.
\end{note}
...
\begin{ex}\label{i:ex:6.6.1}
  Prove \labelcrefs{i:6.6.4}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:6.6.4}.
\end{proof}
...
\begin{proof}
  ...
  Thus, by \labelcrefs{i:5.5.9} such \(f\) is well-defined.
  Let \((b_n)_{n = 1}^\infty\) be a subsequence of \((a_n)_{n = 0}^\infty\) where \(b_n = a_{f(n)}\).
  Then \(0 \leq \abs{1 / b_n} \leq 1 / n\).
  Since \(\lim_{n \to \infty} 0 = 0\) and \(\lim_{n \to \infty} 1 / n = 0\), by squeeze test (\labelcrefs{i:6.4.14}) we have \(\lim_{n \to \infty} \abs{1 / b_n} = 0\).
  Since \(\lim_{n \to \infty} \abs{1 / b_n} = 0\), by zero test (\labelcrefs{i:6.4.17}) we have \(\lim_{n \to \infty} 1 / b_n = 0\).
...
\begin{ex}\label{i:ex:6.6.4}
  Prove \labelcrefs{i:6.6.5}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:6.6.5}.
\end{proof}

\begin{ex}\label{i:ex:6.6.5}
  Prove \labelcrefs{i:6.6.6}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:6.6.6}.
\end{proof}
