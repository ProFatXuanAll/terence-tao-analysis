...
\begin{defn}[Extended real number system]\label{i:6.2.1}
  ...
  (This definition is not directly related to the notion of finite and infinite sets in \labelcrefs{i:sec:3.6}, though it is of course similar in spirit.)
\end{defn}
...
\begin{prop}\label{i:6.2.5}
  ...
  \begin{enumerate}
    \item\label{i:6.2.5.a} (Reflexivity)
    We have \(x \leq x\).
    \item\label{i:6.2.5.b} (Trichotomy)
    Exactly one of the statements \(x < y\), \(x = y\), or \(x > y\) is true.
    \item\label{i:6.2.5.c} (Transitivity)
    If \(x \leq y\) and \(y \leq z\), then \(x \leq z\).
    \item\label{i:6.2.5.d} (Negation reverses order) If \(x \leq y\), then \(-y \leq -x\).
  \end{enumerate}
\end{prop}

\begin{proof}[\pf{i:6.2.5.a}]
  By \labelcrefs{i:5.4.7} we already have \(x \leq x\) when \(x \in \R\).
  So we only need to consider the cases \(x \in \set{+\infty, -\infty}\).
  By \labelcrefs{i:6.2.3} we have \(x \leq +\infty\) for every \(x \in \R^*\).
  So we have \(+\infty \leq +\infty\).
  Again by \labelcrefs{i:6.2.3} we have \(-\infty \leq x\) for every \(x \in \R^*\).
  So we have \(-\infty \leq -\infty\).
  Thus, we conclude that \(x \leq x\) for every \(x \in \R^*\).
\end{proof}

\begin{proof}[\pf{i:6.2.5.b}]
  By \labelcrefs{i:5.4.7}, we already have exactly one of the statements \(x < y\), \(x = y\), or \(x > y\) is true when \(x, y \in \R\).
  So we only need to consider the cases \(x, y \in \set{+\infty, -\infty}\).
  \begin{itemize}
    \item If \(x = +\infty\), then by \labelcrefs{i:6.2.3} we have \(x \geq y\) for every \(y \in \R^*\).
          \begin{itemize}
            \item If \(y = +\infty\), then we have \(x = y\).
            \item If \(y \in \R\), then by \labelcrefs{i:6.2.1} \(x \neq y\).
                  Thus, by \labelcrefs{i:6.2.3} we have \(x > y\).
            \item If \(y = -\infty\), then by \labelcrefs{i:6.2.1} \(x \neq y\).
                  Thus, by \labelcrefs{i:6.2.3} we have \(x > y\).
          \end{itemize}
    \item If \(x = -\infty\), then by \labelcrefs{i:6.2.3} we have \(x \leq y\) for every \(y \in \R^*\).
          \begin{itemize}
            \item If \(y = +\infty\), then by \labelcrefs{i:6.2.1} \(x \neq y\).
                  Thus, by \labelcrefs{i:6.2.3} we have \(x < y\).
            \item If \(y \in \R\), then by \labelcrefs{i:6.2.1} \(x \neq y\).
            ...
            \item If \(y = -\infty\), then we have \(x = y\).
          \end{itemize}
    \item If \(y = +\infty\), then by \labelcrefs{i:6.2.3} we have \(x \leq y\) for every \(x \in \R^*\).
          \begin{itemize}
            \item If \(x = +\infty\), then we have \(x = y\).
            \item If \(x \in \R\), then by \labelcrefs{i:6.2.1} \(x \neq y\).
                  Thus, by \labelcrefs{i:6.2.3} we have \(x < y\).
            \item If \(x = -\infty\), then by \labelcrefs{i:6.2.1} \(x \neq y\).
                  Thus, by \labelcrefs{i:6.2.3} we have \(x < y\).
          \end{itemize}
    \item If \(y = -\infty\), then by \labelcrefs{i:6.2.3} we have \(x \geq y\) for every \(x \in \R^*\).
          \begin{itemize}
            \item If \(x = +\infty\), then by \labelcrefs{i:6.2.1} \(x \neq y\).
                  Thus, by \labelcrefs{i:6.2.3} we have \(x > y\).
            \item If \(x \in \R\), then by \labelcrefs{i:6.2.1} \(x \neq y\).
...
\begin{proof}[\pf{i:6.2.5.c}]
  By \labelcrefs{i:5.4.7}, we already have \((x \leq y) \land (y \leq z) \implies x \leq z\) when \(x, y, z \in \R\).
  So we only need to consider the cases \(x, y, z \in \set{+\infty, -\infty}\).
  \begin{itemize}
    \item If \(x = +\infty\), then by \labelcrefs{i:6.2.3} \((x = +\infty) \land (x \leq y) \implies y = +\infty\).
          Similarly, \((y = +\infty) \land (y \leq z) \implies z = +\infty\).
          Thus, we have \(x = +\infty = z\), and by \labelcrefs{i:6.2.5.a} we have \(x \leq z\).
    \item If \(x = -\infty\), then by \labelcrefs{i:6.2.3} \(x \leq z \) for every \(z \in \R^*\).
    \item If \(y = +\infty\), then by \labelcrefs{i:6.2.3} \((y = +\infty) \land (y \leq z) \implies z = +\infty\).
          Again by \labelcrefs{i:6.2.3} we have \(x \leq +\infty = z\) for every \(x \in \R^*\).
    \item If \(y = -\infty\), then by \labelcrefs{i:6.2.3} \((y = -\infty) \land (x \leq y) \implies x = -\infty\).
          Again by \labelcrefs{i:6.2.3} we have \(x = -\infty \leq z\) for every \(z \in \R^*\).
    \item If \(z = +\infty\), then by \labelcrefs{i:6.2.3}, we have \(x \leq +\infty = z\) for every \(x \in \R^*\).
    \item If \(z = -\infty\), then by \labelcrefs{i:6.2.3} \((z = -\infty) \land (y \leq z) \implies y = -\infty\).
...
\begin{proof}[\pf{i:6.2.5.d}]
  By \labelcrefs{i:5.4.7} we already have \(x \leq y \implies -y \leq -x\) for every \(x, y \in \R\).
  So we only need to consider the cases \(x, y \in \set{+\infty, -\infty}\).
  \begin{itemize}
    \item If \(x = +\infty\), then by \labelcrefs{i:6.2.3} \((x = +\infty) \land (x \leq y) \implies y = +\infty\).
          And by \labelcrefs{i:6.2.2} we have \(-x = -\infty = -y\).
          Thus, by \labelcrefs{i:6.2.5.a} we have \(-y \leq -x\).
    \item If \(x = -\infty\), then by \labelcrefs{i:6.2.2} \(-x = +\infty\) and by \labelcrefs{i:6.2.3} we have \(-y \leq -x\) for every \(-y \in \R^*\).
    \item If \(y = +\infty\), then by \labelcrefs{i:6.2.2} \(-y = -\infty\) and by \labelcrefs{i:6.2.3} we have \(-y \leq -x\) for every \(-x \in \R^*\).
    \item If \(y = -\infty\), then by \labelcrefs{i:6.2.3} \((y = -\infty) \land (x \leq y) \implies x = -\infty\).
          And by \labelcrefs{i:6.2.2} we have \(-x = +\infty = -y\).
          Thus, by \labelcrefs{i:6.2.5.a} we have \(-y \leq -x\).
  \end{itemize}
...
\begin{defn}[Supremum of sets of extended reals]\label{i:6.2.6}
  ...
  \begin{enumerate}
    \item If \(E\) is contained in \(\R\) (i.e., \(+\infty\) and \(-\infty\) are not elements of \(E\)), then we let \(\sup(E)\) be as defined in \labelcrefs{i:5.5.10}.
...
\begin{proof}
  Since \(+\infty \notin \emptyset\) and \(-\infty \notin \emptyset\), by \labelcrefs{i:6.2.6} we know that \(\sup(\emptyset) = -\infty\).
  Since \(-\emptyset\) is also empty, by \labelcrefs{i:6.2.6} we know that \(\sup(-\emptyset) = -\infty\), thus by \labelcrefs{i:6.2.6,i:6.2.2} we have \(\inf(\emptyset) = -\sup(-\emptyset) = -(-\infty) = +\infty\).
...
\begin{thm}\label{i:6.2.11}
  ...
  Then the following statements are true.
  \begin{enumerate}
    \item\label{i:6.2.11.a} For every \(x \in E\) we have \(x \leq \sup(E)\) and \(x \geq \inf(E)\).
    \item\label{i:6.2.11.b} Suppose that \(M \in \R^*\) is an upper bound for \(E\), i.e., \(x \leq M\) for all \(x \in E\).
    Then we have \(\sup(E) \leq M\).
    \item\label{i:6.2.11.c} Suppose that \(M \in \R^*\) is a lower bound for \(E\), i.e., \(x \geq M\) for all \(x \in E\).
    Then we have \(\inf(E) \geq M\).
  \end{enumerate}
\end{thm}

\begin{proof}[\pf{i:6.2.11.a}]
  ...
  \begin{itemize}
    \item If \(+\infty \not\in E\), then we can further split into two cases:
          \begin{itemize}
            \item If \(-\infty \in E\), then by \labelcrefs{i:6.2.6} we know that \(\sup(E) = \sup(E \setminus \set{-\infty})\).
                  Let \(E' = E \setminus \set{-\infty}\).
                  Since \(E' \subseteq \R\), by \labelcrefs{i:5.5.9} we know that \(x \leq \sup(E)\) for every \(x \in E'\).
                  By \labelcrefs{i:6.2.3} we know that \(-\infty \leq \sup(E)\), thus we have \(x \leq \sup(E)\) for every \(x \in E\).
            \item If \(-\infty \notin E\), then \(E \subseteq \R\), thus by \labelcrefs{i:5.5.9} we know that \(x \leq \sup(E)\) for every \(x \in E\).
          \end{itemize}
    \item If \(+\infty \in E\), then by \labelcrefs{i:6.2.6} we have \(\sup(E) = +\infty\), and by \labelcrefs{i:6.2.3} we have \(x \leq \sup(E)\) for every \(x \in E\).
  \end{itemize}
...
\begin{proof}[\pf{i:6.2.11.b}]
  First, suppose that \(E = \emptyset\).
  Then by \labelcrefs{i:6.2.10} and \labelcrefs{i:6.2.3} we have \(\sup(E) = -\infty \leq M\).
  Now suppose that \(E \neq \emptyset\).
  We split into two cases:
  \begin{itemize}
    \item If \(+\infty \not\in E\), then we can further split into two cases:
          \begin{itemize}
            \item If \(-\infty \in E\), then by \labelcrefs{i:6.2.6} we know that \(\sup(E) = \sup(E \setminus \set{-\infty})\).
                  Let \(E' = E \setminus \set{-\infty}\).
                  Then by \labelcrefs{i:5.5.9} we know that \(\sup(E) \leq M\).
            \item If \(-\infty \notin E\), then \(E \subseteq \R\), thus by \labelcrefs{i:5.5.9} we know that \(\sup(E) \leq M\).
          \end{itemize}
    \item If \(+\infty \in E\), then by hypothesis we have \(+\infty \leq M\), and by \labelcrefs{i:6.2.3} we have \(M = +\infty\).
          Again by \labelcrefs{i:6.2.3} we have \(\sup(E) \leq M\).
  \end{itemize}
  From all cases above, we conclude that \(\sup(E) \leq M\).
\end{proof}

\begin{proof}[\pf{i:6.2.11.c}]
  We have
  \begin{align*}
...
\begin{ex}\label{i:ex:6.2.1}
  Prove \labelcrefs{i:6.2.5}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:6.2.5}.
\end{proof}

\begin{ex}\label{i:ex:6.2.2}
  Prove \labelcrefs{i:6.2.11}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:6.2.11}.
\end{proof}
