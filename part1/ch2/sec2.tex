...
\begin{proof}[\pf{i:2.2.14}]
  ...
  However, by \cref{i:ac:2.2.4}, we know that \(0 \leq m_0\) for any natural number \(m_0\).
  ...
  \begin{itemize}
    \item If \(n < m_0\), then there does not exist a natural number \(m\) satisfying \(m_0 \leq m < n\pp\), since such an \(m\) would satisfy \(m \leq n\) by \cref{i:ac:2.2.5}, and thus \(m_0 \leq m \leq n < m_0\), which is absurd.
    ...
    \item If \(n \geq m_0\), then by the induction hypothesis \(Q(n)\), we know that \(P(m')\) is true for all natural numbers \(m_0 \leq m' < n\).
          ...
          Combining this with \(Q(n)\), we know that \(P(m)\) is true for any natural number \(m\) satisfying \(m_0 \leq m \leq n\), and hence, by \cref{i:ac:2.2.5}, for any natural number \(m\) satisfying \(m_0 \leq m < n\pp\).
  ...
  By \cref{i:ac:2.2.3}, we have \(n < n\pp\), and so \(m_0 \leq n < n\pp\).
