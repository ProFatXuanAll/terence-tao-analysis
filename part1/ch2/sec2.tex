...
\begin{proof}[\pf{i:2.2.14}]
  ...
  \begin{itemize}
    \item If \(n < m_0\), then there does not exist a natural number \(m\) satisfying \(m_0 \leq m < n\pp\), since such an \(m\) would satisfy \(m_0 \leq m \leq n < m_0\), which is absurd.
    ...
    \item If \(n \geq m_0\), then by the induction hypothesis \(Q(n)\), we know that \(P(m')\) is true for all natural numbers \(m_0 \leq m' < n\).
          ...
          Combining this with \(Q(n)\), we know that \(P(m)\) is true for any natural number \(m\) satisfying \(m_0 \leq m \leq n\), or equivalently \(m_0 \leq m < n\pp\).
  ...
  Applying \(Q(n\pp)\), we know that \(P(m)\) is true for any natural number \(m\) satisfying \(m_0 \leq m < n\pp\), that is, \(m_0 \leq m \leq n\).
  In particular, since \(m_0 \leq n \leq n\), we see that \(P(n)\) is true.
