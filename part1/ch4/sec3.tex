...
\begin{proof}[\pf{i:4.3.7.h}]
  ...
  \]
  Thus, by \cref{i:4.3.3.b,i:4.3.3.d} we have
  \[
...
\begin{proof}[\pf{i:4.3.12.b}]
  ...
  Then by \cref{i:4.3.10.b,i:4.3.10.c} we have \(x^n \geq y^n > 0\).
  ...
  \begin{itemize}
    \item \(x > y\).
          ...
          \begin{itemize}
            ...
            \item \(n < 0\).
                  Then by \cref{i:ac:4.2.7} we have \(-n > 0\) and by \cref{i:4.3.10.b,i:4.3.10.c} we have \(x^{-n} > y^{-n} > 0\).
                  Since
                  \begin{align*}
