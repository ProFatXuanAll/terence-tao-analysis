...
\begin{proof}[\pf{i:5.3.3}]
  ...
  Let \(\equiv\) denote the equivalence of rational Cauchy sequences as defined in \labelcrefs{i:5.2.6}.
  First, we show that the equality defined in \labelcrefs{i:5.3.1} is reflexive.
  This is true since
  \begin{align*}
  ...
  Next we show that the equality defined in \labelcrefs{i:5.3.1} is symmetric.
  Suppose that \(x = y\).
  Then we have
  \begin{align*}
  ...
  \end{align*}
  Thus, the equality defined in \labelcrefs{i:5.3.1} is symmetric.

  Finally we show that the equality defined in \labelcrefs{i:5.3.1} is transitive.
  ...
  \end{align*}
  Thus, the equality defined in \labelcrefs{i:5.3.1} is transitive.
\end{proof}

\begin{note}
  Because of \labelcrefs{i:5.3.3}, we know that our definition of equality between two real numbers is legitimate.
...
\begin{proof}[\pf{i:5.3.6}]
  ...
  (we know from \labelcrefs{i:2.2.13} that one has to be greater than or equal to the other).
  If \(n, m \geq \max(N, M)\), then we know that \(a_n\) and \(a_m\) are \(\varepsilon / 2\)-close, and \(b_n\) and \(b_m\) are \(\varepsilon / 2\)-close, and so by \labelcrefs{i:4.3.7.d} we see that \(a_n + b_n\) and \(a_m + b_m\) are \(\varepsilon\)-close for every \(n, m \geq \max(N, M)\).
...
\begin{proof}[\pf{i:5.3.7}]
  ...
  Since \(b_n\) is of course \(0\)-close to \(b_n\), we thus see from \labelcrefs{i:4.3.7.d} that \(a_n + b_n\) and \(a_n' + b_n\) are \(\varepsilon\)-close for each \(n \in \Z_{\geq N}\).
...
\begin{rmk}\label{i:5.3.8}
  \labelcrefs{i:5.3.7} verifies the axiom of substitution for the ``x'' variable in \(x + y\), but one can similarly prove the axiom of substitution for the ``y'' variable.
...
\begin{proof}[\pf{i:5.3.10}]
  ...
  Let \(\varepsilon \in \Q^+\).
  Since \((a_n)_{n = 1}^\infty\) and \((b_n)_{n = 1}^\infty\) are rational Cauchy sequences, by \labelcrefs{i:5.1.15} we know that \((a_n)_{n = 1}^\infty\) and \((b_n)_{n = 1}^\infty\) are bounded by some \(M_1, M_2 \in \Q_{\geq 0}\).
  Then by \labelcrefs{i:4.2.9.a} we know that \((a_n)_{n = 1}^\infty\) and \((b_n)_{n = 1}^\infty\) are bounded by \(M = \max(M_1, M_2) + 1\).
  Clearly, \(M \in \Q^+\), so \(\dfrac{\varepsilon}{2M} \in \Q^+\).
  Then by \labelcrefs{i:5.1.8} we have
  \begin{align*}
  ...
  \begin{align*}
    \forall j, k \in \Z_{\geq N}, \abs{a_j b_j - a_k b_k} & = \abs{a_j b_j - a_j b_k + a_j b_k - a_k b_k}              &  & \by{i:4.2.4}             \\
                                                          ...
                                                          & \leq M \dfrac{\varepsilon}{2M} + M \dfrac{\varepsilon}{2M} &  & \by{i:4.2.9.c,i:4.2.9.e} \\
                                                          & = \varepsilon.
  \end{align*}
  ...
  \]
  Thus, by \labelcrefs{i:5.1.8} \((a_n b_n)_{n = 1}^\infty\) is a rational Cauchy sequence and by \labelcrefs{i:5.3.1} \(xy \in \R\).

  Now we show that \(x = x' \implies xy = xy'\).
  Let \(\varepsilon \in \Q^+\).
  Since \((a_n)_{n = 1}^\infty, (a_n')_{n = 1}^\infty, (b_n)_{n = 1}^\infty\) are rational Cauchy sequences, by \labelcrefs{i:5.1.15} we know that \((a_n)_{n = 1}^\infty\) and \((a_n')_{n = 1}^\infty\) are bounded by some \(M_1, M_2, M_3 \in \Q_{\geq 0}\).
  Then by \labelcrefs{i:4.2.9.a} we know that \((a_n)_{n = 1}^\infty, (a_n')_{n = 1}^\infty, (b_n)_{n = 1}^\infty\) are bounded by \(M = \max(M_1, M_2, M_3) + 1\).
  Clearly, \(M \in \Q^+\), so \(\dfrac{\varepsilon}{M} \in \Q^+\).
  Since \(x = x'\), by \labelcrefs{i:5.2.6} we know that
  \[
  ...
  \begin{align*}
    ...
    \implies & \forall n \in \Z_{\geq N}, \abs{b_n} \abs{a_n - a_n'} \leq \abs{b_n} \dfrac{\varepsilon}{M} \leq M \dfrac{\varepsilon}{M} = \varepsilon &  & \by{i:4.2.9.c,i:4.2.9.e} \\
  ...
  \]
  Thus, by \labelcrefs{i:5.2.6,i:5.3.9} we have \(xy = x'y\).
\end{proof}
...
\begin{ac}\label{i:ac:5.3.1}
  ...
  Also, this identification of rational numbers and real numbers is consistent with our definitions of equality (\labelcrefs{i:ex:5.3.3}).
\end{ac}
...
\begin{proof}[\pf{i:ac:5.3.1}]
  ...
  \end{align*}
  by \labelcrefs{i:5.1.8} we see that \((a_n)_{n = 1}^\infty\) is a rational Cauchy sequence.
  Thus, by \labelcrefs{i:5.3.1} \(\LIM_{n \to \infty} a_n\) is well-defined.
  ...
  If \(a = b\), then we have \((a)_{n = 1}^\infty = (b)_{n = 1}^\infty\) and thus by \labelcrefs{i:5.3.3} we have \(\LIM_{n \to \infty} a = \LIM_{n \to \infty} b\).
  So suppose that \(\LIM_{n \to \infty} a = \LIM_{n \to \infty} b\).
  By \labelcrefs{i:ac:5.3.1} this means \((a)_{n = 1}^\infty\) and \((b)_{n = 1}^\infty\) are equivalent rational Cauchy sequences.
  Then we have
  \begin{align*}
...
\begin{ac}\label{i:ac:5.3.2}
  ...
  \[
    -x \coloneqq (-1) \times x,
  \]
  since \(-1\) is a rational number and is hence real (\labelcrefs{i:ac:5.3.1}).
  Note that this is clearly consistent with our negation for rational numbers since we have \(-q = (-1) \times q\) for all rational numbers \(q\) (\labelcrefs{i:ac:5.3.1}).
...
\begin{prop}\label{i:5.3.11}
  All the laws of algebra from \labelcrefs{i:4.1.6} hold not only for the integers, but for the reals as well.
\end{prop}
...
\begin{proof}[\pf{i:5.3.14}]
  ...
  \begin{align*}
             & \abs{b_{n_0}} - \abs{b_{n_0} - b_n} \geq \varepsilon - \varepsilon / 2 = \varepsilon / 2 &  & \by{i:4.2.9.c,i:4.2.9.d} \\
...
\begin{defn}[Reciprocals of real numbers]\label{i:5.3.16}
  Let \(x\) be a non-zero real number.
  Let \((a_n)_{n = 1}^{\infty}\) be a rational Cauchy sequence bounded away from zero such that \(x = \LIM_{n \to \infty} a_n\) (such a sequence exists by \labelcrefs{i:5.3.14}).
  Then we define the reciprocal \(x^{-1}\) by the formula \(x^{-1} \coloneqq \LIM_{n \to \infty} a_n^{-1}\).
  (From \labelcrefs{i:5.3.15} we know that \(x^{-1}\) is a real number.)
\end{defn}
...
\begin{ac}\label{i:ac:5.3.3}
  It is clear from \labelcrefs{i:5.3.16} that \(x x^{-1} = x^{-1} x = 1\);
  thus all the field axioms (\labelcrefs{i:4.2.4}) apply to the reals as well as to the rationals.
...
\begin{ex}\label{i:ex:5.3.1}
  Prove \labelcrefs{i:5.3.3}.
\end{ex}

\begin{proof}[\pf{i:ex:5.3.1}]
  See \labelcrefs{i:5.3.3}.
\end{proof}

\begin{ex}\label{i:ex:5.3.2}
  Prove \labelcrefs{i:5.3.10}.
\end{ex}

\begin{proof}[\pf{i:ex:5.3.2}]
  See \labelcrefs{i:5.3.10}.
\end{proof}
...
\begin{proof}[\pf{i:ex:5.3.4}]
  Since \((a_n)_{n = m}^{\infty}\) and \((b_n)_{n = m}^{\infty}\) are equivalent, by \labelcrefs{i:5.2.6} we know that \((a_n)_{n = m}^{\infty}\) and \((b_n)_{n = m}^{\infty}\) are eventually \(\varepsilon\)-close for every \(\varepsilon \in \Q^+\).
  Thus, by \labelcrefs{i:ex:5.2.2} \((a_n)_{n = m}^{\infty}\) is bounded iff \((b_n)_{n = m}^{\infty}\) is bounded.
\end{proof}
...
\begin{proof}[\pf{i:ex:5.3.5}]
  By \labelcrefs{i:5.3.1} we need to show that \((1 / n)_{n = 1}^\infty\) and \((0)_{n = 1}^\infty\) are equivalent rational Cauchy sequences.
  By \labelcrefs{i:5.1.11,i:ac:5.3.1} we know that both \((1/ n)_{n = 1}^{\infty}\) and \((0)_{n = 1}^\infty\) are rational Cauchy sequences.
  ...
  By \labelcrefs{i:4.4.1} we know that there exists an \(N \in \Z^+\) such that \(\dfrac{1}{\varepsilon} \leq N\), or \(\dfrac{1}{N} \leq \varepsilon\).
  Fix such \(N\).
  Then we have
  \begin{align*}
