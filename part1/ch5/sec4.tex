...
\begin{proof}[\pf{i:5.4.4}]
  ...
  Let \(x \in \R\).
  By \labelcrefs{i:ac:5.3.1} we know that \(0\) is the formal limit of \((0)_{n = 1}^\infty\), thus by \labelcrefs{i:5.3.1,i:5.3.3} we can ask whether \(x = 0\) or \(x \neq 0\).
  If \(x = 0\), then we are done.
  Otherwise by \labelcrefs{i:5.3.14} we know that \(x\) is the formal limit of a rational Cauchy sequence \((a_n)_{n = 1}^\infty\) which is bounded away from \(0\).
  In particular, by \labelcrefs{i:5.3.12} we know that there exists a \(c \in \Q^+\) such that \(\abs{a_n} \geq c\) for all \(n \in \Z^+\).
  Fix such \(c\).
  Since \((a_n)_{n = 1}^{\infty}\) is a Cauchy sequence and \(c \in \Q^+\), by \labelcrefs{i:5.1.8} we have
  \[
  ...
  \begin{align*}
    ...
    \implies & \forall j \in \Z_{\geq N}, -c + a_N \leq a_j \leq c + a_N. &  & \by{i:4.2.9.c,i:4.2.9.d}
  \end{align*}
  Since \(\abs{a_N} \geq c \in \Q^+\), by \labelcrefs{i:4.3.1} we know that we have either \(a_N \in \Q^+\) or \(a_N \in \Q^-\).
  So we split into two cases:
  \begin{itemize}
    \item If \(a_N \in \Q^+\), then by \labelcrefs{i:4.3.1} we have \(a_N \geq c\).
          Thus
          \begin{align*}
                     & \forall j \in \Z_{\geq N}, 0 \leq -c + a_N \leq a_j \leq c + a_N &  & \by{i:4.2.9.c,i:4.2.9.d} \\
          ...
          Thus, by \labelcrefs{i:5.4.3} \(x\) is positive.
    \item If \(a_N \in \Q^-\), then by \labelcrefs{i:4.3.1} we have \(-a_N \geq c\).
          By \labelcrefs{i:ex:4.2.6} we have \(a_N \leq -c\).
          Thus
          \begin{align*}
                     & \forall j \in \Z_{\geq N}, -c + a_N \leq a_j \leq c + a_N \leq 0 &  & \by{i:4.2.9.c,i:4.2.9.d} \\
          ...
          Thus, by \labelcrefs{i:5.4.3} \(x\) is negative.
  \end{itemize}
  ...
  \begin{itemize}
    \item We have both \(x = 0\) and \(x\) is positive.
          ...
          Fix such \(c\).
          Since \(x = 0\), by \labelcrefs{i:5.2.6} we know that \((a_n)_{n = 1}^\infty\) and \((0)_{n = 1}^\infty\) are eventually \(\varepsilon\)-close for all \(\varepsilon \in \Q^+\).
          ...
          But this means for any \(n \in \Z_{\geq N}\), we have both \(a_n < c\) and \(a_n \geq c\), which contradict to \labelcrefs{i:4.2.9.a}.
    \item We have both \(x = 0\) and \(x\) is negative.
          ...
          Since \(c \in \Q^-\), we know that \(-c / 2 \in \Q^+\).
          Thus, \((a_n)_{n = 1}^\infty\) and \((0)_{n = 1}^\infty\) must be eventually \(-c / 2\)-close, i.e., there exists an \(N \in \Z^+\) such that \(-a_n = \abs{a_n - 0} \leq -c / 2 < -c\) for all \(n \in \Z_{\geq N}\).
          But this means for any \(n \in \Z_{\geq N}\), we have both \(a_n > c\) and \(a_n \leq c\), which contradict to \labelcrefs{i:4.2.9.a}.
    \item We have \(x\) is both positive and negative.
          ...
          By \labelcrefs{i:5.4.1} we know that there exist some \(c \in \Q^+\) and \(d \in \Q^-\) such that \(a_n \geq c\) and \(b_n \leq d\) for all \(n \in \Z^+\).
          Fix such \(c, d\) and observe that \(c - d \in \Q^+\).
          Since \(x = \LIM_{n \to \infty} a_n = \LIM_{n \to \infty} b_n\), by \labelcrefs{i:5.3.3} we know that \((a_n)_{n = 1}^\infty\) and \((b_n)_{n = 1}^\infty\) are equivalent rational Cauchy sequences.
          Thus, by \labelcrefs{i:5.2.6} we have
          \[
          ...
          \begin{align*}
            ...
            \implies & \forall n \in \Z_{\geq N}, a_n - b_n = \abs{a_n - b_n} \geq c - d, &  & \by{i:4.2.9.c,i:4.2.9.d}
          \end{align*}
          which contradict to \labelcrefs{i:4.2.9.a}.
  \end{itemize}
  ...
  But by \labelcrefs{i:ac:5.3.2} we know that \(-x = \LIM_{n \to \infty} -a_n\), thus by \labelcrefs{i:5.4.1} we know that \(-x\) is positive.
  ...
  But by \labelcrefs{i:5.3.4,i:5.3.9} we know that \(x + y = \LIM_{n \to \infty} a_n + b_n\) and \(xy = \LIM_{n \to \infty} a_n b_n\), thus by \labelcrefs{i:5.4.1} we know that \(x + y\) and \(xy\) are positive.
\end{proof}
...
\begin{note}
  Comparing \labelcrefs{i:5.4.6} with the definition of order on the rationals from \labelcrefs{i:4.2.8} we see that order on the reals is consistent with order on the rationals, i.e., if two rational numbers \(q, q'\) are such that \(q\) is less than \(q'\) in the rational number system, then \(q\) is still less than \(q'\) in the real number system, and similarly for ``greater than.''
  In the same way we see that the definition of absolute value given in \labelcrefs{i:5.4.5} is consistent with that in \labelcrefs{i:4.3.1}.
\end{note}

\begin{prop}\label{i:5.4.7}
  All the claims in \labelcrefs{i:4.2.9} which held for rationals, continue to hold for real numbers.
\end{prop}

\begin{proof}[\pf{i:5.4.7}(a)]
  By \labelcrefs{i:5.4.4} \(x - y\) satisfy exactly one of the following three statements:
  \begin{itemize}
    \item \(x - y = 0\).
          Then by \labelcrefs{i:5.3.11} we have \(x = y\).
    \item \(x - y\) is a positive rational number.
          Then by \labelcrefs{i:5.4.6} we have \(x > y\).
...
\begin{proof}[\pf{i:5.4.8}]
  ...
  Also, from \labelcrefs{i:5.4.4} it is easy to see that a positive number times a negative number is negative;
  this shows that \(x^{-1}\) cannot be negative, since this would imply that \(xx^{-1} = 1\) is negative, a contradiction.
  Thus, by \labelcrefs{i:5.4.4}, the only possibility left is that \(x^{-1}\) is positive.

  Now let \(y\) be positive as well, so \(x^{-1}\) and \(y^{-1}\) are also positive.
  Suppose that \(x > y\).
  If \(x^{-1} \geq y^{-1}\), then by \labelcrefs{i:5.4.7} we have \(xx^{-1} > yx^{-1} \geq yy^{-1}\), thus \(1 > 1\), which is a contradiction.
...
\begin{proof}[\pf{i:5.4.10}]
  Apply \labelcrefs{i:5.4.9} to the sequence \((a_n - b_n)_{n = 1}^\infty\).
\end{proof}

\begin{rmk}\label{i:5.4.11}
  Note that \labelcrefs{i:5.4.10} does not work if the \(\geq\) signs are replaced by \(>\):
...
\begin{ac}\label{i:ac:5.4.1}
  ...
  In fact, \labelcrefs{i:4.3.3,i:4.3.7} hold not only for the rationals, but for the reals;
...
\begin{proof}[\pf{i:5.4.12}]
  ...
  Also, by \labelcrefs{i:5.1.15}, this sequence is bounded.
  Thus, we have rationals \(q, r \in \Q^+\) such that \(q \leq a_n \leq r\) for all \(n \in \Z^+\).
  But by \labelcrefs{i:4.4.1} we know that there is some integer \(N\) such that \(r \leq N\);
  since \(q\) is positive and \(q \leq r \leq N\), we see that \(N\) is positive.
  Thus, \(q \leq a_n \leq N\) for all \(n \in \Z^+\).
  Applying \labelcrefs{i:5.4.10} we obtain that \(q \leq x \leq N\), as desired.
\end{proof}
...
\begin{proof}[\pf{i:5.4.13}]
  The number \(x / \varepsilon\) is positive, and hence by \labelcrefs{i:5.4.12} there exists a positive integer \(N\) such that \(x / \varepsilon \leq N\).
  If we set \(M \coloneqq N + 1\), then \(x / \varepsilon < M\).
  Now multiply by \(\varepsilon\).
\end{proof}

\begin{note}
  This property (\labelcrefs{i:5.4.13}) is quite important;
...
\begin{proof}[\pf{i:5.4.14}]
  ...
  \end{align*}
  Fix one such \(N\).
  Since \(x\) is a real number, by \labelcrefs{i:5.3.10} we know that \(Nx\) is also a real number.
  By \labelcrefs{i:ex:5.4.3}, there exists an \(M \in \Z\) such that \(M \leq Nx < M + 1\).
  So we have
  \begin{align*}
             & M \leq Nx < M + 1                                                                                \\
...
\begin{proof}[\pf{i:ac:5.4.2}]
  ...
  By \labelcrefs{i:3.6.9} we know that \(\#(X') = n\).
  ...
  Thus, by \labelcrefs{i:5.4.7}(a) we must have \(x = x'\) and \(\max(X)\) is unique.
...
\begin{proof}[\pf{i:ac:5.4.3}]
  By \labelcrefs{i:5.3.11} we have \(x = x - 0\).
  Thus, \(x\) is a positive rational number iff \(x - 0\) is a positive rational number, iff \(x > 0\) (\labelcrefs{i:5.4.6}).
  Similarly, \(x\) is a negative rational number iff \(x - 0\) is a negative rational number, iff \(x < 0\) (\labelcrefs{i:5.4.6}).
\end{proof}

\exercisesection

\begin{ex}\label{i:ex:5.4.1}
  Prove \labelcrefs{i:5.4.4}.
\end{ex}

\begin{proof}[\pf{i:ex:5.4.1}]
  See \labelcrefs{i:5.4.4}.
\end{proof}

\begin{ex}\label{i:ex:5.4.2}
  Prove the remaining claims in \labelcrefs{i:5.4.7}.
\end{ex}

\begin{proof}[\pf{i:ex:5.4.2}]
  See \labelcrefs{i:5.4.7}.
\end{proof}
...
\begin{proof}[\pf{i:ex:5.4.3}]
  ...
  By \labelcrefs{i:5.4.4}, exactly one of the following three statements is true:
  \begin{itemize}
    \item \(x = 0\).
          Then we choose \(N = 0\) so that \(0 \leq 0 < 1\).
    \item \(x\) is positive.
          Then by \labelcrefs{i:5.4.12} there exist some \(q \in \Q^+\) and \(N_1' \in \Z^+\) such that \(q \leq x \leq N_1'\).
          Let \(N_1 = N_1' + 1\).
          Then we have \(x < N_1\).
          By \labelcrefs{i:4.4.1} we know that there exists an \(N_2 \in \Z\) such that \(N_2 \leq q\), thus by \labelcrefs{i:5.4.7}(c) we have \(N_2 \leq x < N_1\).
          Let \(X\) be the set
          \[
            X = \set{n \in \Z : N_2 \leq n \leq x < N_1}.
          \]
          We know that \(X\) is finite since \(X \subseteq \Z_{N_2 \leq N_1}\) and \(\Z_{N_2 \leq N_1}\) is finite (\labelcrefs{i:3.6.14.c}).
          We also know that \(X\) is non-empty since \(N_2 \in X\).
          By \labelcrefs{i:ac:5.4.2} we know that there exists an unique \(\max(X) \in X\).
          Let \(N = \max(X)\).
    ...
    \item \(x\) is negative.
          Then by \labelcrefs{i:5.4.4} we know that \(-x\) is positive.
          By \labelcrefs{i:5.4.13} we know that there exists an \(M \in \Z^+\) such that \(-x < 1M = M\).
          Fix such \(M\).
          By \labelcrefs{i:5.4.7}(d) we know that \(0 < x + M\).
...
\begin{ex}\label{i:ex:5.4.5}
  Prove \labelcrefs{i:5.4.14}.
\end{ex}

\begin{proof}[\pf{i:ex:5.4.5}]
  See \labelcrefs{i:5.4.14}.
\end{proof}
...
\begin{proof}[\pf{i:ex:5.4.8}]
  ...
  Then by \labelcrefs{i:5.4.14}, there exists a \(q \in \Q\) such that \(a > q > x\).
  Since \(q > x\), we have \(a_n \leq x < q\) for all \(n \in \Z^+\).
  But by \labelcrefs{i:5.4.10} we have \(a = \LIM_{n \to \infty} a_n \leq \LIM_{n \to \infty} q = q\), which contradict to \(a > q\).
