...
\begin{prop}\label{i:5.6.3}
  All the properties in \labelcrefs{i:4.3.10,i:4.3.12} remain valid if \(x\) and \(y\) are assumed to be real numbers instead of rational numbers.
\end{prop}

\begin{meta-proof}[\pf{i:5.6.3}]
If one inspects the proof of \labelcrefs{i:4.3.10,i:4.3.12} we see that they rely on the laws of algebra and the laws of order for the rationals (\labelcrefs{i:4.2.4,i:4.2.9}).
But by \labelcrefs{i:5.3.11,i:5.4.7}, and the identity \(xx^{-1} = x^{-1} x = 1\) we know that all these laws of algebra and order continue to hold for real numbers as well as rationals.
Thus, we can modify the proof of \labelcrefs{i:4.3.10,i:4.3.12} to hold in the case when \(x\) and \(y\) are real.
\end{meta-proof}

\begin{note}
  Instead of giving an actual proof of \labelcrefs{i:5.6.3}, we shall give a meta-proof
...
\begin{lem}\label{i:5.6.6}
  ...
  \begin{enumerate}
    \item\label{i:5.6.6.a} If \(y = x^{1 / n}\), then \(y^n = x\).
    \item\label{i:5.6.6.b} Conversely, if \(y^n = x\), then \(y = x^{1 / n}\).
    \item\label{i:5.6.6.c} \(x^{1 / n}\) is a non-negative real number, and is positive iff \(x\) is positive.
    \item\label{i:5.6.6.d} We have \(x > y\) iff \(x^{1 / n} > y^{1 / n}\).
    \item\label{i:5.6.6.e} Let \(k, l \in \Z^+\).
    ...
    \item\label{i:5.6.6.f} We have \((xy)^{1 / n} = x^{1 / n} y^{1 / n}\).
    \item\label{i:5.6.6.g} We have \((x^{1 / n})^{1 / m} = x^{1 / nm}\).
  \end{enumerate}
\end{lem}

\begin{proof}[\pf{i:5.6.6.a}]
  Let \(E = \set{z \in \R_{\geq 0} : z^n \leq x}\).
  By \labelcrefs{i:5.6.5} we have \(y = x^{1 / n} = \sup(E)\).
  Suppose for the sake of contradiction that \(y^n \neq x\).
  Then by \labelcrefs{i:5.4.7}(a) we have either \(y^n < x\) or \(y^n > x\).
  \begin{itemize}
    \item If \(y^n < x\), then we can find a small number \(\varepsilon \in \Q_{0 < 1}\) such that \((y + \varepsilon)^n < x\)
          (this can be proved by induction, and using the binomial formula, see \labelcrefs{i:ex:7.1.4}).
    ...
    \item If \(y^n > x\), then we can find a small number \(\varepsilon \in \Q_{0 < 1}\) such that \((y - \varepsilon)^n > x\).
          ...
          But by \labelcrefs{i:5.5.5} this means \(y - \varepsilon \geq y\), a contradiction.
  \end{itemize}
...
\begin{proof}[\pf{i:5.6.6.b}]
  Let \(E = \set{z \in \R_{\geq 0} : z^n \leq x}\).
  By \labelcrefs{i:5.6.5} we have \(x^{1 / n} = \sup(E)\).
  Since \(y^n = x\), by the definition of \(E\) we know that \(y \in E\).
  Suppose for the sake of contradiction that \(y \neq x^{1 / n}\).
  Then by \labelcrefs{i:5.4.7}(a) exactly one of the following statements is true:
  \begin{itemize}
    \item \(y < x^{1 / n}\).
          But then we have
          \begin{align*}
...
\begin{proof}[\pf{i:5.6.6.c}]
  Let \(E = \set{z \in \R_{\geq 0} : z^n \leq x}\).
  By \labelcrefs{i:5.6.5} we have \(x^{1 / n} = \sup(E)\).
  Since \(0 \in E\), by \labelcrefs{i:5.5.5} we know that \(0 \leq x^{1 / n}\), thus \(x^{1 / n}\) is a non-negative real number.
  ...
  But by \labelcrefs{i:5.6.6.a} we have
  \[
    x = (x^{1 / n})^n = 0^n = 0,
  \]
  a contradiction.
...
\begin{proof}[\pf{i:5.6.6.e}]
  If \(x = 0\), then by \labelcrefs{i:5.6.6.c} we know that \(x^{1 / k} = 0\) for every \(k \in \Z^+\).
  ...
  \begin{align*}
    ...
    \implies & (x^{1 / (k + 1)})^{k + 1} \leq (x^{1 / (k + 1)})^k                                                           &  & \by{i:5.6.6.a,i:5.6.6.b} \\
  ...
  \begin{align*}
    ...
    \implies & (x^{1 / (k + 1)})^{k + 1} \geq (x^{1 / (k + 1)})^k                                                           &  & \by{i:5.6.6.a,i:5.6.6.b} \\
  ...
  Then by \labelcrefs{i:5.4.7} exactly one of the following two statements is true:
  \begin{itemize}
    \item \(x^{1 / k} > 1\).
          But then we have
          \begin{align*}
...
\begin{proof}[\pf{i:5.6.6.f}]
  ...
  \begin{align*}
    ((xy)^{1 / n})^n & = xy                          &  & \by{i:5.6.6.a}           \\
                     & = (x^{1 / n})^n (y^{1 / n})^n &  & \by{i:5.6.6.a,i:5.6.6.b} \\
                     & = (x^{1 / n} y^{1 / n})^n.    &  & \by{i:5.6.3}
  \end{align*}
  Thus, by \labelcrefs{i:5.6.6.b} we have \((xy)^{1 / n} = x^{1 / n} y^{1 / n}\).
\end{proof}
...
\begin{proof}[\pf{i:5.6.6.g}]
  ...
  \begin{align*}
    (x^{1 / nm})^{nm} & = x                                 &  & \by{i:5.6.6.a}           \\
                      & = (x^{1 / n})^n                     &  & \by{i:5.6.6.a,i:5.6.6.b} \\
                      & = \pa{\pa{(x^{1 / n})^{1 / m}}^m}^n &  & \by{i:5.6.6.a,i:5.6.6.b} \\
                      & = \pa{(x^{1 / n})^{1 / m}}^{nm}.    &  & \by{i:5.6.3}
  \end{align*}
  Thus, by \labelcrefs{i:5.6.6.b} we have \(x^{1 / nm} = (x^{1 / n})^{1 / m}\).
\end{proof}

\begin{note}
  The observant reader may note that this definition of \(x^{1 / n}\) might possibly be inconsistent with our previous notion of \(x^n\) when \(n = 1\), but it is easy to check that \(x^{1 / 1} = x = x^1\) by using \labelcrefs{i:5.6.6.e}, so there is no inconsistency.
\end{note}

\begin{note}
  One consequence of \labelcrefs{i:5.6.6.b} is another proof of the cancellation law from \labelcrefs{i:4.3.12.c} and \labelcrefs{i:5.6.3}:
...
\begin{note}
  ...
  So to ensure that \labelcrefs{i:5.6.7} is well-defined, we need to check that different expressions \(a / b\) give the same formula for \(x^q\).
\end{note}
...
\begin{proof}[\pf{i:5.6.8}]
  ...
  By \labelcrefs{i:5.6.6.g} we have \(y = (x^{1 / b'})^{1 / a}\) and \(y = (x^{1 / b})^{1 / a'}\);
  by \labelcrefs{i:5.6.6.a} we thus have \(y^{a'} = x^{1 / b}\) and \(y^a = x^{1 / b'}\).
  Thus, we have
  \[
...
\begin{note}
  ...
  \labelcrefs{i:5.6.7} is consistent with our old definition for \(x^{1 / n}\) (since \(x^{1 / n} = (x^{1 / n})^1\)) and is also consistent with our old definition for \(x^n\) (since \(x^n = (x^{1 / 1})^n\)).
\end{note}

\begin{lem}\label{i:5.6.9}
  Let \(x, y \in \R^+\), and let \(q, r \in \Q\).
  \begin{enumerate}
    \item\label{i:5.6.9.a} \(x^q \in \R^+\).
    \item\label{i:5.6.9.b} \(x^{q + r} = x^q x^r\) and \((x^q)^r = x^{qr}\).
    \item\label{i:5.6.9.c} \(x^{-q} = 1 / x^q\).
    \item\label{i:5.6.9.d} If \(q > 0\), then \(x > y\) iff \(x^q > y^q\).
    \item\label{i:5.6.9.e} If \(x > 1\), then \(x^q > x^r\) iff \(q > r\).
    If \(x < 1\), then \(x^q > x^r\) iff \(q < r\).
    \item\label{i:5.6.9.f} \((xy)^q = x^q y^q\).
  \end{enumerate}
\end{lem}
...
\begin{proof}[\pf{i:5.6.9.b}]
  ...
  \begin{align*}
    x^{q + r} & = x^{(ad + bc) / bd}                  &  & \by{i:4.2.2}                      \\
              ...
              & = x^{ad / bd} x^{bc / bd}             &  & \text{(by  \labelcrefs{i:5.6.7})} \\
  ...
  \begin{align*}
    x^{qr} & = x^{ac / bd}                                       &  & \by{i:4.2.2}             \\
           ...
           & = \pa{\pa{\pa{(x^{1 / b})^a}^{1 / a}}^{1 / d}}^{ac} &  & \by{i:5.6.6.a,i:5.6.6.b} \\
...
\begin{proof}[\pf{i:5.6.9.d}]
  ...
  \begin{align*}
    ...
    \implies & x^{1 / b} > y^{1 / b}                                   &  & \by{i:5.6.6.a,i:5.6.6.b} \\
...
\begin{ex}\label{i:ex:5.6.1}
  Prove \labelcrefs{i:5.6.6}.
\end{ex}

\begin{proof}[\pf{i:ex:5.6.1}]
  See \labelcrefs{i:5.6.6}.
\end{proof}

\begin{ex}\label{i:ex:5.6.2}
  Prove \labelcrefs{i:5.6.9}.
\end{ex}

\begin{proof}[\pf{i:ex:5.6.2}]
  See \labelcrefs{i:5.6.9}.
\end{proof}
...
\begin{proof}[\pf{i:ex:5.6.3}]
  By \labelcrefs{i:5.4.7}(a) exactly one of the following three statements is true:
  \begin{itemize}
    \item \(x > 0\).
          Then by \labelcrefs{i:5.4.5} we have \(\abs{x} = x\) and by \labelcrefs{i:5.6.6.a,i:5.6.6.b} we have \(\abs{x} = x = (x^2)^{1 / 2}\).
    \item \(x = 0\).
          Then by \labelcrefs{i:5.4.5} we have \(\abs{0} = 0\) and by \labelcrefs{i:5.6.6.c} we have \(\abs{0} = 0 = (0^2)^{1 / 2}\).
    \item \(x < 0\).
          Then by \labelcrefs{i:5.4.5} we have \(\abs{x} = -x > 0\).
          By \labelcrefs{i:5.6.6.b,i:5.6.6.c} we have \(-x = ((-x)^2)^{1 / 2}\).
          But by \labelcrefs{i:5.3.11} we know that \((-x)^2 = (-x)(-x) = x^2\).
