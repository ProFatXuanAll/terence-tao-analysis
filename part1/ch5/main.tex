...
\begin{note}
  ...
  but you will have to give up one or more of the field axioms from \labelcrefs{i:4.2.4}, among other things, and you will probably get a less useful number system in which to do any real-world problems.)
\end{note}
