...
\begin{rmk}\label{i:5.2.7}
  As with \labelcrefs{i:5.1.8}, the quantity \(\varepsilon \in \Q^+\) is currently restricted to be a positive rational, rather than a positive real.
  ...
  see \labelcrefs{i:ex:6.1.10}.
\end{rmk}

\begin{ac}\label{i:ac:5.2.1}
  Equivalence defined as \labelcrefs{i:5.2.6} is reflexive, symmetric and transitive.
\end{ac}

\begin{proof}[\pf{i:ac:5.2.1}]
  Let \((a_n)_{n = m}^\infty, (b_n)_{n = m}^\infty, (c_n)_{n = m}^\infty\) be rational sequences.
  We denote the equivalence relation defined in \labelcrefs{i:5.2.6} as \(\equiv\).
  ...
  \begin{align*}
    ...
    \implies & \forall \varepsilon \in \Q^+, \exists N = \max(N_1, N_2) \in \Z_{\geq m} :                                                                      \\
             & \forall n \in \Z_{\geq N}, \abs{a_n - b_n} + \abs{b_n - c_n} \leq \varepsilon                                     &  & \by{i:4.2.9.c,i:4.2.9.d} \\
    \implies & \forall \varepsilon \in \Q^+, \exists N = \max(N_1, N_2) \in \Z_{\geq m} :                                                                      \\
...
\begin{proof}[\pf{i:5.2.8}]
  ...
  First, we observe \(10^N\) is always greater than \(N\) for any \(N \in \Z^+\) (see \labelcrefs{i:ex:4.3.5}).
  ...
  But by \labelcrefs{i:4.4.1} we can always choose such an \(N\), and the claim follows.
\end{proof}

\begin{rmk}\label{i:5.2.9}
  \labelcrefs{i:5.2.8}, in decimal notation, asserts that
  \[
...
\begin{proof}[\pf{i:ex:5.2.1}]
  ...
  Let \(\varepsilon \in \Q^+\).
  Since \((a_n)_{n = m}^\infty, (b_n)_{n = m}^\infty\) are equivalent, by \labelcrefs{i:5.2.6} we have
  \[
    \exists N_1 \in \Z_{\geq m} : \forall n \in \Z_{\geq N_1}, \abs{a_n - b_n} \leq \dfrac{\varepsilon}{3}.
  \]
  Fix such \(N_1\).
  Since \((a_n)_{n = m}^\infty\) is a Cauchy sequence, by \labelcrefs{i:5.1.8} we have
  \[
    \exists N_2 \in \Z_{\geq m} : \forall j, k \in \Z_{\geq N}, \abs{a_j - a_k} \leq \dfrac{\varepsilon}{3}.
  \]
  Fix such \(N_2\).
  Now let \(N = \max(N_1, N_2)\).
  By \labelcrefs{i:4.1.11.f} we know that \(N\) is well-defined.
  Then we have
  \begin{align*}
    \forall j, k \in \Z_{\geq N}, \abs{b_j - b_k} & = \abs{a_j - a_k + b_j - a_j + a_k - b_k}                                                                                  \\
                                                  & \leq \abs{a_j - a_k} + \abs{a_j - b_j} + \abs{a_k - b_k}                                     &  & \by{i:4.3.3.b}           \\
                                                  & \leq \dfrac{\varepsilon}{3} + \dfrac{\varepsilon}{3} + \dfrac{\varepsilon}{3} = \varepsilon. &  & \by{i:4.2.9.c,i:4.2.9.d}
  \end{align*}
  ...
  \]
  By \labelcrefs{i:5.1.8} this means \((b_n)_{n = m}^\infty\) is a Cauchy sequence.
...
\begin{proof}[\pf{i:ex:5.2.2}]
  ...
  Since \((a_n)_{n = m}^{\infty}\) and \((b_n)_{n = m}^{\infty}\) are eventually \(\varepsilon\)-close, by \labelcrefs{i:5.2.3} we have
  \[
    \exists N \in \Z_{\geq m} : \forall n \in \Z_{\geq N}, \abs{a_n - b_n} \leq \varepsilon.
  \]
  Fix such \(N\).
  Since \((a_n)_{n = m}^\infty\) is bounded, by \labelcrefs{i:5.1.12} there exists some \(M \in \Q_{\geq 0}\) such that \(\abs{a_n} \leq M\) for all \(n \in \Z_{\geq m}\).
  Then we have
  \begin{align*}
    \forall n \in \Z_{\geq N}, \abs{b_n} & = \abs{-b_n}                     &  & \by{i:4.3.3.d}           \\
                                         & = \abs{a_n - b_n + a_n}                                        \\
                                         & \leq \abs{a_n - b_n} + \abs{a_n} &  & \by{i:4.3.3.b}           \\
                                         & \leq \varepsilon + M.            &  & \by{i:4.2.9.c,i:4.2.9.d}
  \end{align*}
  ...
  \begin{itemize}
    ...
    \item If \(N \neq m\), then we must have \(m < N\).
          By \labelcrefs{i:5.1.14} we know that the finite rational sequence \((b_n)_{n = m}^{N - 1}\) is bounded by some \(M' \in \Q_{\geq 0}\).
