...
\begin{rmk}\label{i:9.10.2}
  \labelcrefs{i:9.10.1} may seem rather different from \labelcrefs{i:9.1.8}, but can be unified using the topological structure of the extended real line \(\R^*\).
\end{rmk}
...
\begin{ex}\label{i:ex:9.10.1}
  ...
  \]
  where the left-hand limit is defined by \labelcrefs{i:9.10.3} and the right-hand limit is defined by \labelcrefs{i:6.1.8}.
...
\begin{proof}
  ...
  \]
  Since \(\N \subseteq \R\), we have \(N \in \R\) and thus by \labelcrefs{i:9.10.3} we have \(\lim_{n \to +\infty, n \in \N} a_n = L\).
\end{proof}
