\section{Subsets of the real line}\label{i:sec:9.1}

\begin{defn}[Intervals]\label{i:9.1.1}
...
\begin{eg}\label{i:9.1.4}
  If \(a > b\) then all four of the intervals \([a, b], [a, b), (a, b]\), and \((a, b)\) are the empty set (by trichotomy, see \labelcrefs{i:5.4.7}(a)).
...
\begin{defn}[\(\varepsilon\)-adherent points]\label{i:9.1.5}
...
\setcounter{thm}{7}
\begin{defn}[Adherent points]\label{i:9.1.8}
...
\begin{lem}[Elementary properties of closures]\label{i:9.1.11}
...
\begin{proof}
  ...
  \end{align*}
  by \labelcrefs{i:3.1.15} we have \(X \subseteq \overline{X}\).
  ...
  \end{align*}
  by \labelcrefs{i:3.1.18} we have \(\overline{X \cup Y} = \overline{X} \cup \overline{Y}\).
  ...
  \end{align*}
  by \labelcrefs{i:3.1.15} we have \(\overline{X \cap Y} \subseteq \overline{X} \cap \overline{Y}\).
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.15} we have \(\overline{X} \subseteq \overline{Y}\).
\end{proof}

\begin{lem}[Closures of intervals]\label{i:9.1.12}
...
\begin{proof}
  ...
  Suppose for the sake of contradiction that \(x\) does not lie in \([a, b]\), then either \(x > b\) or \(x < a\).
  ...
  By \labelcrefs{i:9.1.11} we know that \((a, \infty) \subseteq \overline{(a, \infty)}\).
  ...
  Suppose for the sake of contradiction that \(\exists x \in \overline{(a, \infty)}\) such that \(x \notin [a, \infty)\).
  Then \(x < a\) (by \labelcrefs{i:9.1.8} \(x \in \R\) so \(x \neq \infty\)).
  ...
  By \labelcrefs{i:9.1.11} we know that \((-\infty, \infty) \subseteq \overline{(-\infty, \infty)}\).
  By \labelcrefs{i:9.1.8} we know that \(\overline{(-\infty, \infty)} \subseteq \R = (-\infty, \infty)\).
...
\begin{proof}
  ...
  By \labelcrefs{i:9.1.8} we have \(\overline{\N} \subseteq \R\).
  By \labelcrefs{i:9.1.11} we have \(\N \subseteq \overline{\N}\).
  Now we show that \(\overline{\N} \subseteq \N\).
  Suppose for the sake of contradiction that \(\exists x \in \overline{\N}\) such that \(x \notin \N\).
  Since
  \begin{align*}
  ...
  \end{align*}
  we know that \(x > 0\).
  By \labelcrefs{i:5.4.12} \(\exists n \in \N\) such that \(n < x < n + 1\).
  Let \(\varepsilon = \min(x - n, n + 1 - x) / 2\).
  By \labelcrefs{i:9.1.10}, \(\exists m \in \N\) such that \(\abs{x - m} \leq \varepsilon\).
  ...
  Thus, such \(m\) does not exists and by \labelcrefs{i:9.1.10} \(x \notin \overline{\N}\).
  So we have \(\overline{\N} \subseteq \N\).
  Since \(\N \subseteq \overline{\N} \land \overline{\N} \subseteq \N\), by \labelcrefs{i:3.1.18} we have \(\N = \overline{\N}\).
  ...
  By \labelcrefs{i:9.1.11} we have \(\Z^- \subseteq \overline{\Z^-}\).
  We need to show that \(\overline{\Z^-} \subseteq \Z^-\).
  Suppose for the sake of contradiction that \(\exists x \in \overline{\Z^-}\) such that \(x \notin \Z^-\).
  Since
  \begin{align*}
  ...
  \end{align*}
  we know that \(x < 0\).
  By \labelcrefs{i:5.4.12} \(\exists n \in \Z^-\) such that \(n < x < n + 1\).
  Let \(\varepsilon = \min(x - n, n + 1 - x) / 2\).
  By \labelcrefs{i:9.1.10}, \(\exists m \in \Z^-\) such that \(\abs{x - m} \leq \varepsilon\).
  We split into two cases:
  \begin{itemize}
    \item If \(m \leq n\), then we have \(x - m \geq x - n \geq \min(x - n, n + 1 - x) > \varepsilon\), a contradiction.
    \item If \(m > n\), then we have \(m \geq n + 1\) and \(m - x \geq n + 1 - x \geq \min(x - n, n + 1 - x) > \varepsilon\), a contradiction.
  ...
  Since \(\Z^- \subseteq \overline{\Z^-} \land \overline{\Z^-} \subseteq \Z^-\), by \labelcrefs{i:3.1.18} we have \(\Z^- = \overline{\Z^-}\), and thus \(\Z = \overline{\Z}\).
  ...
  \end{align*}
  by \labelcrefs{i:3.1.15} we have \(\R \subseteq \overline{\Q}\).
  Since \(\R \subseteq \overline{\Q} \land \overline{\Q} \subseteq \R\), by \labelcrefs{i:3.1.18} we have \(\R = \overline{\Q}\).
  ...
  Suppose for the sake of contradiction that \(\overline{\emptyset} \neq \emptyset\).
  Let \(x \in \overline{\emptyset}\)
  Then by \labelcrefs{i:9.1.10} \(\forall \varepsilon \in \R^+\), \(\exists y \in \emptyset\) such that \(\abs{x - y} \leq \varepsilon\), a contradiction.
...
\begin{proof}
  ...
  \]
  We know by \labelcrefs{i:9.1.10} that \(A_n \neq \emptyset\).
  By axiom of choice (\labelcrefs{i:8.1}) we know \(\prod_{n \in \N} A_n \neq \emptyset\).
  ...
  Since \(\lim_{n \to \infty} a_n = x\), by \labelcrefs{i:6.4.5} \(x\) is the only limit point of \((a_n)_{n = m}^\infty\).
  So we have
  \begin{align*}
...
\begin{eg}\label{i:9.1.16}
  From \labelcrefs{i:9.1.12} we see that if \(a < b\) are real numbers, then \([a, b]\), \([a, +\infty)\), \((-\infty, a]\), and \((-\infty, +\infty)\) are closed, while \((a, b)\), \((a, b]\), \([a, b)\), \((a, +\infty)\), and \((-\infty, a)\) are not.
  From \labelcrefs{i:9.1.13} we see that \(\N\), \(\Z\), \(\R\), \(\emptyset\) are closed, while \(\Q\) is not.
\end{eg}
...
\begin{proof}
  ...
  By \labelcrefs{i:9.1.11} we have \(X \subseteq \overline{X}\).
  Since
  \begin{align*}
  ...
  \end{align*}
  by \labelcrefs{i:3.1.15} we have \(\overline{X} \subseteq X\).
  Since \(X \subseteq \overline{X} \land \overline{X} \subseteq X\), by \labelcrefs{i:3.1.8} we have \(X = \overline{X}\), and thus by \labelcrefs{i:9.1.15} \(X\) is closed.
\end{proof}

\begin{defn}[Limit points]\label{i:9.1.18}
...
\begin{rmk}\label{i:9.1.20}
  From \labelcrefs{i:9.1.14} we see that \(x\) is a limit point of \(X\) iff there exists a sequence \((a_n)_{n = 0}^\infty\), consisting entirely of elements in \(X\) that are distinct from \(x\), and such that \((a_n)_{n = 0}^\infty\) converges to \(x\).
...
\begin{proof}
  ...
  This sequence converges to \(x\), and will lie inside \(I \setminus \set{a} = (a, b]\) if \(N\) is chosen large enough (by \labelcrefs{i:5.4.14}).
  Thus, by \labelcrefs{i:9.1.20} we see that \(x = a\) is a limit point of \([a, b]\).
  A similar argument works when \(a < x < b\).
  When \(x = b\) one has to use the sequence \((x - \dfrac{1}{n})_{n = N}^\infty\) instead.
  This sequence converges to \(x\), and will lie inside \(I \setminus \set{b} = [a, b)\) if \(N\) is chosen large enough (by \labelcrefs{i:5.4.14}).
  Thus, by \labelcrefs{i:9.1.20} we see that \(x = b\) is a limit point of \([a, b]\).
\end{proof}

\begin{defn}[Bounded sets]\label{i:9.1.22}
  A subset \(X\) of the real line is said to be \emph{bounded} if we have \(X \subseteq [-M, M]\) for some real number \(M > 0\).
\end{defn}

\begin{eg}\label{i:9.1.23}
...
\begin{thm}[Heine-Borel theorem for the line]\label{i:9.1.24}
  Let \(X\) be a subset of \(\R\).
...
\begin{proof}
  ...
  Since \(X\) is bounded, by \labelcrefs{i:9.1.22} \(\exists M \in \R^+\) such that \(X \subseteq [-M, M]\), thus \((a_n)_{n = 0}^\infty\) is also bounded by \(M\), i.e., \(\forall n \in \N\), \(\abs{a_n} \leq M\).
  By Bolzano-Weierstrass theorem (\labelcrefs{i:6.6.8}) we know that there exists a subsequence \((a_{n_j})_{j = 0}^\infty\) of \((a_n)_{n = 0}^\infty\) such that \((a_{n_j})_{j = 0}^\infty\) converges.
  Since \(X\) is closed, by \labelcrefs{i:9.1.17} we know that \(\lim_{j \to \infty} a_{n_j} \in X\).
  ...
  Thus, every convergent sequence \((a_n)_{n = 0}^\infty\) have its limit in \(X\), and by \labelcrefs{i:9.1.17} we know that \(X\) is closed.
  Suppose for the sake of contradiction that \(X\) is unbounded.
  ...
  By axiom of choice (\labelcrefs{i:8.1}) we know that \(\prod_{n \in \N} X_n \neq \emptyset\).
  ...
  But by \labelcrefs{i:6.4.18} \((a_{n_j})_{j = 0}^\infty\) is Cauchy sequence and by \labelcrefs{i:6.1.17} \((a_{n_j})_{j = 0}^\infty\) is bounded, a contradiction.
  Thus, \(X\) is closed and bounded.
\end{proof}

\begin{rmk}\label{i:9.1.25}
  This theorem shall play a key role in subsequent sections of \labelcrefs{i:ch:9}.
...
\begin{proof}
  By \labelcrefs{i:9.1.11} we have \(X \subseteq Y \implies \overline{X} \subseteq \overline{Y}\).
  Since
  \begin{align*}
  ...
  \end{align*}
  by \labelcrefs{i:3.1.15} we know that \(\overline{Y} \subseteq \overline{X}\).
  Since \(\overline{Y} \subseteq \overline{X} \land \overline{X} \subseteq \overline{Y}\), by \labelcrefs{i:3.1.18} we have \(\overline{Y} = \overline{X}\).
\end{proof}

\begin{ex}\label{i:ex:9.1.2}
  Prove \labelcrefs{i:9.1.11}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:9.1.11}.
\end{proof}

\begin{ex}\label{i:ex:9.1.3}
  Prove \labelcrefs{i:9.1.13}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:9.1.13}.
\end{proof}
...
\begin{proof}
  ...
  By \labelcrefs{i:9.1.12} we have \(\overline{X} = [0, 0.5]\) and \(\overline{Y} = [0.5, 1]\), so \(\overline{X} \cap \overline{Y} = \set{0.5}\).
  By \labelcrefs{i:9.1.13} we have \(\overline{X \cap Y} = \overline{\emptyset} = \emptyset\).
  Thus, \(\overline{X \cap Y} \neq \overline{X} \cap \overline{Y}\).
\end{proof}

\begin{ex}\label{i:ex:9.1.5}
  Prove \labelcrefs{i:9.1.14}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:9.1.14}.
\end{proof}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & x \in \overline{X},                                                                                                                       &  & \by{i:9.1.10}
  \end{align*}
  by \labelcrefs{i:3.1.15} we know that \(\overline{\overline{X}} \subseteq \overline{X}\).
  Since \(\overline{\overline{X}} \subseteq \overline{X} \land \overline{X} \subseteq \overline{\overline{X}}\), by \labelcrefs{i:3.1.18} we have \(\overline{\overline{X}} = \overline{X}\).
  By \labelcrefs{i:9.1.15} \(\overline{X}\) is closed.
...
\begin{proof}
  By \labelcrefs{i:9.1.11} we have
  \[
  ...
  \end{align*}
  by \labelcrefs{i:3.1.15} we have \(\overline{\bigcap_{\alpha \in I} X_{\alpha}} \subseteq \bigcap_{\alpha \in I} X_{\alpha}\).
  By \labelcrefs{i:3.1.18} we have
  \[
  ...
  \]
  and thus by \labelcrefs{i:9.1.15} \(\bigcap_{\alpha \in I} X_{\alpha}\) is closed.
\end{proof}
...
\begin{proof}
  ...
  \end{align*}
  By \labelcrefs{i:9.1.10} we know that \(x \in \overline{\set{x}}\).
  Thus, we have either \(x \in \overline{X \setminus \set{x}}\) or \(x \notin \overline{X \setminus \set{x}}\).
  \begin{itemize}
    \item If \(x \in \overline{X \setminus \set{x}}\), then by \labelcrefs{i:9.1.18} \(x\) is a limit point of \(X\).
    \item If \(x \notin \overline{X \setminus \set{x}}\), then by \labelcrefs{i:9.1.10} \(\exists \varepsilon \in \R^+\) such that \(\forall y \in X \setminus \set{x}\), \(\abs{x - y} > \varepsilon\).
          Since \(x \in \overline{X}\), we must have \(x \in X\), otherwise \(\nexists y \in X \setminus \set{x}\) such that \(\abs{x - y} \leq \varepsilon\).
          Thus, by \labelcrefs{i:9.1.18} \(x\) is a isolated point of \(X\).
  \end{itemize}
...
\begin{proof}
  ...
  \end{align*}
  Thus, by \labelcrefs{i:9.1.22} \(X\) is bounded.
\end{proof}
...
\begin{proof}
  Since \(X\) is bounded, by \labelcrefs{i:9.1.22} we know that \(\exists M \in \R^+ : X \subseteq [-M, M]\).
  Let \(\varepsilon \in \R^+\).
  Then we have
  \begin{align*}
  ...
  \end{align*}
  By \labelcrefs{i:3.1.15} we have \(\overline{X} \subseteq [-M - \varepsilon, M + \varepsilon]\), and thus by \labelcrefs{i:9.1.22} \(\overline{X}\) is bounded.
\end{proof}
...
\begin{proof}
  ...
  If \(n = 0\), then \(I_n = \emptyset \implies \bigcup_{i \in I_n} X_i = \emptyset\) and by \labelcrefs{i:5.1.14} \(\emptyset\) is bounded.
  So suppose that \(n \neq 0\).
  ...
  Clearly, \(S\) is finite.
  By \labelcrefs{i:5.1.14} we know that \(S\) is bounded by some \(M \in \R\).
  Then we have
  \begin{align*}
    ...
    \implies & x \in [-M, M].
  \end{align*}
  By \labelcrefs{i:3.1.15} we have \(\bigcup_{i \in I_n} X_i \subseteq [-M, M]\), thus by \labelcrefs{i:9.1.22} \(\bigcup_{i \in I_n} X_i\) is bounded.
  ...
  Clearly, \(\forall n \in \N\), \(X_n \subseteq [-n, n]\) and thus by \labelcrefs{i:9.1.22} \(X_n\) is bounded.
  Then we have \(\bigcup_{n \in \N} X_n = \N\) and by \labelcrefs{i:3.6.12} \(\N\) is unbounded.
\end{proof}

\begin{ex}\label{i:ex:9.1.13}
  Prove \labelcrefs{i:9.1.24}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:9.1.24}.
\end{proof}
...
\begin{proof}
  ...
  Thus, by \labelcrefs{i:6.1.19} we have \(\lim_{m \to \infty} a_m = x_i\).
  Since \(x_i \in \set{x_i}\), by Heine-Borel theorem (\labelcrefs{i:9.1.24}) we know that \(\set{x_i}\) is closed and bounded.
  Let \(S = \bigcup_{i \in \N : i \leq n} \set{x_i}\).
  By \labelcrefs{i:ex:9.1.7} we know that \(S\) is closed, and by \labelcrefs{i:ex:9.1.12} we know that \(S\) is bounded.
...
\begin{ex}\label{i:ex:9.1.15}
  ...
  (Note from the least upper bound principle, \labelcrefs{i:5.5.9}, that \(S\) is a real number.)
