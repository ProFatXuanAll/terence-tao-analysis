...
\begin{proof}
  ...
  \end{align*}
  by \labelcrefs{i:3.3.7} we have \((f + g) \circ h = (f \circ h) + (g \circ h)\).
  ...
  \end{align*}
  by \labelcrefs{i:3.3.7} we have \((f + g) \cdot h = (f \cdot h) + (g \cdot h)\).
  ...
  \end{align*}
  by \labelcrefs{i:3.3.7} we have \(f \cdot (g + h) = (f \cdot g) + (f \cdot h)\).
\end{proof}
