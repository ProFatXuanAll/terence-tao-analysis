\section{Upper and lower Riemann integrals}\label{i:sec:11.3}

\begin{defn}[Majorization of functions]\label{i:11.3.1}
...
\begin{defn}[Upper and lower Riemann integrals]\label{i:11.3.2}
...
\begin{defn}[Riemann integral]\label{i:11.3.4}
...
\begin{rmk}\label{i:11.3.5}
  Compare this definition to the relationship between the \(\limsup\), \(liminf\), and limit of a sequence \(a_n\) that was established in \labelcrefs{i:6.4.12.f};
...
\begin{proof}
  Since \(f(x) \leq f(x)\) for every \(x \in I\), by \labelcrefs{i:11.3.2} we have
  \[
  ...
  \]
  By \labelcrefs{i:11.3.3} we know that
  \[
    p.c. \int_I f \leq \underline{\int}_I f \leq \overline{\int}_I f \leq p.c. \int_I f.
  \]
  Thus, by \labelcrefs{i:11.3.4} we have
  \[
    \int_I f = \underline{\int}_I f = \overline{\int}_I f = p.c. \int_I f.
  \]
\end{proof}

\begin{rmk}\label{i:11.3.8}
  Because of \labelcrefs{i:11.3.7}, we will not refer to the piecewise constant integral \(p.c. \int_I\) again, and just use the Riemann integral \(\int_I\) throughout
  (until this integral is itself superceded by the Lebesgue integral).
  We observe one special case of \labelcrefs{i:11.3.7}:
...
\begin{defn}[Riemann sums]\label{i:11.3.9}
...
\begin{proof}
  ...
  \begin{align*}
    U(f, \mathbf{P}) & = \sum_{J \in \mathbf{P} : J \neq \emptyset} \big(\sup_{x \in J} f(x)\big) \abs{J} &  & \by{i:11.3.9}              \\
                     ...
                     & = \sum_{J \in \mathbf{P}} c_{g|_J} \abs{J}                                         &  & \by{i:7.1.11.a,i:7.1.11.e} \\
  ...
  \begin{align*}
    L(f, \mathbf{P}) & = \sum_{J \in \mathbf{P} : J \neq \emptyset} \big(\inf_{x \in J} f(x)\big) \abs{J} &  & \by{i:11.3.9}              \\
                     ...
                     & = \sum_{J \in \mathbf{P}} c_{h|_J} \abs{J}                                         &  & \by{i:7.1.11.a,i:7.1.11.e} \\
...
\begin{proof}
  ...
  By \labelcrefs{i:11.3.11} we have
  \[
  ...
  \]
  Since \(g, h\) were arbitrary, by \labelcrefs{i:11.3.2} we have
  \[
  ...
  \begin{align*}
    U(f, \mathbf{P}) & = \sum_{J \in \mathbf{P} : J \neq \emptyset} \big(\sup_{x \in J} f(x)\big) \abs{J} &  & \by{i:11.3.9}              \\
                     & = \sum_{J \in \mathbf{P}} \big(\sup_{x \in J} f(x)\big) \abs{J}                    &  & \by{i:7.1.11.a,i:7.1.11.e} \\
                     & = p.c. \int_{[\mathbf{P}]} G                                                       &  & \by{i:11.2.9}              \\
                     & = p.c. \int_I G                                                                    &  & \by{i:11.2.14}
  \end{align*}
  and
  \begin{align*}
    L(f, \mathbf{P}) & = \sum_{J \in \mathbf{P} : J \neq \emptyset} \big(\inf_{x \in J} f(x)\big) \abs{J} &  & \by{i:11.3.9}              \\
                     & = \sum_{J \in \mathbf{P}} \big(\inf_{x \in J} f(x)\big) \abs{J}                    &  & \by{i:7.1.11.a,i:7.1.11.e} \\
                     & = p.c. \int_{[\mathbf{P}]} H                                                       &  & \by{i:11.2.9}              \\
                     & = p.c. \int_I H.                                                                   &  & \by{i:11.2.14}
  \end{align*}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & f(x) \geq h(x),
  \end{align*}
  by \labelcrefs{i:11.3.1} we know that \(f\) majorize \(h\).
  ...
  \begin{align*}
    ...
    \implies & f(x) = g(x),
  \end{align*}
  by \labelcrefs{i:3.3.7} we know that \(f = g\).
\end{proof}
...
\begin{proof}
  ...
  \end{align*}
  by \labelcrefs{i:11.3.1} we know that \(f + h\) majorizes \(g + h\).
...
\begin{ex}\label{i:ex:11.3.3}
  Prove \labelcrefs{i:11.3.7}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:11.3.7}.
\end{proof}

\begin{ex}\label{i:ex:11.3.4}
  Prove \labelcrefs{i:11.3.11}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:11.3.11}.
\end{proof}

\begin{ex}\label{i:ex:11.3.5}
  Prove \labelcrefs{i:11.3.12}.
\end{ex}

\begin{prop}
  See \labelcrefs{i:11.3.12}.
\end{prop}
