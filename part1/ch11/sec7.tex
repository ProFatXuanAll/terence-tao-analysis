...
\begin{proof}
  ...
  \]
  by \labelcrefs{i:11.1.13};
  note that the empty set does not contribute anything to the total length.
  In particular, we have \(\overline{\int}_{[0, 1]} f = 1\), by \labelcrefs{i:11.3.12}.
  ...
  \]
  In particular, we have \(\underline{\int}_{[0, 1]} f = 0\), by \labelcrefs{i:11.3.12}.
