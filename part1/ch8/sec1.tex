...
\begin{note}
  From \labelcrefs{i:3.6.12} we know that the set \(\N\) of natural numbers is infinite.
  The set \(\N - \set{0}\) is also infinite, thanks to \labelcrefs{i:3.6.14.a}, and is a proper subset of \(\N\).
...
\begin{proof}
  Suppose for the sake of contradiction that \(X\) has no minimum element.
...
\begin{note}
  ...
  This minimum is clearly the same as the infimum of \(X\), as defined in \labelcrefs{i:5.5.10}.
\end{note}
...
\begin{proof}
  ...
  Thus, by the well-ordering principle (\labelcrefs{i:8.1.5}), the minimum, \(\min\set{x \in X : x \neq a_m \text{ for all } m < n}\) is always well-defined.
  ...
  Also, we have \(a_n \in X\) for each natural number \(n\) (by \labelcrefs{i:8.1.4}).
  ...
  Now suppose for the sake of contradiction that there was at least one other increasing bijection \(g\) from \(\N\) to \(X\) which was not equal to \(f\).
...
\begin{proof}
  Since finite sets are at most countable by definition, combine with \labelcrefs{i:8.1.5} we thus have all subsets of the natural numbers are at most countable.
\end{proof}
...
\begin{proof}
  If \(X\) is finite then this follows from \labelcrefs{i:3.6.14.c}, so assume \(X\) is countable.
  ...
  But \(f(Y)\) is a subset of \(\N\), and hence at most countable by \labelcrefs{i:8.1.6}.
...
\begin{proof}
  If \(f(\N)\) is finite then by \labelcrefs{i:8.1.1} it is at most countable.
  ...
  By \labelcrefs{i:3.4.1} we also know that \(f|_A\) is surjective, thus \(f|_A\) is bijective.
  ...
  \]
  Since \(E \subseteq \N\) and \(E \neq \emptyset\), by well ordering principle (\labelcrefs{i:8.1.4}) we know that \(\min(E)\) exists.
  ...
  Since \(A \subseteq \N\) and \(A\) is infinite, by \labelcrefs{i:8.1.5} \(\exists g : \N \to A\) where \(g\) is bijective.
  This means \(f|_A \circ g\) is bijective and we have
  \[
    (f|_A \circ g)(\N) = f|_A\big(g(\N)\big) = f|_A(A) = f(A) = f(\N).
  \]
  Thus, by \labelcrefs{i:8.1.1} \(f(\N)\) is countable, and thus at most countable.
\end{proof}
...
\begin{proof}
  By \labelcrefs{i:8.1.1} \(\exists g : \N \to X\) such that \(g\) is a bijection.
  Then we have \(f \circ g : \N \to Y\) and by \labelcrefs{i:8.1.8} \((f \circ g)(\N)\) is at most countable.
  But
  \[
...
\begin{proof}
  By \labelcrefs{i:8.1.1} \(\exists f : \N \to X\) and \(g : \N \to Y\) such that \(f\) and \(g\) are bijections.
  ...
  \begin{align*}
    ...
    \iff & z \in X \cup Y.
  \end{align*}
  Then by \labelcrefs{i:8.1.9} we have \(h(\N) = X \cup Y\) is at most countable.
...
\begin{proof}
  ...
  \begin{itemize}
    \item \(X, Y\) are countable.
          Then by \labelcrefs{i:8.1.10} we know that \(X \cup Y\) is countable, thus at most countable.
    \item \(X, Y\) are finite.
          Then by \labelcrefs{i:3.6.14.b} we know that \(X \cup Y\) is finite, thus at most countable.
    \item \(X, Y\) consist of one finite set and one countable set.
          ...
          Since \(Y\) is countable, by \labelcrefs{i:8.1.1} there exists a function \(g : \N \to Y\) such that \(g\) is bijective.
          ...
          By \labelcrefs{i:8.1.8} \(X \cup Y\) is at most countable.
  \end{itemize}
...
\begin{proof}
  ...
  Since the integers are the union of \(\N\) and \(-\N\), the claim follows from \labelcrefs{i:8.1.10}.
\end{proof}
...
\begin{proof}
  ...
  But \(f(A)\) is a subset of \(\N\), and hence by \labelcrefs{i:8.1.6} \(f(A)\) is at most countable.
...
\begin{proof}
  ...
  By \labelcrefs{i:3.1.18} we need to show that \(\N \times \N \subseteq A \cup B\) and \(A \cup B \subseteq \N \times \N\).
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.15} we have \(\N \times \N \subseteq A \cup B\).

  Since \(\N \times \N\) is the union of \(A\) and \(B\), the claim then follows from \labelcrefs{i:8.1.10}.
\end{proof}
...
\begin{proof}
  ...
  But by \labelcrefs{i:8.1.13} we know that \(\N \times \N\) is countable.
  Thus, by \labelcrefs{i:8.1.1} \(X \times Y\) is countable.
\end{proof}
...
\begin{proof}
  ...
  (since \(\Z - \set{0} \subseteq \Z\), by \labelcrefs{i:8.1.7} we know that \(\Z - \set{0}\) is at most countable, and clearly \(\Z - \set{0}\) is not finite.)
  By \labelcrefs{i:8.1.14}, the set
  \[
    \Z \times (\Z - \set{0}) = \set{(a, b) : a, b \in \Z, b \neq 0}
  \]
  is thus countable.
  If one lets \(f : \Z \times (\Z - \set{0}) \to \Q\) be the function \(f(a, b) \coloneqq a / b\)
  (note that \(f\) is well-defined since we prohibit \(b\) from being equal to \(0\)), we see from \labelcrefs{i:8.1.9} that \(f(\Z \times (\Z - \set{0}))\) is at most countable.
...
\begin{proof}
  ...
  Then we have \(X \neq \emptyset\) since by \labelcrefs{i:ex:3.6.2} \(\#(\emptyset) = 0\).
  ...
  For \(n = 0\), we have \(\emptyset \subseteq X\) by \labelcrefs{i:3.1.17}, Thus, the base case holds.
  Suppose inductively that \(P(n)\) is true for some \(n \geq 0\).
  Then we need to show that \(P(n + 1)\) is true.
  By the induction hypothesis, \(\exists A_n \subseteq X : \#(A_n) = n\).
  Then by \labelcrefs{i:3.6.14.b} we know that \(X \setminus A_n\) is infinite.
  ...
  By axiom of choice (\labelcrefs{i:8.1}) the set \(\prod_{n \in \Z^+} A_n\) is non-empty since \(\forall n \in \Z^+\), \(P(n)\) is true.
  ...
  By axiom of choice (\labelcrefs{i:8.1}) \(A\) can be construct as the image of \((x_n)_{n \in \Z^+}\).
  ...
  Since \(f\) is both injective and surjective, we know that \(f\) is bijective, and by \labelcrefs{i:3.6.1} \(X\) and \(X \setminus \set{x_1}\) have the same cardinality.
  But \(x_1 \in X \land x_1 \notin X \setminus \set{x_1}\), we have \(X \neq X \setminus \set{x_1}\).
  Thus, by \labelcrefs{i:3.1.15} \(X \setminus \set{x_1} \subsetneq X\).

  Now we show that if \(\exists Y \subsetneq X\) where \(X\) and \(Y\) have the same cardinality, then \(X\) is infinite.
  We prove this by contradiction.
  Suppose for the sake of contradiction that \(X\) is finite.
  Then by \labelcrefs{i:3.6.14.c} we have \(\#(Y) < \#(X)\), a contradiction.
  Thus, \(X\) is infinite.
\end{proof}

\begin{ex}\label{i:ex:8.1.2}
  Prove \labelcrefs{i:8.1.4}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:8.1.4}.
\end{proof}

\begin{ex}\label{i:ex:8.1.3}
  Fill in the gaps marked in \labelcrefs{i:8.1.5}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:8.1.5}.
\end{proof}

\begin{ex}\label{i:ex:8.1.4}
  Prove \labelcrefs{i:8.1.8}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:8.1.8}.
\end{proof}

\begin{ex}\label{i:ex:8.1.5}
  Use \labelcrefs{i:8.1.8} to prove \labelcrefs{i:8.1.9}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:8.1.9}.
\end{proof}
...
\begin{proof}
  ...
  By \labelcrefs{i:8.1.1} \(A\) is either finite or countable.
  \begin{itemize}
    \item If \(A\) is finite, then by \labelcrefs{i:3.6.10} \(\exists g : A \to \set{i \in \N : 1 \leq i \leq \#(A)}\) such that \(g\) is bijective.
    ...
    \item If \(A\) is countable, then by \labelcrefs{i:8.1.1} \(\exists f : A \to \N\) such that \(f\) is a bijection, and hence \(f\) is injective.
  \end{itemize}
  ...
  Since \(f(A) \subseteq \N\), by \labelcrefs{i:8.1.6} \(f(A)\) is at most countable.
...
\begin{ex}\label{i:ex:8.1.7}
  Prove \labelcrefs{i:8.1.10}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:8.1.10}.
\end{proof}

\begin{ex}\label{i:ex:8.1.8}
  Use \labelcrefs{i:8.1.13} to prove \labelcrefs{i:8.1.14}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:8.1.14}.
\end{proof}
...
\begin{proof}
  ...
  By \labelcrefs{i:8.1.1} \(I\) is either finite or countable.

  We first show that if \(I\) is finite, then \(\bigcup_{\alpha \in I} A_{\alpha}\) is at most countable.
  Since \(I\) is finite, by \labelcrefs{i:3.6.5} \(\exists n \in \N\) such that \(\#(I) = n\).
  ...
  Let \(i \in I\).
  Since \(\#(I \setminus \set{i}) = n\), by the induction hypothesis we know that the set \(\bigcup_{\alpha \in I \setminus \set{i}} A_{\alpha}\) is at most countable.
  By \labelcrefs{i:3.11} we have \(\bigcup_{\alpha \in I} A_{\alpha} = (\bigcup_{\alpha \in I \setminus \set{i}} A_{\alpha}) \cup A_i\).
  Then by \labelcrefs{i:ac:8.1.1} we know that \(\bigcup_{\alpha \in I} A_{\alpha}\) is at most countable.
  This closes the induction.
  ...
  Since \(J \subseteq I\), by \labelcrefs{i:8.1.7} we know that \(J\) is at most countable.
  ...
  \end{align*}
  Thus, by \labelcrefs{i:3.1.4} we have \(\bigcup_{\alpha \in I} A_{\alpha} = \bigcup_{\alpha \in J} A_{\alpha}\).
  ...
  We split into two cases:
  \begin{itemize}
    \item If \(A_{\alpha}\) is finite, then by \labelcrefs{i:3.6.5} \(\exists f_{\alpha}' : \set{n \in \N : 1 \leq n \leq \#(A_{\alpha})} \to A_{\alpha}\) such that \(f_{\alpha}'\) is bijective.
  ...
  \end{itemize}
  Since \(\forall \alpha \in J\), \(F_{\alpha} \neq \emptyset\), by axiom of choice (\labelcrefs{i:8.1}) the set \(\prod_{\alpha \in J} F_{\alpha} \neq \emptyset\).
  ...
  We now use axiom of choice (\labelcrefs{i:8.1}) to choose a function \((f_{\alpha})_{\alpha \in J}\) and fix such function.
  ...
  \]
  By \labelcrefs{i:8.1.9} we now that \(h(\N \times \N)\) is at most countable.
  ...
  Suppose for the sake of contradiction that \(\bigcup_{\alpha \in I} A_{\alpha}\) is finite.
  Let \(\beta \in I\).
  By hypothesis we know that \(A_{\beta}\) is countable, and we have
  \[
    A_{\beta} \subseteq \bigcup_{\alpha \in I} A_{\alpha}.
  \]
  But \(\bigcup_{\alpha \in I} A_{\alpha}\) is finite, thus by \labelcrefs{i:3.6.14.c} we know that \(A_{\beta}\) is finite, a contradiction.
