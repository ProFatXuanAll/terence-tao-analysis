...
\begin{note}
  From \labelcrefs{i:7.4.3}, one can show that these definitions do not depend on the choice of \(g\), and so are well defined.
\end{note}
...
\begin{ac}\label{i:ac:8.2.1}
  ...
  \begin{enumerate}
    \item\label{i:ac:8.2.1.a} The series \(\sum_{x \in X} (f(x) + g(x))\) is absolutely convergent, and
    \[
      \sum_{x \in X} (f(x) + g(x)) = \sum_{x \in X} f(x) + \sum_{x \in X} g(x).
    \]
    \item\label{i:ac:8.2.1.b} If \(c\) is a real number, then \(\sum_{x \in X} cf(x)\) is absolutely convergent, and
    \[
      \sum_{x \in X} cf(x) = c \sum_{x \in X} f(x).
    \]
    \item\label{i:ac:8.2.1.c} If \(X = X_1 \cup X_2\) for some disjoint sets \(X_1\) and \(X_2\), then \(\sum_{x \in X_1} f(x)\) and \\
    ...
    \]
    \item\label{i:ac:8.2.1.d} If \(Y\) is another set, and \(\phi : Y \to X\) is a bijection, then \(\sum_{y \in Y} f(\phi(y))\) is absolutely convergent, and
    \[
...
\begin{proof}[\pf{i:ac:8.2.1.a}]
  Since \(X\) is at most countable, by \labelcrefs{i:8.1.1} we know that \(X\) is either finite or countable.
  If \(X\) is finite, then the statement follows from \labelcrefs{i:7.1.11.f}.
  So suppose that \(X\) is countable.
  By \labelcrefs{i:8.2.1} we know that there exists a bijection \(p : \N \to X\) such that \(\sum_{n = 0}^\infty f\big(p(n)\big)\) converges.
  Similarly, there exists a bijection \(q : \N \to X\) such that \(\sum_{n = 0}^\infty g\big(q(n)\big)\) converges.
  Since \(p\) is bijective, by \labelcrefs{i:7.4.3} we know that
  \[
...
\begin{proof}[\pf{i:ac:8.2.1.b}]
  Since \(X\) is at most countable, by \labelcrefs{i:8.1.1} we know that \(X\) is either finite or countable.
  If \(X\) is finite, then the statement follows from \labelcrefs{i:7.1.11.g}.
  So suppose that \(X\) is countable.
  By \labelcrefs{i:8.2.1} we know that there exists a bijection \(p : \N \to X\) such that \(\sum_{n = 0}^\infty f\big(p(n)\big)\) converges.
  Then we have
  \begin{align*}
...
\begin{proof}[\pf{i:ac:8.2.1.c}]
  ...
  Since \(X\) is at most countable, by \labelcrefs{i:8.1.1} we know that \(X\) is either finite or countable.
  If \(X\) is finite, then the statement follows from \labelcrefs{i:7.1.11.e}.
  So suppose that \(X\) is countable.
  ...
  \begin{itemize}
    \item One of \(X_1, X_2\) is finite and one is countable.
          ...
          Since \(X_2\) is countable, by \labelcrefs{i:8.1.1} we know that \(\exists q_2 : \N \to X_2\) such that \(q_2\) is bijective.
    ...
    \item Both \(X_1, X_2\) are countable.
          Since \(X_1\) is countable, by \labelcrefs{i:8.1.1} we know that \(\exists q_1 : \N \to X_1\) such that \(q_1\) is bijective.
  ...
  Since \(X\) is at most countable, by \labelcrefs{i:8.1.7} we know that \(X_1 \cup X_2\) is at most countable.
  By \labelcrefs{i:8.1.1} we know that \(X_1 \cup X_2\) is either finite or countable.
  If \(X_1 \cup X_2\) is finite, then the statement follows from \labelcrefs{i:7.1.11.e}.
...
\begin{proof}[\pf{i:ac:8.2.1.d}]
  Since \(X\) is at most countable, by \labelcrefs{i:8.1.1} we know that \(X\) is either finite or countable.
  If \(X\) is finite, then the statement follows from \labelcrefs{i:7.1.11.c}.
  So suppose that \(X\) is countable.
  By \labelcrefs{i:8.2.1} we know that there exists a bijection \(p : \N \to X\) such that \(\sum_{n = 0}^\infty f\big(p(n)\big)\) converges.
  Since \(\phi\) is bijective, we know that \(Y\) is also countable and by \labelcrefs{i:8.1.1} \(\exists q : \N \to Y\) such that \(q\) is bijective.
...
\begin{proof}
  The second equality follows easily from \labelcrefs{i:7.4.3} (and \labelcrefs{i:3.6.4}).
  ...
  In particular, for every \(n \in \N\) and \(M \in \N\) we have \(\sum_{m = 0}^M f(n, m) \leq L\), which implies by \labelcrefs{i:6.3.8} that \(\sum_{m = 0}^\infty f(n, m)\) is convergent for each \(n\).
  Similarly, for any \(N \in \N\) and \(M \in \N\) we have (by \labelcrefs{i:7.1.14})
  \[
    \sum_{n = 0}^N \sum_{m = 0}^M f(n, m) = \sum_{(n, m) \in X} f(n, m) \leq L
  \]
  where \(X\) is the set \(\set{(n,m) \in \N \times \N : n \leq N, m \leq M}\) which is finite by \labelcrefs{i:3.6.14}.
  Taking limits of this as \(M \to \infty\) we have (by \labelcrefs{i:ex:7.1.5} and either \labelcrefs{i:6.3.8} or \labelcrefs{i:6.4.13})
  \[
    \sum_{n = 0}^N \sum_{m = 0}^\infty f(n, m) \leq L.
  \]
  By \labelcrefs{i:6.3.8}, this implies that \(\sum_{n = 0}^\infty \sum_{m = 0}^\infty f(n, m)\) converges, and
  \[
  ...
  (Since \(\N \times \N\) is countable by \labelcrefs{i:8.1.13}, we can find a bijection \(g : \N \to \N \times \N\) such that \(\sum_{i = 0}^\infty f(g(i)) = L\), which means \(\forall \varepsilon > 0\), \(\exists H \in \N\) such that \(\abs{\sum_{i = 0}^h f(g(i)) - L} \leq \varepsilon\) for all \(h \geq H\).
  ...
  (We can construct a bijection \(g : \N \to \N \times \N\) and then since \(\forall n \in \N\) we have \(f_+(g(n)) \leq \abs{f(g(n))}\) and \(\abs{f_-(g(n))} \leq \abs{f(g(n))}\), we know that \((f_+(g(n)))_{n = 0}^\infty\) and \((f_-(g(n)))_{n = 0}^\infty\) are absolutely convergent by comparison test (\labelcrefs{i:7.3.2}.))
...
\begin{proof}
  ...
  Since \(\sum_{x \in X} f(x)\) is absolutely convergent, by \labelcrefs{i:8.2.1} \(\exists g : \N \to X\) where \(g\) is a bijection such that
  \[
  ...
  \]
  Since \(A\) is finite, by \labelcrefs{i:ex:3.6.3} \(\exists M \in \N\) such that \(g^{-1}(A)\) is bounded by \(M\).
  So we have
  \[
    \sum_{x \in A} \abs{f(x)} = \sum_{n \in g^{-1}(A)} \abs{f(g(n))} \leq \sum_{n = 0}^M \abs{f(g(n))} \leq L
  \]
  This is true for any finite subset of \(X\).
  Thus, by \labelcrefs{i:5.5.9} \(P(X, f)\) is true.
...
\begin{note}
  Inspired by \labelcrefs{i:8.2.3}, we may now define the concept of an absolutely convergent series even when the set \(X\) could be uncountable.
\end{note}
...
\begin{proof}
  ...
  Since \(\sum_{x \in X} f(x)\) is absolutely convergent, by \labelcrefs{i:8.2.4} we have
  \[
  ...
  Since \(\abs{f(x)} \in \R^+\), by \labelcrefs{i:5.4.12} we have
  \begin{align*}
  ...
  \end{align*}
  Since \(\forall n \in \Z^+\), \(S_n\) is finite, by \labelcrefs{i:8.1.9} we know that \(\bigcup_{n \in \Z^+} S_n\) is at most countable.
  Since \(\set{x \in X : f(x) \neq 0} \subseteq \bigcup_{n \in \Z^+} S_n\), by \labelcrefs{i:8.1.7} we know that \(\set{x \in X : f(x) \neq 0}\) is at most countable.
\end{proof}

\begin{note}
  Because of \labelcrefs{i:8.2.5}, we can define the value of \(\sum_{x \in X} f(x)\) for any absolutely convergent series on an uncountable set \(X\) by the formula
  \[
  ...
  \labelcrefs{i:8.2.4} is consistent with the definitions we already have for series on countable sets (\labelcrefs{i:8.2.1}).
\end{note}
...
\begin{prop}[Absolutely convergent series laws]\label{i:8.2.6}
  ...
  \begin{enumerate}
    \item\label{i:8.2.6.a} The series \(\sum_{x \in X} (f(x) + g(x))\) is absolutely convergent, and
    \[
      \sum_{x \in X} (f(x) + g(x)) = \sum_{x \in X} f(x) + \sum_{x \in X} g(x).
    \]
    \item\label{i:8.2.6.b} If \(c\) is a real number, then \(\sum_{x \in X} cf(x)\) is absolutely convergent, and
    \[
      \sum_{x \in X} cf(x) = c \sum_{x \in X} f(x).
    \]
    \item\label{i:8.2.6.c} If \(X = X_1 \cup X_2\) for some disjoint sets \(X_1\) and \(X_2\), then \(\sum_{x \in X_1} f(x)\) and \\
    \(\sum_{x \in X_2} f(x)\) are absolutely convergent, and
    \[
      \sum_{x \in X_1 \cup X_2} f(x) = \sum_{x \in X_1} f(x) + \sum_{x \in X_2} f(x).
    \]
    ...
    \[
      \sum_{x \in X_1 \cup X_2} h(x) = \sum_{x \in X_1} h(x) + \sum_{x \in X_2} h(x).
    \]
    \item\label{i:8.2.6.d} If \(Y\) is another set, and \(\phi : Y \to X\) is a bijection, then \(\sum_{y \in Y} f(\phi(y))\) is absolutely convergent, and
    \[
      \sum_{y \in Y} f(\phi(y)) = \sum_{x \in X} f(x).
    \]
  \end{enumerate}
...
\begin{proof}[\pf{i:8.2.6.a}]
  ...
  By \labelcrefs{i:7.1.11.f} we already show that the statement is true when \(X\) is finite.
  So suppose that \(X\) is infinite.

  We first show that \(\sum_{x \in X} (f(x) + g(x))\) is absolutely convergent.
  Since \(\sum_{x \in X} f(x)\) and \(\sum_{x \in X} g(x)\) are both absolutely convergent, by \labelcrefs{i:8.2.4} \(\exists N, M \in \R\) such that
  \[
  ...
  \]
  Thus, by \labelcrefs{i:8.2.4} \(\sum_{x \in X} \big(f(x) + g(x)\big)\) is absolutely convergent.

  Now we show that \(\sum_{x \in X} (f(x) + g(x)) = \sum_{x \in X} f(x) + \sum_{x \in X} g(x)\).
  If \(X\) is at most countable, then the statement follows by \labelcrefs{i:ac:8.2.1.a}.
  So suppose that \(X\) is uncountable.
  Let \(X_f = \set{x \in X : f(x) \neq 0}\), \(X_g = \set{x \in X : g(x) \neq 0}\) and \(X_h = \set{x \in X : f(x) + g(x) \neq 0}\) be sets.
  Then by \labelcrefs{i:8.2.5} we know that \(X_f\), \(X_g\) and \(X_h\) are at most countable.
  Since
  \begin{align*}
  ...
  By \labelcrefs{i:ac:8.1.1} we know that \(X_f \cup X_g\) is at most countable.
  By \labelcrefs{i:8.1.7} we know that \(X_f \cup X_g \setminus X_f\), \(X_f \cup X_g \setminus X_g\), \(X_f \cup X_g \setminus X_h\) are at most countable.
  Thus, we have
  \begin{align*}
...
\begin{proof}[\pf{i:8.2.6.b}]
  Suppose that \(c \in \R\), \(X\) is a set and \(f : X \to \R\) is a function such that \(\sum_{x \in X} f(x)\) is absolutely convergent.
  Since \(\sum_{x \in X} f(x)\) is absolutely convergent, by \labelcrefs{i:8.2.4} \(\exists N \in \R\) such that
  \[
    N = \sup\set{\sum_{x \in A} \abs{f(x)} : A \subseteq X, A \text{ finite}} < \infty.
  \]
  Let \(A \subseteq X\) be a finite set.
  ...
  \]
  Thus, by \labelcrefs{i:8.2.4} \(\sum_{x \in X} cf(x)\) is absolutely convergent.

  Now we show that \(\sum_{x \in X} cf(x) = c \sum_{x \in X} f(x)\).
  If \(X\) is at most countable, then the statement follows by \labelcrefs{i:ac:8.2.1.b}.
  So suppose that \(X\) is uncountable.
  Let \(X_f = \set{x \in X : f(x) \neq 0}\) and \(X_h = \set{x \in X : cf(x) \neq 0}\) be two sets.
  By \labelcrefs{i:8.2.5} we know that both \(X_f\) and \(X_h\) are at most countable.
  \begin{itemize}
...
\begin{proof}[\pf{i:8.2.6.c}]
  If \(X\) is at most countable, then the statements follow by \labelcrefs{i:ac:8.2.1.c}.
  So suppose that \(X\) is uncountable.
  ...
  \]
  Thus, by \labelcrefs{i:8.2.4} both \(\sum_{x \in X_1} f(x)\) and \(\sum_{x \in X_2} f(x)\) are absolutely convergent.
  ...
  By \labelcrefs{i:8.2.5} we know that \(X_f, X_{f_1}, X_{f_2}\) are at most countable.
  Then we have
  \begin{align*}
  ...
  Since \(\sum_{x \in X_1} h(x)\) and \(\sum_{x \in X_2} h(x)\) are absolutely convergent, by \labelcrefs{i:8.2.4} \(\exists N, M \in \R\) such that
  \[
  ...
  \]
  Thus, by \labelcrefs{i:8.2.4} \(\sum_{x \in X_1 \cup X_2} h(x)\) is absolutely convergent.
  Since \(\sum_{x \in X_1 \cup X_2} h(x)\) is absolutely convergent, from the proof above we have
  \[
    \sum_{x \in X_1 \cup X_2} h(x) = \sum_{x \in X_1} h(x) + \sum_{x \in X_2} h(x).
  \]
...
\begin{proof}[\pf{i:8.2.6.d}]
  If \(X\) is at most countable, then the statements follow by \labelcrefs{i:ac:8.2.1.d}.
  So suppose that \(X\) is uncountable.
  ...
  \]
  Thus, by \labelcrefs{i:8.2.4} \(\sum_{y \in Y} f\big(\phi(y)\big)\) is absolutely convergent.

  Now we show that \(\sum_{y \in Y} f\big(\phi(y)\big) = \sum_{x \in X} f(x)\).
  Let \(X_f = \set{x \in X : f(x) \neq 0}\) and \(Y_f = \set{y \in Y : f\big(\phi(y)\big) \neq 0}\) be sets.
  By \labelcrefs{i:8.2.5} we know that \(X_f\) and \(Y_f\) are at most countable.
...
\begin{proof}
  ...
  But by \labelcrefs{i:8.2.6.c} we have
  \[
...
\begin{note}
  \labelcrefs{i:8.2.8} is done by Georg Riemann (1826--1866), which asserts that a series which converges conditionally but not absolutely can be rearranged to converge to any value one pleases!
\end{note}
...
\begin{proof}
  Let \(A_+\) and \(A_-\) be the sets in \labelcrefs{i:8.2.7};
  from \labelcrefs{i:8.2.7} we know that \(\sum_{n \in A_+} a_n\) and \(\sum_{n \in A_-} a_n\) both fail to be absolutely convergent.
  ...
  By \labelcrefs{i:8.1.5} we can then find increasing bijections \(f_+ : \N \to A_+\) and \(f_- : \N \to A_-\).
  Thus, the sums \(\sum_{m = 0}^\infty a_{f_+(m)}\) and \(\sum_{m = 0}^\infty a_{f_-(m)}\) both fail to be absolutely convergent (first by \labelcrefs{i:8.2.1} then by \labelcrefs{i:8.2.7}).
  ...
  \begin{itemize}
    ...
    \item Case I occurs an infinite number of times, and Case II also occurs an infinite number of times.
          ...
          Since \(\sum_{i > j} a_{n_i}\) is decreasing and has lower bound, by \labelcrefs{i:ac:6.3.1} \(\sum_{i > j} a_{n_i}\) is convergent.
    ...
    \item We have \(\lim_{j \to \infty} a_{n_j} = 0\).
          By \labelcrefs{i:7.2.6} we have \(\lim_{j \to \infty} a_j = 0\).
          This means
          \[
    ...
    \item We have \(\lim_{j \to \infty} \sum_{0 \leq i \leq j} a_{n_i} = L\).
          ...
          Let \(k = \min(K)\).
          Such \(k\) is well-defined by well ordering principle (\labelcrefs{i:8.1.4}).
...
\begin{ex}\label{i:ex:8.2.1}
  Prove \labelcrefs{i:8.2.3}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:8.2.3}.
\end{proof}

\begin{ex}\label{i:ex:8.2.2}
  Prove \labelcrefs{i:8.2.5}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:8.2.5}.
\end{proof}

\begin{ex}\label{i:ex:8.2.3}
  Prove \labelcrefs{i:8.2.6}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:8.2.6}.
\end{proof}

\begin{ex}\label{i:ex:8.2.4}
  Prove \labelcrefs{i:8.2.7}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:8.2.7}.
\end{proof}

\begin{ex}\label{i:ex:8.2.5}
  Explain the gaps marked (why?) in the proof of \labelcrefs{i:8.2.8}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:8.2.8}.
\end{proof}
...
\begin{proof}
  Let \(A_+\) and \(A_-\) defined as \labelcrefs{i:8.2.7}.
  In \labelcrefs{i:8.2.8} we know that both \(A_+\) and \(A_-\) are countable, and there exist two increasing bijections \(f_+ : \N \to A_+\) and \(f_- : \N \to A_-\).
  ...
  \begin{itemize}
    ...
    \item We have \(\limsup_{j \to \infty} \sum_{i = 0}^j a_{n_j}\) diverges to \(\infty\).
          ...
          \]
          Since this is true for every \(M \in \R^+\), by \labelcrefs{i:ex:6.4.8} we thus have
          \[
