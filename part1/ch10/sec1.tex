\section{Basic definitions}\label{i:sec:10.1}
...
\begin{defn}[Differentiability at a point]\label{i:10.1.1}
...
\begin{rmk}\label{i:10.1.2}
  ...
  In practice, the domain \(X\) will almost always be an interval, and so by \labelcrefs{i:9.1.21} all elements \(x_0\) of \(X\) will automatically be limit points and we will not have to care much about these issues.
\end{rmk}
...
\begin{prop}[Newton's approximation]\label{i:10.1.7}
...
\begin{proof}
  ...
  Since \(f\) is differentiable at \(x_0\) on \(X\) with derivative \(L\), by \labelcrefs{i:10.1.1} we have
  \[
    \lim_{x \to x_0 ; x \in X \setminus \set{x_0}} \dfrac{f(x) - f(x_0)}{x - x_0} = L.
  \]
  By \labelcrefs{i:9.3.6} this means
  \[
  ...
  \[
    \lim_{x \to x_0 ; x \in X \setminus \set{x_0}} \dfrac{f(x) - f(x_0)}{x - x_0} = L
  \]
  and by \labelcrefs{i:10.1.1} we know that \(f\) is differentiable at \(x_0\) on \(X\) with derivative \(L\).
\end{proof}
...
\begin{rmk}\label{i:10.1.9}
  We can phrase \labelcrefs{i:10.1.7} in a more informal way:
  if \(f\) is differentiable at \(x_0\), then one has the approximation \(f(x) \approx f(x_0) + f'(x_0)(x - x_0)\), and conversely.
\end{rmk}

\begin{prop}[Differentiability implies continuity]\label{i:10.1.10}
...
\begin{proof}
  Since \(f\) is differentiable at \(x_0\), by \labelcrefs{i:10.1.1} we have
  \[
    L = \lim_{x \to x_0 ; x \in X \setminus \set{x_0}} \dfrac{f(x) - f(x_0)}{x - x_0}
  \]
  for some \(L \in \R\).
  By \labelcrefs{i:10.1.7}, we have \(\forall \varepsilon \in \R^+\), \(\exists \delta \in \R^+\) such that
  \begin{align*}
  ...
  \end{align*}
  Thus, by \labelcrefs{i:9.3.6} we have \(\lim_{x \to x_0 ; x \in X} f(x) = f(x_0)\), and by \labelcrefs{i:9.4.1} \(f\) is continuous at \(x_0\).
\end{proof}

\begin{defn}[Differentiability on a domain]\label{i:10.1.11}
...
\begin{proof}
  By \labelcrefs{i:9.1.11} we know that \(\forall x_0 \in X\), \(x_0\) is an adherent point.
  By \labelcrefs{i:ex:9.1.9} we know that \(x_0\) is either a limit point or an isolated point.
  By \labelcrefs{i:10.1.10} and \labelcrefs{i:10.1.11} we know that if \(x_0\) is a limit point then \(f\) is continuous at \(x_0\).
  ...
  By \labelcrefs{i:9.1.18} we know that \(\exists \varepsilon' \in \R^+\) such that \(\abs{x - x_0} > \varepsilon'\) for all \(x \in X \setminus \set{x_0}\).
  To show that \(f\) is continuous at \(x_0\), by \labelcrefs{i:9.4.1} and \labelcrefs{i:9.3.6} we need to show that
  \[
...
\begin{thm}[Differential calculus]\label{i:10.1.13}
  Let \(X\) be a subset of \(\R\), let \(x_0 \in X\) be a limit point of \(X\), and let \(f : X \to \R\) and \(g : X \to \R\) be functions.
  \begin{enumerate}
    \item\label{i:10.1.13.a} If \(f\) is a constant function, i.e., there exists a real number \(c\) such that \(f(x) = c\) for all \(x \in X\), then \(f\) is differentiable at \(x_0\) and \(f'(x_0) = 0\).
    \item\label{i:10.1.13.b} If \(f\) is the identity function, i.e., \(f(x) = x\) for all \(x \in X\), then \(f\) is differentiable at \(x_0\) and \(f'(x_0) = 1\).
    \item\label{i:10.1.13.c} (Sum rule)
    If \(f\) and \(g\) are differentiable at \(x_0\), then \(f + g\) is also differentiable at \(x_0\), and \((f + g)'(x_0) = f'(x_0) + g'(x_0)\).
    \item\label{i:10.1.13.d} (Product rule)
    If \(f\) and \(g\) are differentiable at \(x_0\), then \(fg\) is also differentiable at \(x_0\), and \((fg)'(x_0) = f'(x_0)g(x_0) + f(x_0)g'(x_0)\).
    \item\label{i:10.1.13.e} If \(f\) is differentiable at \(x_0\) and \(c\) is a real number, then \(cf\) is also differentiable at \(x_0\), and \((cf)'(x_0) = cf'(x_0)\).
    \item\label{i:10.1.13.f} (Difference rule)
    If \(f\) and \(g\) are differentiable at \(x_0\), then \(f - g\) is also differentiable at \(x_0\), and \((f - g)'(x_0) = f'(x_0) - g'(x_0)\).
    \item\label{i:10.1.13.g} If \(g\) is differentiable at \(x_0\), and \(g\) is non-zero on \(X\) (i.e., \(g(x) \neq 0\) for all \(x \in X\)), then \(1 / g\) is also differentiable at \(x_0\), and \((\dfrac{1}{g})'(x_0) = -\dfrac{g'(x_0)}{g(x_0)^2}\).
    \item\label{i:10.1.13.h} (Quotient rule)
...
\begin{proof}[\pf{i:10.1.13.a}]
  ...
  \]
  Thus, by \labelcrefs{i:9.3.6} we have
  \[
    \lim_{x \to x_0 ; x \in X \setminus \set{x_0}} \dfrac{f(x) - f(x_0)}{x - x_0} = 0
  \]
  and by \labelcrefs{i:10.1.1} we have \(f'(x_0) = 0\).
\end{proof}

\begin{proof}[\pf{i:10.1.13.b}]
  We have \(\forall \varepsilon \in \R^+\), \(\forall \delta \in \R^+\) such that
  \[
  ...
  \]
  and by \labelcrefs{i:10.1.1} we have \(f'(x_0) = 1\).
\end{proof}

\begin{proof}[\pf{i:10.1.13.c}]
  By \labelcrefs{i:10.1.1} and \labelcrefs{i:9.3.14} we have
  \begin{align*}
      & f'(x_0) + g'(x_0)                                                                                                                                             \\
...
\begin{thm}[Chain rule]\label{i:10.1.15}
...
\begin{proof}
  By \labelcrefs{i:10.1.7} we want to show that
  \begin{align*}
  ...
  \end{align*}
  Since \(g'(y_0)\) exists, by \labelcrefs{i:10.1.7} we have
  \begin{align*}
  ...
  Since \(f'(x_0)\) exists, by \labelcrefs{i:10.1.12} \(f\) is continuous at \(x_0\) and by \labelcrefs{i:9.4.1} \(\lim_{x \to x_0 ; x \in X} f(x) = f(x_0)\).
  This means
  \begin{align*}
    ...
    \implies & \begin{dcases}
               ...
               \end{dcases}                   &  & \text{(by \labelcrefs{i:9.4.7.d} and \labelcrefs{i:10.1.7})} \\
    \implies & \begin{dcases}
                 \abs{f(x) - y_0} \leq \delta_g                                        \\
                 \abs{f(x) - y_0 - f'(x_0) (x - x_0)} \leq \varepsilon_g \abs{x - x_0} \\
  ...
  \begin{align*}
    ...
    \implies & \abs{g\big(f(x)\big) - g(y_0) - g'(y_0) f'(x_0) (x - x_0)} \leq \varepsilon \abs{x - x_0}
  \end{align*}
  and by \labelcrefs{i:10.1.7} we have \((g \circ f)'(x_0) = g'(y_0) f'(x_0)\).
\end{proof}
...
\begin{ex}\label{i:ex:10.1.1}
  ...
  Explain why this does not contradict the discussion in \labelcrefs{i:10.1.2}.
\end{ex}

\begin{proof}
  Since \(f\) is differentiable at \(x_0\), by Newton's approximation (\labelcrefs{i:10.1.7}) we have \(\forall \varepsilon \in \R^+\), \(\exists \delta \in \R^+\) such that
  \[
  ...
  \end{align*}
  Thus, by Newton's approximation (\labelcrefs{i:10.1.7}) we know that \(f|_Y'(x_0) = f'(x_0)\).
  This does not contradict to \labelcrefs{i:10.1.2} since \(x_0\) is a limit point of \(Y\) implies \(x_0\) is also a limit point of \(X\).
\end{proof}

\begin{ex}\label{i:ex:10.1.2}
  Prove \labelcrefs{i:10.1.7}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:10.1.7}.
\end{proof}

\begin{ex}\label{i:ex:10.1.3}
  Prove \labelcrefs{i:10.1.10}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:10.1.10}.
\end{proof}

\begin{ex}\label{i:ex:10.1.4}
  Prove \labelcrefs{i:10.1.13}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:10.1.13}.
\end{proof}
...
\begin{proof}
  ...
  By \labelcrefs{i:10.1.13.a} we know that \(f_0\) is differentiable on \(\R\) and \(f_0'(x) = 0\) for every \(x \in X\).
...
\begin{ex}\label{i:ex:10.1.7}
  Prove \labelcrefs{i:10.1.15}.
\end{ex}

\begin{proof}
  See \labelcrefs{i:10.1.15}.
\end{proof}
