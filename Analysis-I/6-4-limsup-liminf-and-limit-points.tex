...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & L \leq \limsup_{n \to \infty} b_n \leq L                                                   &  & \by{6.4.12}[f] \\
  ...
  \begin{align*}
    ...
    \implies & L \leq \liminf_{n \to \infty} b_n \leq L                                                   &  & \by{6.4.12}[f] \\
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & \lim_{n \to \infty} -\abs{a_n} = 0 &  & \by{6.1.19}[c] \\
