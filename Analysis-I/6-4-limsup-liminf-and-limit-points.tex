...
\begin{proof}{(e)}
    ...
    By Definition \ref{6.4.1} we need to show that \(\forall \varepsilon \in \R^+\), \(\forall N \geq m\), \(\exists\ n \geq N\) such that \(\abs{a_n - L^+} \leq \varepsilon\).
...
\begin{proof}{(a)}
    ...
    Since \(c\) is a limit point of \((a_n)_{n = m}^\infty\), by Definition \ref{6.4.1} \(\forall \varepsilon \in \R^+\), we have \(\forall N \geq m\), \(\exists\ n \geq N\) such that \(\abs{a_n - c} \leq \varepsilon\).
