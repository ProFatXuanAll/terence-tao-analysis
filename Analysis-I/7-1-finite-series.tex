...
\begin{proof}{(a)}
  ...
  Now we use induction on \(k\) to show that \cref{i:7.1.4}(a) is true and we start with \(k = 1\).
...
\begin{proof}{(b)}
  ...
  Now we use induction on \(p\) to show that \cref{i:7.1.4}(b) is true.
...
\begin{proof}{(c)}
  Let \(p = n - m\).
  By hypothesis we know that \(p \geq 0\).
  Now we use induction on \(p\) to show that \cref{i:7.1.4}(c) is true.
  For \(p = 0\), we have \(n = m\) and
  \begin{align*}
...
\begin{proof}{(d)}
  Let \(p = n - m\).
  By hypothesis we know that \(p \geq 0\).
  Now we use induction on \(p\) to show that \cref{i:7.1.4}(d) is true.
  For \(p = 0\), we have \(n = m\) and
  \begin{align*}
...
\begin{proof}{(e)}
  Let \(p = n - m\).
  By hypothesis we know that \(p \geq 0\).
  Now we use induction on \(p\) to show that \cref{i:7.1.4}(e) is true.
  For \(p = 0\), we have \(n = m\) and
  \begin{align*}
...
\begin{proof}{(f)}
  Let \(p = n - m\).
  By hypothesis we know that \(p \geq 0\).
  Now we use induction on \(p\) to show that \cref{i:7.1.4}(f) is true.
  For \(p = 0\), we have \(n = m\) and
  \begin{align*}
...
\begin{proof}{(a)}
  Let \(k = p - m\).
  By hypothesis we know that \(k > 0\).
  Now we use induction on \(k\) to show that \cref{i:ac:7.1.2}(a) is true and we start with \(k = 1\).
...
\begin{proof}{(b)}
  Let \(p = n - m\).
  By hypothesis we know that \(p \geq 0\).
  Now we use induction on \(p\) to show that \cref{i:ac:7.1.2}(b) is true.
  For \(p = 0\), we have \(n = m\) and
  \begin{align*}
...
\begin{proof}{(c)}
  Let \(p = n - m\).
  By hypothesis we know that \(p \geq 0\).
  Now we use induction on \(p\) to show that \cref{i:ac:7.1.2}(c) is true.
  For \(p = 0\), we have \(n = m\) and
  \begin{align*}
...
\begin{proof}{(d)}
  Let \(p = n - m\).
  By hypothesis we know that \(p \geq 0\).
  Now we use induction on \(p\) to show that \cref{i:ac:7.1.2}(d) is true.
  For \(p = 0\), we have \(n = m\) and
  \begin{align*}
...
\begin{proof}{(e)}
  Let \(p = n - m\).
  By hypothesis we know that \(p \geq 0\).
  Now we use induction on \(p\) to show that \cref{i:ac:7.1.2}(e) is true.
  For \(p = 0\), we have \(n = m\) and
  \begin{align*}
