...
\begin{proof}
    ...
    Since \(\mathbf{P} \# \mathbf{P}'\) is a partition of \(I\), by Definition \ref{11.1.10} all elements in \(\mathbf{P}_K\) are bounded interval.
    Again by Definition \ref{11.1.10} if \(S, S' \in \mathbf{P}_K\) and \(S \neq S'\), then \(S \cap S' = \emptyset\).
    Let \(x \in K\).
    By Definition \ref{11.1.10} we have \(x \in I\) and \(\exists!\ K' \in \mathbf{P}'\) such that \(x \in K'\).
    By Definition \ref{11.1.16} we know that \(K \cap K' \in \mathbf{P} \# \mathbf{P}'\).
    Since \(K \cap K' \subseteq K\), we have \(x \in \bigcup \mathbf{P}_K\).
    ...
    Thus we have \(S \in \mathbf{P}_K\).
    Since \(S\) is arbitrary, we have \(\mathbf{P} \# \mathbf{P}' \subseteq \bigcup_{K \in \mathbf{P}} \mathbf{P}_K\).
