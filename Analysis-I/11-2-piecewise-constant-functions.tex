...
\begin{proof}
  ...
  \begin{align*}
    p.c. \int_{[\mathbf{P} \# \mathbf{P}']} f & = \sum_{J \in \mathbf{P} \# \mathbf{P}'} c_J \abs{J}                        &                 & \by{11.2.9}    \\
                                              ...
                                              & = \sum_{K \in \mathbf{P}} \sum_{J \in \mathbf{P}_K} c_J \abs{J}             &                 & \by{7.1.11}[e] \\
...
\begin{proof}{(a)}
  ...
  \begin{align*}
    p.c. \int_I f + p.c. \int_I g & = p.c. \int_{[\mathbf{P}]} f + p.c. \int_{[\mathbf{P}]} g                             &  & \by{11.2.14}   \\
                                  ...
                                  & = \sum_{J \in \mathbf{P}} (c_{f|_J} + c_{g|_J}) \abs{J}                               &  & \by{7.1.11}[f] \\
...
\begin{proof}{(b)}
  ...
  \begin{align*}
    c \bigg(p.c. \int_I f\bigg) & = c \bigg(p.c. \int_{[\mathbf{P}]} f\bigg)          &  & \by{11.2.14}   \\
                                ...
                                & = \sum_{J \in \mathbf{P}} c \cdot c_J \abs{J}       &  & \by{7.1.11}[g] \\
...
\begin{proof}{(c)}
  ...
  \begin{align*}
    p.c. \int_I f - p.c. \int_I g & = p.c. \int_I f + (-1) p.c. \int_I g                      \\
                                  & = p.c. \int_I f + p.c. \int_I (-g)   &  & \by{11.2.16}[b] \\
                                  & = p.c. \int_I \big(f + (-g)\big)     &  & \by{11.2.16}[a] \\
...
\begin{proof}{(e)}
  ...
  \begin{align*}
    p.c. \int_I f - p.c. \int_I g & = p.c. \int_I (f - g) &  & \by{11.2.16}[c] \\
                                  & \geq 0.               &  & \by{11.2.16}[d]
  \end{align*}
  Thus
  \[
...
\begin{proof}{(f)}
  ...
  \begin{align*}
    p.c. \int_I f & = p.c. \int_{[I]} f        &  & \by{11.2.14}   \\
                  ...
                  & = c \sum_{J \in I} \abs{J} &  & \by{7.1.11}[g] \\
                  & = c \abs{I}.               &  & \by{11.1.13}
  \end{align*}
\end{proof}
...
\begin{proof}{(g)}
  ...
  \begin{align*}
    p.c. \int_J F & = p.c. \int_{[\mathbf{P} \cup \set{I_1, I_2}]} F                              &  & \by{11.2.14}           \\
                  ...
                  & = c_{I_1} \abs{I_1} + \sum_{K \in \mathbf{P}} c_K \abs{K} + c_{I_2} \abs{I_2} &  & \by{7.1.11}[e]         \\
...
\begin{proof}{(h)}
  ...
  \begin{align*}
    p.c. \int_J f|_J + p.c. \int_K f|_K & = p.c. \int_{[\mathbf{P}_J]} f|_J + p.c. \int_{[\mathbf{P}_K]} f|_K             &  & \by{11.2.14}   \\
                                        & = \sum_{S \in \mathbf{P}_J} c_S \abs{S} + \sum_{S \in \mathbf{P}_K} c_S \abs{S} &  & \by{7.1.11}[e] \\
