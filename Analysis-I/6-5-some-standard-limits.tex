...
\begin{proof}
  ...
  \begin{itemize}
    \item If \(x \geq 1\), then by the proof above we have \(\forall \varepsilon \in \R^+\), \(\exists n \geq 1\) such that \(x^{1 / n} < 1 + \varepsilon\).
          ...
          \begin{align*}
                     & x \geq 1                                                               \\
            \implies & x^{1 / n} \geq 1^{1 / n} = 1                      &  & \by{5.6.6}[d,e] \\
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & \lim_{n \to \infty} (1 / n^{1 / b})^a = 0                                  &  & \by{6.1.19}[b] \\
  ...
  Then we have
  \begin{align*}
             & (\lim_{n \to \infty} n^q)^{-1} = y^{-1}     &  & \by{6.1.19}[e]          \\
    \implies & \lim_{n \to \infty} (n^q)^{-1} = y^{-1}     &  & \by{6.1.19}[e]          \\
