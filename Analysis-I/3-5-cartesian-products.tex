...
\begin{proof}
  ...
  \begin{align*}
    ...
    \iff & \bigg(\set{x} = \set{x'} \lor \set{x} = \set{x', y'}\bigg)                                            \\
         ...
         & \land \bigg(\set{x', y'} = \set{x} \lor \set{x', y'} = \set{x, y}\bigg)   &  & \text{(by \cref{3.3})} \\
  ...
  \begin{align*}
    ...
    \iff & \bigg(x = x' \lor x = \set{x', y'}\bigg)                                                      \\
         ...
         & \land \bigg(\set{x', y'} = x \lor \set{x', y'} = \set{x, y}\bigg) &  & \text{(by \cref{3.3})} \\
...
\begin{proof}
  ...
  \begin{align*}
    (A \times B) \cup (C \times D) & = \set{(1, 2)} \cup \set{(3, 4)}        &  & \by{3.5.4}             \\
                                   & = \set{(1, 2), (3, 4)}.                 &  & \text{(by \cref{3.4})} \\
    (A \cup C) \times (B \cup D)   & = \set{1, 3} \times \set{2, 4}          &  & \text{(by \cref{3.4})} \\
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & \set{(x_i)_{1 \leq i \leq n} : x_i \in X_i \ \forall 1 \leq i \leq n} = \emptyset &  & \text{(by \cref{3.5})} \\
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \iff & \set{(x, f(x)) : x \in X} = \set{(x, \tilde{f}(x)) : x \in X}. &  & \text{(by \cref{3.6})}
  \end{align*}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    Y^X & = \set{f : X \to Y | f \text{'s graph } G \in S_3}.                                             &  & \text{(by \cref{3.6})}
  \end{align*}
\end{proof}
