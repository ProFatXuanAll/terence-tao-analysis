...
\begin{proof}
  ...
  \begin{align*}
    U(f, \mathbf{P}) & = \sum_{J \in \mathbf{P} : J \neq \emptyset} \big(\sup_{x \in J} f(x)\big) \abs{J} &  & \by{11.3.9}      \\
                     & \leq \sum_{J \in \mathbf{P} : J \neq \emptyset} c_{g|_J} \abs{J}                   &  & \by{7.1.11}[h]   \\
                     & = \sum_{J \in \mathbf{P}} c_{g|_J} \abs{J}                                         &  & \by{7.1.11}[a,e] \\
  ...
  \begin{align*}
    L(f, \mathbf{P}) & = \sum_{J \in \mathbf{P} : J \neq \emptyset} \big(\inf_{x \in J} f(x)\big) \abs{J} &  & \by{11.3.9}      \\
                     & \geq \sum_{J \in \mathbf{P} : J \neq \emptyset} c_{h|_J} \abs{J}                   &  & \by{7.1.11}[h]   \\
                     & = \sum_{J \in \mathbf{P}} c_{h|_J} \abs{J}                                         &  & \by{7.1.11}[a,e] \\
...
\begin{proof}
  ...
  \begin{align*}
    U(f, \mathbf{P}) & = \sum_{J \in \mathbf{P} : J \neq \emptyset} \big(\sup_{x \in J} f(x)\big) \abs{J} &  & \by{11.3.9}      \\
                     & = \sum_{J \in \mathbf{P}} \big(\sup_{x \in J} f(x)\big) \abs{J}                    &  & \by{7.1.11}[a,e] \\
                     & = p.c. \int_{[\mathbf{P}]} G                                                       &  & \by{11.2.9}      \\
                     & = p.c. \int_I G                                                                    &  & \by{11.2.14}
  \end{align*}
  and
  \begin{align*}
    L(f, \mathbf{P}) & = \sum_{J \in \mathbf{P} : J \neq \emptyset} \big(\inf_{x \in J} f(x)\big) \abs{J} &  & \by{11.3.9}      \\
                     & = \sum_{J \in \mathbf{P}} \big(\inf_{x \in J} f(x)\big) \abs{J}                    &  & \by{7.1.11}[a,e] \\
                     & = p.c. \int_{[\mathbf{P}]} H                                                       &  & \by{11.2.9}      \\
                     & = p.c. \int_I H.                                                                   &  & \by{11.2.14}
  \end{align*}
