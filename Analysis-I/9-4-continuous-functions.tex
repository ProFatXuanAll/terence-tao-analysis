...
\begin{proof}
  ...
  By \cref{6.5.3} we know that \(\lim_{n \to \infty} a^{\frac{1}{n}} = 1\), thus
  \begin{align*}
    a^{x_0} & = a^{x_0} \lim_{n \to \infty} a^{\pm \frac{1}{n}}   & \text{(by \cref{6.7.3})}  \\
            & = \lim_{n \to \infty} (a^{x_0} a^{\pm \frac{1}{n}}) & \text{(by \cref{6.1.19})} \\
  ...
  \begin{align*}
    ...
    \implies & \forall \varepsilon \in \R^+, \exists\ N \in \N : -\varepsilon \leq a^{x_0 \pm \frac{1}{N}} - a^{x_0} \leq \varepsilon.      & \text{(by \cref{6.7.3})}
  \end{align*}
