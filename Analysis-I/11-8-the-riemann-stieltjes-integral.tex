...
\begin{proof}
  ...
  \]
  Since \(\varepsilon\) is arbitrary, by \cref{i:9.3.6} and \cref{i:9.5.1} we have \(f(x_0+) = U\).
  ...
  \]
  Since \(\varepsilon\) is arbitrary, by \cref{i:9.3.6} and \cref{i:9.5.1} we have \(f(x_0-) = L\).
\end{proof}
...
\begin{proof}
  ...
  \]
  Since \(g, h\) are arbitrary, by \cref{i:ac:11.8.8} we have
  \[
