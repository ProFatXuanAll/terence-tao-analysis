...
\begin{definition}[\(\alpha\)-length]\label{11.8.1}
    ...
    \begin{itemize}
        ...
        \item If \(I\) is a point of the form \(\{a\}\) for some real number \(a\), we set
              \[
                  \alpha[\{a\}] \coloneqq \lim_{x \to a^+ ; x \in X} \alpha(x) - \lim_{x \to a^- ; x \in X} \alpha(x),
              \]
        ...
        \item If \(I\) is an interval of the form \([a, b)\), \((a, b]\), or \([a, b]\) for some real numbers \(b > a\), then we set
              \[
                  \alpha[I] = \begin{cases}
                      \alpha(\{a\}) + \alpha\big((a, b)\big)                 & \text{if } I = [a, b) \\
                      \alpha\big((a, b)\big) + \alpha(\{b\})                 & \text{if } I = (a, b] \\
                      \alpha(\{a\}) + \alpha\big((a, b)\big) + \alpha(\{b\}) & \text{if } I = [a, b]
                  \end{cases}
              \]
    \end{itemize}
\end{definition}
