...
\begin{proof}{(b)}
  ...
  \begin{align*}
    ...
    \implies & \frac{1}{c} \bigg(\overline{\int}_I (cf) \; d \alpha\bigg) \leq \overline{\int}_I f \; d \alpha & \text{(by \cref{ac 11.8.8})}            \\
  ...
  \begin{align*}
    ...
    \implies & \frac{1}{c} \bigg(\underline{\int}_I (cf) \; d \alpha\bigg) \geq \underline{\int}_I f \; d \alpha & \text{(by \cref{ac 11.8.8})}            \\
  ...
  \begin{align*}
    ...
    \implies & \frac{1}{c} \bigg(\overline{\int}_I (cf) \; d \alpha\bigg) \geq p.c. \int_I f_U \; d \alpha \geq \overline{\int}_I f \; d \alpha & \text{(by \cref{ac 11.8.8})}    \\
    \implies & \overline{\int}_I (cf) \; d \alpha \leq c\bigg(\overline{\int}_I f \; d \alpha\bigg)                                                                               \\
    \implies & \overline{\int}_I (cf) \; d \alpha \leq c\bigg(\int_I f \; d \alpha\bigg)                                                        & \text{(by \cref{ac 11.8.8})}
  \end{align*}
  and
  \begin{align*}
    ...
    \implies & \frac{1}{c} \bigg(\underline{\int}_I (cf) \; d \alpha\bigg) \leq p.c. \int_I f_L \; d \alpha \leq \underline{\int}_I f \; d \alpha & \text{(by \cref{ac 11.8.8})}    \\
    \implies & \underline{\int}_I (cf) \; d \alpha \geq c\bigg(\underline{\int}_I f \; d \alpha\bigg)                                                                               \\
    \implies & \underline{\int}_I (cf) \; d \alpha \geq c\bigg(\int_I f \; d \alpha\bigg).                                                        & \text{(by \cref{ac 11.8.8})}
  \end{align*}
  By \cref{ac 11.8.9} we have
