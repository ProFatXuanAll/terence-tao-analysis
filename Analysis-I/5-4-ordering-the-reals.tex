...
\begin{proof}
    ...
    \begin{align*}
        ...
        \iff & (x = \text{LIM}_{n \to \infty} a_n)                                                                   \\
             & \land (\exists\ c \in \Q^+ : \forall n \geq 1, a_n \leq -c < 0) & \text{(by Definition \ref{5.4.3})}  \\
        \iff & (-x = \text{LIM}_{n \to \infty} -a_n)                           & \text{(by Definition \ref{5.3.9})}  \\
             & \land (\exists\ c \in \Q^+ : \forall n \geq 1, a_n \leq -c < 0)                                       \\
        \iff & (-x = \text{LIM}_{n \to \infty} -a_n)                                                                 \\
             & \land (\exists\ c \in \Q^+ : \forall n \geq 1, -a_n \geq c > 0) & \text{(by Exercise \ref{ex 4.2.6})} \\
    ...
    \begin{align*}
        ...
        \implies & (x = \text{LIM}_{n \to \infty} a_n) \land (y = \text{LIM}_{n \to \infty} b_n)                                                \\
                 ...
                 & \land (\exists\ c_2 \in \Q^+ : \forall n \geq 1, 0 < c_2 < b_n)                  & \text{(by Definition \ref{5.4.3})}        \\
        ...
        \implies & (x + y = \text{LIM}_{n \to \infty} a_n + b_n)                                                                                \\
                 & \land (\exists\ c_1, c_2 \in \Q^+ : \forall n \geq 1, 0 < c_1 + c_2 < a_n + b_n) & \text{(by Proposition \ref{4.2.9}(c)(d))} \\
    ...
    \begin{align*}
        ...
        \implies & (xy = \text{LIM}_{n \to \infty} a_n b_n)                                                                                  \\
                 & \land (\exists\ c_1, c_2 \in \Q^+ : \forall n \geq 1, 0 < c_1 c_2 < a_n b_n)  & \text{(by Proposition \ref{4.2.9}(d)(e))} \\
...
\begin{proof}
    ...
    \begin{align*}
        ...
        \implies & y - x \text{ is positive}           & \text{(by Definition \ref{5.4.6})}  \\
        \implies & \exists\ N \in \Z^+ : y - x > 1 / N & \text{(by Exercise \ref{ex 5.4.4})} \\
    ...
    By Exercise \ref{ex 5.4.3}, \(\exists\ M \in \Z\) such that \(M \leq Nx < M + 1\).
    So we have
    \begin{align*}
                 & M \leq Nx < M + 1                                                                                        \\
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item \(x\) is positive.
              Then by Proposition \ref{5.4.12} \(\exists\ q \in \Q^+\) and \(\exists\ N_1' \in \Z^+\) such that \(q \leq x \leq N_1'\).
              Let \(N_1 = N_1' + 1\).
              Then we have \(x < N_1\).
              By Proposition \ref{4.4.1} we know that \(\exists\ N_2 \in \Z\) such that \(N_2 \leq q\), thus by Proposition \ref{5.4.7}(c) we have \(N_2 \leq x < N_1\).
              Let \(X\) be the set
              \[
        ...
        \item \(x\) is negative.
              ...
              \begin{align*}
                  ...
                  \implies & \exists\ M \in \Z^+ : M1 = M > x         & \text{(by Corollary \ref{5.4.13})}     \\
...
\begin{proof}
    ...
    \begin{align*}
        ...
        \implies & \exists\ N \in \Z^+ : N1 = N > x^{-1} & \text{(by Corollary \ref{5.4.13})}  \\
...
\begin{proof}
    ...
    \begin{align*}
        ...
        \iff & \forall \varepsilon \in \R^+, x - y \leq \varepsilon & \text{(by Proposition \ref{5.4.7})} \\
        \iff & \lnot (x - y > 0)                                                                          \\
    ...
    \begin{align*}
        ...
        \iff & \forall \varepsilon \in \R^+, y - \varepsilon \leq x \leq y + \varepsilon & \text{(by Exercise \ref{ex 5.4.6})}  \\
...
\begin{proof}
    ...
    Then by Proposition \ref{5.4.14}, \(\exists\ q \in \Q\) such that \(a > q > x\).
