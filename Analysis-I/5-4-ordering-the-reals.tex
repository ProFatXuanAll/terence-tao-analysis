...
\begin{proof}
  ...
  \begin{align*}
         & x \text{ is negative}                                                               \\
    \iff & (x = \LIM_{n \to \infty} a_n)                                                       \\
         & \land (\exists c \in \Q^+ : \forall n \geq 1, a_n \leq -c < 0) &  & \by{i:5.4.3}    \\
    \iff & (-x = \LIM_{n \to \infty} -a_n)                                &  & \by{i:5.3.9}    \\
  ...
  \begin{align*}
    ...
    \implies & (x = \LIM_{n \to \infty} a_n) \land (y = \LIM_{n \to \infty} b_n)                                  \\
             & \land (\exists c_1 \in \Q^+ : \forall n \geq 1, 0 < c_1 < a_n)                                     \\
             & \land (\exists c_2 \in \Q^+ : \forall n \geq 1, 0 < c_2 < b_n)              &  & \by{i:5.4.3}      \\
    \implies & (xy = \LIM_{n \to \infty} a_n b_n)                                          &  & \by{i:5.3.9}      \\
             & \land (\exists c_1 \in \Q^+ : \forall n \geq 1, 0 < c_1 < a_n)                                     \\
             & \land (\exists c_2 \in \Q^+ : \forall n \geq 1, 0 < c_2 < b_n)                                     \\
    \implies & (xy = \LIM_{n \to \infty} a_n b_n)                                                                 \\
...
\begin{proof}
  ...
  Then by definition of negative real number, we have \(x = \LIM_{n \to \infty} b_n\) for some sequence \(b_n\) which is negatively bounded away from zero, i.e., there is a negative rational \(-c < 0\) such that \(b_n \leq -c\) for all \(n \geq 1\).
...
\begin{proof}
  We first show that if \(a_n \leq x\) for all \(n \geq 1\), then \(\LIM_{n \to \infty} a_n \leq x\).
  ...
  Now we show that if \(a_n \geq x\) for all \(n \geq 1\), then \(\LIM_{n \to \infty} a_n \geq x\).
  We have
  \begin{align*}
             & a_n \geq x                                                      \\
    ...
    \implies & \LIM_{n \to \infty} a_n \geq x.  &  & \by{i:5.4.7}
  \end{align*}
\end{proof}
