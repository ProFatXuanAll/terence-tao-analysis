...
\begin{proof}[\pf{i:5.4.4}]
  ...
  \begin{itemize}
    \item If \(a_N \in \Q^+\), then by \cref{i:4.3.1} we have \(a_N \geq c\).
          ...
          If we now define \((b_n)_{n = 1}^\infty\) to be the sequence where \(b_n = c\) for all \(n \in \Z^+ \cap \Z_{< N}\) and \(b_n = a_n\) for all \(n \in \Z_{\geq N}\), then we see that \((a_n)_{n = 1}^\infty, (b_n)_{n = 1}^\infty\) are equivalent rational Cauchy sequences and \((b_n)_{n = 1}^\infty\) is positively bounded away from zero.
    ...
    \item If \(a_N \in \Q^-\), then by \cref{i:4.3.1} we have \(-a_N \geq c\).
          ...
          \end{align*}
          This means \(a_j \in \Q^-\) for all \(j \in \Z_{\geq N}\).
          If we now define \((b_n)_{n = 1}^\infty\) to be the sequence where \(b_n = -c\) for all \(n \in \Z^+ \cap \Z_{< N}\) and \(b_n = a_n\) for all \(n \in \Z_{\geq N}\), then we see that \((a_n)_{n = 1}^\infty, (b_n)_{n = 1}^\infty\) are equivalent rational Cauchy sequences and \((b_n)_{n = 1}^\infty\) is negatively bounded away from zero.
...
\begin{proof}[\pf{i:ex:5.4.3}]
  ...
  \begin{itemize}
    ...
    \item \(x\) is positive.
          ...
          By \cref{i:ac:5.4.1} we know that there exists an unique \(\max(X) \in X\).
          Let \(N = \max(X)\).
