...
\begin{proof}{(a)}
  ...
  \begin{align*}
     ...
     & = \sum_{n = 0}^\infty \Big(\abs{f\big(p(n)\big)} + \abs{g\big(p(n)\big)}\Big)                &  & \by{7.2.14}[a] \\
     & = \lim_{N \to \infty} \sum_{n = 0}^N \Big(\abs{f\big(p(n)\big)} + \abs{g\big(p(n)\big)}\Big) &  & \by{7.2.2}     \\
     & \geq \lim_{N \to \infty} \sum_{n = 0}^N \abs{f\big(p(n)\big) + g\big(p(n)\big)}              &  & \by{6.1.19}[h] \\
  ...
  \begin{align*}
     ...
     & = \sum_{n = 0}^\infty \Big(f\big(p(n)\big) + g\big(p(n)\big)\Big)           &  & \by{7.2.14}[a] \\
...
\begin{proof}{(b)}
  ...
  \begin{align*}
    \abs{c} \sum_{x \in X} \abs{f(x)} & = \abs{c} \sum_{n = 0}^\infty \abs{f\big(p(n)\big)} &  & \by{8.2.1}     \\
                                      & = \sum_{n = 0}^\infty \abs{c} \abs{f\big(p(n)\big)} &  & \by{7.2.14}[b] \\
  ...
  \begin{align*}
    c \sum_{x \in X} f(x) & = c \sum_{n = 0}^\infty f\big(p(n)\big) &  & \by{8.2.1}     \\
                          & = \sum_{n = 0}^\infty c f\big(p(n)\big) &  & \by{7.2.14}[b] \\
  ...
  \begin{itemize}
    \item One of \(X_1, X_2\) is finite and one is countable.
          ...
          \begin{align*}
            \sum_{x \in X} \abs{f(x)} & = \sum_{n = 0}^\infty \abs{f\big(q(n)\big)}                                                          &  & \by{8.2.1}     \\
                                      & = \sum_{n = 0}^{\#(X_1) - 1} \abs{f\big(q(n)\big)} + \sum_{n = \#(X_1)}^\infty \abs{f\big(q(n)\big)} &  & \by{7.2.14}[c] \\
                                      & = \sum_{n = 0}^{\#(X_1) - 1} \abs{f\big(q_1(n + 1)\big)}                                                                 \\
                                      & \quad + \sum_{n = \#(X_1)}^\infty \abs{f\Big(q_2\big(n - \#(X_1)\big)\Big)}                                              \\
                                      & = \sum_{n = 1}^{\#(X_1)} \abs{f\big(q_1(n)\big)}                                                     &  & \by{7.1.4}[b]  \\
                                      & \quad + \sum_{n = 0}^\infty \abs{f\big(q_2(n)\big)}                                                  &  & \by{7.2.14}[d] \\
          ...
          \begin{align*}
            \sum_{x \in X} f(x) & = \sum_{n = 0}^\infty f(q(x))                                                            &  & \by{8.2.1}     \\
                                & = \sum_{n = 0}^{\#(X_1) - 1} f\big(q(n)\big) + \sum_{n = \#(X_1)}^\infty f\big(q(n)\big) &  & \by{7.2.14}[c] \\
                                & = \sum_{n = 0}^{\#(X_1) - 1} f\big(q_1(n + 1)\big)                                                           \\
                                & \quad + \sum_{n = \#(X_1)}^\infty f\Big(q_2\big(n - \#(X_1)\big)\Big)                                        \\
                                & = \sum_{n = 1}^{\#(X_1)} f\big(q_1(n)\big)                                               &  & \by{7.1.4}[b]  \\
                                & \quad + \sum_{n = 0}^\infty f\big(q_2(n)\big)                                            &  & \by{7.2.14}[c] \\
    ...
    \item Both \(X_1, X_2\) are countable.
          ...
          \begin{align*}
             ...
             & \quad + \sum_{n \leq 2N \land n \text{ is odd}} \abs{f\big(q(n)\big)}\Bigg)                                               &  & \by{7.1.11}[e] \\
             ...
             & \quad + \lim_{N \to \infty} \sum_{n \leq 2N \land n \text{ is odd}} \abs{f\big(q_2(\dfrac{n - 1}{2})\big)}                &  & \by{6.1.19}[a] \\
          ...
          \begin{align*}
             ...
             & \quad + \sum_{n \leq 2N \land n \text{ is odd}} f\big(q(n)\big)\Bigg)                                         &  & \by{7.1.11}[e] \\
             ...
             & \quad + \lim_{N \to \infty} \sum_{n \leq 2N \land n \text{ is odd}} f\big(q_2(\dfrac{n - 1}{2})\big)          &  & \by{6.1.19}[a] \\
  ...
  \begin{itemize}
    \item One of \(X_1, X_2\) is finite and one is countable.
          ...
          \begin{align*}
             ...
             & = \sum_{n = 0}^{\#(X_1) - 1} \abs{h\big(q_1(n + 1)\big)}                                             &  & \by{7.1.4}[b]  \\
             & \quad + \sum_{n = \#(X_1)}^\infty \abs{h\Big(q_2\big(n - \#(X_1)\big)\Big)}                          &  & \by{7.2.14}[d] \\
             & = \sum_{n = 0}^{\#(X_1) - 1} \abs{h\big(q(n)\big)} + \sum_{n = \#(X_1)}^\infty \abs{h\big(q(n)\big)}                     \\
             & = \sum_{n = 0}^\infty \abs{h\big(q(n)\big)}                                                          &  & \by{7.2.14}[c] \\
    ...
    \item Both \(X_1, X_2\) are countable.
          ...
          \begin{align*}
             ...
             & = \sum_{n = 0}^\infty \Big(\abs{h\big(q_1(n)\big)} + \abs{h\big(q_2(n)\big)}\Big)                                   &  & \by{7.2.14}[a] \\
             ...
             & = \lim_{N \to \infty} \sum_{n \leq 2N} \abs{h\big(q(n)\big)}                                                        &  & \by{7.1.11}[e] \\
...
\begin{proof}{(a)}
  ...
  \begin{align*}
    \sum_{x \in A} \abs{f(x) + g(x)} & \leq \sum_{x \in A} (\abs{f(x)} + \abs{g(x)})                               \\
                                     & = \sum_{x \in A} \abs{f(x)} + \sum_{x \in A} \abs{g(x)} &  & \by{7.1.11}[f] \\
                                     & \leq N + M.
  \end{align*}
  ...
  \begin{align*}
     ...
     & = \sum_{x \in X_f \cup X_g} \big(f(x) + g(x)\big)                              &                                                          & \by{ac:8.2.1}[c] \\
     & = \sum_{x \in X_f \cup X_g} f(x) + \sum_{x \in X_f \cup X_g} g(x)              &                                                          & \by{ac:8.2.1}[a] \\
     & = \sum_{x \in X_f} f(x) + \sum_{x \in (X_f \cup X_g) \setminus X_f} f(x)       &                                                          & \by{ac:8.2.1}[c] \\
     & \quad + \sum_{x \in X_g} g(x) + \sum_{x \in (X_f \cup X_g) \setminus X_g} g(x) &                                                          & \by{ac:8.2.1}[c] \\
...
\begin{proof}{(b)}
  ...
  \begin{align*}
    \sum_{x \in A} \abs{cf(x)} & = \sum_{x \in A} \abs{c}\abs{f(x)}                     \\
                               & = \abs{c}\sum_{x \in A} \abs{f(x)} &  & \by{7.1.11}[g] \\
                               & \leq \abs{c} N.
  \end{align*}
  Since \(A\) is arbitrary, we have
  \[
    ...
    \item If \(c \neq 0\), then we have \(X_f = X_h\) since
          ...
          \begin{align*}
            \sum_{x \in X} cf(x) & = \sum_{x \in X_h} cf(x)  &  & \by{8.2.5}       \\
                                 & = c \sum_{x \in X_h} f(x) &  & \by{ac:8.2.1}[b] \\
                                 & = c \sum_{x \in X_f} f(x)                       \\
...
\begin{proof}{(c)}
  ...
  \begin{align*}
    \sum_{x \in X} f(x) & = \sum_{x \in X_f} f(x)                                 &  & \by{8.2.5}       \\
                        ...
                        & = \sum_{x \in X_{f_1}} f(x) + \sum_{x \in X_{f_2}} f(x) &  & \by{ac:8.2.1}[c] \\
...
\begin{proof}{(d)}
  ...
  Then we have
  \begin{align*}
    \sum_{y \in A} \abs{f\big(\phi(y)\big)} & = \sum_{x \in \phi(A)} \abs{f(x)} &  & \by{7.1.11}[c]                 \\
  ...
  \begin{align*}
    \sum_{y \in Y} f\big(\phi(y)\big) & = \sum_{y \in Y_f} f\big(\phi(y)\big) &  & \by{8.2.5}       \\
                                      & = \sum_{x \in X_f} f(x)               &  & \by{ac:8.2.1}[d] \\
...
\begin{proof}
  ...
  \begin{align*}
    \sum_{n = 0}^\infty a_n & = \sum_{n = 0}^\infty b_n - c_n                                                           \\
                            & = \sum_{n = 0}^\infty b_n - \sum_{n = 0}^\infty c_n                   &  & \by{7.2.14}[a] \\
  ...
  \begin{align*}
    \sum_{n \in A_-} \abs{a_n} & = \sum_{n = 0}^\infty \abs{\min(a_n, 0)} &  & \by{8.2.5}     \\
                               ...
                               & = -\sum_{n = 0}^\infty \min(a_n, 0)      &  & \by{7.2.14}[b] \\
  ...
  \begin{itemize}
    ...
    \item Both Case I and II occur infinite number of times.
          ...
          \begin{align*}
            ...
            \implies & \lim_{k \to \infty} L_k \text{ converges}.          &  & \by{6.1.19}[a]
          \end{align*}
          ...
          \begin{align*}
            ...
            \implies & \sum_{k \in A_+} \abs{a_k} \text{ converges}            &                                 & \by{8.2.6}[c]
          \end{align*}
