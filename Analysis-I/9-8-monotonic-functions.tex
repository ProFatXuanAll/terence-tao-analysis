...
\begin{defn}[Monotonic functions]\label{9.8.1}
...
\begin{proof}{(a)}
  ...
  \begin{align*}
    f(b) & = \sum_{r \in \Q : r < b} g(r)                                                                                                \\
         & = \sum_{r \in \Q : r < a} g(r) + \sum_{r \in \Q : a \leq r < c} g(r) + \sum_{r \in \Q : c \leq r < b} g(r) &  & \by{8.2.6}[c] \\
         & = f(a) + \sum_{r \in \Q : a \leq r < c} g(r) + g(c) + \sum_{r \in \Q : c < r < b} g(r)                     &  & \by{8.2.6}[c] \\
         & > f(a).
  \end{align*}
...
\begin{proof}{(b)}
  ...
  \begin{align*}
    f(x) & = \sum_{r \in \Q : r < x} g(r)                                                                             \\
         & = \sum_{r \in \Q : r < \gamma} g(r) + g(\gamma) + \sum_{r \in \Q : \gamma < r < x} g(r) &  & \by{8.2.6}[c] \\
  ...
  \begin{align*}
    ...
    \implies & f \text{ is not continuous at } \gamma.                         &  & \by{ac:9.5.1}
  \end{align*}
...
\begin{proof}{(c)}
  ...
  \begin{align*}
     ...
     & = \abs{\sum_{r \in \Q : r < x, g(r) < 2^{-n}} g(r)}                                   &  & \by{8.2.6}[c] \\
