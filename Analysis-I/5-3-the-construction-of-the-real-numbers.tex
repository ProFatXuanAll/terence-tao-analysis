...
\begin{proof}
    ...
    Since \((a_n)_{n = 1}^\infty\) and \((b_n)_{n = 1}^\infty\) are Cauchy sequence, by Lemma \ref{5.1.15} we know that \((a_n)_{n = 1}^\infty\) and \((b_n)_{n = 1}^\infty\) are bounded by some \(M_1, M_2 \in \Q \setminus \Q^-\).
    ...
    \begin{align*}
        \abs{a_j b_j - a_k b_k} & = \abs{a_j b_j - a_j b_k + a_j b_k - a_k b_k}            & \text{(by Proposition \ref{4.2.4})}       \\
                                ...
                                & = \varepsilon.
    \end{align*}
    Thus by Definition \ref{5.1.8} \((a_n b_n)_{n = 1}^\infty\) is a Cauchy sequence and by Definition \ref{5.3.1} \(xy \in \R\).

    Now we show that \(x = x' \implies xy = xy'\).
    Since \((a_n)_{n = 1}^\infty\), \((a_n')_{n = 1}^\infty\), \((b_n)_{n = 1}^\infty\) are Cauchy sequence, by Lemma \ref{5.1.15} we know that \((a_n)_{n = 1}^\infty\) and \((a_n')_{n = 1}^\infty\) are bounded by some \(M_1, M_2 M_3 \in \Q \setminus \Q^-\).
...
\begin{proof}
    ...
    \begin{align*}
             & a = b                                                                                                                 \\
        \iff & \forall \varepsilon \in \Q^+, \forall n \geq 1, \abs{a - b} \leq \varepsilon & \text{(by Proposition \ref{4.3.7}(a))} \\
...
\begin{proof}
    Since \((a_n)_{n = 0}^{\infty} = (b_n)_{n = 0}^{\infty}\), by Definition \ref{5.2.6} we know that \((a_n)_{n = 0}^{\infty}\) and \((b_n)_{n = 0}^{\infty}\) are eventually \(\varepsilon\)-close for every \(\varepsilon \in \Q^+\).
...
\begin{proof}
    ...
    By Proposition \ref{4.4.1}, \(\forall \varepsilon \in \Q^+\), \(\exists\ N \in \Z^+\) such that
    \[
