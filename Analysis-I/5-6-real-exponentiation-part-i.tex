...
\begin{defn}[Exponentiating a real by a natural number]\label{5.6.1}
...
\begin{defn}[Exponentiating a real by an integer]\label{5.6.2}
...
\begin{lem}[Existence of \(n^{\text{th}}\) roots]\label{5.6.5}
  Let \(x \geq 0\) be a non-negative real, and let \(n \geq 1\) be a positive integer.
