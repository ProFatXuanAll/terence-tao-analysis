...
\begin{proof}{(a)}
    ...
    \begin{itemize}
        \item \(y^n < x\).
              ...
              Since \(m \in \Z^+\), we know that \(y < y + \frac{1}{m}\), thus by Proposition \ref{5.6.3} we know that \(y^n < (y + \frac{1}{m})^n\).
        ...
        \item \(y^n > x\).
              ...
              a contradiction.
              Thus we know that \(\exists\ m \in \Z^+\) such that \((y - \frac{1}{m})^n > x\).
              Since \(m \in \Z^+\), we know that \(y - \frac{1}{m} < y\), thus by Proposition \ref{5.6.3} we know that \((y - \frac{1}{m})^n < y^n\).
...
\begin{proof}{(e)}
    If \(x = 0\), then by Lemma \ref{5.6.6}(c) we know that \(x^{1 / k} = 0\) for every \(k \in \Z^+\).
...
\begin{proof}{(a)}
    ...
    \begin{align*}
                 & x \in \R^+                                                   \\
        \implies & x^{1 / b} \in \R^+     & \text{(by Lemma \ref{5.6.6}(c))}    \\
        \implies & (x^{1 / b})^a \in \R^+ & \text{(by Proposition \ref{5.6.3})} \\
        \implies & x^q \in \R^+.          & \text{(by Definition \ref{5.6.7})}
    \end{align*}
\end{proof}
