...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & q_1 = \lim_{x \to 1 ; x \in (0, \infty) \setminus \set{1}} \dfrac{x^{q_1} - 1}{x - 1}                                                              &  & \by{ex:10.4.2}[b]                           \\
             & \leq \lim_{x \to 1 ; x \in (0, \infty) \setminus \set{1}} \dfrac{x^{\alpha} - 1}{x - 1}                                                            &  & \by{9.3.14}                                 \\
             & \leq \lim_{x \to 1 ; x \in (0, \infty) \setminus \set{1}} \dfrac{x^{q_2} - 1}{x - 1} = q_2                                                         &  & \by{ex:10.4.2}[b]                           \\
  ...
  \begin{align*}
    (f \circ g)'(x_0) & = f'(1) g'(x_0)                                                                                                                           &  & \by{10.1.15}      \\
                      & = \dfrac{\alpha}{x_0}                                                                                                                     &  & \by{10.1.13}[b,e] \\
                      ...
                      & = \dfrac{1}{x_0^{\alpha}} \bigg(\lim_{x \to x_0 ; x \in (0, \infty) \setminus \set{x_0}} \dfrac{x^{\alpha} - x_0^{\alpha}}{x - x_0}\bigg) &  & \by{10.1.13}[e]
  \end{align*}
  and
  \[
