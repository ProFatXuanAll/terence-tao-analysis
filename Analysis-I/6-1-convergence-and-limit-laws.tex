...
\begin{proof}[\pf{i:6.1.12}]
  ...
  Since \(\varepsilon\) is arbitrary, by \cref{i:6.1.3} we see that \((a_n)_{n = m}^\infty\) is a Cauchy sequence of reals.
\end{proof}
...
\begin{proof}[\pf{i:6.1.19}(a)]
  ...
  Since \(\varepsilon\) is arbitrary, by \cref{i:6.1.5} again we know that \((a_n + b_n)_{n = m}^\infty\) converges to \(x + y\).
\end{proof}
...
\begin{proof}[\pf{i:6.1.19}(b)]
  ...
  Since \(\varepsilon\) is arbitrary, by \cref{i:6.1.5} again we know that \((a_n b_n)_{n = m}^\infty\) converges to \(xy\).
\end{proof}
...
\begin{proof}[\pf{i:6.1.19}(e)]
  ...
  Since \(\varepsilon\) is arbitrary, by \cref{i:6.1.5} again we know that \(\pa{b_n^{-1}}_{n = m}^\infty\) converges to \(y^{-1}\).
\end{proof}
...
\begin{proof}[\pf{i:6.1.19}(g)]
  ...
  Since \(\varepsilon\) is arbitrary, by \cref{i:6.1.5} again we know that \(\pa{\max(a_n, b_n)}_{n = m}^\infty\) converges to \(\max(x, y)\).
