...
\begin{additional corollary}\label{ac 9.3.2}
Let \(X\) be a subset of \(\R\), let \(f : X \to \R\) be a function, let \(E\) be a subset of \(X\), and let \(x_0\) be an adherent point of \(E\).
Let \(L \in \R\).
...
\begin{proof}
    ...
    By axiom of choice (Axiom \ref{8.1}) we know that \(\prod_{n \in \N} X_{\frac{1}{n}} \neq \emptyset\).
    ...
    \begin{align*}
        ...
        \implies & \forall \delta \in \R^+, \limsup_{n \to \infty} f(a_n) \leq \sup(S_{\delta})                   & \text{(by Proposition \ref{6.4.12}(c))} \\
        \implies & \limsup_{n \to \infty} f(a_n) \leq \inf\{\sup(S_{\delta}) : \delta \in \R^+\} = L.             & \text{(by Remark \ref{5.5.15})}
    \end{align*}
    ...
    \end{align*}
    a contradiction.
    By axiom of choice (Axiom \ref{8.1}) we know that \(\prod_{n \in \Z^+} Y_n \neq \emptyset\).
    ...
    \begin{align*}
        ...
        \implies & \forall \delta \in \R^+, L = \limsup_{n \to \infty} f(b_n) \leq \sup(S_{\delta})               & \text{(by Proposition \ref{6.4.12}(c))} \\
        \implies & L \leq \inf\{\sup(S_{\delta}) : \delta \in \R^+\}.                                             & \text{(by Remark \ref{5.5.15})}
    \end{align*}
