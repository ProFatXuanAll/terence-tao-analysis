...
\begin{proof}
  ...
  Since
  \begin{align*}
             & \forall y \in \overline{Y}, \forall \varepsilon \in \R^+, \exists\ x \in Y : \abs{y - x} \leq \frac{\varepsilon}{2} & \text{(by \cref{9.1.10})}  \\
    \implies & \exists\ x \in \overline{X} : \abs{y - x} \leq \frac{\varepsilon}{2}                                                & (Y \subseteq \overline{X}) \\
    \implies & \exists\ z \in X : \abs{x - z} \leq \frac{\varepsilon}{2}                                                           & \text{(by \cref{9.1.10})}  \\
...
\begin{proof}
  ...
  Since
  \begin{align*}
             & \forall x \in \overline{\overline{X}}, \forall \varepsilon \in \R^+, \exists\ y \in \overline{X} : \abs{x - y} \leq \frac{\varepsilon}{2} & \text{(by \cref{9.1.10})} \\
    \implies & \exists\ z \in X : \abs{y - z} \leq \frac{\varepsilon}{2}                                                                                 & \text{(by \cref{9.1.10})} \\
