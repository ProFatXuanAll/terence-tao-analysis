...
\begin{cor}[Comparison test]\label{7.3.2}
...
\begin{lem}[Geometric series]\label{7.3.3}
...
\begin{proof}
  ...
  \begin{align*}
    \sum_{n = 0}^\infty x^n & = \lim_{N \to \infty} \sum_{n = 0}^N x^n                               &  & \by{7.2.2}                \\
                            ...
                            & = \dfrac{\lim_{N \to \infty} 1 - x^{N + 1}}{1 - x}                     &  & \by{6.1.19}[f]            \\
                            & = \dfrac{\lim_{N \to \infty} 1 - \lim_{N \to \infty} x^{N + 1}}{1 - x} &  & \by{6.1.19}[d]            \\
...
\begin{prop}[Cauchy criterion]\label{7.3.4}
