...
\begin{rmk}\label{i:9.9.3}
  ...
  From \cref{i:9.4.7}(c), we know that a function \(f\) is \emph{continuous} if for every \(\varepsilon > 0\), and every \(x_0 \in X\), there is a \(\delta > 0\) such that \(f(x)\) and \(f(x_0)\) are \(\varepsilon\)-close whenever \(x \in X\) is \(\delta\)-close to \(x_0\).
...
\begin{rmk}\label{i:9.9.6}
  One could debate whether \(\varepsilon\) should be assumed to be rational or real, but a minor modification of \cref{i:6.1.4} shows that this does not make any difference to the above definitions.
\end{rmk}
...
\begin{proof}
  ...
  \]
  and by \cref{i:9.9.5} \(\big(f(x_n)\big)_{n = 0}^\infty = \big(f(y_n)\big)_{n = 0}^\infty\).
...
\begin{rmk}\label{i:9.9.9}
  The reader should compare \cref{i:9.9.8} with \cref{i:9.3.9}.
  \cref{i:9.3.9} asserted that if \(f\) was continuous, then \(f\) maps convergent sequences to convergent sequences.
  In contrast, \cref{i:9.9.8} asserts that if \(f\) is \emph{uniformly} continuous, then \(f\) maps \emph{equivalent} pairs of sequences to equivalent pairs of sequences.
  To see how the two Propositions are connected, observe from \cref{i:9.9.7} that \((x_n)_{n = 0}^\infty\) will converge to \(x_*\) iff the sequences \((x_n)_{n = 0}^\infty\) and \((x_*)_{n = 0}^\infty\) are equivalent.
\end{rmk}
...
\begin{proof}
  Since \(f\) is uniformly continuous, by \cref{i:9.9.2} we have
  \[
    \forall \varepsilon \in \R^+, \exists \delta \in \R^+ : \big(\forall x, y \in X, \abs{x - y} < \delta \implies \abs{f(x) - f(y)} \leq \varepsilon\big).
  \]
  Let \(i, j \in \N\).
  Since \((x_n)_{n = 0}^\infty\) is a Cauchy sequence, by \cref{i:6.1.3} we have
  \[
  ...
  \]
  and by \cref{i:6.1.3} \(\big(f(x_n)\big)_{n = 0}^\infty\) is a Cauchy sequence.
\end{proof}
...
\begin{proof}
  Since \(x_0\) is an adherent point of \(X\), by \cref{i:9.1.14} there exists a sequence \((a_n)_{n = 0}^\infty\), consisting entirely of elements in \(X\), which converges to \(x_0\).
  Since \(\lim_{n \to \infty} a_n = x_0\), by \cref{i:6.1.12} \((a_n)_{n = 0}^\infty\) is a Cauchy sequence.
  Since \(f\) is uniformly continuous, by \cref{i:9.9.12} \(\big(f(a_n)\big)_{n = 0}^\infty\) is also a Cauchy sequence.
  ...
  \end{align*}
  and \((b_n)_{n = 0}^\infty\) was arbitrary, by \cref{i:9.3.9} we know that \(\lim_{x \to x_0 ; x \in X} f(x)\) exists.
...
\begin{proof}
  ...
  Since \((x_n)_{n = 0}^\infty\) in \(E\), by Bolzano-Weierstrass theorem (\cref{i:6.6.8}) there exists a subsequence \((x_{n_j})_{j = 0}^\infty\) which converges, where \(n_0 < n_1 < n_2 < \dots\) is an increasing sequence of natural numbers.
  In particular, we see that \(n_j \geq j\) for all \(j \in \N\) (use induction).

  Let \(\lim_{n \to \infty} x_n = x_*\).
  Since \((x_n)_{n = 0}^\infty\) in \(E\), by \cref{i:9.1.14} we know that \(x_*\) is an adherent point of \(E\).
  Since \(f\) is continuous on \(X\), by \cref{i:ex:9.4.6} \(f\) is continuous on \(E\).
  In particular, \(f\) is uniformly continuous on \(E\).
  Thus, by \cref{i:9.9.14} we know that \(\lim_{x \to x_* ; x \in E} f(x)\) exists.
  By \cref{i:9.3.9} we see that
  \[
...
\begin{proof}
  ...
  By \cref{i:9.9.8}, there must therefore exist two equivalent sequences \((x_n)_{n = 0}^\infty\) and \((y_n)_{n = 0}^\infty\) in \([a, b]\) such that the sequences \(\big(f(x_n)\big)_{n = 0}^\infty\) and \(\big(f(y_n)\big)_{n = 0}^\infty\) are not equivalent.
  ...
  By \cref{i:8.1.5}, \(E\) is countable;
  ...
  \]
  On the other hand, the sequence \((x_{n_j})_{j = 0}^\infty\) is a sequence in \([a, b]\), and so by the Heine-Borel theorem (\cref{i:9.1.24}) there must be a subsequence \((x_{n_{j_k}})_{k = 0}^\infty\) which converges to some limit \(L\) in \([a, b]\).
  In particular, \(f\) is continuous at \(L\), and so by \cref{i:9.4.7},
  \[
    \lim_{k \to \infty} f(x_{n_{j_k}}) = f(L). \tag{i:9.4}\label{i:eq 9.4}
  \]
  Note that \((x_{n_{j_k}})_{k = 0}^\infty\) is a subsequence of \((x_n)_{n = 0}^\infty\), and \((y_{n_{j_k}})_{k = 0}^\infty\) is a subsequence of \((y_n)_{n = 0}^\infty\), by \cref{i:6.6.4}.
  On the other hand, from \cref{i:9.9.7} we have
  \[
    \lim_{n \to \infty} (x_n - y_n) = 0.
  \]
  By \cref{i:6.6.5}, we thus have
  \[
  ...
  \]
  But this contradicts (9.3) (by \cref{i:9.9.7}).
  From this contradiction we conclude that \(f\) is in fact uniformly continuous.
\end{proof}

\begin{rmk}\label{i:9.9.17}
  One should compare \cref{i:9.6.3}, \cref{i:9.9.15}, and \cref{i:9.9.16} with each other.
  Note, in particular, that \cref{i:9.6.3} follows from combining \cref{i:9.9.15} and \cref{i:9.9.16}.
\end{rmk}
...
\begin{ex}\label{i:ex:9.9.4}
  Use \cref{i:9.9.12} to prove \cref{i:9.9.14}.
...
\begin{proof}
  Since \(f\) is continuous on \(X\) and \(g\) is continuous on \(Y\), by \cref{i:9.4.13} we know that \(g \circ f\) is continuous on \(X\).
  Since \(g\) is uniformly continuous, by \cref{i:9.9.2} we have
  \[
  ...
  \]
  Similarly, since \(f\) is uniformly continuous, by \cref{i:9.9.2} we have
  \[
  ...
  \]
  and by \cref{i:9.9.2} \(g \circ f\) is uniformly continuous on \(X\).
\end{proof}
