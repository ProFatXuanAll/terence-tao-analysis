...
\begin{proof}
    ...
    By Definition \ref{8.5.5}, we know that \(s' \notin Y\), and thus by Definition \ref{8.5.12} \(s'\) is a strict upper bound of \(X\).

    Since \(X \neq \emptyset\), let \(x_0 \in X\).
    By Lemma \ref{8.5.14}, \(\exists\ Y \subseteq X\) such that \(Y\) is well-ordered and \(\min(Y) = x_0\).
...
\begin{proof}
    ...
    Since
    \begin{align*}
                 & \forall\ x \in \bigcup_{m \in Y \cap Y' : m < n} \{y \in Y : y \leq m\} \\
        \implies & \exists\ m \in Y \cap Y' \land m < n : x \leq m                         \\
        \implies & x \leq m < n                                                            \\
        \implies & x \in \{y \in Y : y < n\},
    \end{align*}
    we have \(\bigcup_{m \in Y \cap Y' : m < n} \{y \in Y : y \leq m\} \subseteq \{y \in Y : y < n\}\).
    Since
    \begin{align*}
                 & \forall\ x \in \{y \in Y : y < n\}                              \\
        \implies & x \in \{y \in Y' : y < n\}                                      \\
        \implies & x \in \{y \in Y \cap Y' : y < n\}                               \\
        \implies & x \in \bigcup_{m \in Y \cap Y' : m < n} \{y \in Y : y \leq m\},
    \end{align*}
    we have \(\{y \in Y : y < n\} \subseteq \bigcup_{m \in Y \cap Y' : m < n} \{y \in Y : y \leq m\}\).
    Thus by Proposition \ref{3.1.18} we have \(\bigcup_{m \in Y \cap Y' : m < n} \{y \in Y : y \leq m\} = \{y \in Y : y < n\}\).
