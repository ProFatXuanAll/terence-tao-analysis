...
\begin{prop}[Euclid's division lemma]\label{2.3.9}
...
\begin{ac}\label{ac:2.3.5}
  For any natural number \(n\), we have \(n^1 = n\).
\end{ac}

\begin{proof}[\pf{ac:2.3.5}]
  We have
  \begin{align*}
