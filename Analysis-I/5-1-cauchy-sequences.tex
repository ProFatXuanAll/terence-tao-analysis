...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & \frac{-1}{N} \leq \frac{1}{j} - \frac{1}{k} \leq \frac{1}{N} & \text{(by \cref{4.2.9})} \\
    \implies & \abs{\frac{1}{j} - \frac{1}{k}} \leq \frac{1}{N}.            & \text{(by \cref{4.3.3})}
  \end{align*}
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item An infinite sequence \((a_n)_{n = N}^{\infty}\).
          ...
          \begin{align*}
                     & \forall j \in \Z^+ \land j \geq N, \abs{a_j - a_N} \leq 1                 & \text{(by \cref{5.1.3})}    \\
