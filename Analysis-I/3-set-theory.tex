...
\begin{definition}\label{definition 3.1.1}
...
\begin{axiom}[Sets are objects]\label{axiom 3.1}
...
\begin{definition}[Equality of sets]\label{definition 3.1.2}
...
The definition of equality in Definition \ref{definition 3.1.2} is reflexive, symmetric and transitive.
\end{lemma}

\begin{proof}
We first prove the reflexive property of Definition \ref{definition 3.1.2}.
\(\forall\ x \in A\), \(x \in A\) is always true, thus Definition \ref{definition 3.1.2} is reflexive.
Next we prove the symmetric property of Definition \ref{definition 3.1.2}.
If \(\forall\ x \in A\), \(x \in B\), then \(\forall\ y \in B\), \(y \in A\) is also true, thus Definition \ref{definition 3.1.2} is symmetric.
Finally, we prove the transitive property of Definition \ref{definition 3.1.2}.
If \(\forall\ x \in A\), \(x \in B\) and \(\forall\ y \in B\), \(y \in C\), then \(\forall\ x \in A\), \(x \in C\) is true because \(x \in A \implies x \in B \implies x \in C\), thus Definition \ref{definition 3.1.2} is transitive.
\end{proof}

Observe that if \(x \in A\) and \(A = B\), then \(x \in B\), by Definition \ref{definition 3.1.2}.
...
\begin{definition}\label{definition 3.1.3}
If a set is not equal to the empty set, we call it \emph{non-empty}.
\end{definition}

\begin{lemma}[Single choice]\label{lemma 3.1.3}
...
Also, by Axiom \ref{axiom 3.2} we have \(x \notin \emptyset\).
Thus \(x \in A \iff x \in \emptyset\) (both statements are equally false), and so \(A = \emptyset\) by Definition \ref{definition 3.1.2}, a contradiction.
\end{proof}
...
\begin{axiom}[Singleton sets and pair sets]\label{axiom 3.3}
...
Furthermore, if \(a\) and \(b\) are objects, then there exists a set \(\{a, b\}\) whose only elements are \(a\) and \(b\); i.e., for every object \(y\), we have \(y \in \{a, b\}\) if and only if \(y = a\) or \(y = b\);
...
By Axiom \ref{axiom 3.3}, \(\forall\ x \in A\), \(x = a\), and \(\forall\ y \in A'\), \(y = a\).
But \(x = y = a\) implies \(\forall\ x \in A\), \(x \in A'\).
Similarly, \(\forall\ y \in A'\), \(y \in A\).
Thus \(A = A'\) by Definition \ref{definition 3.1.2}.
Next we prove the uniqueness of pair set.
Let \(P\) and \(P'\) be par sets of object \(a\) and \(b\).
By Axiom \ref{axiom 3.3}, \(\forall\ x \in P\), \(x = a\) or \(x = b\), and \(\forall\ y \in P'\), \(y = a\) or \(y = b\).
But \(x = a\) or \(x = b\) implies \(\forall\ x \in P\), \(x \in P'\).
Similarly, \(\forall\ y \in P'\), \(y \in P\).
Thus \(P = P'\) by Definition \ref{definition 3.1.2}.
\end{proof}


\begin{axiom}[Pairwise union]\label{axiom 3.4}
Given any two sets \(A\), \(B\), there exists a set \(A \cup B\), called the \emph{union} \(A \cup B\) of \(A\) and \(B\), whose elements consists of all the elements which belong to \(A\) or \(B\) or both.
...
By Definition \ref{definition 3.1.2}, we need to show that every element \(x\) of \(\{a, b\}\) is an element of \(\{a\} \cup \{b\}\), and vice versa.
So suppose first that \(x\) is an element of \(\{a, b\}\).
By Axiom \ref{axiom 3.3}, this means that at least one of \(x = a\) or 
\(x = b\) is true.
We now divide into two cases.
If \(x = a\), then by Axiom \ref{axiom 3.3} \(x \in \{a\}\), and so by Axiom \ref{axiom 3.4} \(x \in \{a\} \cup \{b\}\).
Now suppose instead \(x = b\), then by Axiom \ref{axiom 3.3} \(x \in \{b\}\), and so by Axiom \ref{axiom 3.4} again \(x \in \{a\} \cup \{b\}\).
...
By Definition \ref{definition 3.1.2}, we need to show that every element \(x\) of \(A \cup B\) is an element of \(B \cup A\), and vice versa.
So suppose first that \(x\) is an element of \(A \cup B\).
By Axiom \ref{axiom 3.4}, this means that at least one of \(x \in A\) or 
\(x \in B\) is true.
We now divide into two cases.
If \(x \in A\), then by Axiom \ref{axiom 3.4} \(x \in B \cup A\).
Now suppose instead \(x \in B\), then by Axiom \ref{axiom 3.4} again \(x \in B \cup A\).
...
By Definition \ref{definition 3.1.2}, we need to show that every element \(x\) of \((A \cup B) \cup C\) is an element of \(A \cup (B \cup C)\), and vice versa.
So suppose first that \(x\) is an element of \((A \cup B) \cup C\).
By Axiom \ref{axiom 3.4}, this means that at least one of \(x \in A \cup B\) or 
\(x \in C\) is true.
We now divide into two cases.
If \(x \in C\), then by Axiom \ref{axiom 3.4} again \(x \in B \cup C\), and so by Axiom \ref{axiom 3.4} again we have \(x \in A \cup (B \cup C)\).
Now suppose instead \(x \in A \cup B\), then by Axiom \ref{axiom 3.4} again \(x \in A\) or \(x \in B\).
If \(x \in A\) then \(x \in A \cup (B \cup C)\) by Axiom \ref{axiom 3.4}, while if \(x \in B\) then by consecutive applications of Axiom \ref{axiom 3.4} we have \(x \in B \cup C\) and hence \(x \in A \cup (B \cup C)\).
...
By Axiom \ref{axiom 3.4}, \(\forall\ x \in A\), \(x \in A \cup A\) is true, and \(\forall\ y \in A \cup A\), \(y \in A\) is true, thus \(A \cup A = A\) by Definition \ref{definition 3.1.2}.
And by Axiom \ref{axiom 3.4}, \(\forall\ x \in A \cup \emptyset\), we have \(x \in A\) or \(x \in \emptyset\).
But by Axiom \ref{axiom 3.2}, \(x \notin \emptyset\), thus \(x \in A\).
Also by Axiom \ref{axiom 3.4}, \(\forall\ y \in A\), \(y \in A \cup \emptyset\) is true.
Thus \(A \cup \emptyset = A\), and by commutative, \(\emptyset \cup A = A \cup \emptyset = A\).
\end{proof}

\begin{definition}[Subsets]\label{definition 3.1.4}
Let \(A\), \(B\) be sets.
...
\begin{lemma}\label{lemma 3.1.6}
Given any set \(A\), we always have \(A \subseteq A\) and \(\emptyset \subseteq A\).
\end{lemma}

\begin{proof}
By Definition \ref{definition 3.1.4}, \(\forall\ x \in A \implies x \in A\), thus \(A \subseteq A\).
Also by Definition \ref{definition 3.1.4}, \(\forall\ x \in \emptyset \implies x \in A\) (because \(x \in \emptyset\) is false), thus \(\emptyset \subseteq A\).
\end{proof}

\begin{proposition}[Sets are partially ordered by set inclusion]\label{proposition 3.1.1}
Let \(A\), \(B\), \(C\) be sets.
...
Thus \(A = B\) by Definition \ref{definition 3.1.2}.
...
\begin{axiom}[Axiom of specification]\label{axiom 3.5}
...
\begin{remark}
Axiom \ref{axiom 3.5} is also known as the \emph{axiom of separation}.
...
\begin{definition}[Intersections]\label{definition 3.1.5}
...
\begin{definition}[Difference sets]\label{definition 3.1.6}
...
\begin{proposition}[Sets form a boolean algebra]\label{proposition 3.1.2}
...
By Axiom \ref{axiom 3.4}, \(\forall\ x \in A \cup \emptyset\), we have \(x \in A\) or \(x \in \emptyset\).
But by Axiom \ref{axiom 3.2}, \(x \notin \emptyset\), thus \(x \in A\).
Also by Axiom \ref{axiom 3.4}, \(\forall\ y \in A\), \(y \in A \cup \emptyset\) is true.
Thus \(A \cup \emptyset = A\).

Now we prove the intersection part.
By Definition \ref{definition 3.1.5}, \(\forall\ x \in A \cap \emptyset\), we have \(x \in A\) and \(x \in \emptyset\).
But by Axiom \ref{axiom 3.2}, \(x \notin \emptyset\), thus \(x\) does not exist, which means \(\forall\ x\), \(x \notin A \cap \emptyset\).
By Axiom \ref{axiom 3.2} and Lemma \ref{lemma 3.1.2}, \(A \cap \emptyset = \emptyset\).
By Axiom \ref{axiom 3.2} again, \(\forall\ y\), \(y \in \emptyset \implies y \in A \cap \emptyset\) (because both are equivalently false).
...
And \(\forall\ y \in X\), \(y \in A \cup X\) by Axiom \ref{axiom 3.4}.
Thus \(A \cup X = X\).
...
Now we prove the intersection part.
By definition \ref{definition 3.1.5}, \(\forall\ x \in (A \cap B) \cap C \iff x \in A \cap B \) and \(x \in C \iff x \in A\) and \(x \in B\) and \(x \in C \iff x \in A\) and \(x \in B \cap C \iff x \in A \cap (B \cap C)\).
...
Thus \(\forall\ x \notin A \cap (X \setminus A)\) is true, and by Lemma \ref{lemma 3.1.2}, \(A \cap (X \setminus A) = \emptyset\).
\end{proof}

\begin{proof}{(h)}
We first prove \(X \setminus (A \cup B) = (X \setminus A) \cap (X \setminus B)\).
By Definition \ref{definition 3.1.2}, two sets are equal iff for all object in one set does not in other set and vice versa.
...
The above laws are collectively known as the \emph{laws of Boolean algebra}, after the mathematician George Boole (1815–1864), and are also applicable to a number of other objects other than sets;
it plays a particularly important role in logic.
\end{remark}

\begin{axiom}[Replacement]\label{axiom 3.6}
Let \(A\) be a set.
...
\begin{axiom}[Infinity]\label{axiom 3.7}
...
Let \(A\), \(B\) be sets.
Prove the absorption laws \(A \cap (A \cup B) = A\) and \(A \cup (A \cap B) = A\).
\end{exercise}

\begin{proof}
By Proposition \ref{proposition 3.1.2}, \(A \cap (A \cup B) = (A \cap A) \cup (A \cap B) = A \cup (A \cap B)\), thus we only need to prove \(A \cup (A \cap B) = A\).
...
\begin{proof}
By Proposition \ref{proposition 3.1.2}, \(A \cup (X \setminus A) = X\) and \(A \cap (X \setminus A) = \emptyset\).
...
\begin{proof}
By Axiom \ref{axiom 3.6}, \(z \in \{y : P(x, y) \text{ is true for some } x \in A\} \iff P(x, z)\) is true for some \(x \in A\).
Change all \(y\) and \(z\) into \(x\), and replace \(P(x, x)\) with \(P(x)\), we derive \(x \in \{x : P(x) \text{ is true for some } x \in A\} \iff P(x)\) is true for some \(x \in A\), which is the same as Axiom \ref{axiom 3.5}.
Thus we conclude that Axiom \ref{axiom 3.6} implies Axiom \ref{axiom 3.5}.
\end{proof}

\section{Russell's paradox}

\begin{axiom}[Universal specification]\label{axiom 3.8}
(Dangerous!)
...
\begin{remark}
Compare to Axiom \ref{axiom 3.5}, any object \(x\) does not need to be in a set \(A\) to apply this axiom.
\end{remark}

Axiom \ref{axiom 3.8} is also known as the \emph{axiom of comprehension}.
...
Since sets are themselves objects (Axiom \ref{axiom 3.1}), this means that sets are allowed to contain themselves, which is a somewhat silly state of affairs.
...
\begin{axiom}[Regularity]\label{axiom 3.9}
...
Show that the universal specification axiom, Axiom 3.8, if assumed to be true, would imply Axioms \ref{axiom 3.2}, \ref{axiom 3.3}, \ref{axiom 3.4}, \ref{axiom 3.5}, and \ref{axiom 3.6}.
(If we assume that all natural numbers are objects, we also obtain Axiom \ref{axiom 3.7}.)
...
Unfortunately, as we have seen, Axiom \ref{axiom 3.8} is \say{too good to be true}!
\end{exercise}

\begin{proof}
We first prove Axiom \ref{axiom 3.2}.
By Axiom \ref{axiom 3.8}, there exist a set \(\emptyset\) such that \(\{x: x \notin \emptyset\}\).

Next we prove Axiom \ref{axiom 3.3}.
For singleton sets, if \(a\) is an object, then by Axiom \ref{axiom 3.8} there exist a set \(\{x: x = a\}\).
For pair sets, if \(a\) and \(b\) are objects, then by Axiom \ref{axiom 3.8} there exist a set \(\{x: x = a \text{ or } x = b\}\).

Next we prove Axiom \ref{axiom 3.4}.
By Axiom \ref{axiom 3.8}, there exist sets \(A\), \(B\) and \(\{x : x \in A \text{ or } x \in B\}\).

Next we prove Axiom \ref{axiom 3.5}.
By Axiom \ref{axiom 3.8}, there exist sets \(A\) and \(\{x \in A : P(x) \text{ is true}\}\).

Next we prove Axiom \ref{axiom 3.6}.
By Axiom \ref{axiom 3.8}, there exist sets \(A\) and \(\{y : P(x, y), x \in A\}\).

Finally, we prove Axiom \ref{axiom 3.7}.
By Axiom \ref{axiom 3.8}, there exists a set \(\mathds{N}\), as well as an object \(0\) in \(\mathds{N}\), and an object \(n++\) assigned to every object \(n \in \mathds{N}\), such that the Peano axioms holds.
\end{proof}
...
By Axiom \ref{axiom 3.3}, there exist a set \(\{A\}\) and \(A \in \{A\}\) is true.
Then \(A \in A \cap \{A\}\) is true, but by Axiom \ref{axiom 3.9}, the only element \(A\) in \(\{A\}\) must be disjoint from \(\{A\}\), which mean \(A \cap \{A\} = \emptyset\), a contradiction.
...
Then \(A \in A \cup B\) and \(B \in A \cup B\), which means \(A \cup B \in A \cup B\), contradict to Axiom \ref{axiom 3.9}.
Thus \(B \notin A\).
...
Show (assuming the other axioms of set theory) that the universal specification axiom, Axiom \ref{axiom 3.8}, is equivalent to an axiom postulating the existence of a \say{universal set} \(\Omega\) consisting of all objects (i.e., for all objects \(x\), we have \(x \in \Omega\)).
In other words, if Axiom \ref{axiom 3.8} is true, then a universal set exists, and conversely, if a universal set exists, then Axiom \ref{axiom 3.8} is true.
(This may explain why Axiom \ref{axiom 3.8} is called the axiom of universal specification).
Note that if a universal set \(\Omega\) existed, then we would have \(\Omega \in \Omega\) by Axiom \ref{axiom 3.1}, contradicting Exercise \ref{exercise 3.2.2}.
Thus the axiom of foundation specifically rules out the axiom of universal specification.
\end{exercise}

\begin{proof}
If Axiom \ref{axiom 3.8} is true, then there exist a set \(\Omega = \{x: x \text{ is a object}\}\), and \(\Omega \in \Omega\).
Thus Axiom \ref{axiom 3.8} implies a universal set exist.
If a universal set \(\Omega\) exist, then for any set \(A = \{x: P(x)\}\), \(A \in \Omega\) is true.
Thus a universal set exist implies Axiom \ref{axiom 3.8} is true.
Since we prove both necessary and sufficient condition, we conclude that Axiom \ref{axiom 3.8} is logically equivalent to a universal set exist.
\end{proof}
...
\begin{definition}[Equality of functions]\label{definition 3.3.2}
...
\begin{lemma}[Composition is associative]\label{lemma 3.3.1}
...
\begin{definition}[One-to-one function]\label{definition 3.3.4}
...
\begin{definition}[Onto functions]\label{definition 3.3.5}
...
\begin{definition}[Bijective functions]\label{definition 3.3.6}
...
\begin{definition}[Images of sets]\label{definition 3.4.1}
...
\begin{definition}[Inverse images]\label{definition 3.4.2}
...
\begin{axiom}[Power set axiom]\label{axiom 3.10}
Let \(X\) and \(Y\) be sets.
...
\begin{proof}
By Axiom \ref{axiom 3.10}, there exists a set \(\{0, 1\}^X\) which consists of all the functions from \(X\) to \(\{0, 1\}\).
Also by Axiom \ref{axiom 3.6}, we can replace each \(f \in \{0, 1\}^X\) with \(f^{-1}(\{1\})\), i.e., there exists a set \(S = \{f^{-1}(\{1\}) : f \in \{0, 1\}^X\}\).
...
\begin{axiom}[Union]\label{axiom 3.11}
...
\begin{remark}
The axioms of set theory that we have introduced (Axioms \ref{axiom 3.1}-\ref{axiom 3.11}, excluding the dangerous Axiom \ref{axiom 3.8}) are known as the \emph{Zermelo-Fraenkel axioms of set theory}, after Ernest Zermelo (1871--1953) and Abraham Fraenkel (1891--1965).
...
By Axiom \ref{axiom 3.10}, exists a set \(y^{x}\) which is consist of functions with domain \(x\) and range \(y\).
By Axiom \ref{axiom 3.6} and Axiom \ref{axiom 3.11}, exists a set \(\bigcup_{x \in \hat{X} \land y \in \hat{Y}} \{f : f \in y^{x}\}\}\).
Thus the collection of all partial functions from \(X\) to \(Y\) is itself a set.
\end{proof}

\begin{exercise}\label{exercise 3.4.7}
Show that Axiom \ref{axiom 3.4} can be deduced from Axiom \ref{axiom 3.1}, Axiom \ref{axiom 3.3} and Axiom \ref{axiom 3.11}.
\end{exercise}

\begin{proof}
By Axiom \ref{axiom 3.1}, \(A\) is a set and \(B\) is a set.
And if \(x\) is a object, we can say \(x \in A\) or \(x \in B\).
By Axiom \ref{axiom 3.3}, there exists a set \(\{A, B\}\) whose only elements are \(A\) and \(B\).
By Axiom \ref{axiom 3.11}, \(x \in \bigcup \{A, B\} \iff x \in A \lor x \in B\).
...
\begin{definition}[Ordered pair]\label{definition 3.5.1}
...
\begin{definition}[Cartesian product]\label{definition 3.5.2}
...
\begin{definition}[Ordered \(n\)-tuple and \(n\)-fold Cartesian product]\label{definition 3.5.3}
...
\begin{lemma}[Finite choice]\label{lemma 3.5.1}
...
When \(n = 1\) the claim follows from Lemma \ref{lemma 3.1.3}.
...
Also, since \(X_{n++}\) is non-empty, by Lemma \ref{lemma 3.1.3} we may find an object \(a\) such that \(a \in X_{n++}\).
...
By Axiom \ref{axiom 3.3}, \(\{x\}\) is a set for all \(x \in X\), and \(\{x, y\}\) is also a set for all \(x \in X\) and for all \(y \in Y\).
Again by Axiom \ref{axiom 3.3}, \(\{\{x\}, \{x, y\}\}\) is a set for all \(x \in X\) and for all \(y \in Y\).
By Axiom \ref{axiom 3.6}, \(\{\{\{x\}, \{x, y\}\} : x \in X \land y \in Y\}\) is a set.
...
But \(x' \in \{x, \{x, y\}\} \implies x \in x'\), we get both \((x \in x') \land (x' \in x)\), contradict to Axiom \ref{axiom 3.9} and Exercise \ref{exercise 3.2.2}.
So \(x = x'\) must be true.
Now we need to show that \(y = y'\).
\(\{x, y\} \in \{x', \{x', y'\}\} \implies \{x, y\} = \{x', y'\}\) (because \(\{x, y\} = x' \implies x \in x' = x\), contradict to Axiom \ref{axiom 3.9}) and Exercise \ref{exercise 3.2.2}.
...
Next we prove that \(X \times Y\) is a set with the given ordered pair definition.
By Axiom \ref{axiom 3.3}, \(\{x, y\}\) is a set for all \(x \in X\) and for all \(y \in Y\).
Again by Axiom \ref{axiom 3.3}, \(\{x, \{x, y\}\}\) is a set for all \(x \in X\) and for all \(y \in Y\).
By Axiom \ref{axiom 3.6}, \(\{\{x, \{x, y\}\} : x \in X \land y \in Y\}\) is a set.
So \(X \times Y = \{(x, y) : x \in X \land y \in Y\}\) is a set with the given ordered pair definition.
\end{proof}
...
If \((X_i)_{1 \leq i \leq n}\) are an ordered \(n\)-tuple of sets, by Axiom \ref{axiom 3.10}, we can consider a set of all functions \(i \mapsto x_i\) from the domain \(\{1 \leq i \leq n\}\) to the range \(\bigcup_{1 \leq i \leq n} X_i\).
...
Then by Axiom \ref{axiom 3.5}, there exist a set \(\{f \in P \mid (f = i \mapsto x_i) \land (x_i \in X_i) \ \forall\ 1 \leq i \leq n\}\).
...
\begin{exercise}\label{exercise 3.5.10}
...
Show that Axiom \ref{axiom 3.10} can in fact be deduced from Lemma \ref{lemma 3.4.1} and the other axioms of set theory, and thus Lemma \ref{lemma 3.4.1} can be used as an alternate formulation of the power set axiom.
\end{exercise}
...
By Axiom \ref{axiom 3.5}, there exists a set \(B = \{b \mid (b \in A) \land (\forall\ (x, y), (x, y') \in b, (x \in X) \land ((x, y) = (x, y') \implies y = y'))\}\).
By Exercise \ref{exercise 3.5.10}, \(\forall\ G \in B\), there is exactly one \(f : X \to Y\) whose graph is equal to \(G\).
Then by Axiom \ref{axiom 3.6}, there exist a set \(X^Y = \{f : X \to Y \mid (G \in B) \land (\text{graph of } f = G)\}\).
\end{proof}

\begin{exercise}\label{exercise 3.5.12}
...
We prove the claim by using induction on \(N\).
For \(N = 0\), by Axiom \ref{axiom 3.3} there exists a set \(\{0\}\), and let \(A_0 = \{0\}\).
Also by Axiom \ref{axiom 3.7} and \ref{axiom 3.5}, there exists a set \(\mathds{N}\), and there also exists a set \(B_0 = \{n \in \mathds{N} \mid n \neq 0\}\).
...
\begin{proof}
To be added.
% Let \(f : \mathds{N} \times \mathds{N}' \to \mathds{N}'\) and \(a : \mathds{N} \to \mathds{N}'\) be functions such that \(a(0) = 0'\) and \(a(n++) = f(n, a(n)) = a(n)++' = n'++'\).
% By Exercise \ref{exercise 3.5.12}, such \(a\) exists and is unique.
% Because \(a(0) = 0'\) and \((a(n) = n' \iff a(n++) = n'++')\), so \(\forall\ n' \in \mathds{N}'\), there exists a \(n\) such that \(a(n) = n'\), or equivalently, \(a\) is surjective.
% Let \(n_1'\), \(n_2' \in \mathds{N}'\) such that \(n_1' = n_2'\).
% Because \(a\) is surjective, so \(\exists\ n_1, n_2 \in \mathds{N}\) such that \(a(n_1) = n_1'\) and \(a(n_2) = n_2'\).
% Suppose for sake of contradiction that \(n_1 \neq n_2\), so \(n_1++ \neq n_2++\).
% Then \(a(n_1++) = n_1'++' = n_2'++' = a(n_2++)\)
\end{proof}

\section{Cardinality of sets}

\begin{definition}[Equal cardinality]\label{definition 3.6.1}
...
\begin{proposition}[Uniqueness of cardinality]\label{proposition 3.6.2}
...
\begin{definition}[Finite sets]\label{definition 3.6.3}
...
\begin{proposition}[Cardinal arithmetic]\label{proposition 3.6.3}
\leavevmode
\begin{enumerate}
    ...
    \item Let \(X\) and \(Y\) be finite sets.
    Then the set \(Y^X\) (defined in Axiom \ref{axiom 3.10}) is finite and \(\#(Y^X) = \#(Y)^{\#(X)}\).
\end{enumerate}
\end{proposition}
...
\begin{exercise}\label{exercise 3.6.3}
Let \(A\) and \(B\) be sets.
...
By Axiom \ref{axiom 3.10}, \((A^B)^C = \{f \mid f : C \to A^B\}\), \(A^B = \{f \mid f : B \to A\}\) and \(A^{B \times C} = \{f \mid f : B \times C \to A\}\).
...
\begin{exercise}\label{exercise 3.6.5}
Let \(A\) and \(B\) be sets.
...
\begin{exercise}\label{exercise 3.6.7}
