...
\begin{proof}{(g)}
  ...
  \begin{align*}
    ...
    \implies & \overline{\int}_J F \leq \overline{\int}_I f &  & \text{(by \cref{i:11.3.2} and \(f_U\) is arbitrary)} \\
  ...
  \begin{align*}
    ...
    \implies & \underline{\int}_J F \geq \underline{\int}_I f &  & \text{(by \cref{i:11.3.2} and \(f_L\) is arbitrary)} \\
...
\begin{thm}ducts preserve Riemann integrability]\label{i:11.4.5}
  Let \(I\) be a bounded interval.
