...
\begin{proof}
  ...
  \begin{align*}
    \int_{[0, N]} f & = \sum_{n = 0}^{N - 1} \int_{[n, n + 1)} f|_{[n, n + 1)} + \int_{[N, N]} f|_{[N, N]} &                                          & \by{ex:11.4.3} \\
                    ...
                    & \leq \sum_{n = 0}^{N - 1} \int_{[n, n + 1)} f(n)                                     &                                          & \by{11.4.1}[e] \\
  ...
  \begin{align*}
    \int_{[0, N]} f & = \sum_{n = 0}^{N - 1} \int_{[n, n + 1)} f|_{[n, n + 1)} + \int_{[N, N]} f|_{[N, N]} &  & \by{ex:11.4.3} \\
                    & = \sum_{n = 0}^{N - 1} \int_{[n, n + 1)} f|_{[n, n + 1)}                             &  & \by{11.1.8}    \\
                    & \geq \sum_{n = 0}^{N - 1} \int_{[n, n + 1)} f(n + 1)                                 &  & \by{11.4.1}[e] \\
                    & = \sum_{n = 0}^{N - 1} f(n + 1) \abs{n + 1 - n}                                      &  & \by{11.2.9}    \\
                    & = \sum_{n = 0}^{N - 1} f(n + 1)                                                                          \\
                    & = \sum_{n = 1}^N f(n).                                                               &  & \by{7.1.4}[b]
  \end{align*}
...
\begin{proof}
  ...
  Since \(\int_{[1, N]} f = \dfrac{1}{1 - p} (N^{1 - p} - 1)\) and \(\set{N^{1 - p} : N \in \R^+}\) is unbounded, we know that \(\sup_{N > 1} \int_{[1, N]} f = +\infty\) and by \cref{11.6.4} \(\sum_{n = 1}^\infty \dfrac{1}{n^p}\) is divergent.
...
\begin{proof}
  ...
  \begin{align*}
    \sum_{J \in \mathbf{P}} \int_I F_J & = \sum_{J \in \mathbf{P}} \int_J f|_J &  & \by{11.4.1}[g] \\
