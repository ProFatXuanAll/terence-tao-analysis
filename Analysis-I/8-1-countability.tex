...
\begin{proof}
    ...
    Now we show that if \(I\) is countable, then \(\bigcup_{\alpha \in I} A_{\alpha}\) is at most countable.
    Since \(\forall\ \alpha \in I\), \(A_{\alpha}\) is at most countable, \(A_{\alpha}\) can be either finite and countable.
    We now only consider the case where all \(A_{\alpha}\) are countable and disjoint.
    We will deal with other cases latter.

    Since \(\forall\ \alpha \in I\), \(A_{\alpha}\) is countable, \(\exists\ f_{\alpha} : \mathbf{N} \to A_{\alpha}\) such that \(f_{\alpha}\) is bijective.
    We now use Axiom \ref{3.3} to define singleton sets \(\{f_{\alpha}\} \ \forall\ \alpha \in I\).
    By Axiom \ref{8.1}, we have \(\prod_{\alpha \in I} \{f_{\alpha}\}\) is a set and \(\prod_{\alpha \in I} \{f_{\alpha}\} \neq \emptyset\).
    This means \(\forall\ \alpha \in I\), we can choose a function \((f_{\alpha})_{\alpha \in I}\) from \(\prod_{\alpha \in I} \{f_{\alpha}\}\).
    We fix such function \((f_{\alpha})_{\alpha \in I}\).

    Since \(I\) is countable, \(\exists\ g : \mathbf{N} \to I\) such that \(g\) is bijective.
    We now define another function \(h : \mathbf{N} \times \mathbf{N} \to \bigcup_{\alpha \in I} A_{\alpha}\) as follow:
    \[
        \forall\ (n, m) \in \mathbf{N} \times \mathbf{N} : h(n, m) = f_{g(n)}(m).
    \]
    We show that such function \(h\) is bijective.
    We start by showing \(h\) is injective.
    \begin{align*}
                 & \forall\ (n, m), (n', m') \in \mathbf{N} \times \mathbf{N} : h(n, m) = h(n, m')                                         \\
        \implies & f_{g(n)}(m) = f_{g(n')}(m')                                                                                             \\
        \implies & g(n) = g(n') \land m = m'                                                       & (A_{g(n)} \cap A_{g(n')} = \emptyset) \\
        \implies & n = n' \land m = m'                                                             & \text{(\(g\) is bijective)}           \\
        \implies & (n, m) = (n, m').                                                               & \text{(by Definition \ref{3.5.1})}
    \end{align*}
    Thus \(h\) is injective.
    Now we show that \(h\) is surjective.
    \(\forall\ x \in \bigcup_{\alpha \in I} A_{\alpha}\), we have \(\exists!\ \beta \in I\) such that \(x \in A_{\beta}\).
    This is true since we have all \(A_{\alpha}\) are disjoint.
    Since \(f_{\beta}\) is bijective, \(\exists\ m \in \mathbf{N}\) such that \(f_{\beta}(m) = x\).
    ...
    Since \(h\) is both injective and surjective, we have \(h\) is bijective.
    Since \(h\) is bijective, by Definition \ref{3.6.1} \(\mathbf{N} \times \mathbf{N}\) and \(\bigcup_{\alpha \in I} A_{\alpha}\) have the same cardinality.
    Then by Corollary \ref{8.1.13} \(\bigcup_{\alpha \in I} A_{\alpha}\) is countable.

    We now remove the condition \(\forall\ \alpha \in I\), \(A_{\alpha}\) are countable and disjoint.
    We define \(A_{g(n)}'\) recursive by setting \(A_{g(n)}' = A_{g(n)} \setminus \bigcup_{1 \leq i \leq n - 1} A_{g(i)}\).
    We need to show that
    \[
        \bigcup_{\alpha \in I} A_{\alpha}' = \bigcup_{n \in \mathbf{N}} A_{g(n)}' = \bigcup_{n \in \mathbf{N}} A_{g(n)} = \bigcup_{\alpha \in I} A_{\alpha}.
    \]
    We have \(\bigcup_{\alpha \in I} A_{\alpha}' = \bigcup_{n \in \mathbf{N}} A_{g(n)}'\) and \(\bigcup_{\alpha \in I} A_{\alpha} = \bigcup_{n \in \mathbf{N}} A_{g(n)}\) are true.
    It is suffice to show that \(\bigcup_{\alpha \in I} A_{\alpha}' = \bigcup_{\alpha \in I} A_{\alpha}\).
    \begin{enumerate}
        \item \(\forall\ x \in \bigcup_{\alpha \in I} A_{\alpha}'\), \(\exists\ \beta \in I\) such that \(x \in A_{\beta}'\).
              By the definition of \(A_{\beta}'\), we have \(x \in A_{\beta}\), thus \(x \in \bigcup_{\alpha \in I} A_{\alpha}\).
        \item \(\forall\ x \in \bigcup_{\alpha \in I} A_{\alpha}\), \(\exists\ \beta \in I\) such that \(x \in A_{\beta}\).
              By Axiom \ref{3.6} we can define a set \(S = \{n \in \mathbf{N} : x \in A_{g(n)}\}\).
              Since \(S \subseteq \mathbf{N}\), by well ordering principle (Proposition \ref{8.1.4}) \(\exists\ n \in \mathbf{N}\) such that \(n = \min(S)\).
              Then we must have \(x \in \bigcup_{n \in \mathbf{N}} A_{g(n)}'\) since \(\nexists\ i < n\) such that \(x \in A_{g(i)}'\).
    \end{enumerate}
    Thus by Definition \ref{3.1.4} we have \(\bigcup_{\alpha \in I} A_{\alpha}' = \bigcup_{\alpha \in I} A_{\alpha}\) and both are countable, and by Definition \ref{8.1.1}, at most countable.
\end{proof}
