...
\begin{proof}
    ...
    Then we define \(A_{n + 1} = A_n \cup \{x\}\), and this close the induction.
...
\begin{proof}
    ...
    Then by Proposition \ref{8.1.10} and Corollary \ref{8.1.7} we know that \(\bigcup_{\alpha \in I} A_{\alpha}\) is at most countable.
    This close the induction.
