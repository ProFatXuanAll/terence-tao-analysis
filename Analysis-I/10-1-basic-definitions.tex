...
\begin{exercise}\label{ex 10.1.5}
    ...
    Show that \(f\) is differentiable on \(\mathbf{R}\) and \(f'(x) = n x^{n - 1}\) for all \(x \in \mathbf{R}\).
\end{exercise}

\begin{exercise}\label{ex 10.1.6}
    Let \(n\) be a negative integer, and let \(f : \mathbf{R} \setminus \{0\} \to \mathbf{R}\) be the function \(f(x) \coloneqq x^n\).
    Show that \(f\) is differentiable on \(\mathbf{R}\) and \(f'(x) = n x^{n - 1}\) for all \(x \in \mathbf{R} \setminus \{0\}\).
\end{exercise}
