...
\begin{proof}{(h)}
  \begin{align*}
      & (\frac{f}{g})'(x_0)                                                                               \\
    = & (f \cdot \frac{1}{g})'(x_0)                                       & \text{(by \cref{9.2.1})}      \\
    = & f'(x_0) \frac{1}{g}(x_0) + f(x_0) (\frac{1}{g})'(x_0)             & \text{(by \cref{10.1.13}(d))} \\
    = & \frac{f'(x_0)}{g(x_0)} + f(x_0) (\frac{1}{g})'(x_0)               & \text{(by \cref{9.2.1})}      \\
    = & \frac{f'(x_0)}{g(x_0)} + f(x_0) \frac{-g'(x_0)}{g(x_0)^2}         & \text{(by \cref{10.1.13}(g))} \\
...
\begin{thm}in rule]\label{10.1.15}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & \begin{cases}
                 \abs{f(x) - y_0} \leq \delta_g                                        & \text{(by \cref{9.4.7}(d))} \\
                 \abs{f(x) - y_0 - f'(x_0) (x - x_0)} \leq \varepsilon_g \abs{x - x_0} & \text{(by \cref{10.1.7})}
               \end{cases} \\
    \implies & \begin{cases}
...
\begin{proof}
  ...
  \begin{align*}
    f'(x) & = \big(1 / (1 / f)\big)'(x)                                                   \\
          & = -\frac{(1 / f)'(x)}{\big((1 / f)(x)\big)^2} & \text{(by \cref{10.1.13}(g))} \\
          & = -\frac{(-n) x^{-n - 1}}{x^{-2n}}            & \text{(by \cref{ex:10.1.5})}  \\
          & = n x^{n - 1}.
  \end{align*}
\end{proof}
