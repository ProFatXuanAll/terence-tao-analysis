...
\begin{proof}{(c)}
    ...
    \]
    Similarly, since \(g\) is differentiable at \(x_0\), by Definition \ref{10.1.1} we have
    \[
        \lim_{x \to x_0 ; x \in X \setminus \{x_0\}} \frac{g(x) - g(x_0)}{x - x_0} = g'(x_0).
    \]
    Then we have
    \begin{align*}
         & f'(x_0) + g'(x_0)                                                                                                                                                                                \\
         & = \lim_{x \to x_0 ; x \in X \setminus \{x_0\}} \frac{f(x) - f(x_0)}{x - x_0} + \lim_{x \to x_0 ; x \in X \setminus \{x_0\}} \frac{g(x) - g(x_0)}{x - x_0}                                        \\
         & = \lim_{x \to x_0 ; x \in X \setminus \{x_0\}} \frac{f(x) - f(x_0)}{x - x_0} + \frac{g(x) - g(x_0)}{x - x_0}                                              & \text{(by Proposition \ref{9.3.14})} \\
         ...
         & = (f + g)'(x_0).                                                                                                                                          & \text{(by Definition \ref{10.1.1})}
    \end{align*}
