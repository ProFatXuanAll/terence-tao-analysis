...
\begin{note}
  \labelcrefs{ii:4.7.1} were discovered by Leonhard Euler (1707--1783) in 1748, who recognized the link between the complex exponential and the trigonometric functions.
...
\begin{ac}\label{ii:ac:4.7.1}
  From \labelcrefs{ii:4.6.15}, we have
  \[
  ...
  From \labelcrefs{ii:ex:4.2.8} we thus see that the sine and cosine functions are real analytic on all of \(\R\).
  (They are also complex analytic on all of \(\C\), but we will not pursue this matter in this text.)
  In particular, the sine and cosine functions are continuous and differentiable (see \labelcrefs{ii:4.2.6}).
\end{ac}

\begin{thm}[Trigonometric identities]\label{ii:4.7.2}
  Let \(x, y\) be real numbers.
  \begin{enumerate}
    \item\label{ii:4.7.2.a} We have \(\big(\sin(x)\big)^2 + \big(\cos(x)\big)^2 = 1\).
    In particular, we have \(\sin(x) \in [-1, 1]\) and \(\cos(x) \in [-1, 1]\) for all \(x \in \R\).
    \item\label{ii:4.7.2.b} We have \(\sin'(x) = \cos(x)\) and \(\cos'(x) = -\sin(x)\).
    \item\label{ii:4.7.2.c} We have \(\sin(-x) = -\sin(x)\) and \(\cos(-x) = \cos(x)\).
    \item\label{ii:4.7.2.d} We have \(\cos(x + y) = \cos(x) \cos(y) - \sin(x) \sin(y)\) and \(\sin(x + y) = \sin(x) \cos(y) + \cos(x) \sin(y)\).
    \item\label{ii:4.7.2.e} We have \(\sin(0) = 0\) and \(\cos(0) = 1\).
    \item\label{ii:4.7.2.f} We have \(e^{i x} = \cos(x) + i \sin(x)\) and \(e^{- i x} = \cos(x) - i \sin(x)\).
    In particular, \(\cos(x) = \Re(e^{i x})\) and \(\sin(x) = \Im(e^{i x})\).
  \end{enumerate}
\end{thm}

\begin{proof}[\pf{ii:4.7.2.a}]
  Let \(x \in \R\).
  Then we have
  \begin{align*}
     ...
     & = 1.                                                                                                                                               &  & \by{ii:4.5.2.d}
  \end{align*}
  By \labelcrefs{ii:ac:4.7.1} we know that \(\sin(x), \cos(x) \in \R\) when \(x \in \R\).
  Thus, we have
  \begin{align*}
             & \begin{dcases}
...
\begin{proof}[\pf{ii:4.7.2.b}]
  Let \(x \in \R\).
  By \labelcrefs{ii:ac:4.7.1} we know that \(\sin'\) and \(\cos'\) are well-defined.
  Then we have
  \begin{align*}
     & \sin'(x)                                                                                                                                          \\
...
\begin{proof}[\pf{ii:4.7.2.f}]
  ...
  \begin{align*}
     ...
     & = e^{- i x}.                                                         &  & \by{ii:4.6.4}
  \end{align*}
  By \labelcrefs{ii:4.7.2.a} we know that \(\sin(x), \cos(x) \in \R\).
  Thus, we have
  \[
...
\begin{proof}
  ...
  Observe that this would also imply that \(\cos(x) \neq 0\) for all \(x \in (0, \infty)\), since if \(\cos(x) = 0\) then \(\sin(2x) = 0\) by \labelcrefs{ii:4.7.2.d}.
  Since \(\cos(0) = 1\), this implies by the intermediate value theorem (Theorem 9.7.1 in Analysis I) that \(\cos(x) > 0\) for all \(x > 0\)
  (since by \labelcrefs{ii:ac:4.7.1} we know that \(\cos\) is continuous on \(\R\) and by \labelcrefs{ii:4.7.2.a} this means \(\cos(x) \in (0, 1]\)).
  ...
  From the quotient rule (Theorem 10.1.13(h) in Analysis I) and \labelcrefs{ii:4.7.2} we see that the derivative of \(\cot(x)\) is
  \begin{align*}
...
\begin{ac}\label{ii:ac:4.7.2}
  ...
  \begin{enumerate}
    \item\label{ii:ac:4.7.2.a} \(\pi\) is well-defined.
    \item\label{ii:ac:4.7.2.b} \(\pi > 0\).
    \item\label{ii:ac:4.7.2.c} \(\sin(\pi) = 0\).
    \item\label{ii:ac:4.7.2.d} \(\sin(x) > 0\) for all \(x \in (0, \pi)\).
    \item\label{ii:ac:4.7.2.e} \(\cos\) is strictly decreasing on \((0, \pi)\).
    \item\label{ii:ac:4.7.2.f} \(\cos(\pi) = -1\).
    \item\label{ii:ac:4.7.2.g} \(e^{\pi i} = \cos(\pi) + i \sin(\pi) = -1\).
  \end{enumerate}
\end{ac}

\begin{proof}
  Let \(E\) be the set \(E \coloneqq \set{x \in (0, +\infty) : \sin(x) = 0}\), i.e., \(E\) is the set of roots of \(\sin\) on \((0, +\infty)\).
  By \labelcrefs{ii:4.7.3}, \(E\) is non-empty.
  Since \(\sin'(0) > 0\), there exists a \(c > 0\) such that \(E \subseteq [c, +\infty)\) (see \labelcrefs{ii:ex:4.7.2}).
  Also, since \(\sin\) is continuous in \([c, +\infty)\), \(E\) is closed in \([c, +\infty)\)
  (since \(\sin(E) = \set{0} = [0, 0]\) is closed in \((\R, d_{l^1}|_{\R \times \R})\), by \labelcrefs{ii:2.1.5.d} we know that \(E = \sin^{-1}(\set{0})\) is closed in \((\R, d_{l^1}|_{\R \times \R})\)).
  ...
  By \labelcrefs{ii:4.7.4}, \(\sin\) cannot have any zeroes in \((0, \pi)\), and so, in particular, must be positive on \((0, \pi)\)
  (cf. the arguments in \labelcrefs{ii:4.7.3} using the intermediate value theorem).
  ...
  Thus, we conclude by \labelcrefs{ii:4.7.2.f} that \(e^{i \pi} = \cos(\pi) + i \sin(\pi) = -1\).
\end{proof}

\begin{thm}[Periodicity of trigonometric functions]\label{ii:4.7.5}
  Let \(x\) be a real number.
  \begin{enumerate}
    \item\label{ii:4.7.5.a} We have \(\cos(x + \pi) = -\cos(x)\) and \(\sin(x + \pi) = -\sin(x)\).
    In particular, we have \(\cos(x + 2\pi) = \cos(x)\) and \(\sin(x + 2\pi) = \sin(x)\), i.e., \(\sin\) and \(\cos\) are periodic with period \(2\pi\).
    \item\label{ii:4.7.5.b} We have \(\sin(x) = 0\) iff \(x / \pi\) is an integer.
    \item\label{ii:4.7.5.c} We have \(\cos(x) = 0\) iff \(x / \pi\) is an integer plus \(1 / 2\).
  \end{enumerate}
\end{thm}

\begin{proof}[\pf{ii:4.7.5.a}]
  We have
  \begin{align*}
    \cos(x + \pi) & = \cos(x) \cos(\pi) - \sin(x) \sin(\pi) &  & \by{ii:4.7.2.d}                  \\
                  & = \cos(x) (-1) - \sin(x) 0              &  & \by{ii:ac:4.7.2.b,ii:ac:4.7.2.f} \\
                  & = -\cos(x)
  \end{align*}
  and
  \begin{align*}
    \sin(x + \pi) & = \sin(x) \cos(\pi) + \cos(x) \sin(\pi) &  & \by{ii:4.7.2.d}                  \\
                  & = \sin(x) (-1) - \cos(x) 0              &  & \by{ii:ac:4.7.2.b,ii:ac:4.7.2.f} \\
                  & = -\sin(x).
  \end{align*}
  Thus
  \begin{align*}
...
\begin{proof}[\pf{ii:4.7.5.b}]
  ...
  \begin{align*}
             & n + 1 = \dfrac{x}{\pi}                                          \\
    \implies & x = n \pi + \pi                                                 \\
    \implies & \sin(x) = \sin(n \pi + \pi) = -\sin(n \pi) &  & \by{ii:4.7.5.a} \\
  ...
  \begin{itemize}
    \item \(x = 0\).
          By \labelcrefs{ii:ac:4.7.2.b} we know that \(\pi > 0\), thus we know that \(\dfrac{0}{\pi} = 0 \in \N\) and by \labelcrefs{ii:4.7.2.e} we have \(\sin(0) = 0\).
    \item \(x \in \R^+\).
          ...
          \end{align*}
          Fix such \(n\).
          By \labelcrefs{ii:ac:4.7.2.d} we know that \(\sin(y) > 0\) for all \(y \in (0, \pi)\).
...
\begin{proof}[\pf{ii:4.7.5.c}]
  By \labelcrefs{ii:ac:4.7.2.d} we know that \(\sin(\dfrac{\pi}{2}) > 0\).
  Since
  \begin{align*}
...
\begin{ex}\label{ii:ex:4.7.1}
  Prove \labelcrefs{ii:4.7.2}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:4.7.2}.
\end{proof}
...
\begin{proof}
  ...
  By \labelcrefs{ii:4.7.2.b,ii:4.7.2.e} we know that \(\sin'(0) = \cos(0) = 1\), thus we conclude that
  \[
...
\begin{ex}\label{ii:ex:4.7.3}
  Prove \labelcrefs{ii:4.7.5}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:4.7.5}.
\end{proof}
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item \(x \in (0, 1]\).
          ...
          \end{align*}
          Since \(\sin(\dfrac{\pi}{2}) = 1\) (cf. the proof of \labelcrefs{ii:4.7.5.c}) and \(\sin\) is continuous on \(\R\) (by \labelcrefs{ii:ac:4.7.1}), by intermediate value theorem we know that
          \begin{align*}
          ...
          \end{align*}
          Since \(\cos(0) = 1\) (by \labelcrefs{ii:4.7.2.e}) and \(\cos(\dfrac{\pi}{2}) = 0\) (cf. the proof of \labelcrefs{ii:4.7.5.c}), we know that
          \begin{align*}
...
\begin{proof}
  By \labelcrefs{ii:ac:4.7.2.g} we know that
  \begin{align*}
  ...
  \begin{align*}
    \sin(\theta - \alpha) & = \sin(\theta) \cos(-\alpha) + \cos(\theta) \sin(-\alpha) &  & \by{ii:4.7.2.d}               \\
                          ...
                          & = 0.
  \end{align*}
  By \labelcrefs{ii:4.7.5.b} we know that
  \begin{align*}
         & \sin(\theta - \alpha) = 0                           \\
  ...
  \end{align*}
  By \labelcrefs{ii:4.7.5} we know that for any \(\alpha \in \R\), \(\cos(\alpha + k \pi) = \cos(\alpha)\) when \(k\) is even.
  ...
  But by \labelcrefs{ii:4.7.5.c} we know that
  \begin{align*}
...
\begin{ex}\label{ii:ex:4.7.6}
  ...
  Using \labelcrefs{ii:ex:4.7.4}, show that there is exactly one pair of real numbers \(r, \theta\) such that \(r > 0\), \(\theta \in (-\pi, \pi]\), and \(z = r e^{i \theta}\).
...
\begin{proof}
  By \labelcrefs{ii:4.7.2.a} we know that \(\big(\cos(\theta)\big)^2 + \big(\sin(\theta)\big)^2 = 1\), thus we cannot have \(\cos(\theta) = 0\) and \(\sin(\theta) = 0\) at the same time.
  By \labelcrefs{ii:4.6.12} this means \(\big(\cos(\theta) + i \sin(\theta)\big)^{-1}\) is well-defined and
  \[
...
\begin{proof}
  By \labelcrefs{ii:4.7.5.c} we know that \(\cos(-\dfrac{\pi}{2}) = \cos(\dfrac{\pi}{2}) = 0\) and \(\cos(x) \neq 0\) for all \(x \in (-\dfrac{\pi}{2}, \dfrac{\pi}{2})\).
  Thus, \(\tan(x)\) is well-defined on \((-\dfrac{\pi}{2}, \dfrac{\pi}{2})\).
  By \labelcrefs{ii:ac:4.7.1} we know that \(\sin\) and \(\cos\) are differentiable on \(\R\), thus by Theorem 10.1.13(h) in Analysis I we know that \(\tan\) is differentiable on \((-\dfrac{\pi}{2}, \dfrac{\pi}{2})\).
  ...
  Since \(\sin(\dfrac{\pi}{2}) = 1\) (cf. the proof of \labelcrefs{ii:4.7.5.c}), by \labelcrefs{ii:4.7.2.b} we know that \(\sin(-\dfrac{\pi}{2}) = -1\).
  ...
  \end{align*}
  But this contradicts the fact that \(\lim_{x \to \dfrac{\pi}{2}} \dfrac{1}{\cos(x)} = +\infty\).
  Thus, we know that
  \[
...
\begin{ex}\label{ii:ex:4.7.9}
  Recall the arctangent function \(\tan^{-1}\) from \labelcrefs{ii:ex:4.7.8}.
  By modifying the proof of \labelcrefs{ii:4.5.6.e}, establish the identity
  \[
    \tan^{-1}(x) = \sum_{n = 0}^\infty \dfrac{(-1)^n x^{2n + 1}}{2n + 1}
  \]
  for all \(x \in (-1, 1)\).
  Using Abel's theorem (\labelcrefs{ii:4.3.1}) to extend this identity to the case \(x = 1\), conclude in particular the identity
  \[
...
\begin{proof}
  By \labelcrefs{ii:ex:4.7.9}, we know that \(\tan^{-1}(x)\) is well-defined for all \(x \in \R\), in particular, \(\tan(x)\) is well-defined for all \(x \in (-1, 1)\).
  First, suppose that \(x = 0\).
  By \labelcrefs{ii:ex:4.7.9}, we know that \(\tan\) is bijective from \((-\dfrac{\pi}{2}, \dfrac{\pi}{2})\).
  Thus, we have
  \begin{align*}
  ...
  \begin{align*}
     ...
     & = \int_{0}^x \bigg(\sum_{n = 0}^\infty \big((-1)^n y^{2n}\big)\bigg) \; dy &                    & \by{ii:4.1.6.c,ii:4.1.6.e}                  \\
  ...
  \end{align*}
  are convergent.
  Thus, by Abel's theorem (\labelcrefs{ii:4.3.1}) we know that
  \[
...
\begin{ex}\label{ii:ex:4.7.10}
  ...
  \]
  \begin{enumerate}
    \item\label{ii:ex:4.7.10.a} Show that this series is uniformly convergent, and that \(f\) is continuous.
    \item\label{ii:ex:4.7.10.b} Show that for every integer \(j\) and every integer \(m \geq 1\), we have
    \[
      \abs{f\bigg(\dfrac{j + 1}{32^m}\bigg) - f\bigg(\dfrac{j}{32^m}\bigg)} \geq 4^{-m}.
    \]
    \item\label{ii:ex:4.7.10.c} Using (b), show that for every real number \(x_0\), the function \(f\) is not differentiable at \(x_0\).
    \item\label{ii:ex:4.7.10.d} Explain briefly why the result in (c) does not contradict \labelcrefs{ii:3.7.3}.
  \end{enumerate}
\end{ex}

\begin{proof}[\pf{ii:ex:4.7.10.a}]
  Since
  \begin{align*}
  ...
  \end{align*}
  By Weierstrass \(M\)-test (\labelcrefs{ii:3.5.7}) we know that \(\sum_{n = 1}^\infty \big(4^{-n} \cos(32^n \pi x)\big)\) converges uniformly to \(f\) on \(\R\) with respect to \(d_{l^1}|_{\R \times \R}\).
\end{proof}

\begin{proof}[\pf{ii:ex:4.7.10.b}]
  First, we show that
  \[
    \forall x, y \in \R, \abs{\cos(x) - \cos(y)} \leq \abs{x - y}.
  \]
  Fix one pair of \(x, y\) and without the loss of generality suppose that \(y \leq x\).
  By \labelcrefs{ii:4.7.2.a,ii:4.7.2.b} we know that \(\sin\) is continuous and bounded on \([y, x]\), thus by Corollary 11.5.2 in Analysis I we know that \(\sin\) is Riemann integrable on \([y, x]\).
  Then we have
  \begin{align*}
...
\begin{proof}[\pf{ii:ex:4.7.10.c}]
  ...
  \end{align*}
  But this contradicts the fact that \(8^m > \abs{f'(x_0)} + 1\).
  Thus, such \(x_0\) does not exist and \(f\) is not differentiable on \(\R\).
\end{proof}

\begin{proof}[\pf{ii:ex:4.7.10.d}]
  Let \(f_n(x) = 4^{-n} \cos(32^n \pi x)\) for all \(n \in \Z^+\).
  By \labelcrefs{ii:4.7.2.b} we know that \(f_n\) is differentiable on \(\R\) and by chain rule we have
  \[
  ...
  \end{align*}
  the condition in \labelcrefs{ii:3.7.3} is not satisfied.
  Thus, this does not contradict to \labelcrefs{ii:3.7.3}.
\end{proof}
