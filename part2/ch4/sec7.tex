...
\begin{proof}
  ...
  By \cref{ii:4.7.2.b,ii:4.7.2.e} we know that \(\sin'(0) = \cos(0) = 1\), thus we conclude that
  \[
...
\begin{ex}\label{ii:ex:4.7.10}
  ...
  \begin{enumerate}
    ...
    \item\label{ii:ex:4.7.10.d} Explain briefly why the result in (c) does not contradict \cref{ii:3.7.3}.
  \end{enumerate}
\end{ex}
...
\begin{proof}[\pf{ii:ex:4.7.10.b}]
  ...
  By \cref{ii:4.7.2.a,ii:4.7.2.b} we know that \(\sin\) is continuous and bounded on \([y, x]\), thus by Corollary 11.5.2 in Analysis I we know that \(\sin\) is Riemann integrable on \([y, x]\).
  Then we have
  \begin{align*}
