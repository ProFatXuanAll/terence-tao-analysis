...
\begin{proof}[\pf{ii:4.5.2.f}]
  By \cref{ii:4.5.2.b,ii:4.5.2.e} we know that
  \[
...
\begin{proof}
  ...
  \end{align*}
  Since \((x_n, y_n)_{n = 1}^\infty\) was arbitrary, by \cref{ii:2.1.4.a,ii:2.1.4.b} we conclude that \(f\) is continuous at \((x, y)\) from \((\R^+ \times \R, d)\) to \((\R, d_{l^1}|_{\R \times \R})\).
