...
\begin{thm}[Basic properties of exponential]\label{ii:4.5.2}
  \quad
  \begin{enumerate}
    \item\label{ii:4.5.2.a} For every real number \(x\), the series \(\sum_{n = 0}^\infty \dfrac{x^n}{n!}\) is absolutely convergent.
    ...
    \item\label{ii:4.5.2.b} \(\exp\) is differentiable on \(R\), and for every \(x \in \R\), \(\exp'(x) = \exp(x)\).
    \item\label{ii:4.5.2.c} \(\exp\) is continuous on \(R\), and for every interval \([a, b]\), we have \(\int_{[a, b]} \exp(x) \; dx = \exp(b) - \exp(a)\).
    \item\label{ii:4.5.2.d} For every \(x, y \in \R\), we have \(\exp(x + y) = \exp(x) \exp(y)\).
    \item\label{ii:4.5.2.e} We have \(\exp(0) = 1\).
    Also, for every \(x \in \R\), \(\exp(x)\) is positive, and \(\exp(-x) = 1 / \exp(x)\).
    \item\label{ii:4.5.2.f} \(\exp\) is strictly monotone increasing:
    in other words, if \(x, y\) are real numbers, then we have \(\exp(y) > \exp(x)\) iff \(y > x\).
  \end{enumerate}
\end{thm}

\begin{proof}[\pf{ii:4.5.2.a}]
  If \(x = 0\), then we have
  \[
  ...
  \[
    ...
    \end{dcases}
  \]
  and by \labelcrefs{ii:4.2.1} \(\exp\) is real analytic on \((-\infty, \infty)\).
\end{proof}

\begin{proof}[\pf{ii:4.5.2.b}]
  By \labelcrefs{ii:4.5.2.a} we know that \(\exp\) is real analytic on \(\R\), thus by \labelcrefs{ii:4.1.6.d} we know that \(\exp\) is differentiable on \(\R\) and
  \[
    \forall x \in \R, \exp'(x) = \sum_{n = 1}^\infty n \dfrac{x^{n - 1}}{n!} = \sum_{n = 1}^\infty \dfrac{x^{n - 1}}{(n - 1)!} = \sum_{n = 0}^\infty \dfrac{x^n}{n!} = \exp(x).
  \]
\end{proof}

\begin{proof}[\pf{ii:4.5.2.c}]
  By \labelcrefs{ii:4.5.2.a} we know that \(\exp\) is real analytic on \(\R\), thus by \labelcrefs{ii:4.1.6.c} we know that \(\exp\) is continuous on \(\R\).
  Let \(a, b \in \R\) such that \(a \leq b\).
  Then by \labelcrefs{ii:4.5.2.a} we know that \(\exp(a)\) and \(\exp(b)\) are well-defined.
  Since \([a, b] \subseteq \R\), by \labelcrefs{ii:4.1.6.e} we know that \(\exp\) is Riemann integrable on \([a, b]\) and
  \begin{align*}
...
\begin{proof}[\pf{ii:4.5.2.d}]
  ...
  By \labelcrefs{ii:4.5.2.a} we know that \(\sum_{n = 0}^\infty \dfrac{x^n}{n!}\) and \(\sum_{n = 0}^\infty \dfrac{y^n}{n!}\) are absolutely convergent.
  Thus, we know that
  \begin{align*}
...
\begin{proof}[\pf{ii:4.5.2.f}]
  By \labelcrefs{ii:4.5.2.b,ii:4.5.2.e} we know that
  \[
...
\begin{note}
  In light of \labelcrefs{ii:4.5.3} we can and will use \(e^x\) and \(\exp(x)\) interchangeably.
\end{note}
...
\begin{thm}[Logarithm properties]\label{ii:4.5.6}
  \quad
  \begin{enumerate}
    \item\label{ii:4.5.6.a} For every \(x \in (0, \infty)\), we have \(\ln'(x) = \dfrac{1}{x}\).
    ...
    \item\label{ii:4.5.6.b} We have \(\ln(xy) = \ln(x) + \ln(y)\) for all \(x, y \in (0, \infty)\).
    \item\label{ii:4.5.6.c} We have \(\ln(1) = 0\) and \(\ln(1 / x) = -\ln(x)\) for all \(x \in (0, \infty)\).
    \item\label{ii:4.5.6.d} For any \(x \in (0, \infty)\) and \(y \in R\), we have \(\ln(x^y) = y \ln(x)\).
    \item\label{ii:4.5.6.e} For any \(x \in (-1, 1)\), we have
    \[
...
\begin{proof}[\pf{ii:4.5.6.d}]
  Let \(x \in (0, \infty)\).
  We know that \(x^y \in (0, \infty)\) for all \(y \in \R\), thus by \labelcrefs{ii:4.5.5} \(\ln(x^y)\) is well-defined and we have
  \begin{align*}
...
\begin{proof}[\pf{ii:4.5.6.e}]
  Since
  \[
    x \in (-1, 1) \iff 1 - x \in (0, 2),
  \]
  by \labelcrefs{ii:4.5.5} we know that \(\ln(1 - x)\) is well-defined.
  Observe that
  \begin{align*}
  ...
  \end{align*}
  By \labelcrefs{ii:4.2.1} \(\ln\) is real analytic at \(1\) with radius of convergence \(1\).
\end{proof}

\begin{eg}\label{ii:4.5.7}
  We now give a modest application of Abel's theorem (\labelcrefs{ii:4.3.1}):
...
\begin{proof}
  ...
  Then by \labelcrefs{ii:4.5.2.e} we have \(e^x > 0 > x\).
...
\begin{ex}\label{ii:ex:4.5.1}
  Prove \labelcrefs{ii:4.5.2}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:4.5.2}.
\end{proof}
...
\begin{proof}
  ...
  \]
  So suppose for the sake of contradiction that there exists some \(n \geq 3\) such that the identity above holds.
  Then we have
  \begin{align*}
  ...
  Suppose for the sake of contradiction that \(e \in \Q\).
...
\begin{ex}\label{ii:ex:4.5.3}
  Prove \labelcrefs{ii:4.5.4}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:4.5.4}.
\end{proof}
...
\begin{proof}
  ...
  Suppose for the sake of contradiction that \(f\) is real analytic at \(0\).
  Then by \labelcrefs{ii:4.2.10} there exists an \(r \in \R^*\) such that
  \[
...
\begin{ex}\label{ii:ex:4.5.5}
  Prove \labelcrefs{ii:4.5.6}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:4.5.6}.
\end{proof}
...
\begin{proof}
  Let \(a \in \R^+\).
  By \labelcrefs{ii:4.5.6.e} we know that \(\ln\) is real analytic at \(1\), thus
  \begin{align*}
    ...
    \implies & \forall x \in (0, 2a), \ln(x) - \ln(a) = \sum_{n = 1}^\infty \dfrac{(-1)^{n + 1}}{n} \bigg(\dfrac{x}{a} - 1\bigg)^n   &  & \by{ii:4.5.6.b,ii:4.5.6.c} \\
...
\begin{proof}
  By \labelcrefs{ii:3.8.1} we know that
  \[
  ...
  Let \(b = \ceil{a} + 1 \in \Z^+\).
  By \labelcrefs{ii:ex:4.5.8} we have
  \begin{align*}
...
\begin{proof}
  ...
  \]
  By Proposition 9.8.3 in Analysis I and \labelcrefs{ii:4.5.5} we know that \(\ln\) is continuous on \(\R^+\).
  Thus, we have
  \begin{align*}
             & \lim_{n \to \infty} \ln(x_n) = \ln(x)                                    &  & \by{ii:2.1.4.a,ii:2.1.4.b} \\
  ...
  \end{align*}
  Since \((x_n, y_n)_{n = 1}^\infty\) was arbitrary, by \labelcrefs{ii:2.1.4.a,ii:2.1.4.b} we conclude that \(f\) is continuous at \((x, y)\) from \((\R^+ \times \R, d)\) to \((\R, d_{l^1}|_{\R \times \R})\).
