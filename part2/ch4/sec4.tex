...
\begin{proof}
  ...
  By \labelcrefs{ii:4.1.6}, we see that both \(f\) and \(g\) have radii of convergence at least \(r\).
...
\begin{rmk}\label{ii:4.4.2}
  ...
  it is closely related (though not identical) to the notion of convolution introduced in \labelcrefs{ii:3.8.9}.
\end{rmk}
