...
\begin{ac}\label{ii:ac:4.6.1}
  \labelcrefs{ii:4.6.2} is reflexive, symmetry and transitive.
\end{ac}

\begin{proof}
  Let \((a_1, b_1), (a_2, b_2), (a_3, b_3)\) be complex numbers.
  By \labelcrefs{ii:4.6.2} we know that \(a_1, a_2, a_3, b_1, b_2, b_3 \in \R\).
  Since
  \begin{align*}
             & (a_1 = a_1) \land (b_1 = b_1) & (a_1, b_1 \in \R)                 \\
    \implies & (a_1, b_1) = (a_1, b_1),      &                   & \by{ii:4.6.2}
  \end{align*}
  we know that \labelcrefs{ii:4.6.2} is reflexive.
  Since
  \begin{align*}
         & (a_1, b_1) = (a_2, b_2)                                                     \\
  ...
  \end{align*}
  we know that \labelcrefs{ii:4.6.2} is symmetry.
  Since
  \begin{align*}
  ...
  \end{align*}
  we know that \labelcrefs{ii:4.6.2} is transitive.
\end{proof}
...
\begin{proof}
  ...
  By \labelcrefs{ii:4.6.2} we know that \(a, a', b, b', c, c', d, d' \in \R\).
  By \labelcrefs{ii:ac:4.6.1} we know that
  \begin{align*}
    a & = a'; \\
    b & = b'; \\
    c & = c'; \\
...
\begin{proof}
  ...
  By \labelcrefs{ii:4.6.2} we know that \(a, b, c, d, e, f \in \R\).
  Since
  \begin{align*}
    z_1 + z_2 & = (a + c, b + d) &                     & \by{ii:4.6.3} \\
              ...
              & = z_2 + z_1,     &                     & \by{ii:4.6.3}
  \end{align*}
  we know that the addition operation in \labelcrefs{ii:4.6.3} is commutative.
  Since
  \begin{align*}
  ...
  \end{align*}
  we know that the addition operation in \labelcrefs{ii:4.6.3} is associative.
  Since
  \begin{align*}
...
\begin{proof}
  ...
  \begin{align*}
    z_1 z_2 & = (ac - bd, ad + bc) &                     & \by{ii:4.6.5} \\
            ...
            & = z_2 z_1,           &                     & \by{ii:4.6.5}
  \end{align*}
  we know that the multiplication operation in \labelcrefs{ii:4.6.5} is commutative.
  Since
  \begin{align*}
     & (z_1 z_2) z_3                                                                                                \\
  ...
  \end{align*}
  we know that the multiplication operation in \labelcrefs{ii:4.6.5} is associative.
  Since
  \begin{align*}
  ...
  \end{align*}
  we know that the multiplication operation in \labelcrefs{ii:4.6.5} and the addition operation in \labelcrefs{ii:4.6.3} are distributive.
\end{proof}

\begin{note}
  \labelcrefs{ii:4.6.6} can also be stated more succinctly, as the assertion that \(\C\) is a commutative ring.
...
\begin{note}
  Because \labelcrefs{ii:4.6.7}, we will now refer to complex numbers in the more usual notation \(a + bi\), and discard the formal notation \((a, b)\) henceforth.
\end{note}
...
\begin{proof}
  ...
  By \labelcrefs{ii:4.6.7} we know that \(a = a'\) and \(b = b'\).
  Thus, by \labelcrefs{ii:4.6.8} we have
  \begin{align*}
     & \Re(z) = a = a' = \Re(z')                         \\
     & \Im(z) = b = b' = \Im(z')                         \\
...
\begin{note}
  From Exercise 5.6.3 in Analysis I we see that \labelcrefs{ii:4.6.10} generalizes the notion of real absolute value.
\end{note}
...
\begin{defn}[Complex reciprocal]\label{ii:4.6.12}
  ...
  (note that \(\abs{z}^{-2}\) is well-defined as a positive real number because \(\abs{z}\) is positive real, thanks to \labelcrefs{ii:4.6.11}).
...
\begin{note}
  From the \labelcrefs{ii:4.6.12} and \labelcrefs{ii:4.6.11}, we see that
  \[
...
\begin{proof}
  ...
  Combine all proofs above we conclude by \labelcrefs{ii:1.1.2} that \((\C, d)\) is a metric space.
...
\begin{proof}
  ...
  \begin{align*}
     ...
     & = \lim_{n \to \infty} \Im(z_n - w_n).                                                    &  & \by{ii:4.6.3}          \\
  \end{align*}
  Thus, by \labelcrefs{ii:4.6.13} we have
  \begin{align*}
         & \begin{dcases}
  ...
  By \labelcrefs{ii:4.6.5} we know that
  \[
  ...
  \end{align*}
  by \labelcrefs{ii:4.6.13} we have
  \begin{align*}
         & \begin{dcases}
  ...
  By \labelcrefs{ii:4.6.8} we know that
  \begin{align*}
...
\begin{note}
  ...
  For instance, the theory of pointwise and uniform convergence from \labelcrefs{ii:ch:3}, or the theory of power series from this chapter, extends without any difficulty to complex-valued functions.
...
\begin{ac}[Complex series]\label{ii:ac:4.6.6}
  Let \(d\) be the metric in \labelcrefs{ii:4.6.10} and let \((a_n)_{n = 0}^\infty\) be a sequence in \(\C\).
...
\begin{proof}
  By \labelcrefs{ii:ac:4.6.6} we have
  \[
    \sum_{n = 0}^\infty a_n = \sum_{n = 0}^\infty \Re(a_n) + i \bigg(\sum_{n = 0}^\infty \Im(a_n)\bigg).
  \]
  By \labelcrefs{ii:4.6.8} we know that \(\sum_{n = 0}^\infty \Re(a_n) \in \R\) and \(\sum_{n = 0}^\infty \Im(a_n) \in \R\).
...
\begin{proof}
  By \labelcrefs{ii:4.6.10} we know that \(\abs{a_n} \in \R\) for all \(n \in \N\), thus \(\sum_{n = 0}^\infty \abs{a_n}\) is well-defined.
  Let \(N_1, N_2 \in \N\).
  Since
  \[
  ...
  By \labelcrefs{ii:ex:4.6.10} we know that \((\C, d)\) is complete, thus \(\sum_{n = 0}^\infty a_n\) converges in \(\C\) with respect to \(d\).
\end{proof}
...
\begin{proof}
  ...
  By \labelcrefs{ii:ac:4.6.8} we know that \(A, B\) are well-defined.
  ...
  \end{align*}
  By \labelcrefs{ii:ac:4.6.6} we know that \(d - \lim_{N \to \infty} (B_N - B) = 0\).
  Thus, if we define
  \[
  ...
  \end{align*}
  By \labelcrefs{ii:ac:4.6.6} we want to show that
  \[
  ...
  \]
  Fix such \(M_1\).
  Since \(\sum_{n = 0}^\infty a_n \in \C\), by \labelcrefs{ii:ac:4.6.7} we know that \(d - \lim_{N \to \infty} a_N = 0\).
  Thus, we have
  \[
...
\begin{note}
  Inspired by \labelcrefs{ii:4.5.4}, we shall use \(\exp(z)\) and \(e^z\) interchangeably.
...
\begin{ex}\label{ii:ex:4.6.1}
  Prove \labelcrefs{ii:4.6.4}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:4.6.4}.
\end{proof}

\begin{ex}\label{ii:ex:4.6.2}
  Prove \labelcrefs{ii:4.6.6}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:4.6.6}.
\end{proof}

\begin{ex}\label{ii:ex:4.6.3}
  Prove \labelcrefs{ii:4.6.7}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:4.6.7}.
\end{proof}

\begin{ex}\label{ii:ex:4.6.4}
  Prove \labelcrefs{ii:4.6.9}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:4.6.9}.
\end{proof}
...
\begin{ex}\label{ii:ex:4.6.6}
  Prove \labelcrefs{ii:4.6.11}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:4.6.11}.
\end{proof}
...
\begin{ex}\label{ii:ex:4.6.9}
  Prove \labelcrefs{ii:4.6.13}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:4.6.13}.
\end{proof}
...
\begin{proof}
  ...
  By \labelcrefs{ii:1.4.10} we know that there is a Cauchy sequence \((a_n)_{n = 1}^\infty\) in \((\C, d)\) which does not converge.
  Let \(x \in \C\).
  Then we have
  \[
  ...
  Fix such \(\varepsilon\).
  Let \(i, j \in \Z^+\).
  Since \((a_n)_{n = 1}^\infty\) is a Cauchy sequence in \((\C, d)\), by \labelcrefs{ii:1.4.6} we know that
  \[
...
\begin{proof}
  ...
  Let \(x \in \C\).
  Then by \labelcrefs{ii:4.6.2} we know that there exist some \(a, b \in \R\) such that \(x = a + bi\).
  ...
  Let \((a, b) \in \R^2\).
  Let \(d_2 = d_{l^1}|_{\R^2 \times \R^2}\) and let \(d\) be the metric defined in \labelcrefs{ii:4.6.10}.
  We want to show that \(f\) is continuous at \((a, b)\) from \((\R^2, d_2)\) to \((\C, d)\).
  By \labelcrefs{ii:2.1.1} we need to show that
  \[
...
\begin{proof}
  ...
  By \labelcrefs{ii:ex:2.4.7} we want to show that for every \(x, y \in \C\), there exists a continuous function \(\gamma : [0, 1] \to \C\) such that \(\gamma(0) = x\) and \(\gamma(1) = y\).
  So let \(x, y \in \C\).
  ...
  Let \(f : \R^2 \to \C\) be the function in \labelcrefs{ii:ex:4.6.11}.
  Then we have
  \[
    \forall z \in [0, 1], \gamma(z) = f\big((1 - z) \Re(x) + z \Re(y), (1 - z) \Im(x) + z \Im(y)\big).
  \]
  By \labelcrefs{ii:ex:4.6.11} we know that \(f\) is continuous on \(\R^2\) from \((\R^2, d_{l^1}|_{\R^2 \times \R^2})\) to \((\C, d)\).
  Thus, by \labelcrefs{ii:2.1.3} we know that \(\gamma\) is continuous on \([0, 1]\) from \(([0, 1], d_1)\) to \((\C, d)\).
  Since \(x, y\) were arbitrary, by \labelcrefs{ii:ex:2.4.7} we know that \((\C, d)\) is path-connected, and we conclude that \((\C, d)\) is connected.
\end{proof}
...
\begin{proof}
  Let \(d\) be the metric defined in \labelcrefs{ii:4.6.10}.
  By \labelcrefs{ii:1.5.6} we know that \((E, d|_{E \times E})\) is compact implies \((E, d|_{E \times E})\) is closed and bounded.
  ...
  Let \(d_2 = d_{l^1}|_{\R^2 \times \R^2}\) and let \(f : \R^2 \to \C\) be the function defined in \labelcrefs{ii:ex:4.6.11}.
  Then we know that \(f^{-1}\) is well-defined and both \(f, f^{-1}\) are continuous.
  Since \((E, d|_{E \times E})\) is closed, by \labelcrefs{ii:2.1.5.a,ii:2.1.5.d} we know that \(\big(f^{-1}(E), d_2|_{f^{-1}(E) \times f^{-1}(E)}\big)\) is closed.
  ...
  Since \(\big(f^{-1}(E), d_2|_{f^{-1}(E) \times f^{-1}(E)}\big)\) is closed and bounded, by \labelcrefs{ii:1.5.7} we know that \(\big(f^{-1}(E), d_2|_{f^{-1}(E) \times f^{-1}(E)}\big)\) is compact.
  Since \(E = f\big(f^{-1}(E)\big)\), by \labelcrefs{ii:2.3.1} we know that \((E, d|_{E \times E})\) is compact.
...
\begin{ex}\label{ii:ex:4.6.14}
  Prove \labelcrefs{ii:4.6.14}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:4.6.14}.
\end{proof}
...
\begin{proof}
  ...
  \begin{itemize}
    \item \(\limsup_{n \to \infty} \dfrac{\abs{b_{n + 1}}}{\abs{b_n}} < 1\).
          ...
          \]
          By \labelcrefs{ii:ac:4.6.8} we know that \(\sum_{n = 0}^\infty \abs{a_n} \in \R\) implies \(\sum_{n = 0}^\infty a_n \in \C\).
    \item \(\liminf_{n \to \infty} \dfrac{\abs{b_{n + 1}}}{\abs{b_n}} > 1\).
          ...
          \end{align*}
          by \labelcrefs{ii:ac:4.6.7} we know that \(\sum_{n = 0}^\infty a_n\) is divergent.
  ...
  Next we show that \labelcrefs{ii:4.6.15} is absolutely convergent.
  Let \(z \in \C\).
  Suppose that \(z = 0\).
  Then we have
  \begin{align*}
  ...
  Now suppose that \(z \neq 0\).
  By \labelcrefs{ii:4.6.10} we know that \(\abs{z} \in \R\).
  Since
  \begin{align*}
