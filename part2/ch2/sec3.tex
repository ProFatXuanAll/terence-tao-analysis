...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & \forall \alpha \in I, f|_K^{-1}(V_\alpha) \text{ is open in } (K, d_X|_{K \times K})                                         &  & \by{ii:2.1.5.a,ii:2.1.5.d} \\
  ...
  Since \(I\) was arbitrary open cover of \(f(K)\) in \((Y, d_Y)\), by \labelcrefs{ii:ex:1.5.11} we know that \(\big(f(K), d_Y|_{Y \times Y}\big)\) is compact.
\end{proof}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & \begin{dcases}
               ...
               \end{dcases}
  \end{align*}
  Since \(f(X)\) is closed in \((\R, d_{l^1}|_{\R \times \R})\) and \((u_n)_{n = 1}^\infty\), \((l_n)_{n = 1}^\infty\) are convergent sequences in \(\R\) with respect to \(d_{l^1}|_{\R \times \R}\), by \labelcrefs{ii:1.2.15.b} we know that \(U, L \in f(X)\).
...
\begin{rmk}\label{ii:2.3.3}
  ...
  \labelcrefs{ii:2.3.2} should be compared with Lemma 9.6.3 in Analysis I and Proposition 9.6.7 in Analysis I.
\end{rmk}
...
\begin{proof}
  If \(f\) is uniformly continuous then it is also continuous by \labelcrefs{ii:ex:2.3.3}.
  ...
  Hence, by \labelcrefs{ii:1.5.8}, there exist a finite number of points \(x_1, \dots, x_n\) such that the balls \(B_{(X, d_X)}\big(x_j, \delta(x_j) / 2\big)\) for \(j = 1, \dots, n\) cover \(X\):
  \[
...
\begin{ex}\label{ii:ex:2.3.1}
  Prove \labelcrefs{ii:2.3.1}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:2.3.1}.
\end{proof}

\begin{ex}\label{ii:ex:2.3.2}
  Prove \labelcrefs{ii:2.3.2}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:2.3.2}.
\end{proof}
...
\begin{proof}
  Since \(f\) is uniformly continuous from \((X, d_X)\) to \((Y, d_Y)\) and \(g\) is uniformly continuous from \((Y, d_Y)\) to \((Z, d_Z)\), by \labelcrefs{ii:2.3.4} we have
  \begin{align*}
             & \begin{dcases}
  ...
  \end{align*}
  Thus, by \labelcrefs{ii:2.3.4} \(g \circ f\) is uniformly continuous from \((X, d_X)\) to \((Z, d_Z)\).
\end{proof}
...
\begin{proof}
  ...
  Since \(f, g\) are uniformly continuous from \((X, d_X)\) to \((\R, d_1)\), by \labelcrefs{ii:2.3.4} we have
  \begin{align*}
             & \forall \varepsilon \in \R^+, \exists \delta \in \R^+ :                                                                                            \\
             & \begin{dcases}
  ...
  \end{align*}
  Thus, by \labelcrefs{ii:2.3.4} \(f \oplus g\) is uniformly continuous from \((X, d_X)\) to \((\R^2, d_2)\).
\end{proof}
...
\begin{proof}
  ...
  \begin{align*}
     ...
     & d_2\big((x_1, y_1), (x_2, y_2)\big) < \delta \implies \begin{dcases}
                                                             ...
                                                             \end{dcases}
  \end{align*}
  and thus by \labelcrefs{ii:2.3.4} \((x, y) \mapsto x + y\) and \((x, y) \mapsto x - y\) are uniformly continuous from \((\R^2, d_2)\) to \((\R, d_1)\).
  ...
  Thus, by \labelcrefs{ii:2.3.4} \((x, y) \mapsto xy\) is not uniformly continuous from \((\R^2, d_2)\) to \((\R, d_1)\).
  ...
  \begin{align*}
     ...
     & \implies \begin{dcases}
                ...
                \end{dcases}
  \end{align*}
  and thus by \labelcrefs{ii:2.3.4} \((x, y) \mapsto \max(x, y)\) and \((x, y) \mapsto \min(x, y)\) are uniformly continuous from \((\R^2, d_2)\) to \((\R, d_1)\).
  ...
  \]
  and by \labelcrefs{ii:2.3.4} \(f\) is uniformly continuous from \((X, d)\) to \((\R, d_1)\).
  Suppose that \(c \neq 0\).
  Since \(f\) is uniformly continuous from \((X, d)\) to \((\R, d_1)\), by \labelcrefs{ii:2.3.4} we have
  \begin{align*}
             & \forall \varepsilon \in \R^+, \exists \delta \in \R^+:                                                                     \\
  ...
  \end{align*}
  and thus by \labelcrefs{ii:2.3.4} \(cf\) is uniformly continuous from \((X, d)\) to \((\R, d_1)\).
\end{proof}
