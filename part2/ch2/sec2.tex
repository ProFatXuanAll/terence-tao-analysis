...
\begin{lem}\label{ii:2.2.1}
  ...
  \begin{enumerate}
    \item\label{ii:2.2.1.a} If \(x_0 \in X\), then \(f\) and \(g\) are both continuous at \(x_0\) iff \(f \oplus g\) is continuous at \(x_0\).
    \item\label{ii:2.2.1.b} \(f\) and \(g\) are both continuous iff \(f \oplus g\) is continuous.
  \end{enumerate}
\end{lem}

\begin{proof}[\pf{ii:2.2.1.a}]
  ...
  \begin{align*}
    ...
    \iff & \text{every sequence } (x^{(n)})_{n = 1}^\infty \text{ in } X \text{ satisfies the following:}                                                          \\
         ...
         & \begin{dcases}
           ...
           \end{dcases}                                          &  & \by{ii:2.1.4.a,ii:2.1.4.b}                                                                   \\
    \iff & \text{every sequence } (x^{(n)})_{n = 1}^\infty \text{ in } X \text{ satisfies the following:}                                                          \\
         & \lim_{n \to \infty} d\big(x^{(n)}, x_0\big) = 0 \text{ implies }                                                                                        \\
    ...
    \iff & f \oplus g \text{ is continuous at } x_0                                                                                                                \\
         & \text{from } (X, d) \text{ to } (\R^2, d_{l^2}|_{\R^2 \times \R^2}).                                                    &  & \by{ii:2.1.4.a,ii:2.1.4.b}
  \end{align*}
\end{proof}

\begin{proof}[\pf{ii:2.2.1.b}]
  Let \((X, d)\) be a metric space.
  Then we have
  \begin{align*}
...
\begin{ac}\label{ii:ac:2.2.1}
  ...
  Let \(f : X \to \R\) and \(g : X \to \R\) be functions, and let \(f \oplus g : X \to \R^2\) be their direct sum.
  \begin{enumerate}
    \item\label{ii:ac:2.2.1.a} If \(x_0 \in X\), then \(f\) and \(g\) are both continuous at \(x_0\) from \((X, d)\) to \((\R, d_{\R})\) iff \(f \oplus g\) is continuous at \(x_0\) from \((X, d)\) to \((\R^2, d_{\R^2})\).
    \item\label{ii:ac:2.2.1.b} \(f\) and \(g\) are both continuous from \((X, d)\) to \((\R, d_{\R})\) iff \(f \oplus g\) is continuous from \((X, d)\) to \((\R^2, d_{\R^2})\).
  \end{enumerate}
\end{ac}

\begin{proof}
  By \labelcrefs{ii:1.1.18} and \labelcrefs{ii:2.2.1} we are done.
\end{proof}

\begin{lem}\label{ii:2.2.2}
  \begin{enumerate}
    \item\label{ii:2.2.2.a} The addition function \((x, y) \mapsto x + y\), the subtraction function \((x, y) \mapsto x - y\), the multiplication function \((x, y) \mapsto xy\), the maximum function \((x, y) \mapsto \max(x, y)\), and the minimum function \((x, y) \mapsto \min(x, y)\), are all continuous functions from \(\R^2\) to \(\R\).
    \item\label{ii:2.2.2.b} The division function \((x, y) \mapsto x / y\) is a continuous function from \(\R \times (\R \setminus \set{0}) = \set{(x, y) \in \R^2 : y \neq 0}\) to \(\R\).
    \item\label{ii:2.2.2.c} For any real number \(c\), the function \(x \mapsto cx\) is a continuous function from \(\R\) to \(\R\).
  \end{enumerate}
\end{lem}
...
\begin{proof}
  ...
  \end{align*}
  Since \((x^{(n)}, y^{(n)})_{n = 1}^\infty\) was arbitrary, by \labelcrefs{ii:2.1.4.a,ii:2.1.4.b} we know that the addition, subtraction, multiplication, maximum and minimum functions from \(\R^2\) to \(\R\) are continuous at \((x, y)\) from \((\R^2, d_{l^1}|_{\R^2 \times \R^2})\) to \((\R, d_{l^1}|_{\R \times \R})\).
  Since \((x, y)\) was arbitrary, by \labelcrefs{ii:2.1.5.a,ii:2.1.5.b} we know that the addition, subtraction, multiplication, maximum and minimum functions from \(\R^2\) to \(\R\) are continuous from \((\R^2, d_{l^1}|_{\R^2 \times \R^2})\) to \((\R, d_{l^1}|_{\R \times \R})\).
...
\begin{cor}\label{ii:2.2.3}
  ...
  \begin{enumerate}
    \item\label{ii:2.2.3.a} If \(x_0 \in X\) and \(f\) and \(g\) are continuous at \(x_0\), then the functions \(f + g : X \to \R\), \(f - g : X \to \R\), \(fg : X \to \R\), \(\max(f, g) : X \to \R\), \(\min(f, g) : X \to \R\), and \(cf : X \to \R\) (see Definition 9.2.1 in Analysis I for definitions) are also continuous at \(x_0\).
    If \(g(x) \neq 0\) for all \(x \in X\), then \(f / g : X \to \R\) is also continuous at \(x_0\).
    \item\label{ii:2.2.3.b} If \(f\) and \(g\) are continuous, then the functions \(f + g : X \to \R\), \(f - g : X \to \R\), \(fg : X \to \R\), \(\max(f, g) : X \to \R\), \(\min(f, g) : X \to \R\), and \(cf : X \to \R\) are also continuous.
    If \(g(x) \neq 0\) for all \(x \in X\), then \(f / g : X \to \R\) is also continuous.
  \end{enumerate}
\end{cor}

\begin{proof}
  We first prove (a). Since \(f, g\) are continuous at \(x_0\) from \((X, d)\) to \((\R, d_{l^1}|_{\R \times \R})\), then by \labelcrefs{ii:ac:2.2.1.a} \(f \oplus g : X \to \R^2\) is also continuous at \(x_0\) from \((X, d)\) to \((\R^2, d_{l^1}|_{\R^2 \times \R^2})\).
  On the other hand, from \labelcrefs{ii:2.2.2} the function \((x, y) \mapsto x + y\) is continuous from \((\R^2, d_{l^1}|_{\R^2 \times \R^2})\) to \((\R, d_{l^1}|_{\R \times \R})\), and in particular, is continuous at \(f \oplus g(x_0)\) from \((\R^2, d_{l^1}|_{\R^2 \times \R^2})\) to \((\R, d_{l^1}|_{\R \times \R})\).
  If we then compose these two functions using \labelcrefs{ii:2.1.7} we conclude that \(f + g : X \to \R\) is continuous from \((X, d)\) to \((\R, d_{l^1}|_{\R \times \R})\).
  A similar argument gives the continuity of \(f - g\), \(fg\), \(\max(f, g)\), \(\min(f, g)\) and \(cf\).
  To prove the claim for \(f / g\), we first use \labelcrefs{ii:ex:2.1.7} to restrict the codomain of \(g\) from \(\R\) to \(\R \setminus \set{0}\), and then one can argue as before.
...
\begin{ex}\label{ii:ex:2.2.1}
  Prove \labelcrefs{ii:2.2.1}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:2.2.1}.
\end{proof}

\begin{ex}\label{ii:ex:2.2.2}
  Prove \labelcrefs{ii:2.2.2}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:2.2.2}.
\end{proof}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & \abs{x - x'} < \varepsilon                                                 &  & \by{ii:1.1.2.a,ii:1.1.2.b}              \\
  ...
  \end{align*}
  Since \((x, y)\) was arbitrary, by \labelcrefs{ii:2.1.1} \(\pi_1\) is continuous from \((\R^2, d_{l^1}|_{\R^2 \times \R^2})\) to \((\R, d_{l^1}|_{\R \times \R})\).
  ...
  Thus, by \labelcrefs{ii:2.1.7.b} \(g_1, g_2\) are continuous from \((\R^2, d_{l^1}|_{\R^2 \times \R^2})\) to \((X, d)\).
\end{proof}
...
\begin{proof}
  ...
  Let \((x, y) \in \R^2\).
  Let \(\pi_1, \pi_2\) be the functions defined in \labelcrefs{ii:ex:2.2.4}.
  Since \(\pi_1\) is continuous from \((\R^2, d_{l^1}|_{\R^2 \times \R^2})\) to \((\R, d_{l^1}|_{\R \times \R})\), by \labelcrefs{ii:2.2.3.b} we know that
  \[
  ...
  Thus, by \labelcrefs{ii:2.2.3.b} we know that \(c_{ij} x^i y^j\) is continuous at \((x, y)\) from \((\R^2, d_{l^1}|_{\R^2 \times \R^2})\) to \((\R, d_{l^1}|_{\R \times \R})\) for every \(0 \leq i \leq n\) and \(0 \leq j \leq m\), and
  \[
    \sum_{i = 0}^n \sum_{j = 0}^m c_{ij} x^i y^j = P(x, y)
  \]
  is continuous at \((x, y)\) from \((\R^2, d_{l^1}|_{\R^2 \times \R^2})\) to \((\R, d_{l^1}|_{\R \times \R})\).
  Since \((x, y)\) was arbitrary, by \labelcrefs{ii:2.1.1} we know that \(P\) is continuous from \((\R^2, d_{l^1}|_{\R^2 \times \R^2})\) to \((\R, d_{l^1}|_{\R \times \R})\).
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \iff & f \oplus g \text{ is continuous at } x_0                                                                                                          \\
         & \text{from } (X, d) \text{ to } (\R^{m + n}, d_{m + n}).                                                          &  & \by{ii:2.1.4.a,ii:2.1.4.b}
  \end{align*}
...
\begin{proof}
  ...
  Thus, by \labelcrefs{ii:2.2.2.b} we know that
  \begin{align*}
...
\begin{ex}\label{ii:ex:2.2.8}
  ...
  \]
  Show that \((X \times Y, d_{X \times Y})\) is a metric space, and deduce an analogue of \labelcrefs{ii:1.1.18} and \labelcrefs{ii:2.2.1}.
\end{ex}
...
\begin{proof}
  ...
  \begin{align*}
    d_{X \times Y}\big((x, y), (x, y)\big) & = d_X(x, x) + d_Y(y, y)                      \\
                                           & = 0 + 0 = 0             &  & \by{ii:1.1.2.a}
  \end{align*}
  and thus \((X \times Y, d_{X \times Y})\) satisfies \labelcrefs{ii:1.1.2.a}.
  ...
  \end{align*}
  and thus \((X \times Y, d_{X \times Y})\) satisfies \labelcrefs{ii:1.1.2.b}.
  For any \((x_1, y_1), (x_2, y_2) \in X \times Y\), we have
  \begin{align*}
  ...
  \end{align*}
  and thus \((X \times Y, d_{X \times Y})\) satisfies \labelcrefs{ii:1.1.2.c}.
  ...
  \end{align*}
  and thus \((X \times Y, d_{X \times Y})\) satisfies \labelcrefs{ii:1.1.2.d}.
  By \labelcrefs{ii:1.1.2} we conclude that \((X \times Y, d_{X \times Y})\) is a metric space.

  Next we propose an analogue of \labelcrefs{ii:1.1.18} and proof it.
  ...
  Finally we propose an analogue of \labelcrefs{ii:2.2.1} and proof it.
  ...
  \end{itemize}
  The claim is true since by \labelcrefs{ii:2.1.1} we have
  \begin{align*}
         & \begin{dcases}
...
\begin{proof}
  ...
  Since \(f\) is continuous at \((x_0, y_0)\) from \((\R^2, d_2)\) to \((\R, d_1)\), by \labelcrefs{ii:2.1.1} we have
  \begin{align*}
...
\begin{proof}
  Let \(d_1 = d_{l^1}|_{\R \times \R}\) and let \(d_2 = d_{l^1}|_{\R^2 \times \R^2}\).
  Let \(x_0, y_0 \in \R\).
  Since \(f\) is continuous from \((\R^2, d_2)\) to \((\R, d_1)\), by \labelcrefs{ii:2.1.1} we know that \(f\) is continuous at \((x_0, y_0)\) from \((\R^2, d_2)\) to \((\R, d_1)\) and we have
  \begin{align*}
             & \forall \varepsilon \in \R^+, \exists \delta \in \R^+ : \forall (x, y) \in \R^2,                          \\
             & d_2\big((x, y), (x_0, y_0)\big) < \delta \text{ implies } d_1\big(f(x, y), f(x_0, y_0)\big) < \varepsilon \\
    \implies & \forall \varepsilon \in \R^+, \exists \delta \in \R^+ : \forall (x, y) \in \R^2,                          \\
...
\begin{ex}\label{ii:ex:2.2.11}
  ...
  This shows that the converse to \labelcrefs{ii:ex:2.2.10} fails;
...
\begin{proof}
  ...
  \]
  and thus by \labelcrefs{ii:2.2.2} \(y \mapsto f(0, y)\) is continuous from \((\R, d_{l^1}|_{\R \times \R})\) to \((\R, d_{l^1}|_{\R \times \R})\).
  By \labelcrefs{ii:2.2.2} and \labelcrefs{ii:ex:2.2.10} we also have
  \begin{align*}
             & \begin{dcases}
  ...
  \begin{align*}
    ...
    \implies & \lim_{n \to \infty} d_{l^1}|_{\R^2, \R^2}\big((\dfrac{1}{n}, \dfrac{1}{n}), (0, 0)\big) = 0 &  & \by{ii:1.1.18.b,ii:1.1.18.d}
  \end{align*}
  and
  \begin{align*}
  ...
  \end{align*}
  Thus, by \labelcrefs{ii:2.1.4.a,ii:2.1.4.b} \(f\) is not continuous at \((0, 0)\) from \((\R^2, d_{l^1}|_{\R^2 \times \R^2})\) to \((\R, d_{l^1}|_{\R \times \R})\).
\end{proof}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & \lim_{n \to \infty} d_{l^1}|_{\R^2 \times \R^2}\big((\dfrac{1}{n}, \dfrac{1}{n^2}), (0, 0)\big) = 0 &  & \by{ii:1.1.18.b,ii:1.1.18.d}
  \end{align*}
  and
  \begin{align*}
  ...
  \end{align*}
  by \labelcrefs{ii:2.1.4.a,ii:2.1.4.b} we know that \(f\) is not continuous at \((0, 0)\) from \((\R^2, d_{l^1}|_{\R^2 \times \R^2})\) to \((\R, d_{l^1}|_{\R \times \R})\).
\end{proof}
