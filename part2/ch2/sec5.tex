...
\begin{note}
  From \labelcrefs{ii:1.2.15} we see that every metric space \((X, d)\) is automatically also a topological space
...
\begin{eg}\label{ii:2.5.3}
  If \((X, d)\) is a metric space, \(x \in X\), and \(r > 0\), then \(B_{(X, d)}(x, r)\) is a neighbourhood of \(x\) (see \labelcrefs{ii:1.2.15.c}).
\end{eg}
...
\begin{note}
  \labelcrefs{ii:2.5.4} is consistent with that of convergence in metric spaces (\labelcrefs{ii:1.1.14}).
  One can then ask whether one has the basic property of uniqueness of limits (\labelcrefs{ii:1.1.20}).
...
\begin{note}
  \labelcrefs{ii:2.5.5} is consistent with the corresponding notion for metric spaces (\labelcrefs{ii:1.2.5}).
\end{note}
...
\begin{note}
  ...
  this is consistent with the metric space definition, thanks to \labelcrefs{ii:1.2.15.e}.
\end{note}
...
\begin{note}
  From \labelcrefs{ii:1.3.4} we see that \labelcrefs{ii:2.5.7} is compatible with the one for metric spaces.
\end{note}
...
\begin{note}
  \labelcrefs{ii:2.5.8} is consistent with that in \labelcrefs{ii:2.1.1}.
...
\begin{note}
  Many basic facts about compact metric spaces continue to hold true for compact topological spaces, notably \labelcrefs{ii:2.3.1} and \labelcrefs{ii:2.3.2}.
  However, there is no notion of uniform continuity, and so there is no analogue of \labelcrefs{ii:2.3.5}.
\end{note}

\begin{note}
  We can also define the notion of connectedness by repeating \labelcrefs{ii:2.4.1} verbatim, and also repeating \labelcrefs{ii:2.4.3} (but with \labelcrefs{ii:2.5.7} instead of \labelcrefs{ii:1.3.3}).
  Many of the results and exercises in \labelcrefs{ii:sec:2.4} continue to hold for topological spaces
...
\begin{proof}
  ...
  Since \(\emptyset, X \in \mathcal{F}\) and the claims above, by \labelcrefs{ii:2.5.1} we know that \((X, \mathcal{F})\) is a topology.
  ...
  Given arbitrary metric \(d\), by \labelcrefs{ii:1.1.2.b} we know that \(d(x, y) > \R^+\).
  But by \labelcrefs{ii:1.2.15.c} we know that \(B_{(X, d)}\big(x, \dfrac{d(x, y)}{2}\big)\) is open in \((X, d)\), thus by \labelcrefs{ii:2.5.1} we must have \(B_{(X, d)}\big(x, \dfrac{d(x, y)}{2}\big) \in \mathcal{F}\), which means \((X, \mathcal{F})\) is a not trivial topology.
  ...
  Thus, by \labelcrefs{ii:2.5.9} \((X, \mathcal{F})\) is compact.
  Since \(X\) is the only non-empty open set in \(\mathcal{F}\), by \labelcrefs{ii:2.4.3} we know that \((X, \mathcal{F})\) is connected.
\end{proof}

\begin{ex}\label{ii:ex:2.5.2}
  Let \((X, d)\) be a metric space
  (and hence a topological space).
  Show that the two notions of convergence of sequences in \labelcrefs{ii:1.1.14} and \labelcrefs{ii:2.5.4} coincide.
\end{ex}

\begin{proof}
  Let \(\mathcal{F}\) be the set of all open sets in \((X, d)\) and let \(N \in \N\).
  First, suppose that \((x^{(n)})_{n = m}^\infty\) converges to \(x\) in the sense of \labelcrefs{ii:1.1.14}.
  Let \(V \in \mathcal{F}\) be a neighbourhood of \(x\).
  By \labelcrefs{ii:2.5.2} we know that \(V\) is open in \((X, d)\).
  Since \(x \in V\), by \labelcrefs{ii:1.2.15.a} we know that
  \[
  ...
  \end{align*}
  Since \(V\) was arbitrary, we know that \((x^{(n)})_{n = m}^\infty\) converges to \(x\) in the sense of \labelcrefs{ii:2.5.4}.

  Now suppose that \((x^{(n)})_{n = m}^\infty\) converges to \(x\) in the sense of \labelcrefs{ii:2.5.4}.
  Then we have
  \begin{align*}
  ...
  \end{align*}
  Thus, \labelcrefs{ii:1.1.14} and \labelcrefs{ii:2.5.4} coincide.
\end{proof}

\begin{ex}\label{ii:ex:2.5.3}
  Let \((X, d)\) be a metric space (and hence a topological space).
  Show that the two notions of interior, exterior, and boundary in \labelcrefs{ii:1.2.5,ii:2.5.5} coincide.
\end{ex}

\begin{proof}
  Let \(\mathcal{F}\) be the set of all open sets in \((X, d)\), let \(E \subseteq X\) and let \(x_0 \in X\).
  First, suppose that \(x_0\) is an interior point of \(E\) in the sense of \labelcrefs{ii:1.2.5}.
  Then we have
  \begin{align*}
  ...
  Next suppose that \(x_0\) is an interior point of \(E\) in the sense of \labelcrefs{ii:2.5.5}.
  Then we have
  \begin{align*}
  ...
  Next suppose that \(x_0\) is an exterior point of \(E\) in the sense of \labelcrefs{ii:1.2.5}.
  Then we have
  \begin{align*}
  ...
  Next suppose that \(x_0\) is an exterior point of \(E\) in the sense of \labelcrefs{ii:2.5.5}.
  Then we have
  \begin{align*}
  ...
  Next suppose that \(x_0\) is an boundary point of \(E\) in the sense of \labelcrefs{ii:1.2.5}.
  Then we have
  \begin{align*}
  ...
  Finally suppose that \(x_0\) is an boundary point of \(E\) in the sense of \labelcrefs{ii:2.5.5}.
  Then we have
  \begin{align*}
  ...
  \end{align*}
  Thus, \labelcrefs{ii:1.2.5} and \labelcrefs{ii:2.5.5} coincide.
\end{proof}
...
\begin{ex}\label{ii:ex:2.5.4}
  ...
  Show that the analogue of \labelcrefs{ii:1.1.20} holds for Hausdorff topological spaces, but give an example of a non-Hausdorff topological space in which \labelcrefs{ii:1.1.20} fails.
...
\begin{proof}
  ...
  By \labelcrefs{ii:2.5.2} the only neighbourhood of \(x\) in \(\mathcal{F}\) is \(X\), similarly the only neighbourhood of \(y\) in \(\mathcal{F}\) is \(X\).
  ...
  Finally we give an non-Hausdorff topology space in which \labelcrefs{ii:1.1.20} fails.
  ...
  By \labelcrefs{ii:2.5.2} we know that the only neighbourhood of \(0\) in \(\mathcal{F}\) is \(X\).
...
\begin{ex}\label{ii:ex:2.5.5}
  ...
  Show that \((X, \mathcal{F})\) is a topology (this is the \emph{order topology} on the totally ordered set \((X, \leq)\)) which is Hausdorff in the sense of \labelcrefs{ii:ex:2.5.4}.
...
\begin{proof}
  ...
  Combine all the results above we know that \((X, \mathcal{F})\) is a topological space by \labelcrefs{ii:2.5.1}.
  ...
  Since \(x_1, x_2\) were arbitrary, by \labelcrefs{ii:ex:2.5.4} we know that \((X, \mathcal{F})\) is Hausdorff.
  ...
  Since \(x\) was arbitrary, by \labelcrefs{ii:1.2.15.a} we know that \(V\) is open in \((X, d_{l^1}|_{\R \times \R})\) and thus \(V \in \mathcal{F}_s\).
  ...
  Since \(\infty \notin \R\) and \(\R\) is open in \((\R^*, \mathcal{F})\), by \labelcrefs{ii:2.5.5} we know that \(\infty\) is either an exterior point or a boundary point of \(\R\) in \((\R^*, \mathcal{F})\).
  Suppose for the sake of contradiction that \(\infty\) is an exterior point of \(\R\) in \((\R^*, \mathcal{F})\).
  Then by \labelcrefs{ii:2.5.5} we have
  \[
...
\begin{ex}\label{ii:ex:2.5.6}
  ...
  Show that \((X, \mathcal{F})\) is a topology (this is called the \emph{co-finite topology} on \(X\)) which is not Hausdorff in the sense of \labelcrefs{ii:ex:2.5.4}, and is compact and connected.
...
\begin{proof}
  ...
  Combine all the proofs above we conclude that \((X, \mathcal{F})\) is a topological space by \labelcrefs{ii:2.5.1}.

  Next we show that \((X, \mathcal{F})\) is not Hausdorff.
  Suppose for the sake of contradiction that \((X, \mathcal{F})\) is Hausdorff.
  Let \(x_1, x_2 \in X\) such that \(x_1 \neq x_2\).
  By \labelcrefs{ii:ex:2.5.4} we know that
  \[
  ...
  \end{align*}
  Since \(S\) was arbitrary, by \labelcrefs{ii:2.5.9} we know that \((X, \mathcal{F})\) is compact.

  Next we show that \((X, \mathcal{F})\) is connected.
  Suppose for the sake of contradiction that \((X, \mathcal{F})\) is disconnected.
  Then by \labelcrefs{ii:2.4.1} we have
  \[
  ...
  By \labelcrefs{ii:1.2.15.c} we know that \(V_n\) is open in \((X, d)\) for each \(n \in \Z^+\).
  From the proof above we must have \(\bigcap_{n = 1}^\infty V_n \neq \set{x}\).
  So let \(y \in \bigcap_{n = 1}^\infty V_n\) such that \(y \neq x\).
  By \labelcrefs{ii:1.1.2.b} we know that \(d(y, x) \in \R^+\).
  But then we have
  \begin{align*}
...
\begin{ex}\label{ii:ex:2.5.7}
  ...
  Show that \((X, \mathcal{F})\) is a topology (this is called the \emph{co-countable topology} on \(X\)) which is not Hausdorff in the sense of \labelcrefs{ii:ex:2.5.4}, and connected, but cannot arise from a metric space and is not compact.
\end{ex}
...
\begin{proof}
  ...
  Thus, by \labelcrefs{ii:2.5.9} \((X, \mathcal{F})\) is not compact.
\end{proof}
...
\begin{ex}\label{ii:ex:2.5.9}
  ...
  Show that every sequence in \(X\) has a convergent subsequence, by modifying \labelcrefs{ii:ex:1.5.11}.
\end{ex}
...
\begin{proof}
  ...
  By \labelcrefs{ii:2.5.4} we know that \((x^{(n_j)})_{j = 1}^\infty\) converges to \(x\).
  ...
  \begin{align*}
     ...
     & n_{j + 1} = \min(A_{j + 1})
  \end{align*}
  Since \(U_{j + 1} = \bigcap_{i = 1}^{j + 1} V_i\), by \labelcrefs{ii:2.5.1} we know that \(U_{j + 1}\) is a neighbourhood of \(y\).
  ...
  \end{align*}
  Since \(W\) was arbitrary, by \labelcrefs{ii:2.5.4} we know that \((x^{(n_j)})_{j = 1}^\infty\) converges to \(y\) in \((X, \mathcal{F})\).
...
\begin{ex}\label{ii:ex:2.5.10}
  Prove the following partial analogue of \labelcrefs{ii:1.2.10} for topological spaces:
  (c) implies both (a) and (b), which are equivalent to each other.
  Show that in the co-countable topology in \labelcrefs{ii:ex:2.5.7}, it is possible for (a) and (b) to hold without (c) holding.
\end{ex}
...
\begin{proof}
  ...
  Then by \labelcrefs{ii:ex:2.5.7} we know that \(E \in \mathcal{F}\) and \(E \neq \emptyset\).

  Let \(x_0 \in C\).
  Since \(x_0 \in C\), we know that \(x_0 \notin E\) and by \labelcrefs{ii:2.5.5} we know that \(x_0 \notin \text{int}_{(X, \mathcal{F})}(E)\).
  ...
  \]
  Fix this \(V\).
  Since \((X, \mathcal{F})\) is a co-countable, by \labelcrefs{ii:ex:2.5.7} we know that \(X \setminus V\) is at most countable.
  But then we have
  \begin{align*}
  ...
  By \labelcrefs{ii:2.5.4} this means \((x^{(n)})_{n = 1}^\infty\) does not coverges to \(x_0\) in \((X, \mathcal{F})\), a contradiction.
...
\begin{ex}\label{ii:ex:2.5.11}
  ...
  Prove analogues of \labelcrefs{ii:1.2.15.e}-(h) (some of these are automatic by definition).
  If we assume in addition that \(X\) is Hausdorff, prove an analogue of \labelcrefs{ii:1.2.15.d} also, but give an example to show that (d) can fail when \(X\) is not Hausdorff.
\end{ex}
...
\begin{proof}
  ...
  This is true by \labelcrefs{ii:2.5.1}.
  ...
  \[
    ...
    \end{dcases}
  \]
  and by \labelcrefs{ii:2.5.5} we have \(\text{int}_{(X, \mathcal{F})}\big(\text{int}_{(X, \mathcal{F})}(E)\big) = \text{int}_{(X, \mathcal{F})}(E)\).
  ...
  Finally we give an counterexample of \labelcrefs{ii:1.2.15.d} when \((X, \mathcal{F})\) is not Hausdorff.
  Let \(X \neq \emptyset\) and let \((X, \mathcal{F})\) be a trivial topology.
  Then by \labelcrefs{ii:ex:2.5.1} we know that \(\mathcal{F} = \set{\emptyset, X}\) and by \labelcrefs{ii:ex:2.5.4} \((X, \mathcal{F})\) is not Hausdorff.
...
\begin{ex}\label{ii:ex:2.5.12}
  Show that the pair \((Y, \mathcal{F}_Y)\) defined in \labelcrefs{ii:2.5.7} is indeed a topological space.
\end{ex}
...
\begin{proof}
  ...
  Combine all the proofs above we conclude by \labelcrefs{ii:2.5.1} that \((Y, \mathcal{F}_Y)\) is a topological space.
\end{proof}

\begin{ex}\label{ii:ex:2.5.13}
  Generalize \labelcrefs{ii:1.5.9} to compact sets in a Hausdorff topological space.
\end{ex}
...
\begin{proof}
  ...
  Since \(K_n \subseteq K_1\) for each \(n \in \Z^+\), by \labelcrefs{ii:2.5.7} we know that
  \begin{align*}
  ...
  \end{align*}
  Thus, by \labelcrefs{ii:2.5.7} we know that for every \(n \in \Z^+\), \((K_n, \mathcal{F}_{K_n})\) induced by \((X, \mathcal{F})\) can also induced by \((K_1, \mathcal{F}_{K_1})\).
  By \labelcrefs{ii:2.5.9} we have
  \begin{align*}
    ...
    \implies & \forall n \in \Z^+, \exists S_n \subseteq \mathcal{F}_{K_n} : \begin{dcases}
                                                                               ...
                                                                               S_n' \subseteq \mathcal{F}_{K_n} \text{ by \labelcrefs{ii:2.5.7}}   \\
  ...
  Then by \labelcrefs{ii:ex:2.5.11} we know that \(\overline{K_n}_{(K_1, \mathcal{F}_{K_1})} \setminus K_n = \emptyset\).
  ...
  \[
    ...
    \end{dcases}
  \]
  Since \((K_n, \mathcal{F}_{K_n})\) is a compact topological subspace of \((K_1, \mathcal{F}_{K_1})\), by \labelcrefs{ii:2.5.9} we have
  \[
    ...
    \end{dcases}
  \]
  By \labelcrefs{ii:2.5.1} we have
  \begin{align*}
             & \begin{dcases}
  ...
  \]
  and \((K_1, \mathcal{F}_{K_1})\) is compact, by \labelcrefs{ii:1.5.8} we know that there exists a finite set \(F \subseteq \Z^+\) such that
  \[
...
\begin{ex}\label{ii:ex:2.5.14}
  Generalize \labelcrefs{ii:1.5.10} to compact sets in a Hausdorff topological space.
\end{ex}
...
\begin{proof}
  ...
  By \labelcrefs{ii:ex:2.5.13} we know that if \((Z, \mathcal{F}_Z)\) is compact then \(Z\) is closed in \((Y, \mathcal{F}_Y)\).
  ...
  \end{align*}
  Since \(S_Z\) was arbitrary, by \labelcrefs{ii:2.5.9} we know that \((Z, \mathcal{F}_Z)\) is compact.
  ...
  By \labelcrefs{ii:2.5.7} we have
  \[
  ...
  By \labelcrefs{ii:2.5.1} and all the proofs above we conclude that \(\big(\bigcup_{i = 1}^n Y_i, \mathcal{F}_{\bigcup_{i = 1}^n Y_i}\big)\) is a topological subspace of \((X, \mathcal{F})\).
  ...
  Since \(S\) was arbitrary, by \labelcrefs{ii:2.5.9} we know that \(\big(\bigcup_{i = 1}^n Y_i, \mathcal{F}_{\bigcup_{i = 1}^n Y_i}\big)\) is a compact topological subspace of \((X, \mathcal{F})\).
  ...
  \begin{align*}
    ...
    \implies & \begin{dcases}
               ...
               \end{dcases}
  \end{align*}
  Since \(\mathcal{F}_{\set{x_0}} = \set{\emptyset, \set{x_0}}\), by \labelcrefs{ii:ex:2.5.1} we know that \((\set{x_0}, \mathcal{F}_{\set{x_0}})\) is a topological space.
  ...
  \end{align*}
  Since \(S\) was arbitrary, we conclude that every open cover of \(\set{x_0}\) has a finite subcover in \((\set{x_0}, \mathcal{F}_{\set{x_0}})\), and by \labelcrefs{ii:2.5.9} we know that \((\set{x_0}, \mathcal{F}_{\set{x_0}})\) is compact.
...
\begin{ex}\label{ii:ex:2.5.15}
  ...
  Show that the two notions continuity (both at a point, and on the whole domain) of a function \(f : X \to Y\) in \labelcrefs{ii:2.1.1} and \labelcrefs{ii:2.5.8} coincide.
\end{ex}
...
\begin{proof}
  ...
  Let \(x_0 \in X\).
  First, suppose that \(f\) is continuous at \(x_0\) in the sense of \labelcrefs{ii:2.1.1}.
  Then we have
  \begin{align*}
  ...
  \end{align*}
  By \labelcrefs{ii:1.2.15.c} we know that \(B_{(X, d_X)}(x_0, \delta) \in \mathcal{F}_X\).
  Since \(V\) was arbitrary, by \labelcrefs{ii:2.5.8} we know that \(f\) is continuous at \(x_0\) from \((X, \mathcal{F}_X)\) to \((Y, \mathcal{F}_Y)\).

  Now suppose that \(f\) is continuous at \(x_0\) in the sense of \labelcrefs{ii:2.5.8}.
  Then we have
  \[
  ...
  \begin{align*}
    ...
    \implies & \exists \delta \in \R^+ :                                                                                               \\
             & \Big(\forall x \in X, d_X(x, x_0) < \delta \implies d_Y\big(f(x), f(x_0)\big) < \varepsilon\Big).
  \end{align*}
  Since \(\varepsilon\) was arbitrary, by \labelcrefs{ii:2.1.1} we know that \(f\) is continuous at \(x_0\) from \((X, d_X)\) to \((Y, d_Y)\).
...
\begin{ex}\label{ii:ex:2.5.16}
  Show that when \labelcrefs{ii:2.1.4} is extended to topological spaces, that (a) implies (b).
  (The converse is false, but constructing an example is diffcult.)
  Show that when \labelcrefs{ii:2.1.5} is extended to topological spaces, that (a), (c), (d) are all equivalent to each other, and imply (b).
...
\begin{proof}
  ...
  Since \(f\) is continuous at \(x_0\) from \((X, \mathcal{F}_X)\) to \((Y, \mathcal{F}_Y)\), by \labelcrefs{ii:2.5.8} we know that
  \[
    \forall V \in \mathcal{F}_Y, f(x_0) \in V \implies \exists U \in \mathcal{F}_X : \begin{dcases}
      x_0 \in U \\
      f(U) \subseteq V
    \end{dcases}
  \]
  Since \((x^{(n)})_{n = 1}^\infty\) converges to \(x_0\) in \((X, \mathcal{F}_X)\), by \labelcrefs{ii:2.5.4} we have
  \[
  ...
  \]
  By \labelcrefs{ii:2.5.4} we know that \(\big(f(x^{(n)})\big)_{n = 1}^\infty\) converges to \(f(x_0)\) in \((Y, \mathcal{F}_Y)\).
  ...
  Since \(U \in \mathcal{F}_X\), by \labelcrefs{ii:2.5.5} we know that \(x_0 \in \text{int}_{(X, \mathcal{F}_X)}\big(f^{-1}(V)\big)\).
  Since \(x_0\) was arbitrary, by \labelcrefs{ii:ex:2.5.11} we know that \(f^{-1}(V) \in \mathcal{F}_X\).
  ...
  \[
    ...
    \end{dcases}
  \]
  and by \labelcrefs{ii:2.5.8} \(f\) is continuous at \(x_0\) from \((X, \mathcal{F}_X)\) to \((Y, \mathcal{F}_Y)\).
  Since \(x_0\) was arbitrary, we conclude that \(f\) is continuous on \(X\) from \((X, \mathcal{F}_X)\) to \((Y, \mathcal{F}_Y)\).

  From all proofs above, we conclude that \labelcrefs{ii:2.1.5.a,ii:2.1.5.c,ii:2.1.5.d} are equivalent in the topological version.
\end{proof}

\begin{ex}\label{ii:ex:2.5.17}
  Generalize both \labelcrefs{ii:2.3.1} and \labelcrefs{ii:2.3.2} to compact sets in a topological space.
\end{ex}
...
\begin{proof}
  ...
  By \labelcrefs{ii:2.5.7} we know that the set \(S_Y = \set{V \in \mathcal{F}_Y : V \cap f(K) \in S}\) is non-empty.
  Then we have
  \begin{align*}
    ...
    \implies & \exists S_Y' \subseteq S_Y : \begin{dcases}
                                            ...
                                            \end{dcases}                                     &  & \by{ii:2.5.9}                          \\
  \end{align*}
  Since \(S\) was arbitrary, by \labelcrefs{ii:2.5.9} we know that \(\big(f(K), \mathcal{F}_{f(K)}\big)\) is compact.
  ...
  \end{align*}
  The rest follows as in \labelcrefs{ii:2.3.2}.
\end{proof}
