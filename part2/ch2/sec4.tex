...
\begin{proof}
  ...
  By \cref{ii:2.4.5.a,ii:2.4.5.c} we know that \(f(E)\) is an interval.
  Thus, we have
  \begin{align*}
...
\begin{proof}
  ...
  \[
    ...
    \end{dcases}
  \]
  By \cref{ii:1.2.10.a,ii:1.2.10.b} we know that \(E \subseteq \overline{E}\), thus we know that at least one of \(E \cap V\) and \(E \cap W\) is not empty.
  ...
  But by \cref{ii:2.4.5.a,ii:2.4.5.c} we know that \((\overline{E}_{(\R, d_{l^1}|_{\R \times \R})}, d_{l^1}|_{\R \times \R})\) is connected but \((E, d_{l^1}|_{\R \times \R})\) is not.
\end{proof}
