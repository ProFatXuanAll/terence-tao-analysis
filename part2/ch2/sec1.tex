\section{Continuous functions}\label{ii:sec:2.1}

\begin{defn}[Continuous functions]\label{ii:2.1.1}
...
\begin{thm}[Continuity preserves convergence]\label{ii:2.1.4}
  ...
  \begin{enumerate}
    \item\label{ii:2.1.4.a} \(f\) is continuous at \(x_0\).
    \item\label{ii:2.1.4.b} Whenever \((x^{(n)})_{n = 1}^\infty\) is a sequence in \(X\) which converges to \(x_0\) with respect to the metric \(d_X\), the sequence \(\big(f(x^{(n)})\big)_{n = 1}^\infty\) converges to \(f(x_0)\) with respect to the metric \(d_Y\).
    \item\label{ii:2.1.4.c} For every open set \(V \subseteq Y\) that contains \(f(x_0)\), there exists an open set \(U \subseteq X\) containing \(x_0\) such that \(f(U) \subseteq V\).
  \end{enumerate}
\end{thm}
...
\begin{proof}
  ...
  Suppose that \(f : X \to Y\) is continuous at \(x_0\) from \((X, d_X)\) to \((Y, d_Y)\).
  Then by \labelcrefs{ii:2.1.1} we have
  \[
  ...
  By \labelcrefs{ii:1.2.4} we know that \(f(x_0) \in V_\varepsilon\), thus we have \(x_0 \in f^{-1}(V_\varepsilon)\) and \(f^{-1}(V_\varepsilon) \neq \emptyset\).
  Now we claim that
  \[
  ...
  By \labelcrefs{ii:1.2.15.c} we know that \(U\) is open in \((X, d_X)\).
  By \labelcrefs{ii:1.2.4} we know that \(x_0 \in U\).
  ...
  \end{align*}
  Let \(\varepsilon \in \R^+\).
  By \labelcrefs{ii:1.2.15.c} we know that \(B_{(Y, d_Y)}\big(f(x_0), \varepsilon\big)\) is open in \((Y, d_Y)\).
  ...
  \]
  Thus, by \labelcrefs{ii:2.1.1} \(f\) is continuous at \(x_0\) from \((X, d_X)\) to \((Y, d_Y)\).
  We conclude that statements (a)(b)(c) are equivalent.
\end{proof}

\begin{thm}\label{ii:2.1.5}
  Let \((X, d_X)\) be a metric space, and let \((Y, d_Y)\) be another metric space.
  Let \(f : X \to Y\) be a function.
  Then the following four statements are equivalent:
  \begin{enumerate}
    \item\label{ii:2.1.5.a} \(f\) is continuous.
    \item\label{ii:2.1.5.b} Whenever \((x^{(n)})_{n = 1}^\infty\) is a sequence in \(X\) which converges to some point \(x_0 \in X\) with respect to the metric \(d_X\), the sequence \(\big(f(x^{(n)})\big)_{n = 1}^\infty\) converges to \(f(x_0)\) with respect to the metric \(d_Y\).
    \item\label{ii:2.1.5.c} Whenever \(V\) is an open set in \(Y\), the set \(f^{-1}(V) \coloneqq \set{x \in X : f(x) \in V}\) is an open set in \(X\).
    \item\label{ii:2.1.5.d} Whenever \(F\) is a closed set in \(Y\), the set \(f^{-1}(F) \coloneqq \set{x \in X : f(x) \in F}\) is a closed set in \(X\).
  \end{enumerate}
\end{thm}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \iff & \forall x_0 \in X, \text{ every sequence } (x^{(n)})_{n = 1}^\infty \text{ in } X \text{ satisfies }                                 \\
         ...
         & \lim_{n \to \infty} d_Y\big(f(x^{(n)}), f(x_0)\big) = 0.                                             &  & \by{ii:2.1.4.a,ii:2.1.4.b}
  \end{align*}
  ...
  \begin{align*}
    ...
    \implies & \forall x_0 \in E, \exists U \subseteq X :                                                                                           \\
             & \big(U \text{ is open in } (X, d_X)\big) \land (x_0 \in U) \land \big(f(U) \subseteq V\big) &  & \by{ii:2.1.4.a,ii:2.1.4.c}          \\
    \implies & \forall x_0 \in E, \exists U \subseteq X :                                                                                           \\
  ...
  \end{align*}
  and by \labelcrefs{ii:2.1.4.a,ii:2.1.4.c} we know that \(f\) is continuous at \(x_0\) from \((X, d_X)\) to \((Y, d_Y)\).
...
\begin{rmk}\label{ii:2.1.6}
  ...
  see \labelcrefs{ii:ex:1.5.4,ii:ex:1.5.5}.
\end{rmk}

\begin{cor}[Continuity preserved by composition]\label{ii:2.1.7}
  Let \((X, d_X)\), \((Y, d_Y)\), and \((Z, d_Z)\) be metric spaces.
  \begin{enumerate}
    \item\label{ii:2.1.7.a} If \(f : X \to Y\) is continuous at a point \(x_0 \in X\), and \(g : Y \to Z\) is continuous at \(f(x_0)\), then the composition \(g \circ f : X \to Z\), defined by \(g \circ f(x) \coloneqq g(f(x))\), is continuous at \(x_0\).
    \item\label{ii:2.1.7.b} If \(f : X \to Y\) is continuous, and \(g : Y \to Z\) is continuous, then \(g \circ f : X \to Z\) is also continuous.
  \end{enumerate}
\end{cor}

\begin{proof}[\pf{ii:2.1.7.a}]
  Since \(f\) is continuous at \(x_0\) from \((X, d_X)\) to \((Y, d_Y)\), by \labelcrefs{ii:2.1.4.a,ii:2.1.4.c} we know that
  \begin{align*}
             & \forall V \subseteq Y, \big(V \text{ is open in } (Y, d_Y)\big) \land \big(f(x_0) \in V\big)                        \\
    \implies & \exists U \subseteq X : \big(U \text{ is open in } (X, d_X)\big) \land (x_0 \in U) \land \big(f(U) \subseteq V\big)
  \end{align*}
  Now we choose such \(U\) for each open set \(V\) in \((Y, d_Y)\) and denote it as \(U_V\).
  Since \(g\) is continuous at \(f(x_0)\) from \((Y, d_Y)\) to \((Z, d_Z)\), by \labelcrefs{ii:2.1.4.a,ii:2.1.4.c} we know that
  \begin{align*}
  ...
  \end{align*}
  Thus, by \labelcrefs{ii:2.1.4.a,ii:2.1.4.c} we know that \(g \circ f\) is continuous at \(x_0\) from \((X, d_X)\) to \((Z, d_Z)\).
\end{proof}

\begin{proof}[\pf{ii:2.1.7.b}]
  Let \(x_0 \in X\).
  Then we have
  \begin{align*}
             & f \text{ is continuous from } (X, d_X) \text{ to } (Y, d_Y)                                     \\
  ...
  \end{align*}
  Since \(x_0\) was arbitrary, by \labelcrefs{ii:2.1.1} we know that \(g \circ f\) is continuous from \((X, d_X)\) to \((Z, d_Z)\).
\end{proof}

\exercisesection

\begin{ex}\label{ii:ex:2.1.1}
  Prove \labelcrefs{ii:2.1.4}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:2.1.4}.
\end{proof}

\begin{ex}\label{ii:ex:2.1.2}
  Prove \labelcrefs{ii:2.1.5}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:2.1.5}.
\end{proof}

\begin{ex}\label{ii:ex:2.1.3}
  Use \labelcrefs{ii:2.1.4} and \labelcrefs{ii:2.1.5} to prove \labelcrefs{ii:2.1.7}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:2.1.7}.
\end{proof}

\begin{ex}\label{ii:ex:2.1.4}
  Give an example of functions \(f : \R \to \R\) and \(g : \R \to \R\) such that
  \begin{enumerate}
    \item\label{ii:ex:2.1.4.a} \(f\) is not continuous, but \(g\) and \(g \circ f\) are continuous;
    \item\label{ii:ex:2.1.4.b} \(g\) is not continuous, but \(f\) and \(g \circ f\) are continuous;
    \item\label{ii:ex:2.1.4.c} \(f\) and \(g\) are not continuous, but \(g \circ f\) is continuous.
  \end{enumerate}
  Explain briefly why these examples do not contradict \labelcrefs{ii:2.1.7}.
\end{ex}

\begin{proof}[\pf{ii:ex:2.1.4.a}]
  ...
  This does not contradict to \labelcrefs{ii:2.1.7} since \(f\) is not continuous from \((\R, d_{l^1}|_{\R \times \R})\) to \((\R, d_{l^1}|_{\R \times \R})\).
\end{proof}

\begin{proof}[\pf{ii:ex:2.1.4.b}]
  ...
  This does not contradict to \labelcrefs{ii:2.1.7} since \(g\) is not continuous from \((\R, d_{l^1}|_{\R \times \R})\) to \((\R, d_{l^1}|_{\R \times \R})\).
\end{proof}

\begin{proof}[\pf{ii:ex:2.1.4.c}]
  Let \(f : \R \to \R\) be the function
  \[
    \forall x \in \R, f(x) = \begin{dcases}
      1 & \text{if } x = 0    \\
  ...
  Since \(g \circ f\) is a constant function, we know that \(g \circ f\) is continuous from \((\R, d_{l^1}|_{\R \times \R})\) to \((\R, d_{l^1}|_{\R \times \R})\).
  This does not contradict to \labelcrefs{ii:2.1.7} since \(f, g\) are not continuous from \((\R, d_{l^1}|_{\R \times \R})\) to \((\R, d_{l^1}|_{\R \times \R})\).
\end{proof}

\begin{ex}\label{ii:ex:2.1.5}
...
\begin{proof}
  ...
  \end{align*}
  and thus by \labelcrefs{ii:2.1.1} \(\iota_{E \to X}\) is continuous at \(x_0\) from \((E, d|_{E \times E})\) to \((X, d)\).
  Since \(x_0\) was arbitrary, by \labelcrefs{ii:2.1.1} \(\iota_{E \to X}\) is continuous from \((E, d|_{E \times E})\) to \((X, d)\).
\end{proof}
...
\begin{proof}
  ...
  \]
  Thus, by \labelcrefs{ii:2.1.1} we have
  \begin{align*}
         & \forall \varepsilon \in \R^+, \exists \delta \in \R^+ : \Big(\forall x \in X, d_X(x, x_0) < \delta \implies d_Y\big(f(x), f(x_0)\big) < \varepsilon\Big)                \\
  ...
  By \labelcrefs{ii:2.1.1} we conclude that \(f\) is continuous from \((X, d_X)\) to \((Y, d_Y)\) iff \(g\) is continuous from \((X, d_X)\) to \((E, d_Y|_{E \times E})\).
\end{proof}
