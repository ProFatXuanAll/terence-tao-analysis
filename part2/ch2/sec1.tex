...
\begin{proof}
  ...
  \end{align*}
  and by \cref{ii:2.1.4.a,ii:2.1.4.c} we know that \(f\) is continuous at \(x_0\) from \((X, d_X)\) to \((Y, d_Y)\).
...
\begin{proof}[\pf{ii:2.1.7.a}]
  Since \(f\) is continuous at \(x_0\) from \((X, d_X)\) to \((Y, d_Y)\), by \cref{ii:2.1.4.a,ii:2.1.4.c} we know that
  \begin{align*}
             & \forall V \subseteq Y, \big(V \text{ is open in } (Y, d_Y)\big) \land \big(f(x_0) \in V\big)                        \\
    \implies & \exists U \subseteq X : \big(U \text{ is open in } (X, d_X)\big) \land (x_0 \in U) \land \big(f(U) \subseteq V\big)
  \end{align*}
  Now we choose such \(U\) for each open set \(V\) in \((Y, d_Y)\) and denote it as \(U_V\).
  Since \(g\) is continuous at \(f(x_0)\) from \((Y, d_Y)\) to \((Z, d_Z)\), by \cref{ii:2.1.4.a,ii:2.1.4.c} we know that
  \begin{align*}
  ...
  \end{align*}
  Thus, by \cref{ii:2.1.4.a,ii:2.1.4.c} we know that \(g \circ f\) is continuous at \(x_0\) from \((X, d_X)\) to \((Z, d_Z)\).
\end{proof}
