...
\begin{proof}
  ...
  In particular, by the triangle inequality (\cref{ii:5.2.7.c,ii:5.2.7.e}) this implies that
  \[
...
\begin{ex}\label{ii:ex:5.5.2}
  ...
  \begin{enumerate}
    \item\label{ii:ex:5.5.2.a} Using \cref{ii:ex:5.5.1}, show that the series
    \[
