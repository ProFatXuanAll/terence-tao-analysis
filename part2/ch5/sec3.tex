...
\begin{proof}
  ...
  \begin{align*}
    \inner*{e_n, e_m} & = \int_{[0, 1]} e_n(x) \overline{e_m(x)} \; dx                   &  & \by{ii:5.2.1}              \\
                      ...
                      & = \int_{[0, 1]} e^{2 \pi i n x} e^{- 2 \pi i m x} \; dx          &  & \by{ii:4.7.2.c,ii:4.7.2.f} \\
...
\begin{ac}\label{ii:ac:5.3.1}
  From \labelcrefs{ii:5.3.6}, we see that whenever
  \[
  ...
  Also, from the second identity of \labelcrefs{ii:5.3.6} we have the \emph{Plancherel formula}
  \[
...
\begin{ex}\label{ii:ex:5.3.2}
  Prove \labelcrefs{ii:5.3.5}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:5.3.5}.
\end{proof}

\begin{ex}\label{ii:ex:5.3.3}
  Prove \labelcrefs{ii:5.3.6}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:5.3.6}.
\end{proof}
