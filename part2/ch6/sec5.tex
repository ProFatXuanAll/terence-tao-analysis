\section{Double derivatives and Clairaut's theorem}\label{ii:sec:6.5}

\begin{defn}[Twice continuous differentiability]\label{ii:6.5.1}
...
\setcounter{thm}{3}
\begin{thm}[Clairaut's theorem]\label{ii:6.5.4}
...
\begin{proof}
  ...
  \end{align*}
  Since \((a, b)\) was arbitrary, by \labelcrefs{ii:2.2.2} we know that \(\dfrac{\partial f}{\partial x}\) and \(\dfrac{\partial f}{\partial y}\) are continuous on \(\R^2 \setminus \set{(0, 0)}\) from \((\R^2, d_{l^2}|_{\R^2 \times \R^2})\) to \((\R, d_{l^1}|_{\R \times \R})\).
  Observe that
  \begin{align*}
  ...
  \begin{align*}
    \dfrac{\partial f}{\partial y}(0, 0) & = \lim_{t \to 0 ; t \neq 0} \dfrac{f\big((0, 0) + t(0, 1)\big) - f(0, 0)}{t} &  & \by{ii:6.3.7} \\
                                         ...
                                         & = 0,
  \end{align*}
  by \labelcrefs{ii:2.1.1} we know that \(\dfrac{\partial f}{\partial x}\) and \(\dfrac{\partial f}{\partial y}\) are continuous at \((0, 0)\) from \((\R^2, d_{l^2}|_{\R^2 \times \R^2})\) to \((\R, d_{l^1}|_{\R \times \R})\).
  Combine the proof above we conclude by \labelcrefs{ii:6.5.1} that \(f\) is continuously differentiable on \(\R^2\).
  ...
  \begin{align*}
     ...
     & = \dfrac{-3 a^6 b^2 + 3 a^4 b^4 + 7 a^2 b^6 + b^8}{(a^2 + b^2)^4}.
  \end{align*}
  Thus, by \labelcrefs{ii:6.3.7} \(\dfrac{\partial}{\partial y} \dfrac{\partial f}{\partial x}\) and \(\dfrac{\partial}{\partial x} \dfrac{\partial f}{\partial y}\) exist for all \((a, b) \in \R^2 \setminus \set{(0, 0)}\).
  Since
  \begin{align*}
  ...
  This does not contradict to \labelcrefs{ii:6.5.4} since both \(\dfrac{\partial}{\partial y} \dfrac{\partial f}{\partial x}\) and \(\dfrac{\partial}{\partial x} \dfrac{\partial f}{\partial y}\) are not continuous at \((0, 0)\).
\end{proof}
