...
\begin{proof}
  ...
  Since \(f'(0)\) and its inverse are both continuous, \(f'(0)(V')\) is open (see \cref{ii:2.1.5.a,ii:2.1.5.c}), and it certainly contains \(0\).
...
\begin{proof}
  ...
  Thus, by \cref{ii:2.1.5.a,ii:2.1.5.c} we know that \(f\big(U \cap B_{(\R^n, d)}(x, r)\big)\) is open in \((\R, d)\).
  Now we have
  \begin{align*}
