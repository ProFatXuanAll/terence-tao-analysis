...
\begin{ex}\label{ii:ex:3.1.3}
  ...
  If \(X\) is a topological space and \(Y\) is a Hausdorff topological space (see \cref{ii:ex:2.5.4}), prove the equivalence of \cref{ii:3.1.5.c,ii:3.1.5.d} in this setting, as well as an analogue of \cref{ii:3.1.6}.
    ...
    \forall x \in E \cup \set{x_0}, & (f^* + g^*)(x) = \begin{dcases}
                                    ...
                                    & (f^* / g^*)(x) = \begin{dcases}
                                                       ...
                                                       \end{dcases} \text{ when } \begin{dcases}
                                                                                  ...
                                                                                  \end{dcases}
  \end{align*}
  by \cref{ii:3.1.5.a,ii:3.1.5.d} we know that
  \begin{align*}
     & d_1 - \lim_{x \to x_0 ; x \in E} (f + g)(x) = L + M                                          \\
     & d_1 - \lim_{x \to x_0 ; x \in E} (f - g)(x) = L - M                                          \\
     & d_1 - \lim_{x \to x_0 ; x \in E} (fg)(x) = LM                                                \\
