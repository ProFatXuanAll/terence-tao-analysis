...
\begin{note}
  To rephrase \labelcrefs{ii:3.6.1}:
...
\begin{note}
  \labelcrefs{ii:3.6.2} works particularly well in conjunction with the Weierstrass \(M\)-test
  (\labelcrefs{ii:3.5.7}).
\end{note}
...
\begin{ex}\label{ii:ex:3.6.1}
  Use \labelcrefs{ii:3.6.1} to prove \labelcrefs{ii:3.6.2}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:3.6.2}.
\end{proof}
