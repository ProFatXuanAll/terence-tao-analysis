...
\begin{note}
  From \labelcrefs{ii:1.1.20} we see that a sequence \((f^{(n)})_{n = 1}^\infty\) of functions from one metric space \((X, d_X)\) to another \((Y, d_Y)\) can have at most one pointwise limit \(f\)
...
\begin{rmk}\label{ii:3.2.8}
  Note that \labelcrefs{ii:3.2.7} is subtly different from the definition for pointwise convergence in \labelcrefs{ii:3.2.1}.
  ...
  (i.e., between \labelcrefs{ii:2.1.1} and \labelcrefs{ii:2.3.4}).
\end{rmk}
...
\begin{ex}\label{ii:ex:3.2.1}
  ...
  \begin{enumerate}
    \item\label{ii:ex:3.2.1.a} Show that \(f\) is continuous iff, whenever \((a_n)_{n = 0}^\infty\) is a sequence of real numbers which converges to zero, the shifted functions \(f_{a_n}\) converge pointwise to \(f\).
    \item\label{ii:ex:3.2.1.b} Show that \(f\) is uniformly continuous iff, whenever \((a_n)_{n = 0}^\infty\) is a sequence of real numbers which converges to zero, the shifted functions \(f_{a_n}\) converge uniformly to \(f\).
  \end{enumerate}
\end{ex}

\begin{proof}[\pf{ii:ex:3.2.1.a}]
  ...
  \end{align*}
  Since \(x_0\) was arbitrary, by \labelcrefs{ii:3.2.1} we know that \((f_{a_n})_{n = 0}^\infty\) converges pointwise to \(f\) on \(\R\) with respect to \(d_{l^1}|_{\R \times \R}\).
...
\begin{proof}[\pf{ii:ex:3.2.1.b}]
  ...
  \end{align*}
  Since this is true for arbitrary \(\varepsilon\), by \labelcrefs{ii:3.2.7} we know that \((f_{a_n})_{n = 0}^\infty\) converges uniformly to \(f\) on \(\R\) with respect to \(d_{l^1}|_{\R \times \R}\).
  ...
  \end{align*}
  But by hypothesis we know that \((f_{a_n})_{n = 0}^\infty\) uniformly converges to \(f\) on \(\R\), which by \labelcrefs{ii:3.2.7} means
  \[
...
\begin{ex}\label{ii:ex:3.2.2}
  \quad
  \begin{enumerate}
    \item\label{ii:ex:3.2.2.a} Let \((f^{(n)})_{n = 1}^\infty\) be a sequence of functions from one metric space \((X, d_X)\) to another \((Y, d_Y)\), and let \(f : X \to Y\) be another function from \(X\) to \(Y\).
    Show that if \(f^{(n)}\) converges uniformly to \(f\), then \(f^{(n)}\) also converges pointwise to \(f\).
    \item\label{ii:ex:3.2.2.b} For each integer \(n \geq 1\), let \(f^{(n)} : (-1, 1) \to \R\) be the function \(f^{(n)}(x) \coloneqq x^n\).
    Prove that \(f^{(n)}\) converges pointwise to the zero function \(0\), but does not converge uniformly to any function \(f : (-1, 1) \to \R\).
    \item\label{ii:ex:3.2.2.c} Let \(g : (-1, 1) \to \R\) be the function \(g(x) \coloneqq x / (1 - x)\).
...
\begin{proof}[\pf{ii:ex:3.2.2.a}]
  ...
  \end{align*}
  and \(x_0\) was arbitrary, by \labelcrefs{ii:3.2.1} we know that \((f^{(n)})_{n = 1}^\infty\) converges pointwise to \(f\) on \(X\) with respect to \(d_Y\).
\end{proof}

\begin{proof}[\pf{ii:ex:3.2.2.b}]
  ...
  By \labelcrefs{ii:ex:3.2.2.a} and \labelcrefs{ii:1.1.20} we know that \(f = z\).
  Then we have
  \begin{align*}
...
\begin{proof}[\pf{ii:ex:3.2.2.c}]
  ...
  \begin{align*}
    \forall x \in (-1, 1), \lim_{N \to \infty} \sum_{n = 1}^N f^{(n)}(x) & = \lim_{N \to \infty} \sum_{n = 1}^N x^n                 \\
                                                                         ...
                                                                         & = g(x).
  \end{align*}
  Thus, by \labelcrefs{ii:3.2.1} we know that \((\sum_{n = 1}^N f^{(n)})_{N = 1}^\infty\) converges pointwise to \(g\) on \((-1, 1)\) with respect to \(d_{l^1}|_{\R \times \R}\).
  ...
  Then by \labelcrefs{ii:3.2.7} we know that
  \begin{align*}
  ...
  If we replace \((-1, 1)\) with \([-1, 1]\), then by Lemma 7.3.3 in Analysis I \(\sum_{n = 1}^\infty 1\) and \(\sum_{n = 1}^\infty -1\) does not converge, thus by \labelcrefs{ii:3.2.1} \((\sum_{n = 1}^N f^{(n)})_{N = 1}^\infty\) does not converge pointwise to \(g\) on \([-1, 1]\) with respect to \(d_{l^1}|_{\R \times \R}\).
\end{proof}
...
\begin{proof}
  ...
  \]
  Since \(x_0\) was arbitrary, by \labelcrefs{ii:3.2.1} we know \((h \circ f_n)_{n = 1}^\infty\) converges pointwise to \(h \circ f\) on \(X\) with respect to \(d_{l^1}|_{\R \times \R}\).
\end{proof}
...
\begin{proof}
  Since \(f\) is bounded, by \labelcrefs{ii:1.5.3} we have
  \[
  ...
  So suppose that \(S \neq \emptyset\).
  By hypothesis we know that \(f_n\) is bounded for each \(n \in S\), thus by \labelcrefs{ii:1.5.3} we have
  \[
  ...
  \end{align*}
  Since \(y\) was arbitrary, by \labelcrefs{ii:1.5.3} we know that \(f_n\) is bounded for each \(n \in \Z^+\), i.e.,
  \[
