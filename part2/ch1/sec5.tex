\section{Compact metric spaces}\label{ii:sec:1.5}
...
\begin{rmk}\label{ii:1.5.2}
  ...
  The notions of completeness in \labelcrefs{ii:1.4.10}, and of boundedness in \labelcrefs{ii:1.5.3}, are also intrinsic, but the notions of open and closed are not
  (see the discussion in \labelcrefs{ii:sec:1.3}).
\end{rmk}
...
\begin{defn}[Bounded sets]\label{ii:1.5.3}
...
\begin{rmk}\label{ii:1.5.4}
  \labelcrefs{ii:1.5.3} is compatible with the definition of a bounded set in \((\R, d_{l^1}|_{\R \times \R})\).
\end{rmk}

\begin{prop}\label{ii:1.5.5}
...
\begin{proof}
  ...
  Since \((X, d)\) is compact, by \labelcrefs{ii:1.5.1} we know that there exists a subsequence of \((a_n)_{n = 1}^\infty\) which converges to some \(x_0 \in X\) with respect to \(d\).
  Since \((a_n)_{n = 1}^\infty\) is a Cauchy sequence in \((X, d)\), by \labelcrefs{ii:1.4.9} we know that \((a_n)_{n = 1}^\infty\) must converge to \(x_0\) with respect to \(d\).
  Since \((a_n)_{n = 1}^\infty\) was arbitrary, by \labelcrefs{ii:1.4.10} we know that \((X, d)\) is complete.

  Now we show that \((X, d)\) is bounded by contradiction.
  Suppose for the sake of contradiction that \((X, d)\) is not bounded.
  Then by \labelcrefs{ii:1.5.3} we have
  \begin{align*}
  ...
  Since \(a_n \in X \setminus B_{(X, d)}(x_0, n)\), by \labelcrefs{ii:1.2.1} we know that \(d(a_n, x_0) \geq n\) for all \(n \in \Z^+\).
  Since \((X, d)\) is compact, by \labelcrefs{ii:1.5.1} there exists a subsequence \((a_{n_j})_{j = 1}^\infty\) of \((a_n)_{n = 1}^\infty\) such that \((a_{n_j})_{j = 1}^\infty\) converges in \(X\).
  Let \(\lim_{j \to \infty} d(a_{n_j}, L) = 0\) for some \(L \in X\).
  By \labelcrefs{ii:1.1.14} we know that
  \[
...
\begin{cor}[Compact sets are closed and bounded]\label{ii:1.5.6}
  Let \((X, d)\) be a metric space, and let \(Y\) be a compact subset of \(X\).
  Then \(Y\) is closed and bounded.
\end{cor}

\begin{proof}
  Since \((Y, d|_{Y \times Y})\) is compact, by \labelcrefs{ii:1.5.5} we know that \((Y, d)\) is complete and bounded.
  Thus, by \labelcrefs{ii:1.4.12.a} we know that \(Y\) is closed in \((X, d)\).
\end{proof}

\begin{thm}[Heine-Borel theorem]\label{ii:1.5.7}
...
\begin{proof}
  ...
  By \labelcrefs{ii:ex:1.1.7} we know that \((\R^n, d_{l^1}|_{\R^n \times \R^n})\) is a metric space, and by \labelcrefs{ii:1.5.6} we know that if \((E, d_{l^1}|_{E \times E})\) is compact, then \(E\) is closed and bounded in \((\R^n, d_{l^1}|_{\R^n \times \R^n})\).
  ...
  But by \labelcrefs{ii:1.4.3} we know that every subsequence of \((b^{(k_j)})_{j = 1}^\infty\) also converges in \(\R^n\) with respect to \(d_{l^1}|_{\R^n \times \R^n}\).
  In particular, \((b^{k_{j_p}})_{p = 1}^\infty\) converges in \(\R^n\) with respect to \(d_{l^1}|_{\R^n \times \R^n}\).
  Thus, by \labelcrefs{ii:1.1.18.b,ii:1.1.18.d} we know that \((a^{(k_{j_p})})_{p = 1}^\infty\) converges in \(\R^{n + 1}\) with respect to \(d_{l^1}|_{\R^{n + 1} \times \R^{n + 1}}\), and this closes the induction.
  ...
  Since \(E\) is closed in \((\R^n, d_{l^1}|_{\R^n \times \R^n})\), by \labelcrefs{ii:1.2.15.b} we know that such subsequence must converges in \(E\) with respect to \(d_{l^1}|_{\R^n \times \R^n}\).
  Thus, by \labelcrefs{ii:1.5.1} \((E, d_{l^1}|_{E \times E})\) is compact.

  Since every sequence in \(E\) has a subsequence which converges in \(E\) with respect to \(d_{l^1}|_{E \times E}\), by \labelcrefs{ii:1.1.18} we know that such subsequence also converges with respect to \(d_{l^2}|_{E \times E}\) and \(d_{l^\infty}|_{E \times E}\).
...
\begin{note}
  One can characterize compactness topologically via \labelcrefs{ii:1.5.8}:
...
\begin{proof}
  We assume for the sake of contradiction that there does not exist any finite subset \(F\) of \(A\) for which \(Y \subseteq \bigcup_{\alpha \in F} V_{\alpha}\).

  Let \(y\) be any element of \(Y\).
  Then \(y\) must lie in at least one of the sets \(V_{\alpha}\).
  Since each \(V_{\alpha}\) is open in \((X, d)\), by \labelcrefs{ii:1.2.15.a} there must therefore be an \(r > 0\) such that \(B_{(X, d)}(y, r) \subseteq V_{\alpha}\).
  ...
  \begin{itemize}
    ...
    \item Case 2:
          ...
          But this contradicts the assumption that \((Y, d|_{Y \times Y})\) is compact (by \labelcrefs{ii:1.4.7}).
    \item Case 3:
          \(r_0 = \infty\).
...
\begin{note}
  It turns out that \labelcrefs{ii:1.5.8} has a converse:
...
\begin{proof}
  Since \((K_1, d|_{K_1 \times K_1})\) is compact and \(K_1 \subseteq X\), by \labelcrefs{ii:1.5.6} we know that \(K_1\) is closed in \((X, d)\).
  Since \(K_1\) is closed in \((X, d)\) and \(K_1 \cap K_n = K_n\) for every \(n \geq 1\), by \labelcrefs{ii:1.3.4.b} we know that \(K_n\) is relatively closed in \((K_1, d|_{K_1 \times K_1})\).
  Let \(V_n = K_1 \setminus K_n\) for every \(n \geq 1\).
  Then for every \(n \geq 1\), we have \(V_n \subseteq K_1\) and by \labelcrefs{ii:1.2.15.e} \(V_n\) is open in \((K_1, d|_{K_1 \times K_1})\).
  ...
  \]
  and \((K_1, d)\) is compact, by \labelcrefs{ii:1.5.8} we know that there exists a finite set \(F \subseteq \Z^+\) such that
  \[
...
\begin{thm}\label{ii:1.5.10}
  Let \((X, d)\) be a metric space.
  \begin{enumerate}
    \item\label{ii:1.5.10.a} If \(Y\) is a compact subset of \(X\), and \(Z \subseteq Y\), then \(Z\) is compact iff \(Z\) is closed.
    \item\label{ii:1.5.10.b} If \(Y_1, \dots, Y_n\) are a finite collection of compact subsets of \(X\), then their union \(Y_1 \cup \dots \cup Y_n\) is also compact.
    \item\label{ii:1.5.10.c} Every finite subset of \(X\) (including the empty set) is compact.
  \end{enumerate}
\end{thm}

\begin{proof}[\pf{ii:1.5.10.a}]
  By \labelcrefs{ii:1.5.6} we know that if \((Z, d|_{Z \times Z})\) is compact then \(Z\) is closed in \((Y, d|_{Y \times Y})\).
  Now we show that if \(Z\) is closed in \((Y, d|_{Y \times Y})\) then \((Z, d|_{Z \times Z})\) is compact.
  Since \((Y, d|_{Y \times Y})\) is compact and \(Z \subseteq Y\), by \labelcrefs{ii:1.5.1} we know that every sequence \((z^{(n)})_{n = 1}^\infty\) in \(Z\) has a convergent subsequence \((z^{(n_j)})_{j = 1}^\infty\) which converges in \(Y\) with respect to \(d|_{Y \times Y}\).
  Since \(Z\) is closed in \((Y, d|_{Y \times Y})\), by \labelcrefs{ii:1.2.15.b} we know that \((z^{(n_j)})_{j = 1}^\infty\) converges in \(Z\) with respect to \(d|_{Y \times Y}\).
  Since \((z^{(n)})_{n = 1}^\infty\) was arbitrary, by \labelcrefs{ii:1.5.1} we know that \((Z, d|_{Z \times Z})\) is compact.
\end{proof}

\begin{proof}[\pf{ii:1.5.10.b}]
  ...
  \begin{itemize}
    ...
    \item If there does not exist a subsequence \((y^{(k_j)})_{j = 1}^\infty\) whose elements are in \(\bigcup_{i = 1}^n Y_i\), then there is only finitely many elements in \((y^{(k)})_{k = 1}^\infty\) which are in \(\bigcup_{i = 1}^n Y_i\).
          ...
          By hypothesis we know that \((Y_{n + 1}, d)\) is compact, thus by \labelcrefs{ii:1.5.1} there exists a subsequence \((y^{(k_{j_p})})_{p = 1}^\infty\) of \((y^{(k_j)})_{j = 1}^\infty\) converges in \(Y_{n + 1}\) with respect to \(d\).
  ...
  Since \((y^{(k)})_{k = 1}^\infty\) was arbitrary, by \labelcrefs{ii:1.5.1} \((\bigcup_{i = 1}^{n + 1} Y_i, d)\) is compact.
  This closes the induction.
\end{proof}

\begin{proof}[\pf{ii:1.5.10.c}]
  ...
  Thus, by \labelcrefs{ii:1.5.1} \((\emptyset, d)\) is compact and the base case holds.
  ...
  \begin{itemize}
    \item If the set \(\set{k \in \N : y^{(k)} = x_0}\) is finite, then we can have a subsequence \((y^{(k_j)})_{j = 1}^\infty\) whose elements are in \(Y \setminus \set{x_0}\).
          Since \((y^{(k_j)})_{j = 1}^\infty\) is in \(Y \setminus \set{x_0}\) and \(\#(Y \setminus \set{x_0}) = n\), by the induction hypothesis we know that there exists a subsequence of \((y^{(k_j)})_{j = 1}^\infty\) which converges in \(Y \setminus \set{x_0}\) with respect to \(d\).
  ...
  Since \(P(n)\) is true for every \(n \in \N\), by \labelcrefs{ii:1.5.1} we know that if \(Y\) is a finite subset of \(X\), then \((Y, d|_{Y \times Y})\) is compact.
\end{proof}

\exercisesection

\begin{ex}\label{ii:ex:1.5.1}
  Show that Definitions 9.1.22 in Analysis I and \labelcrefs{ii:1.5.3} match when talking about subsets of the real line with the standard metric.
\end{ex}

\begin{proof}
  Let \(X \subseteq \R\) and let \(d = d_{l^1}|_{\R \times \R}\).
  By \labelcrefs{ii:ex:1.1.2} we know that \((\R, d)\) is a metric space.
  Then we have
  \begin{align*}
    ...
    \iff & X \text{ is bounded in the sense of \labelcrefs{ii:1.5.3}}.
  \end{align*}
\end{proof}

\begin{ex}\label{ii:ex:1.5.2}
  Prove \labelcrefs{ii:1.5.5}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:1.5.5}.
\end{proof}

\begin{ex}\label{ii:ex:1.5.3}
  Prove \labelcrefs{ii:1.5.7}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:1.5.7}.
\end{proof}
...
\begin{proof}
  ...
  By \labelcrefs{ii:1.2.1} and \labelcrefs{ii:1.2.15.c} we know that
  \[
    B_{(\R, d_{l^1}|_{\R \times \R})}(1, 1) = (0, 2)
  \]
  is open in \((\R, d_{l^1}|_{\R \times \R})\) and by \labelcrefs{ii:1.2.15.d}
  \[
    f\big((0, 2)\big) = \set{1}
  \]
  is closed in \((\R, d_{l^1}|_{\R \times \R})\).
  By \labelcrefs{ii:1.2.15.a} we know that \(\set{1}\) is not open in \((\R, d_{l^1}|_{\R \times \R})\) since we cannot find an \(r \in \R^+\) such that \(B_{(\R, d_{l^1})}(1, r) \subseteq \set{1}\).
...
\begin{proof}
  ...
  Let \(F = (-\infty, 0]\).
  If \(x_0 \in \partial_{(\R, d)}(F)\), then by \labelcrefs{ii:1.2.5} we must have \(B(x_0, r) \not\subseteq F\) and \(B(x_0, r) \cap F \neq \emptyset\) for every \(r \in \R^+\).
  Thus, we must have \(\partial_{(\R, d)}(F) = \set{0}\).
  Since \(0 \in F\), by \labelcrefs{ii:1.2.12} we know that \(F\) is closed in \((\R, d)\).
  Since
  \[
    f(F) = f\big((-\infty, 0]\big) = (0, 1]
  \]
  and \(0 \notin (0, 1]\), by \labelcrefs{ii:1.2.12} we know that \(f(F)\) is not closed in \((\R, d)\).
  Thus, the function \(f\) and the closed set \(F\) satisfy the requirements.
\end{proof}

\begin{ex}\label{ii:ex:1.5.6}
  Prove \labelcrefs{ii:1.5.9}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:1.5.9}.
\end{proof}

\begin{ex}\label{ii:ex:1.5.7}
  Prove \labelcrefs{ii:1.5.10}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:1.5.10}.
\end{proof}

\begin{ex}\label{ii:ex:1.5.8}
  Let \((X, d_{l^1})\) be the metric space from \labelcrefs{ii:ex:1.1.15}.
...
\begin{proof}
  ...
  \]
  for every \(n \in \N\), we know that \(e^{(n)}\) is absolutely convergent and by \labelcrefs{ii:ex:1.1.15} \(e^{(n)} \in X\).
  By \labelcrefs{ii:ex:1.1.15} we know that
  \[
  ...
  \end{align*}
  by \labelcrefs{ii:1.2.1} we know that the ball
  \[
  ...
  Thus, by \labelcrefs{ii:1.5.3} we know that \(E\) is bounded in \((X, d_{l^1})\).
  ...
  By \labelcrefs{ii:1.2.10.c} we know that there exists a sequence \((a^{(k)})_{k = 0}^\infty\) in \(E\) such that \(\lim_{k \to \infty} d_{l^1}\big((a_j^{(k)})_{j = 0}^\infty, x\big) = 0\).
  By \labelcrefs{ii:1.4.7} we know that \((a^{(k)})_{k = 0}^\infty\) is a Cauchy sequence in \((X, d_{l^1})\).
  Let \(k, k' \in \N\).
  By \labelcrefs{ii:1.4.6} we have
  \[
  ...
  \]
  Thus, by \labelcrefs{ii:1.4.6} \((e^{(n)})_{n = 0}^\infty\) is not a Cauchy sequence in \((E, d_{l^1}|_{E \times E})\).
  Similarly, any subsequence of \((e^{(n)})_{n = 0}^\infty\) is not a Cauchy sequence in \((E, d_{l^1}|_{E \times E})\).
  By \labelcrefs{ii:1.4.7} this means no subsequence is convergent in \((E, d_{l^1}|_{E \times E})\), and by \labelcrefs{ii:1.5.1} \((E, d_{l^1}|_{E \times E})\) is not compact.
\end{proof}
...
\begin{ex}\label{ii:ex:1.5.10}
  ...
  \begin{enumerate}
    \item\label{ii:ex:1.5.10.a} Show that every totally bounded space is bounded.
    \item\label{ii:ex:1.5.10.b} Show the following stronger version of \labelcrefs{ii:1.5.5}:
    if \((X, d)\) is compact, then complete and totally bounded.
    \item\label{ii:ex:1.5.10.c} Conversely, show that if \(X\) is complete and totally bounded, then \(X\) is compact.
  \end{enumerate}
\end{ex}

\begin{proof}[\pf{ii:ex:1.5.10.a}]
  ...
  \]
  If \(n = 0\), then we have \(X = \emptyset\) and by \labelcrefs{ii:1.5.3} \(\emptyset\) is bounded in \((\emptyset, d)\).
  So suppose that \(n > 0\).
...
\begin{proof}[\pf{ii:ex:1.5.10.b}]
  By \labelcrefs{ii:1.5.5} we know that if \((X, d)\) is compact then \((X, d)\) is complete.
  ...
  \begin{align*}
    ...
    \implies & \bigcup_{y \in X} B_{(X, d)}(y, \varepsilon) \text{ is an open cover of } X \text{ in } (X, d)                            &  & \by{ii:1.2.15.c,ii:1.2.15.g} \\
...
\begin{proof}[\pf{ii:ex:1.5.10.c}]
  ...
  So suppose that \(X \neq \emptyset\).
  To show that \((X, d)\) is compact, by \labelcrefs{ii:1.5.1} we need to show that every sequence in \(X\) has a convergent subsequence which converges in \(X\) with respect to \(d\).
  ...
  \begin{align*}
    ...
    \implies & \forall i, j \geq 2J, \exists y \in A_{\dfrac{1}{2J}} :                                                                        \\
             & d(x^{(n_i)}, x^{(n_j)}) \leq d(x^{(n_i)}, y) + d(x^{(n_j)}, y) < \varepsilon                   &  & \by{ii:1.1.2.c,ii:1.1.2.d} \\
  ...
  \]
  and by \labelcrefs{ii:1.4.6} \((x^{(n_j)})_{j = 1}^\infty\) is a Cauchy sequence in \((X, d)\).
  Since \((X, d)\) is compatible, by \labelcrefs{ii:1.4.10} we know that \((x^{(n_j)})_{j = 1}^\infty\) converges in \(X\) with respect to \(d\).
  Since \((x^{(n)})_{n = 1}^\infty\) was arbitrary, we know that any sequence in \(X\) has a subsequence converges in \(X\) with respect to \(d\), and by \labelcrefs{ii:1.5.1} \((X, d)\) is compact.
\end{proof}

\begin{ex}\label{ii:ex:1.5.11}
...
\begin{proof}
  ...
  Suppose for the sake of contradiction that \((X, d)\) is not compact.
  Then by \labelcrefs{ii:1.5.1} we know that there exists a sequence \((x^{(n)})_{n = 1}^\infty\) in \(X\) which has no convergent subsequence which converges in \(X\) with respect to \(d\).
  We know that
  \[
    \forall N \in \Z^+, \set{n \in \Z^+ : x^{(n)} = x^{(N)}} \text{ is finite}.
  \]
  ...
  By \labelcrefs{ii:ex:1.5.9} we know that \((x^{(n)})_{n = 1}^\infty\) cannot have a limit point in \(X\) with respect to \(d\).
  By \labelcrefs{ii:1.4.4} this means
  \begin{align*}
...
\begin{ex}\label{ii:ex:1.5.12}
  ...
  \begin{enumerate}
    \item\label{ii:ex:1.5.12.a} Show that \(X\) is always complete.
    \item\label{ii:ex:1.5.12.b} When is \(X\) compact, and when is \(X\) not compact?
    Prove your claim.
  \end{enumerate}
\end{ex}

\begin{proof}[\pf{ii:ex:1.5.12.a}]
  Let \((x^{(n)})_{n = 1}^\infty\) be a Cauchy sequence in \((X, d_{\text{disc}})\).
  Let \(i, j \in \Z^+\).
  By \labelcrefs{ii:1.4.6} we know that
  \[
  ...
  \]
  But by \labelcrefs{ii:1.1.11} we know that
  \[
  ...
  \]
  and by \labelcrefs{ii:1.1.14} we have \(\lim_{n \to \infty} d_{\text{disc}}(x^{(n)}, x^{(N)}) = 0\).
  This means \((x^{(n)})_{n = 1}^\infty\) converges to some \(x^{(N)} \in X\) with respect to \(d_{\text{disc}}\).
  Since \((x^{(n)})_{n = 1}^\infty\) was arbitrary, by \labelcrefs{ii:1.4.10} we know that \((X, d_{\text{disc}})\) is complete.
\end{proof}

\begin{proof}[\pf{ii:ex:1.5.12.b}]
  We claim that \((X, d_{\text{disc}})\) is compact iff \(X\) is finite.
  By \labelcrefs{ii:1.5.10.c} we know that if \(X\) is finite then \((X, d_{\text{disc}})\) is compact.
  So we only need to show that if \((X, d_{\text{disc}})\) is compact then \(X\) is finite.
  Suppose that \((X, d_{\text{disc}})\) is compact.
  By \labelcrefs{ii:1.5.8} we know that every open cover of \(X\) in \((X, d_{\text{disc}})\) has a finite subcover.
...
\begin{proof}
  ...
  Since \((E, d_{l^1}|_{\R \times \R})\) is compact, by \labelcrefs{ii:1.5.1} we know that there exists a subsequence \((x_1^{(n_j)})_{j = 1}^\infty\) which converges to some \(L_E \in E\) with respect to \(d_{l^1}|_{\R \times \R}\).
  Since \((x_2^{(n_j)})_{j = 1}^\infty\) is a subsequence of \((x_2^{(n)})_{n = 1}^\infty\) and \((F, d_{l^1}|_{\R \times \R})\) is compact, by \labelcrefs{ii:1.5.1} we know that there exists a subsequence \((x_2^{(n_{j_p})})_{p = 1}^\infty\) which converges to some \(L_F \in F\) with respect to \(d_{l^1}|_{\R \times \R}\).
  Since \(\lim_{j \to \infty} d_{l^1}|_{\R \times \R}(x_1^{(n_j)}, L_E) = 0\), by \labelcrefs{ii:1.4.9} we know that \(\lim_{p \to \infty} d_{l^1}|_{\R \times \R}(x_1^{(n_{j_p})}, L_E) = 0\).
  Thus, by \labelcrefs{ii:1.1.18.a,ii:1.1.18.b,ii:1.1.18.d} we have
  \[
  ...
  \]
  Since \((x^{(n)})_{n = 1}^\infty\) was arbitrary, by \labelcrefs{ii:1.5.1} we know that \((E \times F, d_{l^2}|_{\R^2 \times \R^2})\) is compact.
\end{proof}

\begin{ex}\label{ii:ex:1.5.14}
...
\begin{proof}
  ...
  \end{align*}
  Since \((E, d)\) is compact, by \labelcrefs{ii:1.5.1} we know that there exists a subsequence \((x^{(n_j)})_{j = 1}^\infty\) such that
  \[
...
\begin{proof}
  Suppose for the sake of contradiction that \(\bigcap_{\alpha \in I} K_\alpha = \emptyset\).
  Since
  \[
  ...
  We know that the sequence \((n)_{n = 1}^\infty\) in \(\R^+\) has no convergent subsequence with respect to \(d_{l^1}|_{\R \times \R}\), thus by \labelcrefs{ii:1.5.1} \((\R^+, d_{l^1}|_{\R \times \R})\) is not compact.
  ...
  Suppose for the sake of contradiction that \(\bigcap_{\varepsilon \in \R^+} K_\varepsilon \neq \emptyset\).
