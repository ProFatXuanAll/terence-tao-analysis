...
\begin{proof}
  ...
  Thus, by \cref{ii:1.1.18.b,ii:1.1.18.d} we know that \((a^{(k_{j_p})})_{p = 1}^\infty\) converges in \(\R^{n + 1}\) with respect to \(d_{l^1}|_{\R^{n + 1} \times \R^{n + 1}}\), and this closes the induction.
...
\begin{ex}\label{ii:ex:1.5.10}
  ...
  \begin{enumerate}
    ...
    \item\label{ii:ex:1.5.10.b} Show the following stronger version of \cref{ii:1.5.5}:
...
\begin{proof}
  ...
  Thus, by \cref{ii:1.1.18.a,ii:1.1.18.b,ii:1.1.18.d} we have
  \[
