...
\begin{ex}\label{ii:ex:1.1.3}
  ...
  \begin{enumerate}
    \item\label{ii:ex:1.1.3.a} Give an example of a pair \((X, d)\) which obeys axioms (bcd) of \cref{ii:1.1.2}, but not (a).
    \item\label{ii:ex:1.1.3.b} Give an example of a pair \((X, d)\) which obeys axioms (acd) of \cref{ii:1.1.2}, but not (b).
    \item\label{ii:ex:1.1.3.c} Give an example of a pair \((X, d)\) which obeys axioms (abd) of \cref{ii:1.1.2}, but not (c).
    \item\label{ii:ex:1.1.3.d} Give an example of a pair \((X, d)\) which obeys axioms (abc) of \cref{ii:1.1.2}, but not (d).
  \end{enumerate}
\end{ex}
