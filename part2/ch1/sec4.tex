...
\begin{proof}
  ...
  Let \(N \in \N\).
  Since \(L\) is a limit point of \((x^{(n)})_{n = m}^\infty\) in \((X, d)\), by \labelcrefs{ii:1.4.4} we know that
  \[
  ...
  \end{align*}
  and thus by \labelcrefs{ii:1.1.14} the sequence \((x^{(n_j)})_{j = 1}^\infty\) converges to \(L\) with respect to \(d\).
...
\begin{proof}
  Let \(N \in \N\).
  Since \(\lim_{n \to \infty} d(x^{(n)}, x_0) = 0\), by \labelcrefs{ii:1.1.14} we know that
  \[
  ...
  \begin{align*}
    d(x^{(n)}, x^{(k)}) & \leq d(x^{(n)}, x_0) + d(x_0, x^{(k)})               &  & \by{ii:1.1.2.d} \\
                        ...
                        & = \varepsilon
  \end{align*}
  and by \labelcrefs{ii:1.4.6} \((x^{(n)})_{n = m}^\infty\) is a Cauchy sequence in \((X, d)\).
\end{proof}
...
\begin{proof}
  ...
  Since \(\lim_{j \to \infty} d(x^{(n_j)}, x_0) = 0\), by \labelcrefs{ii:1.1.14} we know that
  \[
    \forall \varepsilon \in \R^+, \exists N_1 \geq 1 : \forall j \geq N_1, d(x^{(n_j)}, x_0) \leq \dfrac{\varepsilon}{2}.
  \]
  Now fix such \(\varepsilon\).
  Since \((x^{(n)})_{n = m}^\infty\) is a Cauchy sequence in \((X, d)\), by \labelcrefs{ii:1.4.6} we know that
  \[
  ...
  \begin{align*}
    d(x^{(i)}, x_0) & \leq d(x^{(i)}, x^{(n_j)}) + d(x^{(n_j)}, x_0)       &                     & \by{ii:1.1.2.d} \\
                    ...
                    & = \varepsilon.
  \end{align*}
  Since \(\varepsilon\) was arbitrary, by \labelcrefs{ii:1.1.14} \(\lim_{n \to \infty} d(x^{(n)}, x_0) = 0\).
\end{proof}
...
\begin{prop}\label{ii:1.4.12}
  \quad
  \begin{enumerate}
    \item\label{ii:1.4.12.a} Let \((X, d)\) be a metric space, and let \((Y, d|_{Y \times Y})\) be a subspace of \((X, d)\).
    If \((Y, d|_{Y \times Y})\) is complete, then \(Y\) must be closed in \(X\).
    \item\label{ii:1.4.12.b} Conversely, suppose that \((X, d)\) is a complete metric space, and \(Y\) is a closed subset of \(X\).
...
\begin{proof}
  ...
  \end{align*}
  Since \(x_0\) was arbitrary, we have \(\partial_{(X, d)}(Y) \subseteq Y\) and by \labelcrefs{ii:1.2.12} \(Y\) is closed in \((X, d)\).
  ...
  Since \((X, d)\) is complete, by \labelcrefs{ii:1.4.10} we know that \(\lim_{n \to \infty} d(x^{(n)}, x_0) = 0\) for some \(x_0 \in X\).
  Since \((x^{(n)})_{n = m}^\infty\) is in \(Y\) and \(\lim_{n \to \infty} d(x^{(n)}, x_0) = 0\), by \labelcrefs{ii:1.2.10.c} we know that \(x_0 \in \overline{Y}_{(X, d)}\).
  But \(Y\) is closed in \((X, d)\), thus by \labelcrefs{ii:1.2.15.b} we know that \(x_0 \in Y\).
  Since \((x^{(n)})_{n = m}^\infty\) was arbitrary Cauchy sequence in \((Y, d|_{Y \times Y})\), by \labelcrefs{ii:1.4.10} \((Y, d|_{Y \times Y})\) is complete.
\end{proof}

\exercisesection

\begin{ex}\label{ii:ex:1.4.1}
  Prove \labelcrefs{ii:1.4.3}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:1.4.3}.
\end{proof}
...
\begin{proof}
  See \labelcrefs{ii:1.4.5}.
\end{proof}

\begin{ex}\label{ii:ex:1.4.3}
  Prove \labelcrefs{ii:1.4.7}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:1.4.7}.
\end{proof}

\begin{ex}\label{ii:ex:1.4.4}
  Prove \labelcrefs{ii:1.4.9}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:1.4.9}.
\end{proof}
...
\begin{proof}
  ...
  By \labelcrefs{ii:1.4.5} we know that \(\exists (x^{(n_j)})_{j = 1}^\infty\) in \(E\) such that \(\lim_{j \to \infty} d(x^{(n_j)}, L) = 0\).
  Thus, by \labelcrefs{ii:1.2.10.c} \(L \in \overline{E}_{(X, d)}\).
  ...
  Then by \labelcrefs{ii:1.2.9} we know that \(1 \in \overline{E}_{(X, d)}\).
  But by \labelcrefs{ii:1.4.4} we know that \(1\) is not an limit point of \((x^{(n)})_{n = m}^\infty\) in \((\R, d_{l^1})\) since every subsequence of \((x^{(n)})_{n = 1}^\infty\) converges to \(0\) with respect to \(d_{l^1}|_{\R \times \R}\).
...
\begin{proof}
  ...
  Then by \labelcrefs{ii:1.4.5} \(\exists (x^{(n_i)})_{i = 1}^\infty, (x^{(n_j)})_{j = 1}^\infty,\) which converges to \(L\) and \(L'\) respectively.
  Since \((x^{(n)})_{n = m}^\infty\) is a Cauchy sequence in \((X, d)\), by \labelcrefs{ii:1.4.9} we know that \((x^{(n)})_{n = m}^\infty\) converges to \(L\) and \(L'\) with respect to \(d\), which contradict to \labelcrefs{ii:1.1.20}.
  Thus, every Cauchy sequence can have at most one limit point.
\end{proof}

\begin{ex}\label{ii:ex:1.4.7}
  Prove \labelcrefs{ii:1.4.12}.
\end{ex}

\begin{proof}
  See \labelcrefs{ii:1.4.12}.
\end{proof}
...
\begin{ex}\label{ii:ex:1.4.8}
  ...
  \begin{enumerate}
    \item\label{ii:ex:1.4.8.a} Given any Cauchy sequence \((x^{(n)})_{n = m}^\infty\) in \(X\), we introduce the \emph{formal limit} \\
    \(\LIM_{n \to \infty} x_n\).
    ...
    \item\label{ii:ex:1.4.8.b} Let \(\overline{X}\) be the space of all formal limits of Cauchy sequences in \(X\), with the above equality relation.
    ...
    \item\label{ii:ex:1.4.8.c} Show that the metric space \((\overline{X}, d_{\overline{X}})\) is complete.
    \item\label{ii:ex:1.4.8.d} We identify an element \(x \in X\) with the corresponding formal limit \(\LIM_{n \to \infty} x\) in \(X\);
    ...
    \item\label{ii:ex:1.4.8.e} Show that the closure of \(X\) in \(\overline{X}\) is \(\overline{X}\) (which explains the choice of notation \(\overline{X}\)).
    \item\label{ii:ex:1.4.8.f} Show that the formal limit agrees with the actual limit, thus if \((x_n)_{n = 1}^\infty\) is any Cauchy sequence in \(X\), then we have \(\lim_{n \to \infty} x_n = \LIM_{n \to \infty} x_n\) in \(\overline{X}\).
  \end{enumerate}
\end{ex}

\begin{proof}[\pf{ii:ex:1.4.8.a}]
  ...
  \end{align*}
  and thus the equality relation of \labelcrefs{ii:ex:1.4.8.a} is reflexive.
  ...
  \end{align*}
  and thus the equality relation of \labelcrefs{ii:ex:1.4.8.a} is symmetry.
  ...
  \end{align*}
  and thus the equality relation of \labelcrefs{ii:ex:1.4.8.a} is transitive.
\end{proof}

\begin{proof}[\pf{ii:ex:1.4.8.b}]
  ...
  \]
  Let \(N = \max(N_1, N_2)\).
  Then by \labelcrefs{ii:1.1.2} we have
  \begin{align*}
  ...
  \begin{align*}
             & \begin{dcases}
               ...
               \end{dcases}                              &  & \by{ii:1.1.2.c,ii:1.1.2.d}                                                                                           \\
    \implies & \begin{dcases}
  ...
  \end{align*}
  Thus, by \labelcrefs{ii:1.1.2} \((\overline{X}, d_{\overline{X}})\) is a metric space.
\end{proof}

\begin{proof}[\pf{ii:ex:1.4.8.c}]
  Let \(I, J, K, N, k_1, k_2, n_1, n_2 \in \Z^+\).
  Let \((a^{(n)})_{n = m}^\infty\) be arbitrary Cauchy sequence in \((\overline{X}, d_{\overline{X}})\).
  Since \((a^{(n)})_{n = m}^\infty\) is a Cauchy sequence in \((\overline{X}, d_{\overline{X}})\), by \labelcrefs{ii:1.4.6} we know that
  \begin{align*}
  ...
  Since \(a^{(n)} \in \overline{X}\) for each \(n \geq m\), by \labelcrefs{ii:ex:1.4.8.b} we know that there exists a Cauchy sequence \((a_k^{(n)})_{k = 1}^\infty\) in \((X, d)\) such that \(\LIM_{k \to \infty} a_k^{(n)} = a^{(n)}\) for each \(n \geq m\).
  ...
  By \labelcrefs{ii:1.4.6} it suffices to show that
  \[
  ...
  \[
    \forall \varepsilon \in \R^+, \exists K \geq 1 : \forall k_1, k_2 \geq K, d(b_{k_1}, b_{k_2}) \leq \varepsilon.
  \]
  Thus, by \labelcrefs{ii:1.4.6} \((b_k)_{k = 1}^\infty\) is a Cauchy sequence in \((X, d)\).
  ...
  Since for arbitrary Cauchy sequence \((a^{(n)})_{n = m}^\infty\) in \((\overline{X}, d_{\overline{X}})\), \((a^{(n)})_{n = m}^\infty\) converges in \(\overline{X}\) with respect to \(d_{\overline{X}}\), by \labelcrefs{ii:1.4.10} we know that \((\overline{X}, d_{\overline{X}})\) is complete.
\end{proof}

\begin{proof}[\pf{ii:ex:1.4.8.d}]
...
\begin{proof}[\pf{ii:ex:1.4.8.e}]
  From \labelcrefs{ii:ex:1.4.8.d} have \(d = d_{\overline{X}}|_{X \times X}\).
  Let \(Y\) be the closure of \(X\) in \((\overline{X}, d_{\overline{X}})\).
  We want to show that \(Y = \overline{X}\).
  By \labelcrefs{ii:1.2.9} we know that \(Y \subseteq \overline{X}\).
  Thus, we only need to show that \(\overline{X} \subseteq Y\).

  Let \(x_0 \in \overline{X}\).
  By \labelcrefs{ii:ex:1.4.8.b} there exists a Cauchy sequence \((a_n)_{n = 1}^\infty\) in \((X, d_{\overline{X}})\) such that \(\LIM_{n \to \infty} a_n = x_0\).
  Since \((\overline{X}, d_{\overline{X}})\) is complete, by \labelcrefs{ii:1.4.10} we know that \((a_n)_{n = 1}^\infty\) converges in \(\overline{X}\) with respect to \(d_{\overline{X}}\).
  But we know that \((a_n)_{n = 1}^\infty\) is a Cauchy sequence in \((X, d_{\overline{X}})\), thus by \labelcrefs{ii:1.2.10.c} \(x_0\) is an adherent point of \(X\) in \((\overline{X}, d_{\overline{X}})\) and \(x_0 \in Y\).
  Since \(x_0\) was arbitrary, we thus have \(\overline{X} \subseteq Y\).
\end{proof}

\begin{proof}[\pf{ii:ex:1.4.8.f}]
  By \labelcrefs{ii:ex:1.4.8.d} we know that if \((x_n)_{n = 1}^\infty\) is a Cauchy sequence in \((X, d)\), then \((x_n)_{n = 1}^\infty\) is also a Cauchy sequence in \((\overline{X}, d_{\overline{X}})\).
  Thus, by \labelcrefs{ii:ex:1.4.8.c,ii:ex:1.4.8.e} we have \(\lim_{n \to \infty} x_n = \LIM_{n \to \infty} x_n\).
\end{proof}
