...
\begin{proof}
    ...
    \]
    The function \(g\) is continuous on \([0, 1]\) since \(y \mapsto \frac{y - a}{b - a}\) is bijective on \([a, b]\), and so by Corollary \ref{3.8.19} we may find a polynomial \(Q : [0, 1] \to \R\) such that \(\abs{Q(x) - g(x)} \leq \varepsilon\) for all \(x \in [0, 1]\).
...
\begin{proof}{(a)}
    ...
    Since \(z_x\) is continuous on \(\R\), by Definition \ref{3.8.4} and Definition \ref{3.8.9} we have
    \begin{align*}
    ...
    \end{align*}
    Since \(f, g\) are compactly supported and continuous on \(\R\), by Exercise \ref{ex 3.8.3} we know that
    \[
...
\begin{proof}
    ...
    \end{itemize}
    Since \(f\) is continuous on \(\R\), by Definition \ref{3.8.9} we have
    \begin{align*}
...
\begin{proof}
    Let \(\varepsilon \in \R^+\).
    Since \(f\) is continuous on \(\R\) and supported on \([0, 1]\), by Exercise \ref{ex 3.8.3} we know that \(f\) is bounded by some \(M \in \R^+\) and \(f\) is uniformly continuous on \(\R\).
    This means
    \[
    ...
    By Definition \ref{3.8.6} we know that \(P\) is continuous on \(\R\) and supported on \([-1, 1]\).
    Since \(f\) is continuous on \(\R\) and supported on \([0, 1]\), by Lemma \ref{3.8.13} we know that \(f * P\) is a polynomial on \([0, 1]\).
...
\begin{proof}
    Using Lemma \ref{3.8.6} we can define an \(F : \R \to \R\) such that
    \[
...
\begin{proof}
    ...
    By Corollary \ref{3.8.18}, we can thus find a polynomial \(Q : [0, 1] \to \R\) such that \(\abs{Q(x) - F(x)} \leq \varepsilon\) for all \(x \in [0, 1]\).
    But
    \[
...
\begin{proof}
    Since \(f\) is compactly supported, by Definition \ref{3.8.4} we know that there exists some \(a, b \in \R\) such that
    \[
        \forall x \notin [a, b], f(x) = 0.
    \]
    Since \([a, b]\) is closed and bounded in \((\R, d_{l^1}|_{\R \times \R})\), by Theorem \ref{1.5.7} we know that \(\big([a, b], d_{l^1}|_{\R \times \R}\big)\) is compact.
    Since \(\big([a, b], d_{l^1}|_{\R \times \R}\big)\) is compact and \(f\) is continuous on \([a, b]\), by Proposition \ref{2.3.2} we know that \(f\) is bounded.
...
\begin{proof}
    ...
    \begin{align*}
        \int_{[0, 1]} f(x) P(x) \; dx & = \int_{[0, 1]} f(x) \sum_{j = 0}^n c_j x^j \; dx \\
                                      ...
                                      & = 0.
    \end{align*}
    Since \([0, 1]\) is closed and bounded in \((\R, d_{l^1}|_{\R \times \R})\), by Theorem \ref{1.5.7} we know that \(\big([0, 1], d_{l^1}|_{\R \times \R}\big)\) is compact.
    By Proposition \ref{2.3.2} we know that \(f\) is bounded, i.e., there exists a \(M \in \R^+\) such that \(\abs{f(x)} \leq M\) for all \(x \in [0, 1]\).
