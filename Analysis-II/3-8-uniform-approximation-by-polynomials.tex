...
\begin{proof}
    ...
    \begin{align*}
        ...
        \implies & \forall\ x \in [0, 1],                                                                                                                                              \\
                 & f(x) \int_{[-\delta, \delta]} g(y) \; dy - \varepsilon \int_{[-\delta, \delta]} g(y) \; dy                                                                          \\
                 & \leq \int_{[-\delta, \delta]} g(y) f(x - y) \; dy                                                                                                                   \\
                 & \leq f(x) \int_{[-\delta, \delta]} g(y) \; dy + \varepsilon \int_{[-\delta, \delta]} g(y) \; dy                                                                     \\
        \implies & \forall\ x \in [0, 1],                                                                                                                                              \\
    ...
    % Since \(f\) is supported on \([0, 1]\), by Definition \ref{3.8.4} we have
    % \begin{align*}
    %              & \forall\ y \in \mathbf{R} \setminus [0, 1], f(y) = 0                                      \\
    %     \implies & \forall\ x \in \mathbf{R}, \forall\ y \in \mathbf{R} \setminus [0, 1], f(y) g(x - y) = 0.
    % \end{align*}
\end{proof}
