...
\setcounter{thm}{2}
\begin{thm}[Weierstrass approximation theorem]\label{3.8.3}
...
\begin{defn}[Compactly supported functions]\label{3.8.4}
  Let \([a, b]\) be an interval.
...
\begin{defn}[Approximation to the identity]\label{3.8.6}
...
\begin{lem}[Polynomials can approximate the identity]\label{3.8.8}
...
\begin{defn}[Convolution]\label{3.8.9}
...
\begin{prop}[Basic properties of convolution]\label{3.8.11}
...
\begin{cor}[Weierstrass approximation theorem I]\label{3.8.15}
...
\begin{cor}[Weierstrass approximation theorem II]\label{3.8.18}
...
\begin{cor}[Weierstrass approximation theorem III]\label{3.8.19}
...
\begin{proof}
  ...
  \begin{align*}
             & d_\infty(P, f) \leq \dfrac{\varepsilon}{M}                                                                                                                            \\
    \implies & \sup_{x \in [0, 1]} \abs{P(x) - f(x)} \leq \dfrac{\varepsilon}{M}                                                                       &  & \text{(by \cref{3.4.2})} \\
