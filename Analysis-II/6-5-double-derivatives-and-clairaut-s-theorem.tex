...
\begin{proof}
  ...
  \begin{align*}
     ...
     & = \lim_{t \to 0 ; t \neq 0} \dfrac{f\big((a, b) + t(1, 0)\big) - f(a, b)}{t}                                                           &  & \text{(by \cref{6.3.7})} \\
  ...
  \begin{align*}
     ...
     & = \lim_{t \to 0 ; t \neq 0} \dfrac{f\big((a, b) + t(0, 1)\big) - f(a, b)}{t}                                                             &  & \text{(by \cref{6.3.7})} \\
