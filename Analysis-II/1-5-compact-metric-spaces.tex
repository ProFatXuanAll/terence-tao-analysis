...
\begin{proof}
  ...
  By \cref{1.2.15}(a) we know that \(\set{1}\) is not open in \((\R, d_{l^1}|_{\R \times \R})\) since we cannot find an \(r \in \R^+\) such that \(B_{(\R, d_{l^1})}(1, r) \subseteq \set{1}\).
...
\begin{proof}{(b)}
  ...
  We know that
  \begin{align*}
             & \forall y \in F, B_{(X, d)}(y, \dfrac{1}{2}) = \set{z \in X : d(z, y) < \dfrac{1}{2}} &  & \by{1.2.1}  \\
    \implies & \forall y \in F, B_{(X, d)}(y, \dfrac{1}{2}) = \set{y}                                &  & \by{1.1.11} \\
...
\begin{proof}
  ...
  Then we have
  \begin{align*}
             & \forall \varepsilon \in \R^+, \overline{K_\varepsilon}_{(\R^+, d_{l^1}|_{\R \times \R})} = \set{\varepsilon} &  & \by{1.2.5}                   \\
