...
\begin{proof}
    Since \((K_n, d)\) is compact and \(K_n \subseteq K_1\) for every \(n \geq 1\), by Corollary \ref{1.5.6} we know that \((K_n, d)\) is closed in \(K_1\).
    Let \(V_n = K_1 \setminus K_n\) for every \(n \geq 1\).
    Then for every \(n \geq 1\), \(V_n \subseteq K_1\) and by Proposition \ref{1.2.15}(e) we know that \((V_n, d)\) is open in \(K_1\).
