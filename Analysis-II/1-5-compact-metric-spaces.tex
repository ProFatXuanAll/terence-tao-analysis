...
\begin{proof}
    ...
    Thus by Proposition \ref{1.1.18}(b)(d) we know that \((a^{(k_{j_p})})_{p = 1}^\infty\) converges in \(\mathbf{R}^{n + 1}\) with respect to \(d_{l^1}|_{\mathbf{R}^{n + 1} \times \mathbf{R}^{n + 1}}\), and this closes the induction.
