...
\begin{remark}\label{1.5.4}
    Definition \ref{1.5.3} is compatible with the definition of a bounded set in \((\R, d_{l^1}|_{\R \times \R})\).
\end{remark}
...
\begin{proof}
    ...
    Since \(a_n \in X \setminus B_{(X, d)}(x_0, n)\), by Definition \ref{1.2.1} we know that \(d(a_n, x_0) \geq n\) for all \(n \in \Z^+\).
...
\begin{proof}
    ...
    By Exercise \ref{ex 1.1.7} we know that \((\R^n, d_{l^1}|_{\R^n \times \R^n})\) is a metric space, and by Corollary \ref{1.5.6} we know that if \((E, d_{l^1}|_{E \times E})\) is compact, then \(E\) is closed and bounded in \((\R^n, d_{l^1}|_{\R^n \times \R^n})\).
    ...
    \begin{align*}
        ...
        \implies & \forall y \in \R^n, \exists\ r \in \R^+ : E \subseteq B_{(\R^n, d_{l^1}|_{\R^n \times \R^n})}(y, r)            & \text{(by Definition \ref{1.5.3})} \\
        ...
        \implies & \forall y \in \R^n, \exists\ r \in \R^+ : \forall x \in E,                                                                                          \\
                 & d_{l^1}|_{\R^n \times \R^n}(x, y) = \sum_{i = 1}^n \abs{x_i - y_i} < r                                         & \text{(by Definition \ref{1.2.1})} \\
        ...
        \implies & \forall y \in \R^n, \exists\ r \in \R^+ : \forall i \in I_n,                                                                                        \\
                 & E_i \subseteq B_{(\R, d_{l^1}|_{\R \times \R})}(y_i, r)                                                        & \text{(by Definition \ref{1.2.1})} \\
        \implies & \forall i \in I_n, E_i \text{ is bounded in } (\R, d_{l^1}|_{\R \times \R}).                                   & \text{(by Definition \ref{1.5.3})}
    \end{align*}
    ...
    But by Lemma \ref{1.4.3} we know that every subsequence of \((b^{(k_j)})_{j = 1}^\infty\) also converges in \(\R^n\) with respect to \(d_{l^1}|_{\R^n \times \R^n}\).
    In particular, \((b^{k_{j_p}})_{p = 1}^\infty\) converges in \(\R^n\) with respect to \(d_{l^1}|_{\R^n \times \R^n}\).
    Thus by Proposition \ref{1.1.18}(b)(d) we know that \((a^{(k_{j_p})})_{p = 1}^\infty\) converges in \(\R^{n + 1}\) with respect to \(d_{l^1}|_{\R^{n + 1} \times \R^{n + 1}}\), and this closes the induction.
    ...
    Since \(E\) is closed in \((\R^n, d_{l^1}|_{\R^n \times \R^n})\), by Proposition \ref{1.2.15}(b) we know that such subsequence must converges in \(E\) with respect to \(d_{l^1}|_{\R^n \times \R^n}\).
...
\begin{proof}
    ...
    \]
    and \((K_1, d)\) is compact, by Theorem \ref{1.5.8} we know that there exists a finite set \(F \subseteq \Z^+\) such that
    \[
...
\begin{proof}{(c)}
    ...
    Since \(P(n)\) is true for every \(n \in \N\), by Definition \ref{1.5.1} we know that if \(Y\) is a finite subset of \(X\), then \((Y, d|_{Y \times Y})\) is compact.
\end{proof}
...
\begin{proof}
    ...
    By Exercise \ref{ex 1.1.2} we know that \((\R, d)\) is a metric space.
    Then we have
    \begin{align*}
...
\begin{proof}
    ...
    \]
    is open in \((\R, d_{l^1}|_{\R \times \R})\) and by Proposition \ref{1.2.15}(d)
    \[
        f\big((0, 2)\big) = \{1\}
    \]
    is closed in \((\R, d_{l^1}|_{\R \times \R})\).
    By Proposition \ref{1.2.15}(a) we know that \(\{1\}\) is not open in \((\R, d_{l^1}|_{\R \times \R})\) since we cannot find an \(r \in \R^+\) such that \(B_{(\R, d_{l^1})}(1, r) \subseteq \{1\}\).
...
\begin{proof}
    ...
    Let \(F = (-\infty, 0]\).
    If \(x_0 \in \partial_{(\R, d)}(F)\), then by Definition \ref{1.2.5} we must have \(B(x_0, r) \not\subseteq F\) and \(B(x_0, r) \cap F \neq \emptyset\) for every \(r \in \R^+\).
    Thus we must have \(\partial_{(\R, d)}(F) = \{0\}\).
    Since \(0 \in F\), by Definition \ref{1.2.12} we know that \(F\) is closed in \((\R, d)\).
    Since
    \[
        f(F) = f\big((-\infty, 0]\big) = (0, 1]
    \]
    and \(0 \notin (0, 1]\), by Definition \ref{1.2.12} we know that \(f(F)\) is not closed in \((\R, d)\).
...
\begin{proof}
    ...
    \]
    for every \(n \in \N\), we know that \(e^{(n)}\) is absolutely convergent and by Exercise \ref{ex 1.1.15} \(e^{(n)} \in X\).
    ...
    \begin{align*}
        ...
        \implies & \exists\ N \in \N : \lim_{k \to \infty} d_{l^1}(a^{(k)}, a^{(N)}) = 0                     & \text{(by Definition \ref{1.1.14})}  \\
        \implies & \exists\ N \in \N : a^{(N)} = x                                                           & \text{(by Proposition \ref{1.1.20})} \\
        \implies & x \in E.
    \end{align*}
...
\begin{proof}
    ...
    Since \((E, d_{l^1}|_{\R \times \R})\) is compact, by Definition \ref{1.5.1} we know that there exists a subsequence \((x_1^{(n_j)})_{j = 1}^\infty\) which converges to some \(L_E \in E\) with respect to \(d_{l^1}|_{\R \times \R}\).
    Since \((x_2^{(n_j)})_{j = 1}^\infty\) is a subsequence of \((x_2^{(n)})_{n = 1}^\infty\) and \((F, d_{l^1}|_{\R \times \R})\) is compact, by Definition \ref{1.5.1} we know that there exists a subsequence \((x_2^{(n_{j_p})})_{p = 1}^\infty\) which converges to some \(L_F \in F\) with respect to \(d_{l^1}|_{\R \times \R}\).
    Since \(\lim_{j \to \infty} d_{l^1}|_{\R \times \R}(x_1^{(n_j)}, L_E) = 0\), by Lemma \ref{1.4.9} we know that \(\lim_{p \to \infty} d_{l^1}|_{\R \times \R}(x_1^{(n_{j_p})}, L_E) = 0\).
    ...
    \]
    Since \((x^{(n)})_{n = 1}^\infty\) is arbitrary, by Definition \ref{1.5.1} we know that \((E \times F, d_{l^2}|_{\R^2 \times \R^2})\) is compact.
\end{proof}
...
\begin{proof}
    ...
    We know that the sequence \((n)_{n = 1}^\infty\) in \(\R^+\) has no convergent subsequence with respect to \(d_{l^1}|_{\R \times \R}\), thus by Definition \ref{1.5.1} \((\R^+, d_{l^1}|_{\R \times \R})\) is not compact.
    For each \(\varepsilon \in \R^+\), we define \(K_\varepsilon = [\varepsilon, \infty)\) (which is an interval in \(\R\)).
    Then we have
    \begin{align*}
                 & \forall \varepsilon \in \R^+, \overline{K_\varepsilon}_{(\R^+, d_{l^1}|_{\R \times \R})} = \{\varepsilon\} & \text{(by Definition \ref{1.2.5})}      \\
        \implies & \forall \varepsilon \in \R^+, K_\varepsilon \text{ is closed in } (\R^+, d_{l^1}|_{\R \times \R})          & \text{(by Proposition \ref{1.2.15}(b))}
    \end{align*}
