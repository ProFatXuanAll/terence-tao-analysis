...
\begin{proof}
    ...
    From the proof above we know that \(E \subseteq \mathbf{R}^n\) is close and bounded implies \(E_i\) is bounded and \(E_i\) is a subset of some closed set \(C_i \subseteq \mathbf{R}\) for every \(i \in \{1, \dots, n\}\).
    Thus we know that for every sequence in \(E\) there exists a subsequence which converges in \(\mathbf{R}^n\).
    By Definition \ref{1.5.1} this means \(E\) is compact.
\end{proof}