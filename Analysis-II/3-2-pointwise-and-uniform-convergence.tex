...
\begin{proof}{(a)}
  ...
  \end{align*}
  Since \(x_0\) is arbitrary, by \cref{ii:3.2.1} we know that \((f_{a_n})_{n = 0}^\infty\) converges pointwise to \(f\) on \(\R\) with respect to \(d_{l^1}|_{\R \times \R}\).
...
\begin{proof}{(a)}
  ...
  \end{align*}
  and \(x_0\) is arbitrary, by \cref{ii:3.2.1} we know that \((f^{(n)})_{n = 1}^\infty\) converges pointwise to \(f\) on \(X\) with respect to \(d_Y\).
\end{proof}
...
\begin{proof}
  ...
  \]
  Since \(x_0\) is arbitrary, by \cref{ii:3.2.1} we know \((h \circ f_n)_{n = 1}^\infty\) converges pointwise to \(h \circ f\) on \(X\) with respect to \(d_{l^1}|_{\R \times \R}\).
\end{proof}
...
\begin{proof}
  ...
  \end{align*}
  Since \(y\) is arbitrary, by \cref{ii:1.5.3} we know that \(f_n\) is bounded for each \(n \in \Z^+\), i.e.,
  \[
