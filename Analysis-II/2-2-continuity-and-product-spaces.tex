...
\begin{proof}
    We first prove (a). Since \(f, g\) are continuous at \(x_0\) from \((X, d)\) to \((\mathbf{R}, d_{l^1}|_{\mathbf{R} \times \mathbf{R}})\), then by Additional Corollary \ref{ac 2.2.1} \(f \oplus g : X \to \mathbf{R}^2\) is also continuous at \(x_0\) from \((X, d)\) to \((\mathbf{R}^2, d_{l^1}|_{\mathbf{R}^2 \times \mathbf{R}^2})\).
