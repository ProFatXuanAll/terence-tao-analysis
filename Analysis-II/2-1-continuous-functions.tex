...
\begin{exercise}\label{ex 2.1.4}
    ...
    \end{enumerate}
    Explain brieﬂy why these examples do not contradict Corollary \ref{2.1.7}.
\end{exercise}
...
\begin{exercise}\label{ex 2.1.7}
    ...
    (Thus the notion of continuity is not aﬀected if one restricts the range of the function.)
\end{exercise}