...
\begin{proof}
    ...
    \end{align*}
    This means \(f\) is continuous at \(x_0\) in \((X, d_X)\) iff \(g\) is continuous at \(x_0\) in \((X, d_X)\).
    By Definition \ref{2.1.1} we conclude that \(f\) is continuous in \((X, d_X)\) iff \(g\) is continuous in \((X, d_X)\).
\end{proof}