...
\begin{proof}{(b)}
  ...
  \end{align*}
  Since \(x_0\) is arbitrary, by \cref{ii:2.1.1} we know that \(g \circ f\) is continuous from \((X, d_X)\) to \((Z, d_Z)\).
\end{proof}
...
\begin{proof}
  ...
  Since \(x_0\) is arbitrary, by \cref{ii:2.1.1} \(\iota_{E \to X}\) is continuous from \((E, d|_{E \times E})\) to \((X, d)\).
\end{proof}
