...
\begin{proof}
  ...
  \end{align*}
  Since \(\varepsilon\) is arbitrary, by \cref{ii:3.1.1} we have
  \[
    d_Y - \lim_{x \to x_0 ; x \in E} f(x) = L
  \]
...
\begin{proof}
  ...
  \begin{align*}
    g\big(U \cap (E \cup \set{x_0})\big) & = g\big((U \cap E) \cup \set{x_0}\big)                        \\
                                         ...
                                         & \subseteq V.
  \end{align*}
  Since \(V\) is arbitrary, by \cref{ii:2.5.8} we know that \(g\) is continuous at \(x_0\) from \((E \cup \set{x_0}, \mathcal{F}_{E \cup \set{x_0}})\) to \((Y, \mathcal{F}_Y)\).
