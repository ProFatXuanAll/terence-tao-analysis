...
\input{5-1-periodic-functions.tex}
\input{5-2-inner-products-on-periodic-functions.tex}
\input{5-3-trigonometric-polynomials.tex}
\input{5-4-periodic-convolutions.tex}
\input{5-5-the-fourier-and-plancherel-theorems.tex}
