...
\begin{proof}{(d)}
  ...
  \begin{align*}
     ...
     & = \sum_{m = 0}^\infty \dfrac{(x + y)^m}{m!}                                                            &                                   & \text{(by \cref{ex:4.2.5})}  \\
...
\begin{proof}{(a)}
  ...
  \begin{align*}
    ...
    \implies & \forall x \in (0, \infty), \ln'(x) = \dfrac{1}{x}.                    &  & \text{(by \cref{4.5.5})}
  \end{align*}
...
\begin{proof}
  ...
  Then we have
  \begin{align*}
    e^x & = \sum_{n = 0}^\infty \dfrac{x^n}{n!}                                     &         & \text{(by \cref{4.5.1})} \\
...
\begin{proof}
  ...
  we have
  \begin{align*}
    \forall n \geq 3, n! e & = n! \sum_{m = 0}^\infty \dfrac{1}{m!}                                                        &  & \text{(by \cref{4.5.3})} \\
...
\begin{proof}
  ...
  \begin{align*}
     ...
     & = \lim_{x \to 0 ; x \in \R^+} \dfrac{P_k(x^{-1}) \exp(-x^{-1}) - 0}{x} &  & \text{(by induction hypothesis)} \\
...
\begin{proof}
  ...
  \begin{align*}
    \forall x \in \R, f(x) & = \sum_{n = 0}^\infty \dfrac{f^{(n)}(0)}{n!} (x - 0)^n &  & \text{(by \cref{4.2.10})} \\
