...
\begin{proof}{(b)}
    By Theorem \ref{4.5.2}(a) we know that \(\exp\) is real analytic on \((-\infty, \infty)\), thus by Theorem \ref{4.1.6}(d) we know that \(\exp\) is differentiable on \((-\infty, \infty)\) and
    \[
