...
\begin{proof}
    ...
    Let \((X, d) = (\mathbf{R}, d_{l^1}|_{\mathbf{R} \times \mathbf{R}})\) and let \(x^{(n)} = 1 / n\).
    Then by Definition \ref{1.2.9} we know that \(1 \in \overline{E}_{(X, d)}\).
    But by Definition \ref{1.4.4} we know that \(1\) is not an limit point of \((x^{(n)})_{n = m}^\infty\) in \((\mathbf{R}, d_{l^1})\) since every subsequence of \((x^{(n)})_{n = 1}^\infty\) converges to \(0\) with respect to \(d_{l^1}|_{\mathbf{R} \times \mathbf{R}}\).
...
\begin{proof}{(b)}
    ...
    To show that the above limit exists, it will suffice to show that \((a^{(n)})_{n = m}^\infty\) converges in \(\mathbf{R}\) with respect to \(d_{l^1}|_{\mathbf{R} \times \mathbf{R}}\).
    ...
    \begin{align*}
         ...
         & = \varepsilon
    \end{align*}
    and thus \((a^{(n)})_{n = m}^\infty\) is a Cauchy sequence in \((\mathbf{R}, d_{l^1}|_{\mathbf{R} \times \mathbf{R}})\).
    Since \((\mathbf{R}, d_{l^1}|_{\mathbf{R} \times \mathbf{R}})\) is complete (see Theorem 6.4.18, Analysis I), we know that \((a^{(n)})_{n = m}^\infty\) converges in \(\mathbf{R}\) with respect to \(d_{l^1}|_{\mathbf{R} \times \mathbf{R}}\).
...
\begin{proof}{(c)}
    ...
    Since \(\Big(d(a_k^{(n_1)}, a_k^{(n_2)})\Big)_{k = 1}^\infty\) is a sequence in \(\mathbf{R}\) and converges to \(L\) with respect to \(d_{l^1}|_{\mathbf{R} \times \mathbf{R}}\), we have
    \begin{align*}
