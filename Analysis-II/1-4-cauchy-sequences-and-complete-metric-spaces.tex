...
\begin{proof}{(e)}
    ...
    By Exercise \ref{ex 1.4.8}(b) there exists a Cauchy sequence \((a_n)_{n = 1}^\infty\) in \(X\) such that \(\text{LIM}_{n \to \infty} a_n = x_0\).
...
\begin{proof}{(f)}
    By Exercise \ref{ex 1.4.8}(d) we know that \((x_n)_{n = 1}^\infty\) is also in \(\overline{X}\).
