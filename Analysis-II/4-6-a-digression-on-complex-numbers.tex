...
\setcounter{thm}{1}
\begin{defn}[Formal definition of complex numbers]\label{4.6.2}
...
\begin{defn}[Complex addition, negation, and zero]\label{4.6.3}
...
\begin{lem}[The complex numbers are an additive group]\label{4.6.4}
...
\begin{defn}[Complex multiplication]\label{4.6.5}
...
\begin{defn}[Real and imaginary parts]\label{4.6.8}
...
\begin{lem}[Complex conjugation is an involution]\label{4.6.9}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & \overline{\overline{z}} = \overline{\overline{w}} &  & \by{ac:4.6.4}                 \\
    \implies & z = w                                             &  & \text{(from the proof above)} \\
    \implies & \overline{z} = \overline{w}.                      &  & \by{ac:4.6.4}
  \end{align*}
...
\begin{defn}[Complex absolute value]\label{4.6.10}
...
\begin{lem}[Properties of complex absolute value]\label{4.6.11}
...
\begin{proof}
  ...
  \begin{align*}
    \abs{z} & = \abs{\Re(z) + i \Im(z)}                        &                         & \by{4.6.8}  \\
            & = \sqrt{\big(\Re(z)\big)^2 + \big(\Im(z)\big)^2} &                         & \by{4.6.10} \\
  ...
  \begin{align*}
    ...
    \iff & \sqrt{\big(\Re(z)\big)^2 + \big(\Im(z)\big)^2} = 0 &                         & \by{4.6.10} \\
  ...
  \begin{align*}
    ...
    \implies & \Re(z \overline{w}) = \dfrac{z \overline{w} + \overline{z} w}{2}                                       &                                        & \by{ex:4.6.5}                 \\
...
\begin{defn}[Complex reciprocal]\label{4.6.12}
...
\begin{proof}
  \begin{align*}
             & z = w                                                                                  \\
    \implies & \overline{z} = \overline{w}                           &                & \by{ac:4.6.4} \\
    \implies & z \overline{z} = w \overline{w}                       &                & \by{ac:4.6.3} \\
    \implies & \abs{z} = \abs{w}                                     &                & \by{4.6.11}   \\
    \implies & \abs{z}^{-2} = \abs{w}^{-2}                           & (z = w \neq 0)                 \\
    \implies & \abs{z}^{-2} \overline{z} = \abs{w}^{-2} \overline{w} &                & \by{ac:4.6.3} \\
    \implies & z^{-1} = w^{-1}.                                      &                & \by{4.6.12}
  \end{align*}
\end{proof}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & d(w, z) = \abs{w - z} > 0,                                                               &  & \by{4.6.10}
  \end{align*}
...
\begin{lem}[Complex limit laws]\label{4.6.14}
...
\begin{proof}
  ...
  \begin{align*}
     & \dfrac{z}{w}                                                                                                                                  \\
     & = z w^{-1}                                                                                                                                    \\
     & = z \abs{w}^{-2} \overline{w}                                                                                                &  & \by{4.6.12} \\
     & = \abs{w}^{-2} z \overline{w}                                                                                                &  & \by{4.6.6}  \\
     & = \dfrac{z \overline{w}}{\big(\Re(w)\big)^2 + \big(\Im(w)\big)^2}                                                            &  & \by{4.6.10} \\
...
\begin{ac}[Complex series]\label{ac:4.6.6}
...
\begin{proof}
  ...
  \begin{align*}
     ...
     & = d - \lim_{N \to \infty} \Bigg(\sum_{n = 0}^N \Re(a_n) + i \bigg(\sum_{n = 0}^N \Im(a_n)\bigg)\Bigg)             &  & \by{4.6.14} \\
  ...
  \begin{align*}
     ...
     & = \Bigg(d - \lim_{N \to \infty} \Re\bigg(\sum_{n = 0}^N a_n\bigg)\Bigg) + i \Bigg(d - \lim_{N \to \infty} \Im\bigg(\sum_{n = 0}^N a_n\bigg)\Bigg) &  & \by{4.6.13} \\
     & = \bigg(d - \lim_{N \to \infty} \sum_{n = 0}^N \Re(a_n)\bigg) + i \bigg(d - \lim_{N \to \infty} \sum_{n = 0}^N \Im(a_n)\bigg)                     &  & \by{4.6.3}  \\
     & = \sum_{n = 0}^\infty \Re(a_n) + i \bigg(\sum_{n = 0}^\infty \Im(a_n)\bigg).
  \end{align*}
\end{proof}

\begin{ac}[Zero test of complex series]\label{ac:4.6.7}
  Let \(d\) be the metric in \cref{4.6.10} and let \((a_n)_{n = 0}^\infty\) be a sequence in \(\C\).
...
\begin{ac}[Absolutely convergent of complex series]\label{ac:4.6.8}
  Let \(d\) be the metric in \cref{4.6.10} and let \((a_n)_{n = 0}^\infty\) be a sequence in \(\C\).
...
\begin{ac}[Cauchy Product]\label{ac:4.6.9}
...
\begin{proof}
  ...
  \begin{align*}
     ...
     & \leq \sum_{n = 0}^N \abs{a_{N - n} \beta_n} = \sum_{n = 0}^N (\abs{a_{N - n}} \abs{\beta_n})                 &  & \by{4.6.11} \\
...
\begin{defn}[Complex exponential]\label{4.6.15}
...
\begin{proof}
  \begin{align*}
    \abs{\dfrac{z}{w}} & = \abs{z w^{-1}}                                                                    \\
                       & = \abs{z \abs{w}^{-2} \overline{w}}       &                           & \by{4.6.12} \\
                       & = \abs{z} \abs{w}^{-2} \abs{\overline{w}} &                           & \by{4.6.11} \\
                       & = \abs{z} \abs{w}^{-2} \abs{w}            &                           & \by{4.6.11} \\
...
\begin{proof}
  ...
  \begin{align*}
    \abs{z + w} & = \abs{\Re(z) + \Re(w) + i \big(\Im(z) + \Im(w)\big)}              &  & \by{4.6.8}  \\
                & = \sqrt{\big(\Re(z) + \Re(w)\big)^2 + \big(\Im(z) + \Im(w)\big)^2} &  & \by{4.6.10}
  \end{align*}
  and
  \begin{align*}
    \abs{z} + \abs{w} & = \abs{\Re(z) + i \Im(z)} + \abs{\Re(w) + i \Im(w)}                                                &  & \by{4.6.8}  \\
                      & = \sqrt{\big(\Re(z)\big)^2 + \big(\Im(z)\big)^2} + \sqrt{\big(\Re(w)\big)^2 + \big(\Im(w)\big)^2}, &  & \by{4.6.10}
  \end{align*}
  we know that
  \begin{align*}
         & \abs{z + w} = \abs{z} + \abs{w}                                                                                 \\
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & \sqrt{(x - a)^2 + (y - b)^2} < \varepsilon                                                  &  & \by{4.6.10}   \\
    \implies & \sqrt{2} \sqrt{(x - a)^2 + (y - b)^2} < \sqrt{2} \varepsilon                                                   \\
    \implies & \abs{x - a} + \abs{y - b} \leq \sqrt{2} \sqrt{(x - a)^2 + (y - b)^2} < \sqrt{2} \varepsilon &  & \by{ex:1.1.8} \\
  ...
  \begin{align*}
    ...
    \implies & \sqrt{\big(\Re(x) - \Re(y)\big)^2 + \big(\Im(x) - \Im(y)\big)^2} < \varepsilon &  & \by{ex:1.1.8} \\
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & \exists r \in \R^+ : \forall x \in E, \sqrt{\big(\Re(x)\big)^2 + \big(\Im(x)\big)^2} < r &  & \by{4.6.10} \\
...
\begin{proof}
  ...
  \begin{align*}
             & \abs{z} = 0                                   &  & \by{4.6.11}                 \\
    \implies & \exp(0) = \sum_{n = 0}^\infty \dfrac{0^n}{n!} &  & \by{4.6.15}                 \\
  ...
  Since
  \begin{align*}
    \forall n \in \N, \dfrac{\abs{\dfrac{z^{n + 1}}{(n + 1)!}}}{\abs{\dfrac{z^n}{n!}}} & = \dfrac{\abs{z^{n + 1}} \abs{n!}}{\abs{z^n} \abs{(n + 1)!}} &  & \by{ex:4.6.7} \\
                                                                                       & = \dfrac{\abs{z}^{n + 1} \abs{n!}}{\abs{z}^n \abs{(n + 1)!}} &  & \by{4.6.11}   \\
                                                                                       & = \dfrac{\abs{z}}{n + 1},
  \end{align*}
  we know that
  \begin{align*}
  ...
  \begin{align*}
     & \exp(z) \exp(w)                                                                                                                     \\
     & = \bigg(\sum_{n = 0}^\infty \dfrac{z^n}{n!}\bigg) \bigg(\sum_{n = 0}^\infty \dfrac{w^n}{n!}\bigg)                &  & \by{4.6.15}   \\
     & = \sum_{n = 0}^\infty \bigg(\sum_{k = 0}^n (\dfrac{z^k}{k!} \dfrac{w^{n - k}}{(n - k)!})\bigg)                   &  & \by{ac:4.6.9} \\
     & = \sum_{n = 0}^\infty \Bigg(\dfrac{1}{n!} \sum_{k = 0}^n \bigg(\dfrac{n!}{k! (n - k)!} z^k w^{n - k}\bigg)\Bigg)                    \\
     & = \sum_{n = 0}^\infty \dfrac{(z + w)^n}{n!}                                                                      &  & \by{ex:4.2.5} \\
     & = \exp(z + w).                                                                                                   &  & \by{4.6.15}
  \end{align*}
\end{proof}
