...
\begin{proof}
    ...
    Since
    \[
        (a_1 = a_1) \land (b_1 = b_1) \iff (a_1, b_1) = (a_1, b_2),
    \]
    we know that Definition \ref{4.6.2} is reflexive.
    Since
    \begin{align*}
             & (a_1, b_1) = (a_2, b_2)       \\
        \iff & (a_1 = a_2) \land (b_1 = b_2) \\
        \iff & (a_2 = a_1) \land (b_2 = b_1) \\
        \iff & (a_2, b_2) = (a_1, b_1),
    \end{align*}
    ...
    \begin{align*}
        ...
        \iff & (a_1 = a_2) \land (b_1 = b_2) \land (a_2 = a_3) \land (b_2 = b_3)         \\
        \iff & (a_1 = a_3) \land (b_1 = b_3)                                             \\
        \iff & (a_1, b_1) = (a_3, b_3),
    \end{align*}
...
\begin{proof}
    ...
    Then we have
    \begin{align*}
        w + z & = (a, b) + (c, d)     & \text{(by Definition \ref{4.6.3})}              \\
              & = (a', b') + (c', d') & \text{(by Additional Corollary \ref{ac 4.6.1})} \\
              & = w' + z'
    \end{align*}
    and
    \begin{align*}
        -w & = -(a, b)                                                     \\
           & = -(a', b') & \text{(by Additional Corollary \ref{ac 4.6.1})} \\
           & = -w'.
    \end{align*}
\end{proof}
