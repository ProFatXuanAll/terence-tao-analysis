...
\begin{note}
  \cref{3.6.2} works particularly well in conjunction with the Weierstrass \(M\)-test
  (\cref{3.5.7}).
\end{note}
...
\begin{ex}\label{ex:3.6.1}
  Use \cref{3.6.1} to prove \cref{3.6.2}.
\end{ex}
