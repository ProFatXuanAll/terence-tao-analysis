...
\begin{note}
    ...
    Extending the convention from Example \ref{1.1.4}, if we refer to \(\R^n\) as a metric space, we assume that the metric is given by the Euclidean metric unless otherwise specified.
\end{note}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        \iff & \forall j \in \{i \in \N : 1 \leq i \leq n\}, \lim_{k \to \infty} \abs{x_j^{(k)} - x_j} = 0            & \text{(by Lemma \ref{1.1.1})}       \\
...
\begin{note}
    Because of the equivalence of Proposition \ref{1.1.18}(a), (b) and (c), we say that the Euclidean, taxicab, and sup norm metrics on \(\R^n\) are \emph{equivalent}.
...
\begin{proof}
    By Definition \ref{1.1.14} we know that \(\lim_{n \to \infty} d_{\text{disc}}(x^{(n)}, x) = 0\) iff \(\forall \varepsilon \in \R^+\), \(\exists\ N \in \N\) and \(N \geq m\) such that \(d(x^{(n)}, x) \leq \varepsilon\) for all \(n \geq N\).
...
\begin{proof}
    ...
    Thus by Definition \ref{1.1.2} \((\R, d)\) is a metric space.
\end{proof}
...
\begin{exercise}\label{ex 1.1.6}
    Show that \((\R^n, d_{l^2})\) in Example \ref{1.1.6} is indeed a metric space.
\end{exercise}
...
\begin{proof}
    ...
    \end{align*}
    Thus by Definition \ref{1.1.2} \((\R^n, d_{l^2})\) is a metric space.
\end{proof}

\begin{exercise}\label{ex 1.1.7}
    Show that \((\R^n, d_{l^1})\) in Example \ref{1.1.7} is indeed a metric space.
\end{exercise}
...
\begin{proof}
    ...
    \end{align*}
    Thus by Definition \ref{1.1.2} \((\R^n, d_{l^1})\) is a metric space.
\end{proof}
...
\begin{exercise}\label{ex 1.1.9}
    Show that \((\R^n, d_{l^\infty})\) in Example \ref{1.1.9} is indeed a metric space.
\end{exercise}
...
\begin{proof}
    ...
    \end{align*}
    Thus by Definition \ref{1.1.2} \((\R^n, d_{l^\infty})\) is a metric space.
\end{proof}
