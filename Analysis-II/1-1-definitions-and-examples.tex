...
\begin{proof}
    ...
    So
    \[
        d_{l^2}(x, y) = \bigg(\sum_{i = 1}^n (x_i - y_i)^2\bigg)^{1 / 2} > 0.
    \]
    For symmetry:
    We have
    \[
    ...
    \end{align*}
    Thus by Definition \ref{1.1.2} \((\mathbf{R}, d_{l^2})\) is a metric space.
\end{proof}
...
\begin{proof}
    ...
    So
    \[
        d_{l^1}(x, y) = \sum_{i = 1}^n \abs*{x_i - y_i} > 0.
    \]
    For symmetry:
    We have
    \[
    ...
    \end{align*}
    Thus by Definition \ref{1.1.2} \((\mathbf{R}, d_{l^1})\) is a metric space.
\end{proof}
