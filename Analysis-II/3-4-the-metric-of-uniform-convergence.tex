...
\begin{proof}
    ...
    \begin{align*}
        \forall\ f \in B(X \to Y), d_{B(X \to Y)}(f, f) & = \sup_{x \in X} d_Y\big(f(x), f(x)\big) & \text{(by Definition \ref{3.4.2})}    \\
                                                        ...
                                                        & = 0,
    \end{align*}
    we know that \(d_{B(X \to Y)}\) is reflexive.
    Since
    \begin{align*}
    ...
    \end{align*}
    we know that \(d_{B(X \to Y)}\) is positive given pair of inequivalent inputs.
    Since
    \begin{align*}
    ...
    \end{align*}
    we know that \(d_{B(X \to Y)}\) is symmetry.
    Since
    \begin{align*}
    ...
    \end{align*}
    we know that \(d_{B(X \to Y)}\) is transitive.
