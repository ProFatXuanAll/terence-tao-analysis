...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & \exists\ n \in \Z^+ : y \notin B_{(X, d)}(x, \dfrac{1}{n}) &  & \text{(by \cref{1.2.1})}         \\
    \implies & \exists\ n \in \Z^+ : y \notin V_n                                                               \\
