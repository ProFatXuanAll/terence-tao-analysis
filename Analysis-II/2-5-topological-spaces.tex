...
\begin{proof}
    ...
    Then we have
    \begin{align*}
                 & \forall\ i \in I_n, V_i \text{ is cofinite}                     \\
        ...
        \implies & \bigcap A \text{ is cofinite}
    \end{align*}
    ...
    Then we have
    \begin{align*}
                 & \forall\ V \in S, V \text{ is cofinite}             \\
        ...
        \implies & \bigcup S \text{ is cofinite}
    \end{align*}
    ...
    Let \(V_0 \in S\).
    Since \(V_0\) is cofinite, we know that \(X \setminus V_0\) is finite.
    ...
    This is true since
    \begin{align*}
                 & \forall\ n \in \mathbf{Z}^+, V_n \text{ is cofinite}                                                                                         \\
    ...
    Finally we show that the cofinite topology \((X, \mathcal{F})\) cannot be obtained by placing a metric \(d\) on \(X\).
    ...
    \end{align*}
    a contradiction.
    Thus the cofinite topology \((X, \mathcal{F})\) cannot be obtained by placing a metric \(d\) on \(X\).
\end{proof}
