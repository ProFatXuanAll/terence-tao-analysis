...
\begin{proof}
  ...
  \begin{align*}
    ...
    \implies & \exists N \geq m : \forall n \geq N, d(x^{(n)}, x) < \varepsilon            &                                          & \by{1.1.14} \\
  ...
  \begin{align*}
    ...
    \implies & \lim_{n \to \infty} d(x^{(n)}, x) = 0.                                                                    &  & \by{1.1.14}
  \end{align*}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \iff & E = \overline{E}_{(X, \mathcal{F})}.                                                         &  & \by{ex:2.5.10}
  \end{align*}
  ...
  \begin{align*}
    ...
    \iff & \overline{E}_{(X, \mathcal{F})}(E) \text{ is closed in } (X, \mathcal{F}).                                                                              &  & \by{ex:2.5.10}
  \end{align*}
  ...
  \begin{align*}
    ...
    \implies & \forall y \in X \setminus \set{x_0}, \exists V, W \in \mathcal{F} : \begin{dcases}
                                                                                     ...
                                                                                     y \in W                 \\
                                                                                     V \cap W = \emptyset
                                                                                   \end{dcases}              &  & \by{ex:2.5.4}                   \\
    \implies & \forall y \in X \setminus \set{x_0}, \exists W \in \mathcal{F} : \begin{dcases}
                                                                                  y \in W \\
                                                                                  W \subseteq (X \setminus \set{x_0})
                                                                                \end{dcases}                                \\
    \implies & \forall y \in X \setminus \set{x_0}, y \in \text{int}_{(X, \mathcal{F})}(X \setminus \set{x_0}) &  & \by{2.5.5}                    \\
    \implies & X \setminus \set{x_0} = \text{int}_{(X, \mathcal{F})}(X \setminus \set{x_0})                    &  & \by{2.5.5}                    \\
  ...
  Then by \cref{ex:2.5.1} we know that \(\mathcal{F} = \set{\emptyset, X}\) and by \cref{ex:2.5.4} \((X, \mathcal{F})\) is not Hausdorff.
...
\begin{proof}
  ...
  \begin{align*}
             & Z = \bigcup S_Z                                                                                                \\
    \implies & Z \subseteq \bigcup \set{V \in \mathcal{F}_Y : V \cap Z \in S_Z}                               &  & \by{2.5.7} \\
  ...
  \begin{align*}
    ...
    \implies & \begin{dcases}
               ...
               \end{dcases}
  \end{align*}
  Since \(\mathcal{F}_{\set{x_0}} = \set{\emptyset, \set{x_0}}\), by \cref{ex:2.5.1} we know that \((\set{x_0}, \mathcal{F}_{\set{x_0}})\) is a topological space.
  ...
  \end{align*}
  Since \(S\) is arbitrary, we conclude that every open cover of \(\set{x_0}\) has a finite subcover in \((\set{x_0}, \mathcal{F}_{\set{x_0}})\), and by \cref{2.5.9} we know that \((\set{x_0}, \mathcal{F}_{\set{x_0}})\) is compact.
...
\begin{proof}
  ...
  By \cref{2.5.7} we know that the set \(S_Y = \set{V \in \mathcal{F}_Y : V \cap f(K) \in S}\) is non-empty.
  Then we have
  \begin{align*}
             & \forall V \in S_Y, f^{-1}(V) \in \mathcal{F}_X                                                     &  & \by{ex:2.5.16} \\
