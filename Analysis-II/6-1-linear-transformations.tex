...
\begin{proof}
    ...
    \begin{align*}
        x + (-x) & = (-x) + x                                                      & \text{(from the proof above)}      \\
                 ...
                 & = 0_{\R^n}.                                                     & \text{(by Definition \ref{6.1.1})}
    \end{align*}
...
\begin{proof}
    ...
    \end{align*}
    Thus by Definition \ref{6.1.6} \(L_A\) is a linear transformation from \(\R^n\) to \(\R^m\).
\end{proof}
...
\begin{proof}
    ...
    \begin{align*}
        (T \circ S)(cx) & = T\big(S(cx)\big)                                       \\
                        ...
                        & = c (T \circ S)(x).
    \end{align*}
    Thus by Definition \ref{6.1.6} we know that \(T \circ S\) is a linear transformation from \(\R^p\) to \(\R^m\).
\end{proof}
...
\begin{proof}
    Since \(T\) is a linear transformations from \(\R^n\) to \(\R^m\), by Lemma \ref{6.1.13} we know that there exists an \(m \times n\) matrix such that
    \[
    ...
    \]
    Since \(x_0\) is arbitrary, by Definition \ref{2.1.1} this means \(T\) is continuous on \(\R^n\) from \((\R^n, d_{l^1}|_{\R^n \times \R^n})\) to \((\R^m, d_{l^1}|_{\R^m \times \R^m})\).
\end{proof}