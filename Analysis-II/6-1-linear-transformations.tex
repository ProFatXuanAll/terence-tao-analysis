...
\begin{defn}[Row vector]\label{6.1.1}
...
\begin{lem}[\(\R^n\) is a vector space]\label{6.1.2}
...
\begin{defn}[Transpose]\label{6.1.3}
...
\begin{defn}[Standard basis row vectors]\label{6.1.5}
...
\begin{defn}[Linear transformations]\label{6.1.6}
...
\setcounter{thm}{9}
\begin{defn}[Matrices]\label{6.1.10}
...
\begin{defn}[Matrix product]\label{6.1.11}
