...
\begin{proof}{(c)}
    ...
    \begin{align*}
         ...
         & \bigg(x \mapsto \sum_{n = 0}^\infty c_n (x - a)^n\bigg) \text{ on } [a - r, a + r] \text{ with respect to } d_{l^1}|_{\mathbf{R} \times \mathbf{R}} \\
         & \text{ and } \bigg(x \mapsto \sum_{n = 0}^\infty c_n (x - a)^n\bigg) \text{ is continuous on } (a - R, a + R).
    \end{align*}
\end{proof}
...
\begin{proof}{(d)}
    ...
    \begin{align*}
         ...
         & \bigg(x \mapsto \sum_{n = 1}^\infty n c_n (x - a)^{n - 1}\bigg) \text{ on } [a - r, a + r] \text{ with respect to } d_{l^1}|_{\mathbf{R} \times \mathbf{R}}.
    \end{align*}
\end{proof}
