...
\begin{defn}[Trigonometric polynomials]\label{5.3.2}
...
\begin{lem}[Characters are an orthonormal system]\label{5.3.5}
...
\begin{defn}[Fourier transform]\label{5.3.7}
